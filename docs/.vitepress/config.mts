    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'pickSquare 正方形', link: '/tools/pick-square' },
          { text: 'pickRectangle 矩形', link: '/tools/pick-rectangle' },
          { text: 'pickCircle 圆形', link: '/tools/pick-circle' },
          { text: 'pickEllipse 椭圆', link: '/tools/pick-ellipse' },
