    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '天地图', link: '/base-maps/tdt' },
          { text: '天地图三维地形', link: '/base-maps/tdt-terrain' },
          { text: 'Cesium World Terrain', link: '/base-maps/cesium-terrain' },
          { text: '星图地球 GeoVis', link: '/base-maps/geovis' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'CircleGroupLayer 范围圆', link: '/layers/circle-group' },
          { text: 'MaskLayer 区域遮罩', link: '/layers/mask' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'CloudEffect 体积云', link: '/weather/cloud' },
