...
var jg = (n, e, t) => e in n ? Qg(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var le = (n, e, t) => jg(n, typeof e != "symbol" ? e + "" : e, t);
import { ref as ed, onMounted as td, nextTick as nd, onUnmounted as rd, openBlock as id, createElementBlock as sd, createElementVNode as od, renderSlot as ad } from "vue";
...
function cd() {
  if (!Js) {
    ...
    Js = crypto.getRandomValues.bind(crypto);
  }
  return Js(ld);
}
const hd = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), xu = { randomUUID: hd };
function fd(n, e, t) {
  var o;
  n = n || {};
  const r = n.random ?? ((o = n.rng) == null ? void 0 : o.call(n)) ?? cd();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, ud(r);
}
function gd(n, e, t) {
  return xu.randomUUID && !n ? xu.randomUUID() : fd(n);
}
const Eu = (n) => {
...
function Cu(n) {
  ...
  }), w = 10 * f, S = a ? 30 * f : 0, L = 8 * f, b = v * f, k = m * f, N = 6 * f, A = 20 * f, Y = document.createElement("canvas").getContext("2d");
  let V = 0;
  if (a) {
  ...
  Y.font = `${k}px Arial, sans-serif`, _.forEach((te) => {
    const se = Y.measureText(te.text).width;
    V = Math.max(V, se);
  });
  const C = V + w * 2.5, M = k + L, T = _.length * M - L + w * 2, D = 20, B = 20 * f, z = C + B * 2, X = S + T + A + B * 2, R = document.createElement("canvas"), U = window.devicePixelRatio || 1;
  R.width = z * U, R.height = X * U, R.style.width = `${z}px`, R.style.height = `${X}px`;
  const G = R.getContext("2d");
  G.scale(U, U);
  const H = z / 2, J = X - B, W = B, j = B, Q = (te, se) => {
    let fe = te;
  ...
  G.shadowBlur = 10 * f, G.shadowColor = r, G.lineWidth = 2 * f, G.strokeStyle = Q(r, 0.8), G.beginPath(), G.moveTo(H, j + S + T), G.lineTo(H, J), G.stroke(), G.shadowBlur = D * f, G.shadowColor = r, G.lineWidth = 2 * f, G.strokeStyle = Q(r, 0.9), G.beginPath(), G.roundRect(W, j, C, S + T, N), G.stroke(), G.shadowBlur = 0, G.shadowColor = "transparent", G.save(), G.beginPath(), G.roundRect(W, j, C, S + T, N), G.clip(), a ? (G.fillStyle = Q(r, u), G.fillRect(W, j, C, S), G.fillStyle = Q(o, l), G.fillRect(W, j + S, C, T)) : (G.fillStyle = Q(o, l), G.fillRect(W, j, C, T)), G.restore(), G.shadowBlur = 0, G.shadowColor = "transparent", G.textBaseline = "middle", G.fillStyle = "#ffffff", G.textAlign = g === "center" ? "center" : "left";
  const re = g === "center" ? W + C / 2 : W + w;
  a && (G.shadowBlur = 1 * f, G.shadowColor = "rgba(0, 0, 0, 0.3)", G.shadowOffsetX = 0, G.shadowOffsetY = 0, G.font = `bold ${b}px Arial, sans-serif`, G.fillText(e, re, j + S / 2), G.shadowBlur = 0, G.shadowColor = "transparent"), G.font = `${k}px Arial, sans-serif`;
  const ee = a ? j + S : j;
  return _.forEach((te, se) => {
    G.shadowBlur = 0;
    const fe = ee + w + k / 2 + se * M;
...
function dd() {
  return [
    Kt([27426, 36814, 20351, 29992, 32, 66, 77, 97, 112, 86, 105, 101, 119, 101, 114]),
    Kt([20316, 32773, 65306, 98, 97, 110, 121, 97, 110, 54, 54, 54]),
    Kt([37038, 31665, 65306, 49, 53, 48, 50, 57, 50, 57, 54, 50, 57, 51, 64, 49, 54, 51, 46, 99, 111, 109]),
    Kt([22320, 22336, 65306, 104, 116, 116, 112, 115, 58, 47, 47, 98, 97, 110, 121, 97, 110, 54, 54, 54, 46, 103, 105, 116, 104, 117, 98, 46, 105, 111, 47, 66, 77, 97, 112, 86, 105, 101, 119, 101, 114, 47])
  ].join(`
`);
}
function md() {
  if (typeof globalThis > "u") return null;
  const n = globalThis[Kt([99, 111, 110, 115, 111, 108, 101])], e = n == null ? void 0 : n[Kt([105, 110, 102, 111])];
...
function vd() {
  ...
  if (!n) return;
  Su = !0;
  const e = Kt([37, 99]), t = Kt([37, 99, 10]);
  n(
    `${e}${dd().replace(`
`, t)}`,
    Kt([112, 97, 100, 100, 105, 110, 103, 58, 32, 52, 112, 120, 32, 56, 112, 120, 59, 32, 99, 111, 108, 111, 114, 58, 32, 35, 48, 54, 49, 53, 49, 100, 59, 32, 98, 97, 99, 107, 103, 114, 111, 117, 110, 100, 58, 32, 35, 52, 53, 101, 97, 100, 102, 59, 32, 102, 111, 110, 116, 45, 119, 101, 105, 103, 104, 116, 58, 32, 55, 48, 48, 59, 32, 102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 32, 49, 52, 112, 120, 59]),
    Kt([99, 111, 108, 111, 114, 58, 32, 35, 54, 57, 98, 57, 102, 102, 59, 32, 102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 32, 49, 50, 112, 120, 59, 32, 108, 105, 110, 101, 45, 104, 101, 105, 103, 104, 116, 58, 32, 49, 46, 55, 59])
  );
}
function yd() {
  ...
  const r = async (v, m) => {
    ...
    try {
      n = new I.Viewer(v, {
        ...
        sceneMode: (m == null ? void 0 : m.sceneMode) === 0 ? I.SceneMode.SCENE2D : I.SceneMode.SCENE3D,
        //初始场景模式
        sceneModePicker: !1,
        //是否显示3D/2D选择器，右上角按钮
        ...
        skyBox: new I.SkyBox({ show: !1 }),
        baseLayer: !1,
        // 不显示默认图层
        showRenderLoopErrors: !1
      }), m.mapConfig && (console.log("mapConfig", m), e = ((p = m.mapConfig) == null ? void 0 : p.minHeight) || 1, t = ((_ = m.mapConfig) == null ? void 0 : _.maxHeight) || 15e5, a(m.mapConfig)), n.scene.preRender.addEventListener(g), m.baseColor && (n.scene.globe.baseColor = I.Color.fromCssColorString(m.baseColor));
      let w = n.scene.screenSpaceCameraController;
      return w.tiltEventTypes = [
        I.CameraEventType.RIGHT_DRAG,
        // 右键拖动旋转
        I.CameraEventType.PINCH,
        // 保留多点触控旋转
        {
          eventType: I.CameraEventType.LEFT_DRAG,
          modifier: I.KeyboardEventModifier.CTRL
          // 保留Ctrl+左键拖动旋转
        },
        {
          eventType: I.CameraEventType.RIGHT_DRAG,
          modifier: I.KeyboardEventModifier.CTRL
          // 保留Ctrl+右键拖动旋转
        }
      ], w.zoomEventTypes = [
        I.CameraEventType.WHEEL,
        // 保留滚轮缩放
        I.CameraEventType.PINCH
        // 保留多点触控缩放
        // {
    ...
    let {
      ...
      latitude: p = 44.14712267403385,
      height: _ = 1e4,
      pitch: w = 0
    } = v;
    n.scene.camera.setView({
      destination: I.Cartesian3.fromDegrees(m, Eu({ lat: p, pitch: w, height: _ }), _),
      orientation: {
        heading: I.Math.toRadians(0),
        pitch: I.Math.toRadians(w),
        roll: 0
      }
    });
  }, u = (v, m = 3) => {
    ...
    n.camera.flyTo({
      destination: I.Cartesian3.fromDegrees(
        v.longitude,
        Eu(p),
        v.height || 800
      ),
      ...
      orientation: v.orientation || {
        heading: I.Math.toRadians(0),
        pitch: I.Math.toRadians(p.pitch),
        roll: 0
      }
    });
  }, l = () => n, f = (v) => {
    ...
    v.height < e && n.camera.setView({
      destination: I.Cartesian3.fromRadians(v.longitude, v.latitude, e),
      orientation: {
        direction: n.camera.direction,
        up: n.camera.up
      }
    }), v.height >= t && n.camera.setView({
      destination: I.Cartesian3.fromRadians(v.longitude, v.latitude, t),
      orientation: {
        direction: n.camera.direction,
        up: n.camera.up
      }
...
const pd = (n, e) => {
  ...
  for (const [r, o] of e)
    t[r] = o;
  return t;
}, _d = { class: "cesium-container" }, wd = ["id"], xd = {
  __name: "BMapViewer",
  props: {
    id: {
      type: String,
  ...
  setup(n, { expose: e, emit: t }) {
    ...
    const p = async (L) => {
      try {
        await nd(), S(), g(), l = await f(a.value, { ...r, mapConfig: L }), u = new I.ScreenSpaceEventHandler(l.scene.canvas), l.scene.moon.show = !1, l.scene.fog.enabled = !1, l.scene.sun.show = !1, I.FeatureDetection.supportsImageRenderingPixelated() && (l.resolutionScale = window.devicePixelRatio), _(), o("ready", l);
      } catch (b) {
        o("error", b);
      }
    }, _ = () => {
      !u || u.isDestroyed() || u.setInputAction((L) => {
        const b = l.scene.camera.pickEllipsoid(
          L.position,
          l.scene.globe.ellipsoid
        );
        if (!b) return;
        const k = I.Cartographic.fromCartesian(b), N = l.scene.pick(L.position);
        I.defined(N) ? o("click", {
          lon: I.Math.toDegrees(k.longitude),
          lat: I.Math.toDegrees(k.latitude),
          feature: N
        }) : o("click", { lon: I.Math.toDegrees(k.longitude), lat: I.Math.toDegrees(k.latitude) });
      }, I.ScreenSpaceEventType.LEFT_CLICK);
    }, w = () => {
      !u || u.isDestroyed() || u.removeInputAction(I.ScreenSpaceEventType.LEFT_CLICK);
    }, S = () => {
...
class Bw {
  constructor(e, t) {
    ...
    this.viewer = e, this.config = {
      ...
      icon: {
        url: ((a = t == null ? void 0 : t.icon) == null ? void 0 : a.url) || Ed,
        width: ((u = t == null ? void 0 : t.icon) == null ? void 0 : u.width) || 32,
        height: ((l = t == null ? void 0 : t.icon) == null ? void 0 : l.height) || 32
      }
    }, this.handler = null, this.label = null, this.viewer.cesiumWidget.screenSpaceEventHandler.removeInputAction(I.ScreenSpaceEventType.LEFT_DOUBLE_CLICK);
  }
  moveLabel() {
    this.handler && this.config.mouseHints.show && this.handler.setInputAction((e) => {
      const t = this.viewer.scene.camera.pickEllipsoid(e.endPosition), r = I.Cartographic.fromCartesian(t), o = I.Math.toDegrees(r.longitude), a = I.Math.toDegrees(r.latitude);
      this.addLabel(t, [o, a]);
    }, I.ScreenSpaceEventType.MOUSE_MOVE);
  }
  /**
   * 拾取点
   * @param callback
  ...
  pickPoint(e, t = []) {
    let r = null, o = t;
    const a = () => {
      r ? r.position = I.Cartesian3.fromDegrees(o[0], o[1]) : r = this.viewer.entities.add({
        position: I.Cartesian3.fromDegrees(o[0], o[1]),
        point: {
          pixelSize: this.config.pointSize,
          color: I.Color.fromCssColorString(this.config.color),
          outlineColor: I.Color.WHITE,
          outlineWidth: 2
        }
      });
    }, u = () => {
      this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.handler.setInputAction((l) => {
        const f = this.viewer.scene.pick(l.position);
        I.defined(f) && f.id === r && (document.body.style.cursor = "move", this.viewer.scene.screenSpaceCameraController.enableRotate = !1, this.viewer.scene.screenSpaceCameraController.enableTranslate = !1, this.viewer.scene.screenSpaceCameraController.enableZoom = !1, this.handler.setInputAction((g) => {
          const v = this.viewer.scene.camera.pickEllipsoid(g.endPosition);
          if (!v) return;
          const m = I.Cartographic.fromCartesian(v), p = I.Math.toDegrees(m.longitude), _ = I.Math.toDegrees(m.latitude);
          o = [p, _], r.position = I.Cartesian3.fromDegrees(o[0], o[1]);
        }, I.ScreenSpaceEventType.MOUSE_MOVE));
      }, I.ScreenSpaceEventType.LEFT_DOWN), this.handler.setInputAction((l) => {
        this.viewer.scene.screenSpaceCameraController.enableRotate = !0, this.viewer.scene.screenSpaceCameraController.enableTranslate = !0, this.viewer.scene.screenSpaceCameraController.enableZoom = !0, document.body.style.cursor = "default", this.handler.removeInputAction(I.ScreenSpaceEventType.MOUSE_MOVE);
        const f = this.viewer.scene.pick(l.position);
        I.defined(f) && f.id === r && e && e(o);
      }, I.ScreenSpaceEventType.LEFT_UP);
    };
    if (o && o.length) {
      a(), u();
      return;
    }
    this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.moveLabel(), this.handler.setInputAction((l) => {
      const f = this.viewer.scene.camera.pickEllipsoid(l.position), g = I.Cartographic.fromCartesian(f);
      let v = I.Math.toDegrees(g.longitude), m = I.Math.toDegrees(g.latitude);
  ...
  pickPointIcon(e, t = []) {
    ...
    const u = () => {
      r ? r.position = I.Cartesian3.fromDegrees(o[0], o[1]) : r = this.viewer.entities.add({
        ...
        billboard: {
          ...
          scaleByDistance: new I.NearFarScalar(5e5, 1, 1e6, 0.5),
          show: !0,
          horizontalOrigin: I.HorizontalOrigin.CENTER,
      ...
      this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.handler.setInputAction((f) => {
        const g = this.viewer.scene.pick(f.position);
        I.defined(g) && g.id === r && (a = g.id, document.body.style.cursor = "move", this.viewer.scene.screenSpaceCameraController.enableRotate = !1, this.viewer.scene.screenSpaceCameraController.enableTranslate = !1, this.viewer.scene.screenSpaceCameraController.enableZoom = !1, this.handler.setInputAction((v) => {
          const m = this.viewer.scene.camera.pickEllipsoid(v.endPosition);
          if (!m) return;
          const p = I.Cartographic.fromCartesian(m), _ = I.Math.toDegrees(p.longitude), w = I.Math.toDegrees(p.latitude);
          o = [_, w], r.position = I.Cartesian3.fromDegrees(o[0], o[1]);
        }, I.ScreenSpaceEventType.MOUSE_MOVE));
      }, I.ScreenSpaceEventType.LEFT_DOWN), this.handler.setInputAction((f) => {
        this.viewer.scene.screenSpaceCameraController.enableRotate = !0, this.viewer.scene.screenSpaceCameraController.enableTranslate = !0, this.viewer.scene.screenSpaceCameraController.enableZoom = !0, document.body.style.cursor = "default", this.handler.removeInputAction(I.ScreenSpaceEventType.MOUSE_MOVE), a === r && e && e(o);
      }, I.ScreenSpaceEventType.LEFT_UP);
    };
    if (o && o.length) {
      u(), l();
    ...
    this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.moveLabel(), this.handler.setInputAction((f) => {
      const g = this.viewer.scene.camera.pickEllipsoid(f.position), v = I.Cartographic.fromCartesian(g);
      let m = I.Math.toDegrees(v.longitude), p = I.Math.toDegrees(v.latitude);
      o = [m, p], u(), !this.config.isReserve && this.viewer.entities.remove(r), this.destroy(), this.removeLabel(), m && p && (this.config.isReserve && l(), e && e(o));
    }, I.ScreenSpaceEventType.LEFT_CLICK);
  }
  /**
   * 拾取线
   ...
   */
  pickLine(e, t = []) {
    let r = t, o = null, a = null, u = [], l = -1;
    const f = () => {
      r.length > 1 && (o ? o.polyline.positions = new I.CallbackProperty(() => r.map((m) => I.Cartesian3.fromDegrees(m[0], m[1])), !1) : o = this.viewer.entities.add({
        polyline: {
          positions: new I.CallbackProperty(() => r.map((m) => I.Cartesian3.fromDegrees(m[0], m[1])), !1),
          width: this.config.lineWidth,
          material: I.Color.fromCssColorString(this.config.color),
          clampToGround: !0,
          zIndex: 1
        }
      }));
      ...
      u.push(this.viewer.entities.add({
        position: I.Cartesian3.fromDegrees(m[0], m[1]),
        point: {
          pixelSize: this.config.pointSize,
          color: I.Color.fromCssColorString(this.config.color),
          outlineColor: I.Color.WHITE,
      ...
      this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.handler.setInputAction((m) => {
        const p = this.viewer.scene.pick(m.position);
        if (l = -1, I.defined(p)) {
          let _ = u.findIndex((w) => w === p.id);
          _ !== -1 && (l = _, document.body.style.cursor = "move", this.viewer.scene.screenSpaceCameraController.enableRotate = !1, this.viewer.scene.screenSpaceCameraController.enableTranslate = !1, this.viewer.scene.screenSpaceCameraController.enableZoom = !1, this.handler.setInputAction((w) => {
            const S = this.viewer.scene.camera.pickEllipsoid(w.endPosition);
            if (!S) return;
            const L = I.Cartographic.fromCartesian(S), b = I.Math.toDegrees(L.longitude), k = I.Math.toDegrees(L.latitude);
            r[_] = [b, k], o.polyline.positions = new I.CallbackProperty(() => r.map((N) => I.Cartesian3.fromDegrees(N[0], N[1])), !1), u[_].position.setValue(I.Cartesian3.fromDegrees(b, k));
          }, I.ScreenSpaceEventType.MOUSE_MOVE));
        }
      }, I.ScreenSpaceEventType.LEFT_DOWN), this.handler.setInputAction((m) => {
        this.viewer.scene.screenSpaceCameraController.enableRotate = !0, this.viewer.scene.screenSpaceCameraController.enableTranslate = !0, this.viewer.scene.screenSpaceCameraController.enableZoom = !0, document.body.style.cursor = "default", this.handler.removeInputAction(I.ScreenSpaceEventType.MOUSE_MOVE);
        const p = this.viewer.scene.pick(m.position);
        I.defined(p) && l > -1 && e && e(r);
      }, I.ScreenSpaceEventType.LEFT_UP);
    };
    if (r.length > 1) {
      f(), r.forEach((m) => {
    ...
    this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.handler.setInputAction((m) => {
      ...
      if (!p) return;
      const _ = I.Cartographic.fromCartesian(p), w = I.Math.toDegrees(_.longitude), S = I.Math.toDegrees(_.latitude);
      this.addLabel(p, [w, S]), r.length > 0 && (a ? a.polyline.positions = new I.CallbackProperty(() => {
        let L = r[r.length - 1];
        return [
          I.Cartesian3.fromDegrees(L[0], L[1]),
          I.Cartesian3.fromDegrees(w, S)
        ];
      }, !1) : a = this.viewer.entities.add({
        polyline: {
          positions: new I.CallbackProperty(() => {
            let L = r[r.length - 1];
            return [
              I.Cartesian3.fromDegrees(L[0], L[1]),
              I.Cartesian3.fromDegrees(w, S)
          ...
          material: new I.PolylineDashMaterialProperty({
            color: I.Color.fromCssColorString(this.config.color).withAlpha(0.5),
            // 虚线颜色及透明度
            dashLength: 20
            //短划线长度
          })
    ...
    }, I.ScreenSpaceEventType.MOUSE_MOVE), this.handler.setInputAction((m) => {
      ...
      r.push([w, S]), f(), g([w, S]);
    }, I.ScreenSpaceEventType.LEFT_CLICK), this.handler.setInputAction((m) => {
    ...
    }, I.ScreenSpaceEventType.LEFT_DOUBLE_CLICK);
  }
  /**
   * 拾取面
   * @param callback
   */
  pickPolygon(e, t = []) {
    let r = t, o = null, a = null, u = null, l = [], f = -1;
    const g = (_) => {
      _.length > 1 && (o ? o.polyline.positions = new I.CallbackProperty(() => _.map((w) => I.Cartesian3.fromDegrees(w[0], w[1])), !1) : o = this.viewer.entities.add({
        polyline: {
          positions: new I.CallbackProperty(() => _.map((w) => I.Cartesian3.fromDegrees(w[0], w[1])), !1),
          width: this.config.lineWidth,
          material: I.Color.fromCssColorString(this.config.color),
          clampToGround: !0,
          zIndex: 1
      ...
      if (r.length > 2) {
        ...
        r.forEach((w) => {
          _.push(w[0], w[1]);
        }), a ? a.polygon.hierarchy = new I.CallbackProperty(() => new I.PolygonHierarchy(I.Cartesian3.fromDegreesArray(_)), !1) : a = this.viewer.entities.add({
          polygon: {
            hierarchy: new I.CallbackProperty(() => new I.PolygonHierarchy(I.Cartesian3.fromDegreesArray(_)), !1),
            material: I.Color.fromCssColorString(this.config.color).withAlpha(0.5),
            outline: !1
          }
        });
      }
      ...
      l.push(this.viewer.entities.add({
        position: I.Cartesian3.fromDegrees(_[0], _[1]),
        point: {
          pixelSize: this.config.pointSize,
          color: I.Color.fromCssColorString(this.config.color),
          outlineColor: I.Color.WHITE,
      ...
      this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.handler.setInputAction((_) => {
        const w = this.viewer.scene.pick(_.position);
        if (f = -1, I.defined(w)) {
          let S = l.findIndex((L) => L === w.id);
          S !== -1 && (f = S, document.body.style.cursor = "move", this.viewer.scene.screenSpaceCameraController.enableRotate = !1, this.viewer.scene.screenSpaceCameraController.enableTranslate = !1, this.viewer.scene.screenSpaceCameraController.enableZoom = !1, this.handler.setInputAction((L) => {
            const b = this.viewer.scene.camera.pickEllipsoid(L.endPosition);
            if (!b) return;
            const k = I.Cartographic.fromCartesian(b), N = I.Math.toDegrees(k.longitude), A = I.Math.toDegrees(k.latitude);
            r[S] = [N, A];
            let O = [...r, r[0]];
            g(O);
            let Y = [];
            r.forEach((V) => {
              Y.push(V[0], V[1]);
            }), a.polygon.hierarchy = new I.CallbackProperty(() => new I.PolygonHierarchy(I.Cartesian3.fromDegreesArray(Y)), !1), l[S].position.setValue(I.Cartesian3.fromDegrees(N, A));
          }, I.ScreenSpaceEventType.MOUSE_MOVE));
        }
      }, I.ScreenSpaceEventType.LEFT_DOWN), this.handler.setInputAction((_) => {
        this.viewer.scene.screenSpaceCameraController.enableRotate = !0, this.viewer.scene.screenSpaceCameraController.enableTranslate = !0, this.viewer.scene.screenSpaceCameraController.enableZoom = !0, document.body.style.cursor = "default", this.handler.removeInputAction(I.ScreenSpaceEventType.MOUSE_MOVE);
        const w = this.viewer.scene.pick(_.position);
        I.defined(w) && f > -1 && e && e(r);
      }, I.ScreenSpaceEventType.LEFT_UP);
    };
    if (r.length > 1) {
      let _ = [...r, r[0]];
    ...
    this.handler = new I.ScreenSpaceEventHandler(this.viewer.scene.canvas), this.handler.setInputAction((_) => {
      ...
      if (!w) return;
      const S = I.Cartographic.fromCartesian(w), L = I.Math.toDegrees(S.longitude), b = I.Math.toDegrees(S.latitude);
      if (this.addLabel(w, [L, b]), r.length > 0 && (u ? u.polyline.positions = new I.CallbackProperty(() => {
        let k = r[r.length - 1], N = r[0];
        return [
          I.Cartesian3.fromDegrees(k[0], k[1]),
          I.Cartesian3.fromDegrees(L, b),
          I.Cartesian3.fromDegrees(N[0], N[1])
        ];
      }, !1) : u = this.viewer.entities.add({
        polyline: {
          positions: new I.CallbackProperty(() => {
            let k = r[0], N = r[r.length - 1];
            return [
              I.Cartesian3.fromDegrees(N[0], N[1]),
              I.Cartesian3.fromDegrees(L, b),
              I.Cartesian3.fromDegrees(k[0], k[1])
        ...
        r.forEach((N) => {
          k.push(N[0], N[1]);
        }), a ? a.polygon.hierarchy = new I.CallbackProperty(() => {
          let N = k[k.length - 2], A = k[k.length - 1];
          return N !== L && A !== b && k.push(L, b), new I.PolygonHierarchy(I.Cartesian3.fromDegreesArray(k));
        }, !1) : a = this.viewer.entities.add({
          polygon: {
            hierarchy: new I.CallbackProperty(() => {
              let N = k[k.length - 2], A = k[k.length - 1];
              return N !== L && A !== b && k.push(L, b), new I.PolygonHierarchy(I.Cartesian3.fromDegreesArray(k));
            }, !1),
            material: I.Color.fromCssColorString(this.config.color).withAlpha(0.5),
    ...
    }, I.ScreenSpaceEventType.MOUSE_MOVE), this.handler.setInputAction((_) => {
      const w = this.viewer.scene.camera.pickEllipsoid(_.position);
      if (!w) return;
      const S = I.Cartographic.fromCartesian(w), L = I.Math.toDegrees(S.longitude), b = I.Math.toDegrees(S.latitude);
      if (r.length > 0) {
        let k = r[r.length - 1][0], N = r[r.length - 1][1];
        if (k === L && N === b)
          return;
      }
      r.push([L, b]), g(r), m([L, b]);
    }, I.ScreenSpaceEventType.LEFT_CLICK), this.handler.setInputAction((_) => {
      if (this.viewer.entities.remove(u), this.destroy(), r.length < 3)
        ...
        if (!this.config.isReserve)
          this.viewer.entities.remove(o), this.viewer.entities.remove(a), l.forEach((w) => {
            this.viewer.entities.remove(w);
          });
        else {
          let w = [];
  ...
  addLabel(e, t) {
    this.label || (this.label = this.viewer.entities.add({
      label: {
        ...
        horizontalOrigin: I.HorizontalOrigin.LEFT,
        verticalOrigin: I.VerticalOrigin.TOP,
        pixelOffset: new I.Cartesian2(10, 10),
        fillColor: I.Color.WHITE,
        outlineColor: I.Color.BLACK,
        disableDepthTestDistance: Number.POSITIVE_INFINITY
      }
...
#endif
`;
      let l = `color = czm_saturation(color, textureSaturation);
#endif
`;
      e.invertColor && (l += `
                    color.r = 1.0 - color.r;
  ...
  hexColorToRgba(e) {
    ...
    const o = (p) => parseInt(p, 16), a = t.substring(0, 2), u = t.substring(2, 4), l = t.substring(4, 6), f = o(a), g = o(u), v = o(l);
    let m = 1;
    if (r) {
...
class Sd {
  constructor(e, t) {
    this.viewer = e, this.config = {
      ...
      height: 60,
      ...t
    }, this.billboardCollection = new I.BillboardCollection(), this.layer = this.viewer.scene.primitives.add(this.billboardCollection), this.data = [];
  }
  /**
   * 新增数据
   */
  ...
  addLayer(e) {
    ...
    const a = {
      ...this.config,
      scaleByDistance: new I.NearFarScalar(15e4, 1, 4e5, 0.5),
      position: I.Cartesian3.fromDegrees(t, r, o),
      ...
      verticalOrigin: I.VerticalOrigin.BOTTOM,
      // 从底部锚定
      id: e.properties.id || bt(),
      // 确保有唯一的标识符
      disableDepthTestDistance: this.config.disableDepthTestDistance || 100,
      // 在相机100米时进行深度测试
      color: e.properties.color ? new I.Color.fromCssColorString(e.properties.color) : this.config.color ? new I.Color.fromCssColorString(this.config.color) : new I.Color.fromCssColorString("#ffffff")
...
], Id = `data:image/svg+xml;charset=utf-8,${encodeURIComponent(`
...
function bd(n, e = I.Color.WHITE) {
  return n instanceof I.Color ? n : I.Color.fromCssColorString(n) || e;
}
function Md(n) {
  if (n instanceof I.Cartesian2) return n;
  const e = Array.isArray(n) ? n : [0, 0];
  return new I.Cartesian2(
    qt(e[0], 0),
    qt(e[1], 0)
  );
}
function Iu(n) {
  return (Array.isArray(n) && n.length ? n : Ki).map((t, r) => {
    var o;
    return {
      min: Math.max(1, Math.floor(qt(
        t.min ?? t.num,
        ((o = Ki[r]) == null ? void 0 : o.min) ?? (r + 1) * 50
      ))),
      size: Math.max(20, qt(t.size, 34)),
...
class Pd {
  constructor(e, t = {}) {
    ...
    const r = t.clusterStyles ?? t.colorArr ?? Ki;
    this.viewer = e, this.config = {
      ...kd,
      ...t,
      clusterStyles: Iu(r)
    }, this.data = [], this.dataSource = new I.CustomDataSource(t.name || "bmap-viewer-icon-cluster"), this.clusterIconCache = /* @__PURE__ */ new Map(), this.removeClusterListener = null, this.destroyed = !1, this.viewer.dataSources.add(this.dataSource), this.applyClustering(), this.bindClusterStyle();
  }
  applyClustering() {
    const e = this.dataSource.clustering;
    e.enabled = !!this.config.enabled, e.pixelRange = Math.max(0, qt(this.config.pixelRange, 36)), e.minimumClusterSize = Math.max(
      1,
      Math.floor(qt(this.config.minimumClusterSize, 2))
    ), this.forceCluster();
  }
  bindClusterStyle() {
    var e;
    (e = this.removeClusterListener) == null || e.call(this), this.removeClusterListener = this.dataSource.clustering.clusterEvent.addEventListener(
      (t, r) => {
        const o = t.length, a = this.getClusterStyle(o), u = a.size;
        r.label.show = !1, r.point.show = !1, r.billboard.show = !0, r.billboard.image = this.createClusterImage(o, a), r.billboard.width = u, r.billboard.height = u, r.billboard.color = I.Color.WHITE, r.billboard.horizontalOrigin = I.HorizontalOrigin.CENTER, r.billboard.verticalOrigin = I.VerticalOrigin.CENTER, r.billboard.disableDepthTestDistance = this.config.disableDepthTestDistance, r.billboard.id = r.label.id, r.billboard.properties = {
          type: "cluster",
          count: o,
          entities: t
        };
  ...
  getClusterStyle(e) {
    let t = this.config.clusterStyles[0];
    return this.config.clusterStyles.forEach((r) => {
      e >= r.min && (t = r);
    }), t;
  }
  createClusterImage(e, t = this.getClusterStyle(e)) {
    const r = t.strokeColor || this.config.clusterStrokeColor, o = Math.max(
      0,
      qt(t.strokeWidth, this.config.clusterStrokeWidth)
    ), a = t.textColor || this.config.clusterTextColor, u = JSON.stringify([
      e,
      t.size,
      t.color,
      r,
      o,
      a,
      t.fontSize || this.config.clusterFontSize
    ]);
    if (this.clusterIconCache.has(u)) return this.clusterIconCache.get(u);
    const l = t.size, f = 2, g = document.createElement("canvas");
    g.width = l * f, g.height = l * f;
    const v = g.getContext("2d");
    v.scale(f, f);
    const m = l / 2, p = m - Math.max(1, o / 2);
    v.beginPath(), v.arc(m, m, p, 0, Math.PI * 2), v.fillStyle = t.color, v.shadowColor = t.color, v.shadowBlur = Math.max(4, l * 0.16), v.fill(), v.shadowBlur = 0, o > 0 && (v.strokeStyle = r, v.lineWidth = o, v.stroke()), v.beginPath(), v.arc(m, m, Math.max(1, p - 4), 0, Math.PI * 2), v.strokeStyle = "rgba(255, 255, 255, 0.2)", v.lineWidth = 1, v.stroke();
    const _ = String(e), w = qt(t.fontSize, this.config.clusterFontSize), S = Math.max(10, Math.min(w, l / Math.max(2.2, _.length * 0.68)));
    v.fillStyle = a, v.font = `700 ${S}px "Cascadia Code", "Microsoft YaHei", sans-serif`, v.textAlign = "center", v.textBaseline = "middle", v.fillText(_, m, m + 0.5);
    const L = g.toDataURL("image/png");
    return this.clusterIconCache.set(u, L), L;
  }
  /**
  ...
  setData(e) {
    ...
    const r = t.map((o) => this.addLayer(o)).filter(Boolean);
    return this.forceCluster(), r;
  }
  /**
   * 从 URL、Cesium.Resource 或本地对象加载 GeoJSON 点数据。
   */
  async load(e) {
    if (typeof e != "string" && !(e instanceof I.Resource))
      return this.setData(e);
    const r = await (e instanceof I.Resource ? e : new I.Resource({ url: e })).fetchJson();
    return this.setData(r);
  }
  /**
   * 添加单个点位。
   */
  addLayer(e) {
    var g;
    const t = (g = e == null ? void 0 : e.geometry) == null ? void 0 : g.coordinates;
    ...
    const r = Number(t[0]), o = Number(t[1]), a = qt(t[2], 0);
    if (!Number.isFinite(r) || !Number.isFinite(o))
      return console.error("coordinates must contain valid longitude and latitude."), null;
    const u = e.properties || {}, l = u.id ?? e.id ?? bt(), f = this.dataSource.entities.add({
      id: String(l),
      position: I.Cartesian3.fromDegrees(r, o, a),
      properties: { ...u },
      billboard: {
        image: u.icon || e.icon || this.config.icon,
        width: qt(u.width ?? e.width, this.config.width),
        height: qt(u.height ?? e.height, this.config.height),
        color: bd(u.color || e.color || this.config.color),
        horizontalOrigin: I.HorizontalOrigin.CENTER,
        verticalOrigin: I.VerticalOrigin.BOTTOM,
        pixelOffset: Md(u.offset || e.offset || this.config.offset),
        disableDepthTestDistance: this.config.disableDepthTestDistance,
        scaleByDistance: this.config.scaleByDistance || new I.NearFarScalar(15e4, 1, 4e5, 0.5)
      }
    });
    return f.bmapViewerSource = e, f;
  }
  removeLayer(e) {
    if (!e)
      return console.error("Entity is required to remove."), !1;
    const t = this.dataSource.entities.remove(e);
    return t && this.forceCluster(), t;
  }
  getLayerById(e) {
    return e == null ? (console.error("ID is required to get."), null) : this.dataSource.entities.getById(String(e)) || null;
  }
  removeLayerById(e) {
  ...
  clearLayer() {
    this.dataSource && (this.dataSource.entities.removeAll(), this.data = [], this.forceCluster());
  }
  show() {
    this.dataSource && (this.dataSource.show = !0);
  }
  hide() {
    this.dataSource && (this.dataSource.show = !1);
  }
  setEnabled(e) {
    this.config.enabled = !!e, this.dataSource.clustering.enabled = this.config.enabled, this.forceCluster();
  }
  updateConfig(e = {}) {
    const t = Object.prototype.hasOwnProperty.call(e, "clusterStyles") ? e.clusterStyles : Object.prototype.hasOwnProperty.call(e, "colorArr") ? e.colorArr : this.config.clusterStyles;
    this.config = {
      ...this.config,
      ...e,
      clusterStyles: Iu(t)
  ...
  forceCluster() {
    ...
    const e = this.dataSource.clustering, t = e.pixelRange;
    e.pixelRange = 0, e.pixelRange = t, this.viewer.scene.requestRender();
  }
  destroy() {
    var e;
    this.destroyed || ((e = this.removeClusterListener) == null || e.call(this), this.removeClusterListener = null, this.clusterIconCache.clear(), this.clearLayer(), this.viewer && !this.viewer.isDestroyed() && this.viewer.dataSources.contains(this.dataSource) && this.viewer.dataSources.remove(this.dataSource, !0), this.dataSource = null, this.viewer = null, this.data = null, this.destroyed = !0);
  }
  isDestroyed() {
...
class Nd {
  constructor(e, t) {
    this.viewer = e, this.config = {
      ...
      offsetY: 0,
      ...t
    }, this.labelCollection = new I.LabelCollection(), this.layer = this.viewer.scene.primitives.add(this.labelCollection);
  }
  /**
   * 新增数据
   */
  ...
  addLayer(e) {
    ...
    const a = {
      ...
      verticalOrigin: I.VerticalOrigin.BOTTOM,
      // 从底部锚定
      pixelOffset: new I.Cartesian2(this.config.offsetZ || 0, this.config.offsetY || 0),
      backgroundColor: this.config.backgroundColor ? new I.Color.fromCssColorString(this.config.backgroundColor) : I.Color(0, 0, 0, 0.5),
      showBackground: this.config.showBackground || !1,
      fillColor: this.config.color ? new I.Color.fromCssColorString(this.config.color) : I.Color.WHITE,
      id: e.properties.id || bt()
      // 确保有唯一的标识符
...
class Td {
  constructor(e, t) {
    this.viewer = e, this.config = {
      ...
      width: 2,
      ...t
    }, this.polylineCollection = new I.PolylineCollection(), this.layer = this.viewer.scene.primitives.add(this.polylineCollection);
  }
  /**
   * 设置数据
   */
  ...
  getMaterial(e, t = {}) {
    var o, a, u, l, f, g, v, m;
    const r = t.color ? I.Color.fromCssColorString(t.color) : I.Color.fromCssColorString(this.config.color);
    switch (e) {
      case "default":
        return I.Material.fromType("Color", {
          color: r
        });
      case "dash":
        return I.Material.fromType("PolylineDash", {
          color: r,
          dashLength: (t == null ? void 0 : t.dashLength) || ((o = this.config) == null ? void 0 : o.dashLength) || 16,
          gapColor: t != null && t.gapColor ? new I.Color.fromCssColorString(t == null ? void 0 : t.gapColor) : (a = this.config) != null && a.gapColor ? new I.Color.fromCssColorString((u = this.config) == null ? void 0 : u.gapColor) : I.Color.TRANSPARENT
        });
      case "glow":
        return I.Material.fromType("PolylineGlow", {
          glowPower: t.glowPower || ((l = this.config) == null ? void 0 : l.glowPower) || 0.25,
          taperPower: t.taperPower || ((f = this.config) == null ? void 0 : f.taperPower) || 1,
          color: r
        });
      case "outline":
        return I.Material.fromType("PolylineOutline", {
          color: r,
          outlineColor: t.outlineColor ? I.Color.fromCssColorString(t.outlineColor) : (g = this.config) != null && g.outlineColor ? new I.Color.fromCssColorString((v = this.config) == null ? void 0 : v.outlineColor) : new I.Color.fromCssColorString("#ff0000"),
          outlineWidth: t.outlineWidth || ((m = this.config) == null ? void 0 : m.outlineWidth) || 1
        });
      case "arrow":
        return I.Material.fromType("PolylineArrow", {
          color: r
        });
      default:
        return I.Material.fromType("Color", {
  ...
  addLayer(e) {
    var l, f, g, v;
    if (!((l = e == null ? void 0 : e.geometry) != null && l.coordinates)) {
      console.error("缺少coordinates字段");
      return;
    }
    ...
    const o = ((f = e.properties) == null ? void 0 : f.type) || this.config.type, a = this.getMaterial(o, e.properties), u = this.polylineCollection.add({
      positions: I.Cartesian3.fromDegreesArray(r),
      width: ((g = e == null ? void 0 : e.properties) == null ? void 0 : g.width) || this.config.width,
      material: a,
      id: ((v = e.properties) == null ? void 0 : v.id) || bt()
    });
    return u.properties = {
      ...e.properties
    }, u;
...
class Rd {
  ...
  setData(e) {
    ...
    e.forEach((a) => {
      var g;
      let u = a.geometry.coordinates, l = [];
      u.forEach((v) => {
        l.push(v[0], v[1]);
      });
      const f = new I.PolylineGeometry({
        positions: I.Cartesian3.fromDegreesArray(l),
        width: ((g = a == null ? void 0 : a.properties) == null ? void 0 : g.width) || this.config.width,
        vertexFormat: I.PolylineMaterialAppearance.VERTEX_FORMAT
      });
      f.properties = {
        ...a.properties
      }, t.push(
        new I.GeometryInstance({
          geometry: f,
          id: a.properties.id || bt(),
          attributes: {
            color: I.ColorGeometryInstanceAttribute.fromColor(
              a.properties.color ? new I.Color.fromCssColorString(a.properties.color) : new I.Color.fromCssColorString(this.config.color)
            )
          }
        })
      );
    });
    const r = new I.PolylineColorAppearance(
      {
        translucent: !1,
        renderState: I.RenderState.fromCache({
          depthTest: { enabled: !0 },
          depthMask: !0,
          //写入深度，防止颜色污染
          blending: I.BlendingState.ALPHA_BLEND
        })
      }
    ), o = new I.Primitive({
      geometryInstances: t,
...
class Ad {
  ...
  async load(e) {
    try {
      this.tileset = await I.Cesium3DTileset.fromUrl(e || this.config.url, {
  ...
  setStyle(e) {
    let t = e || [];
    this.tileset && (this.tileset.style = new I.Cesium3DTileStyle({
      color: {
        conditions: t
      }
    }));
  ...
  setShader(e) {
    const t = {
      ...
      u_sweep_color: { value: I.Color.fromCssColorString(t.sweepColor), type: I.UniformType.VEC3 },
      u_mix_color1: { value: I.Color.fromCssColorString(t.minColor), type: I.UniformType.VEC3 },
      u_mix_color2: { value: I.Color.fromCssColorString(t.maxColor), type: I.UniformType.VEC3 },
      u_sweep_width: { value: t.sweepWidth, type: I.UniformType.FLOAT },
      u_time: { value: 0, type: I.UniformType.FLOAT },
      u_model_height: { value: t.modelHeight, type: I.UniformType.FLOAT },
      u_height_offset: { value: t.heightOffset, type: I.UniformType.FLOAT },
      u_min_interval: { value: t.minInterval, type: I.UniformType.FLOAT },
      u_max_interval: { value: t.maxInterval, type: I.UniformType.FLOAT },
      u_speed: { value: t.speed, type: I.UniformType.FLOAT }
    }, o = new I.CustomShader({
      //不考虑光照模型
      ...
      uniforms: r,
      varyings: { v_uv: I.VaryingType.VEC2 }
    });
...
class Od {
  ...
  addLayer(e) {
    ...
    const r = I.Cartesian3.fromDegrees(t[0], t[1]), o = ((g = e == null ? void 0 : e.properties) == null ? void 0 : g.id) || bt(), a = document.createElement("div");
    ...
    return typeof this.eventListener != "function" && (this.eventListener = () => this.render(), this.viewer.clock.onTick.addEventListener(this.eventListener)), { id: o, element: a, updateContent: l };
  }
  render() {
    const e = [];
    if (Object.keys(this.ctnList).forEach((r) => {
      const o = this.ctnList[r], a = I.SceneTransforms.wgs84ToWindowCoordinates(
        this.viewer.scene,
        o.geometry
      );
      if (!a) {
  ...
  checkOverlap(e, t, r = 0.5) {
    ...
    ), u = o * a, l = Math.min(e.width * e.height, t.width * t.height);
    return u / l > r;
  }
  updateContent(e, t) {
...
function si(n, e = "kilometers") {
  const t = gs[e];
  if (!t)
    throw new Error(e + " units is invalid");
  return n * t;
}
function vr(n, e = "kilometers") {
  const t = gs[e];
  if (!t)
    throw new Error(e + " units is invalid");
  return n / t;
...
function Dn(n, e = "kilometers", t = "kilometers") {
  if (!(n >= 0))
    throw new Error("length must be a positive number");
  return si(vr(n, e), t);
}
function Jo(n, e = "meters", t = "kilometers") {
  if (!(n >= 0))
...
function wn(n) {
  delete n.bbox, n.type === "Feature" ? n.geometry && wn(n.geometry) : n.type === "FeatureCollection" ? n.features.forEach(wn) : n.type === "GeometryCollection" && n.geometries.forEach(wn);
}
function Wr(n) {
  if (!n)
...
function fn(n, e, t = {}) {
  if (t.final === !0)
    return Bd(n, e);
  const r = Me(n), o = Me(e), a = Qe(r[0]), u = Qe(o[0]), l = Qe(r[1]), f = Qe(o[1]), g = Math.sin(u - a) * Math.cos(f), v = Math.cos(l) * Math.sin(f) - Math.sin(l) * Math.cos(f) * Math.cos(u - a);
  return jt(Math.atan2(g, v));
}
function Bd(n, e) {
  let t = fn(e, n);
...
function en(n, e, t, r = {}) {
  const o = Me(n), a = Qe(o[0]), u = Qe(o[1]), l = Qe(t), f = vr(e, r.units), g = Math.asin(
    Math.sin(u) * Math.cos(f) + Math.cos(u) * Math.sin(f) * Math.cos(l)
  ), v = a + Math.atan2(
    Math.sin(l) * Math.sin(f) * Math.cos(u),
    Math.cos(f) - Math.sin(u) * Math.sin(g)
  ), m = jt(v), p = jt(g);
  return o[2] !== void 0 ? de([m, p, o[2]], r.properties) : de([m, p], r.properties);
}
function ze(n, e, t = {}) {
  var r = Me(n), o = Me(e), a = Qe(o[1] - r[1]), u = Qe(o[0] - r[0]), l = Qe(r[1]), f = Qe(o[1]), g = Math.pow(Math.sin(a / 2), 2) + Math.pow(Math.sin(u / 2), 2) * Math.cos(l) * Math.cos(f);
  return si(
...
function Fn(n, e, t = {}) {
  let r;
  return t.final ? r = ku(Me(e), Me(n)) : r = ku(Me(n), Me(e)), r > 180 ? -(360 - r) : r;
}
function ku(n, e) {
...
function zd(n, e, t, r = {}) {
  ...
  const o = n, a = e, u = t, l = lr(
    r.mercator !== !0 ? fn(a, o) : Fn(a, o)
  );
  let f = lr(
    r.mercator !== !0 ? fn(a, u) : Fn(a, u)
  );
  f < l && (f = f + 360);
  const g = f - l;
...
function He(n, e, t) {
  if (n !== null)
    for (var r, o, a, u, l, f, g, v = 0, m = 0, p, _ = n.type, w = _ === "FeatureCollection", S = _ === "Feature", L = w ? n.features.length : 1, b = 0; b < L; b++) {
      g = w ? (
        ...
        // @ts-expect-error: Known type conflict
        n.geometry
      ) : n, p = g ? g.type === "GeometryCollection" : !1, l = p ? g.geometries.length : 1;
      for (var k = 0; k < l; k++) {
        var N = 0, A = 0;
        if (u = p ? g.geometries[k] : g, u !== null) {
          f = u.coordinates;
          var O = u.type;
...
function at(n, e) {
  var t, r, o, a, u, l, f, g, v, m, p = 0, _ = n.type === "FeatureCollection", w = n.type === "Feature", S = _ ? n.features.length : 1;
  for (t = 0; t < S; t++) {
    for (l = _ ? (
      // @ts-expect-error: Known type conflict
      ...
      // @ts-expect-error: Known type conflict
      n.id
    ) : void 0, f = l ? l.type === "GeometryCollection" : !1, u = f ? l.geometries.length : 1, o = 0; o < u; o++) {
      if (a = f ? l.geometries[o] : l, a === null) {
        if (
          // @ts-expect-error: Known type conflict
          e(
            // @ts-expect-error: Known type conflict
...
function Hc(n, e) {
  ...
  var t = e.featureIndex || 0, r = e.multiFeatureIndex || 0, o = e.geometryIndex || 0, a = e.segmentIndex || 0, u = e.properties, l;
  switch (n.type) {
    case "FeatureCollection":
      t < 0 && (t = n.features.length + t), u = u || n.features[t].properties, l = n.features[t].geometry;
      break;
    case "Feature":
      u = u || n.properties, l = n.geometry;
      break;
    case "Point":
    case "MultiPoint":
      return null;
  ...
  switch (l.type) {
    ...
    case "Polygon":
      return o < 0 && (o = f.length + o), a < 0 && (a = f[o].length + a - 1), ke(
        [
          // @ts-expect-error: Known type conflict
          f[o][a],
          // @ts-expect-error: Known type conflict
...
function Wc(n, e) {
  if (e = e || {}, !Oe(e)) throw new Error("options is invalid");
  var t = e.featureIndex || 0, r = e.multiFeatureIndex || 0, o = e.geometryIndex || 0, a = e.coordIndex || 0, u = e.properties, l;
  switch (n.type) {
    case "FeatureCollection":
      t < 0 && (t = n.features.length + t), u = u || n.features[t].properties, l = n.features[t].geometry;
      break;
...
var Yd = Be * Be / 2, Qs = Math.PI / 180;
function Mu(n) {
  const e = n.length - 1;
  if (e <= 2) return 0;
  let t = 0, r = 0;
  for (; r < e; ) {
    const o = n[r], a = n[r + 1 === e ? 0 : r + 1], u = n[r + 2 >= e ? (r + 2) % e : r + 2], l = o[0] * Qs, f = a[1] * Qs, g = u[0] * Qs;
    t += (g - l) * Math.sin(f), r++;
  }
  return t * Yd;
}
...
function Xd(n, e, t) {
  var r = n.length, o = er(n[0], e), a = [], u, l, f;
  let g, v;
  for (t || (t = []), u = 1; u < r; u++) {
    for (g = n[u - 1], v = n[u], l = f = er(v, e); ; )
      if (o | l) {
        if (o & l)
          break;
        o ? (g = Eo(g, v, o, e), o = er(g, e)) : (v = Eo(g, v, l, e), l = er(v, e));
      } else {
        a.push(g), l !== f ? (a.push(v), u < r - 1 && (t.push(a), a = [])) : u === r - 1 && a.push(v);
        break;
      }
    o = f;
  }
...
function Vd(n, e) {
  var t, r, o, a, u, l, f;
  for (r = 1; r <= 8; r *= 2) {
    for (t = [], o = n[n.length - 1], a = !(er(o, e) & r), u = 0; u < n.length; u++)
      l = n[u], f = !(er(l, e) & r), f !== a && t.push(Eo(o, l, r, e)), f && t.push(l), o = l, a = f;
...
function Hd(n, e) {
  ...
  switch (r) {
    ...
    case "MultiLineString": {
      const u = [];
      return r === "LineString" && (a = [a]), a.forEach((l) => {
        Xd(l, e, u);
      }), u.length === 1 ? ke(u[0], o) : En(u, o);
    }
    case "Polygon":
      return ye(Lu(a, e), o);
    case "MultiPolygon":
...
function Kd(n, e = {}) {
  const t = e.resolution || 1e4, r = e.sharpness || 0.85, o = [], a = Ye(n).coordinates.map((g) => ({ x: g[0], y: g[1] })), u = new Wd({
    duration: t,
    points: a,
    sharpness: r
  }), l = (g) => {
  ...
  for (var f = 0; f < u.duration; f += 10)
    l(f);
  return l(u.duration), ke(o, e.properties);
}
function Qi(n) {
  const e = me(n);
  let t = 0, r = 1, o, a;
...
function Jd(n) {
  ...
  for (let o = 0; o < r; o++) {
    const a = e[0][(o + 2) % r][0] - e[0][(o + 1) % r][0], u = e[0][(o + 2) % r][1] - e[0][(o + 1) % r][1], l = e[0][o][0] - e[0][(o + 1) % r][0], f = e[0][o][1] - e[0][(o + 1) % r][1], g = a * f - u * l;
    if (o === 0)
      t = g > 0;
    else if (t !== g > 0)
      return !0;
...
const cn = 11102230246251565e-32, lt = 134217729, Qd = (3 + 8 * cn) * cn;
function js(n, e, t, r, o) {
  let a, u, l, f, g = e[0], v = r[0], m = 0, p = 0;
  v > g == v > -g ? (a = g, g = e[++m]) : (a = v, v = r[++p]);
  let _ = 0;
  if (m < n && p < t)
    for (v > g == v > -g ? (u = g + a, l = a - (u - g), g = e[++m]) : (u = v + a, l = a - (u - v), v = r[++p]), a = u, l !== 0 && (o[_++] = l); m < n && p < t; )
      v > g == v > -g ? (u = a + g, f = u - a, l = a - (u - f) + (g - f), g = e[++m]) : (u = a + v, f = u - a, l = a - (u - f) + (v - f), v = r[++p]), a = u, l !== 0 && (o[_++] = l);
  for (; m < n; )
    u = a + g, f = u - a, l = a - (u - f) + (g - f), g = e[++m], a = u, l !== 0 && (o[_++] = l);
  for (; p < t; )
    u = a + v, f = u - a, l = a - (u - f) + (v - f), v = r[++p], a = u, l !== 0 && (o[_++] = l);
...
const em = (3 + 16 * cn) * cn, tm = (2 + 12 * cn) * cn, nm = (9 + 64 * cn) * cn * cn, $n = li(4), Pu = li(8), Nu = li(12), Tu = li(16), mt = li(4);
function rm(n, e, t, r, o, a, u) {
  let l, f, g, v, m, p, _, w, S, L, b, k, N, A, O, Y, V, C;
  const M = n - o, T = t - o, D = e - a, B = r - a;
  A = M * B, p = lt * M, _ = p - (p - M), w = M - _, p = lt * B, S = p - (p - B), L = B - S, O = w * L - (A - _ * S - w * S - _ * L), Y = D * T, p = lt * D, _ = p - (p - D), w = D - _, p = lt * T, S = p - (p - T), L = T - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, $n[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, $n[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, $n[2] = k - (C - m) + (b - m), $n[3] = C;
  let z = jd(4, $n), X = tm * u;
  if (z >= X || -z >= X || (m = n - M, l = n - (M + m) + (m - o), m = t - T, g = t - (T + m) + (m - o), m = e - D, f = e - (D + m) + (m - a), m = r - B, v = r - (B + m) + (m - a), l === 0 && f === 0 && g === 0 && v === 0) || (X = nm * u + Qd * Math.abs(z), z += M * v + B * l - (D * g + T * f), z >= X || -z >= X)) return z;
  A = l * B, p = lt * l, _ = p - (p - l), w = l - _, p = lt * B, S = p - (p - B), L = B - S, O = w * L - (A - _ * S - w * S - _ * L), Y = f * T, p = lt * f, _ = p - (p - f), w = f - _, p = lt * T, S = p - (p - T), L = T - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, mt[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, mt[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, mt[2] = k - (C - m) + (b - m), mt[3] = C;
  const R = js(4, $n, 4, mt, Pu);
  A = M * v, p = lt * M, _ = p - (p - M), w = M - _, p = lt * v, S = p - (p - v), L = v - S, O = w * L - (A - _ * S - w * S - _ * L), Y = D * g, p = lt * D, _ = p - (p - D), w = D - _, p = lt * g, S = p - (p - g), L = g - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, mt[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, mt[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, mt[2] = k - (C - m) + (b - m), mt[3] = C;
  const U = js(R, Pu, 4, mt, Nu);
  A = l * v, p = lt * l, _ = p - (p - l), w = l - _, p = lt * v, S = p - (p - v), L = v - S, O = w * L - (A - _ * S - w * S - _ * L), Y = f * g, p = lt * f, _ = p - (p - f), w = f - _, p = lt * g, S = p - (p - g), L = g - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, mt[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, mt[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, mt[2] = k - (C - m) + (b - m), mt[3] = C;
  const G = js(U, Nu, 4, mt, Tu);
  return Tu[G - 1];
}
function im(n, e, t, r, o, a) {
  const u = (e - a) * (t - o), l = (n - o) * (r - a), f = u - l, g = Math.abs(u + l);
  return Math.abs(f) >= em * g ? f : -rm(n, e, t, r, o, a, g);
}
function sm(n, e) {
  var t, r, o = 0, a, u, l, f, g, v, m, p = n[0], _ = n[1], w = e.length;
  for (t = 0; t < w; t++) {
    r = 0;
    var S = e[t], L = S.length - 1;
    if (v = S[0], v[0] !== S[L][0] && v[1] !== S[L][1])
      throw new Error("First and last coordinates in a ring must be the same");
    for (u = v[0] - p, l = v[1] - _, r; r < L; r++) {
      if (m = S[r + 1], f = m[0] - p, g = m[1] - _, l === 0 && g === 0) {
        if (f <= 0 && u >= 0 || u <= 0 && f >= 0)
          return 0;
      } else if (g >= 0 && l <= 0 || g <= 0 && l >= 0) {
        if (a = im(u, f, l, g, 0, 0), a === 0)
          return 0;
        (a > 0 && g > 0 && l <= 0 || a < 0 && g <= 0 && l > 0) && o++;
      }
      v = m, l = g, u = f;
    }
  }
...
function Ie(n, e, t = {}) {
  ...
  for (let a = 0; a < o.length - 1; a++) {
    let u = !1;
    if (t.ignoreEndVertices && (a === 0 && (u = "start"), a === o.length - 2 && (u = "end"), a === 0 && a + 1 === o.length - 1 && (u = "both")), am(
      o[a],
      o[a + 1],
      r,
      u,
...
function am(n, e, t, r, o) {
  const a = t[0], u = t[1], l = n[0], f = n[1], g = e[0], v = e[1], m = t[0] - l, p = t[1] - f, _ = g - l, w = v - f, S = m * w - p * _;
  if (o !== null) {
    if (Math.abs(S) > o)
      return !1;
  } else if (S !== 0)
  ...
  if (r) {
    if (r === "start")
      return Math.abs(_) >= Math.abs(w) ? _ > 0 ? l < a && a <= g : g <= a && a < l : w > 0 ? f < u && u <= v : v <= u && u < f;
    if (r === "end")
      return Math.abs(_) >= Math.abs(w) ? _ > 0 ? l <= a && a < g : g < a && a <= l : w > 0 ? f <= u && u < v : v < u && u <= f;
    if (r === "both")
      return Math.abs(_) >= Math.abs(w) ? _ > 0 ? l < a && a < g : g < a && a < l : w > 0 ? f < u && u < v : v < u && u < f;
  } else return Math.abs(_) >= Math.abs(w) ? _ > 0 ? l <= a && a <= g : g <= a && a <= l : w > 0 ? f <= u && u <= v : v <= u && u <= f;
  return !1;
}
function um(n, e, t, r, o) {
  $c(n, e, t || 0, r || n.length - 1, o || lm);
}
function $c(n, e, t, r, o) {
  for (; r > t; ) {
    if (r - t > 600) {
      var a = r - t + 1, u = e - t + 1, l = Math.log(a), f = 0.5 * Math.exp(2 * l / 3), g = 0.5 * Math.sqrt(l * f * (a - f) / a) * (u - a / 2 < 0 ? -1 : 1), v = Math.max(t, Math.floor(e - u * f / a + g)), m = Math.min(r, Math.floor(e + (a - u) * f / a + g));
      $c(n, e, v, m, o);
    }
    var p = n[e], _ = t, w = r;
    for (Mr(n, t, e), o(n[r], p) > 0 && Mr(n, t, r); _ < w; ) {
      for (Mr(n, _, w), _++, w--; o(n[_], p) < 0; ) _++;
      for (; o(n[w], p) > 0; ) w--;
    }
    o(n[t], p) === 0 ? Mr(n, t, w) : (w++, Mr(n, w, r)), w <= e && (t = w + 1), e <= w && (r = w - 1);
  }
}
function Mr(n, e, t) {
  var r = n[e];
...
let yr = class {
  ...
  search(e) {
    ...
    for (; t; ) {
      for (let u = 0; u < t.children.length; u++) {
        const l = t.children[u], f = t.leaf ? o(l) : l;
        ki(e, f) && (t.leaf ? r.push(l) : to(e, f) ? this._all(l, r) : a.push(l));
      }
      t = a.pop();
    }
    return r;
  ...
  remove(e, t) {
    ...
    let l, f, g;
    for (; r || a.length; ) {
      if (r || (r = a.pop(), f = a[a.length - 1], l = u.pop(), g = !0), r.leaf) {
        const v = cm(e, r.children, t);
        if (v !== -1)
          return r.children.splice(v, 1), a.push(r), this._condense(a), this;
      }
      !g && !r.leaf && to(r, o) ? (a.push(r), u.push(l), l = 0, f = r, r = r.children[0]) : f ? (l++, r = f.children[l], g = !1) : r = null;
    }
    return this;
  }
  toBBox(e) {
  ...
  _build(e, t, r, o) {
    const a = r - t + 1;
    let u = this._maxEntries, l;
    if (a <= u)
      return l = jn(e.slice(t, r + 1)), Zn(l, this.toBBox), l;
    o || (o = Math.ceil(Math.log(a) / Math.log(u)), u = Math.ceil(a / Math.pow(u, o - 1))), l = jn([]), l.leaf = !1, l.height = o;
    const f = Math.ceil(a / u), g = f * Math.ceil(Math.sqrt(u));
    Ru(e, t, r, g, this.compareMinX);
    for (let v = t; v <= r; v += g) {
      const m = Math.min(v + g - 1, r);
      Ru(e, v, m, f, this.compareMinY);
      for (let p = v; p <= m; p += f) {
        const _ = Math.min(p + f - 1, m);
        l.children.push(this._build(e, p, _, o - 1));
      }
    }
    return Zn(l, this.toBBox), l;
  }
  _chooseSubtree(e, t, r, o) {
    for (; o.push(t), !(t.leaf || o.length - 1 === r); ) {
      let a = 1 / 0, u = 1 / 0, l;
      for (let f = 0; f < t.children.length; f++) {
        const g = t.children[f], v = eo(g), m = gm(e, g) - v;
        m < u ? (u = m, a = v < a ? v : a, l = g) : m === u && v < a && (a = v, l = g);
      }
      t = l || t.children[0];
    }
    return t;
  ...
  _insert(e, t, r) {
    ...
    for (u.children.push(e), Dr(u, o); t >= 0 && a[t].children.length > this._maxEntries; )
      this._split(a, t), t--;
  ...
  _split(e, t) {
    ...
    const u = this._chooseSplitIndex(r, a, o), l = jn(r.children.splice(u, r.children.length - u));
    l.height = r.height, l.leaf = r.leaf, Zn(r, this.toBBox), Zn(l, this.toBBox), t ? e[t - 1].children.push(l) : this._splitRoot(r, l);
  }
  _splitRoot(e, t) {
    this.data = jn([e, t]), this.data.height = e.height + 1, this.data.leaf = !1, Zn(this.data, this.toBBox);
  }
  _chooseSplitIndex(e, t, r) {
    let o, a = 1 / 0, u = 1 / 0;
    for (let l = t; l <= r - t; l++) {
      const f = Or(e, 0, l, this.toBBox), g = Or(e, l, r, this.toBBox), v = dm(f, g), m = eo(f) + eo(g);
      v < a ? (a = v, o = l, u = m < u ? m : u) : v === a && m < u && (u = m, o = l);
    }
    return o || r - t;
  }
  // sorts node children by the best axis for split
  _chooseSplitAxis(e, t, r) {
    const o = e.leaf ? this.compareMinX : hm, a = e.leaf ? this.compareMinY : fm, u = this._allDistMargin(e, t, r, o), l = this._allDistMargin(e, t, r, a);
    u < l && e.children.sort(o);
  }
  // total margin of all possible split distributions where each node is at least m full
  _allDistMargin(e, t, r, o) {
    e.children.sort(o);
    const a = this.toBBox, u = Or(e, 0, t, a), l = Or(e, r - t, r, a);
    let f = Ii(u) + Ii(l);
    for (let g = t; g < r - t; g++) {
      const v = e.children[g];
      Dr(u, e.leaf ? a(v) : v), f += Ii(u);
    }
    for (let g = r - t - 1; g >= t; g--) {
      const v = e.children[g];
      Dr(l, e.leaf ? a(v) : v), f += Ii(l);
    }
    return f;
  }
  ...
  _condense(e) {
    for (let t = e.length - 1, r; t >= 0; t--)
      e[t].children.length === 0 ? t > 0 ? (r = e[t - 1].children, r.splice(r.indexOf(e[t]), 1)) : this.clear() : Zn(e[t], this.toBBox);
  }
};
function cm(n, e, t) {
...
function Zn(n, e) {
  Or(n, 0, n.children.length, e, n);
}
function Or(n, e, t, r, o) {
  o || (o = jn(null)), o.minX = 1 / 0, o.minY = 1 / 0, o.maxX = -1 / 0, o.maxY = -1 / 0;
  for (let a = e; a < t; a++) {
...
var vm = class {
  constructor(e = 9) {
    this.tree = new yr(e), this.tree.toBBox = no;
  }
  /**
   ...
   */
  collides(e) {
    return this.tree.collides(no(e));
  }
  /**
...
function _m(n, e) {
  ...
  return n.reduce((r, o) => {
    const a = ke([r, o], e);
    return a.bbox = wm(r, o), t.push(a), o;
  }), t;
}
function wm(n, e) {
  const t = n[0], r = n[1], o = e[0], a = e[1], u = t < o ? t : o, l = r < a ? r : a, f = t > o ? t : o, g = r > a ? r : a;
  return [u, l, f, g];
}
class sa {
  constructor(e = [], t = xm) {
  ...
  _down(e) {
    ...
    for (; e < o; ) {
      let u = (e << 1) + 1, l = t[u];
      const f = u + 1;
      if (f < this.length && r(t[f], l) < 0 && (u = f, l = t[f]), r(l, a) >= 0) break;
      t[e] = l, e = u;
    }
    t[e] = a;
  }
...
const Em = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: sa
}, Symbol.toStringTag, { value: "Module" })), hn = 11102230246251565e-32, ct = 134217729, Cm = (3 + 8 * hn) * hn;
...
const Im = (3 + 16 * hn) * hn, km = (2 + 12 * hn) * hn, bm = (9 + 64 * hn) * hn * hn, Kn = ci(4), Au = ci(8), Ou = ci(12), Du = ci(16), vt = ci(4);
function Mm(n, e, t, r, o, a, u) {
  let l, f, g, v, m, p, _, w, S, L, b, k, N, A, O, Y, V, C;
  const M = n - o, T = t - o, D = e - a, B = r - a;
  A = M * B, p = ct * M, _ = p - (p - M), w = M - _, p = ct * B, S = p - (p - B), L = B - S, O = w * L - (A - _ * S - w * S - _ * L), Y = D * T, p = ct * D, _ = p - (p - D), w = D - _, p = ct * T, S = p - (p - T), L = T - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, Kn[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, Kn[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, Kn[2] = k - (C - m) + (b - m), Kn[3] = C;
  let z = Sm(4, Kn), X = km * u;
  if (z >= X || -z >= X || (m = n - M, l = n - (M + m) + (m - o), m = t - T, g = t - (T + m) + (m - o), m = e - D, f = e - (D + m) + (m - a), m = r - B, v = r - (B + m) + (m - a), l === 0 && f === 0 && g === 0 && v === 0) || (X = bm * u + Cm * Math.abs(z), z += M * v + B * l - (D * g + T * f), z >= X || -z >= X)) return z;
  A = l * B, p = ct * l, _ = p - (p - l), w = l - _, p = ct * B, S = p - (p - B), L = B - S, O = w * L - (A - _ * S - w * S - _ * L), Y = f * T, p = ct * f, _ = p - (p - f), w = f - _, p = ct * T, S = p - (p - T), L = T - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, vt[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, vt[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, vt[2] = k - (C - m) + (b - m), vt[3] = C;
  const R = ro(4, Kn, 4, vt, Au);
  A = M * v, p = ct * M, _ = p - (p - M), w = M - _, p = ct * v, S = p - (p - v), L = v - S, O = w * L - (A - _ * S - w * S - _ * L), Y = D * g, p = ct * D, _ = p - (p - D), w = D - _, p = ct * g, S = p - (p - g), L = g - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, vt[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, vt[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, vt[2] = k - (C - m) + (b - m), vt[3] = C;
  const U = ro(R, Au, 4, vt, Ou);
  A = l * v, p = ct * l, _ = p - (p - l), w = l - _, p = ct * v, S = p - (p - v), L = v - S, O = w * L - (A - _ * S - w * S - _ * L), Y = f * g, p = ct * f, _ = p - (p - f), w = f - _, p = ct * g, S = p - (p - g), L = g - S, V = w * L - (Y - _ * S - w * S - _ * L), b = O - V, m = O - b, vt[0] = O - (b + m) + (m - V), k = A + b, m = k - A, N = A - (k - m) + (b - m), b = N - Y, m = N - b, vt[1] = N - (b + m) + (m - Y), C = k + b, m = C - k, vt[2] = k - (C - m) + (b - m), vt[3] = C;
  const G = ro(U, Ou, 4, vt, Du);
  return Du[G - 1];
}
function Fu(n, e, t, r, o, a) {
  const u = (e - a) * (t - o), l = (n - o) * (r - a), f = u - l;
  if (u === 0 || l === 0 || u > 0 != l > 0) return f;
  const g = Math.abs(u + l);
  return Math.abs(f) >= Im * g ? f : -Mm(n, e, t, r, o, a, g);
}
function Lm(n, e) {
  const t = new sa([], Kc);
  return Nm(n, t), Tm(t, e);
}
function Kc(n, e) {
...
function Bu(n, e) {
  ...
  for (let o = 0; o < r.length; o++)
    for (let a = 0; a < r[o].length; a++) {
      let u = r[o][a][0], l = null;
      Mi = Mi + 1;
      for (let f = 0; f < r[o][a].length - 1; f++) {
        l = r[o][a][f + 1];
        const g = new Gu(u, bi, Mi, Li), v = new Gu(l, bi, Mi, Li + 1);
        g.otherEvent = v, v.otherEvent = g, Kc(g, v) > 0 ? (v.isLeftEndpoint = !0, g.isLeftEndpoint = !1) : (g.isLeftEndpoint = !0, v.isLeftEndpoint = !1), e.push(g), e.push(v), u = l, Li = Li + 1;
      }
    }
  bi = bi + 1;
}
  ...
  for (; n.length; ) {
    ...
    if (o.isLeftEndpoint) {
      ...
      for (let u = 0; u < r.data.length; u++) {
        const l = r.data[u];
        if (e && l.leftSweepEvent.featureId === o.featureId)
          continue;
        const f = Am(a, l);
        f !== !1 && t.push(f);
      }
...
function Am(n, e) {
  ...
  const t = n.leftSweepEvent.p.x, r = n.leftSweepEvent.p.y, o = n.rightSweepEvent.p.x, a = n.rightSweepEvent.p.y, u = e.leftSweepEvent.p.x, l = e.leftSweepEvent.p.y, f = e.rightSweepEvent.p.x, g = e.rightSweepEvent.p.y, v = Fu(t, r, o, a, u, l), m = Fu(t, r, o, a, f, g);
  if (v > 0 && m > 0) return !1;
  if (v < 0 && m < 0) return !1;
  ...
  const p = (g - l) * (o - t) - (f - u) * (a - r), _ = (f - u) * (r - l) - (g - l) * (t - u), w = (o - t) * (r - l) - (a - r) * (t - u);
  if (p === 0)
    return !1;
  const S = _ / p, L = w / p;
  if (S >= 0 && S <= 1 && L >= 0 && L <= 1) {
    const b = t + S * (o - t), k = r + S * (a - r);
    return [b, k];
  }
  return !1;
}
function tn(n, e, t = {}) {
  ...
  if (r) {
    ...
    l = u;
  return ce(l.map((f) => de(f)));
}
var Om = Object.defineProperty, Dm = Object.defineProperties, Fm = Object.getOwnPropertyDescriptors, zu = Object.getOwnPropertySymbols, Bm = Object.prototype.hasOwnProperty, Gm = Object.prototype.propertyIsEnumerable, qu = (n, e, t) => e in n ? Om(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, zm = (n, e) => {
  for (var t in e || (e = {}))
    Bm.call(e, t) && qu(n, t, e[t]);
  if (zu)
    for (var t of zu(e))
      Gm.call(e, t) && qu(n, t, e[t]);
  return n;
}, qm = (n, e) => Dm(n, Fm(e));
function ln(n, e, t = {}) {
  if (!n || !e)
  ...
  return it(
    ...
    function(f, g, v) {
      ...
      for (let p = 0; p < m.length - 1; p++) {
        const _ = de(m[p]), w = Me(_), S = de(m[p + 1]), L = Me(S), b = ze(_, S, t);
        let k, N;
        L[0] === r[0] && L[1] === r[1] ? [k, N] = [L, !0] : w[0] === r[0] && w[1] === r[1] ? [k, N] = [w, !1] : [k, N] = Xm(
          w,
          L,
          r
        );
        ...
        if (A < o.properties.pointDistance) {
          ...
          o = de(k, {
            ...
            dist: 1 / 0
            // deprecated properties END
          }), o.properties = qm(zm({}, o.properties), {
...
function Pn(n, e) {
  const [t, r, o] = n, [a, u, l] = e;
  return t * a + r * u + o * l;
}
function Lr(n, e) {
  const [t, r, o] = n, [a, u, l] = e;
  return [r * l - o * u, o * a - t * l, t * u - r * a];
}
function Um(n) {
...
function Ym(n) {
  const [e, t, r] = n, o = Math.min(Math.max(r, -1), 1), a = jt(Math.asin(o));
  return [jt(Math.atan2(t, e)), a];
}
function Xm(n, e, t) {
  const r = io(n), o = io(e), a = io(t), u = Lr(r, o);
  if (u[0] === 0 && u[1] === 0 && u[2] === 0)
    return Pn(r, o) > 0 ? [[...e], !0] : [[...t], !1];
  const l = Lr(u, a);
  if (l[0] === 0 && l[1] === 0 && l[2] === 0)
    return [[...e], !0];
  const f = Lr(l, u), g = Uu(f), v = [-g[0], -g[1], -g[2]], m = Pn(a, g) > Pn(a, v) ? g : v, p = Uu(u), _ = Pn(Lr(r, m), p), w = Pn(Lr(m, o), p);
  return _ >= 0 && w >= 0 ? [Ym(m), !1] : Pn(r, a) > Pn(o, a) ? [[...n], !1] : [[...e], !0];
}
function Jc(n, e) {
...
function Yu(n, e) {
  ...
  return it(
    ...
    function(o) {
      if (t.forEach(function(l, f) {
        l.id = f;
      }), !t.length)
        t = Co(n, o).features, r.load(ce(t));
      else {
        var a = r.search(o);
        if (a.features.length) {
          ...
          t = t.filter(function(l) {
            return l.id !== u.id;
          }), r.remove(u), Le(Co(u, o), function(l) {
            t.push(l), r.insert(l);
          });
        }
      }
...
function Co(n, e) {
  ...
  if (so(r, Me(e)) || so(o, Me(e)))
    return ce([n]);
  var a = ms(), u = Kr(n);
  a.load(u);
  var l = a.search(e);
  if (!l.features.length) return ce([n]);
  var f = Qc(e, l), g = [r], v = ta(
    u,
    function(m, p, _) {
      var w = me(p)[1], S = Me(e);
      return _ === f.id ? (m.push(S), t.push(ke(m)), so(S, w) ? [S] : [S, w]) : (m.push(w), m);
    },
    g
  );
  return v.length > 1 && t.push(ke(v)), ce(t);
}
function Qc(n, e) {
  ...
  return Le(e, function(o) {
    var a = ln(o, n), u = a.properties.pointDistance;
    u < r && (t = o, r = u);
  }), t;
}
function so(n, e) {
...
function jc(n, e) {
  const t = Ye(n), r = Ye(e), o = t.type, a = r.type, u = t.coordinates, l = r.coordinates;
  switch (o) {
    case "Point":
      switch (a) {
        case "Point":
...
function Vm(n, e) {
  ...
  return n.coordinates.some(
    (r) => vs({ type: "Polygon", coordinates: r }, e, t)
  );
}
function Hm(n, e) {
...
function $m(n, e) {
  return n.coordinates.some(
    (t) => th({ type: "Polygon", coordinates: t }, e)
  );
}
function Zm(n, e) {
  let t = !1;
...
function Km(n, e) {
  for (const t of e.coordinates) {
    const r = { type: "Polygon", coordinates: t }, o = qe(r);
...
function Jm(n, e) {
  return e.coordinates.every(
    (t) => vs(n, { type: "Polygon", coordinates: t })
  );
}
function Qm(n, e) {
  let t, r = !1;
  for (t = 0; t < n.coordinates.length; t++)
    if (oa(n.coordinates[t], e.coordinates)) {
      r = !0;
      break;
    }
  return r;
...
function eh(n, e) {
  ...
  for (let o = 0; o < t.length - 1; o++) {
    const a = ke([t[o], t[o + 1]]), u = Jc(a, Je(e));
    u.features.length === 0 ? r.push(a) : r.push(...u.features);
  }
  return ce(r);
}
function th(n, e) {
  return nh(n, e) === "interior";
}
function nh(n, e) {
  const t = qe(n), r = qe(e);
  if (!rh(t, r))
...
function iv(n, e, t) {
  ...
  const l = e[0] + u * r, f = e[1] + u * o, g = n[0] - l, v = n[1] - f;
  return Math.sqrt(g * g + v * v);
}
function sv(n, e) {
  return e.coordinates.some((t) => {
    for (let r = 0; r < t.length - 1; r++)
      if (iv(n, t[r], t[r + 1]) <= rv)
        return !0;
    return !1;
  });
}
...
function sh(n, e) {
  return n.length > 1 ? En(n, e) : ke(n[0], e);
}
var uv = Object.defineProperty, pr = (n, e) => uv(n, "name", { value: e, configurable: !0 }), oh = class {
  constructor(e) {
  ...
  compareLine(e, t, r = 0, o = !1) {
    ...
    const l = this.compareCoord(a[r], u[r]);
    return this.direction || l ? this.comparePath(a, u) : this.compareCoord(a[r], u[u.length - (1 + r)]) ? this.comparePath(a.slice().reverse(), u) : !1;
  }
  fixStartIndex(e, t) {
    let r, o = -1;
  ...
  compareGeometryCollection(e, t) {
    return Fr(e.geometries, t.geometries) && this.compareBBox(e, t) && e.geometries.every((r, o) => this.compare(r, t.geometries[o]));
  }
  compareFeature(e, t) {
    return e.id === t.id && (this.compareProperties ? ua(e.properties, t.properties) : !0) && this.compareBBox(e, t) && this.compare(e.geometry, t.geometry);
  }
  compareFeatureCollection(e, t) {
    return Fr(e.features, t.features) && this.compareBBox(e, t) && e.features.every((r, o) => this.compare(r, t.features[o]));
  }
  compareBBox(e, t) {
    return !e.bbox && !t.bbox || (e.bbox && t.bbox ? this.compareCoord(e.bbox, t.bbox) : !1);
  }
};
pr(oh, "GeojsonEquality");
var lv = oh;
function Fr(n, e) {
...
pr(So, "explode");
function aa(n, e, t) {
  return new lv(t).compare(n, e);
}
pr(aa, "geojsonEquality");
function ua(n, e) {
  if (n === null && e === null)
    return !0;
  if (n === null || e === null)
...
pr(ua, "equal");
var Xu = /* @__PURE__ */ pr((n) => n != null && typeof n == "object", "isObject");
function Bn(n, e = {}) {
  ...
  switch (r) {
    ...
    case "MultiPoint":
      ...
      me(n).forEach(function(u) {
        var l = u.join("-");
        Object.prototype.hasOwnProperty.call(a, l) || (o.push(u), a[l] = !0);
      });
      break;
    default:
...
function oo(n, e) {
  const t = me(n);
  if (t.length === 2 && !Vu(t[0], t[1])) return t;
  const r = [];
  let o = 0, a = 1, u = 2;
  for (r.push(t[o]); u < t.length; )
    Ie(t[a], ke([t[o], t[u]])) ? a = u : (r.push(t[a]), o = a, a++, u = a), u++;
...
function Hu(n, e) {
  for (var t = !1, r = !1, o = n.coordinates.length, a = 0; a < o && (!t || !r); a++) {
    for (var u = !1, l = 0; l < e.coordinates.length - 1; l++) {
      var f = !0;
      if ((l === 0 || l === e.coordinates.length - 2) && (f = !1), hv(
        e.coordinates[l],
        e.coordinates[l + 1],
        n.coordinates[a],
        f
...
function cv(n, e) {
  ...
  for (const r of t.features)
    if (!Br(r, de(n.coordinates[0])) && !Br(
      r,
      de(n.coordinates[n.coordinates.length - 1])
    ) && !Br(r, de(e.coordinates[0])) && !Br(
      r,
...
function Wu(n, e) {
  const t = cr(e);
  return tn(n, t).features.length > 0;
}
function $u(n, e) {
...
function hv(n, e, t, r) {
  var o = t[0] - n[0], a = t[1] - n[1], u = e[0] - n[0], l = e[1] - n[1], f = o * l - a * u;
  return f !== 0 ? !1 : r ? Math.abs(u) >= Math.abs(l) ? u > 0 ? n[0] <= t[0] && t[0] <= e[0] : e[0] <= t[0] && t[0] <= n[0] : l > 0 ? n[1] <= t[1] && t[1] <= e[1] : e[1] <= t[1] && t[1] <= n[1] : Math.abs(u) >= Math.abs(l) ? u > 0 ? n[0] < t[0] && t[0] < e[0] : e[0] < t[0] && t[0] < n[0] : l > 0 ? n[1] < t[1] && t[1] < e[1] : e[1] < t[1] && t[1] < n[1];
}
function la(n, e, {
...
function fv(n, e, t) {
  switch (n.type) {
    case "Point":
      switch (e.type) {
        case "Point":
          return !vv(n.coordinates, e.coordinates);
        case "LineString":
          return !ji(e, n);
        case "Polygon":
          return !xe(n, e);
...
function uh(n, e, {
  ...
  return !la(n, e, { ignoreSelfIntersections: t });
}
...
const Gr = /* @__PURE__ */ hi(yv);
function hh(n, e, t = {}) {
  if (t = t || {}, !Oe(t)) throw new Error("options is invalid");
  var r = t.tolerance || 0, o = [], a = ms();
  const u = Kr(n);
  a.load(u);
  var l;
  let f = [];
  return Jt(e, function(g) {
    var v = !1;
    if (!g)
      return;
    let m = g;
    if (r !== 0) {
      const p = oi(r, "kilometers"), _ = qe(g);
      m = [
        _[0] - p,
        _[1] - p,
        _[2] + p,
    ...
    Le(a.search(m), function(p) {
      if (v === !1) {
        ...
        if (Gr(_, w))
          v = !0, l ? l = ao(l, g) || l : l = g;
        else if (r === 0 ? Ie(_[0], p) && Ie(_[1], p) : ln(p, _[0]).properties.pointDistance <= r && ln(p, _[1]).properties.pointDistance <= r)
          v = !0, l ? l = ao(l, g) || l : l = g;
        else if (r === 0 ? Ie(w[0], g) && Ie(w[1], g) : ln(g, w[0]).properties.pointDistance <= r && ln(g, w[1]).properties.pointDistance <= r)
          if (l) {
            const S = ao(l, p);
            S ? l = S : f.push(p);
          } else l = p;
      }
    }), v === !1 && l && (o.push(l), f.length && (o = o.concat(f), f = []), l = void 0);
  }), l && o.push(l), ce(o);
}
function ao(n, e) {
  var t = me(e), r = me(n), o = r[0], a = r[r.length - 1], u = n.geometry.coordinates;
  if (Gr(t[0], o)) u.unshift(t[1]);
  else if (Gr(t[0], a)) u.push(t[1]);
  else if (Gr(t[1], o)) u.unshift(t[0]);
  else if (Gr(t[1], a)) u.push(t[0]);
  else return;
  return n;
}
function pv(n, e) {
    ...
    case "MultiPoint":
      for (var l = 0; l < t.coordinates.length; l++)
        for (var f = 0; f < r.coordinates.length; f++) {
          var g = t.coordinates[l], v = r.coordinates[f];
          if (g[0] === v[0] && g[1] === v[1])
            return !0;
        }
      return !1;
...
function _v(n, e) {
  ...
  for (var o = Kr(Bn(n)).features, a = Kr(Bn(e)).features, u = 0; u < o.length; u++) {
    var l = o[u].geometry.coordinates;
    if (!a[u]) break;
...
function wv(n, e) {
  var t = lr(Fn(n[0], n[1])), r = lr(Fn(e[0], e[1]));
  ...
  switch (o) {
    case "Point":
      switch (a) {
        case "LineString":
          return ht(t, r);
        case "MultiLineString":
          for (var u = !1, l = 0; l < r.coordinates.length; l++)
            ht(t, {
        ...
        case "MultiPolygon":
          for (var f = 0; f < r.coordinates.length; f++)
            for (var l = 0; l < r.coordinates[f].length; l++)
              if (Ie(t, {
                type: "LineString",
                coordinates: r.coordinates[f][l]
              }))
                return !0;
          return !1;
        default:
    ...
    case "MultiPoint":
      switch (a) {
        ...
        case "MultiLineString":
          for (var u = !1, f = 0; f < t.coordinates.length; f++)
            for (var l = 0; l < r.coordinates.length; l++)
              if (u || ht(
                { coordinates: t.coordinates[f] },
                { coordinates: r.coordinates[l] }
              ) && (u = !0), Ie(
                { type: "Point", coordinates: t.coordinates[f] },
                { type: "LineString", coordinates: r.coordinates[l] },
                { ignoreEndVertices: !0 }
              ))
                return !1;
          return u;
          ...
          for (var u = !1, f = 0; f < t.coordinates.length; f++)
            for (var l = 0; l < r.coordinates.length; l++)
              if (u || Ie(
                ...
                {
                  type: "LineString",
                  coordinates: r.coordinates[l][0]
                }
              ) && (u = !0), xe(
                { type: "Point", coordinates: t.coordinates[f] },
                { type: "Polygon", coordinates: r.coordinates[l] },
                { ignoreBoundary: !0 }
              ))
                return !1;
          return u;
      ...
      switch (a) {
        ...
        case "MultiLineString":
          for (var g = !1, f = 0; f < r.coordinates.length; f++) {
            ...
            for (var l = 0; l < t.coordinates[f].length; l++)
              if (Ie(
                { type: "Point", coordinates: t.coordinates[l] },
      ...
      switch (a) {
          ...
          for (var u = !1, f = 0; f < t.coordinates.length; f++)
            for (var l = 0; l < r.coordinates.length; l++)
              if (u || ht(
                ...
                { type: "Point", coordinates: r.coordinates[l] },
                { type: "LineString", coordinates: t.coordinates[l] },
                { ignoreEndVertices: !0 }
              ))
                return !1;
          return u;
        ...
        case "Polygon":
          for (var u = !1, f = 0; f < t.coordinates.length; f++)
            for (var l = 0; l < t.coordinates.length; l++)
              if (u || Ie(
                { type: "Point", coordinates: t.coordinates[f][l] },
                { type: "LineString", coordinates: r.coordinates[0] }
              ) && (u = !0), xe(
                { type: "Point", coordinates: t.coordinates[f][l] },
                r,
        ...
        case "MultiPolygon":
          for (var u = !1, f = 0; f < r.coordinates[0].length; f++)
            for (var l = 0; l < t.coordinates.length; l++)
              for (var v = 0; v < t.coordinates[l].length; v++)
                if (u || Ie(
                  {
                    type: "Point",
                    coordinates: t.coordinates[l][v]
                  },
                  {
                    type: "LineString",
                  ...
                  { type: "Point", coordinates: t.coordinates[l][v] },
      ...
      switch (a) {
        ...
        case "MultiLineString":
          for (var u = !1, f = 0; f < r.coordinates.length; f++)
            for (var l = 0; l < r.coordinates[f].length; l++)
              if (u || Ie(
                { type: "Point", coordinates: r.coordinates[f][l] },
                { type: "LineString", coordinates: t.coordinates[0] }
              ) && (u = !0), xe(
                { type: "Point", coordinates: r.coordinates[f][l] },
                t,
        ...
        case "MultiPolygon":
          for (var u = !1, f = 0; f < r.coordinates[0].length; f++)
            for (var l = 0; l < t.coordinates[0].length; l++)
              if (u || Ie(
                { type: "Point", coordinates: t.coordinates[0][l] },
    ...
    case "MultiPolygon":
      switch (a) {
        ...
        case "MultiLineString":
          for (var u = !1, f = 0; f < t.coordinates.length; f++)
            for (var l = 0; l < r.coordinates.length; l++)
              for (var v = 0; v < r.coordinates[l].length; v++)
                if (u || Ie(
                  {
                    type: "Point",
                    coordinates: r.coordinates[l][v]
                  },
                  {
                    type: "LineString",
                    coordinates: t.coordinates[f][0]
                  ...
                  { type: "Point", coordinates: r.coordinates[l][v] },
        ...
        case "Polygon":
          for (var u = !1, f = 0; f < t.coordinates[0].length; f++)
            for (var l = 0; l < t.coordinates[0][f].length; l++)
              if (u || Ie(
                { type: "Point", coordinates: t.coordinates[0][f][l] },
                { type: "LineString", coordinates: r.coordinates[0] }
              ) && (u = !0), xe(
                { type: "Point", coordinates: t.coordinates[0][f][l] },
                r,
        ...
        case "MultiPolygon":
          for (var u = !1, f = 0; f < t.coordinates[0].length; f++)
            for (var l = 0; l < r.coordinates[0].length; l++)
              for (var v = 0; v < t.coordinates[0].length; v++)
                if (u || Ie(
                  ...
                  { type: "Polygon", coordinates: r.coordinates[0][l] },
                  { ignoreBoundary: !0 }
                ))
                  return !1;
          return u;
  ...
  switch (t) {
    ...
    case "Polygon":
      for (var o = 0; o < e.coordinates.length; o++)
        if (r[o].length < 4 || !Qu(r[o]) || ju(r[o]) || o > 0 && tn(ye([r[0]]), ye([r[o]])).features.length > 1)
          return !1;
      return !0;
    case "MultiPolygon":
      for (var o = 0; o < e.coordinates.length; o++)
        for (var a = e.coordinates[o], u = 0; u < a.length; u++)
          if (a[u].length < 4 || !Qu(a[u]) || ju(a[u]) || u === 0 && !Cv(a, e.coordinates, o) || u > 0 && tn(ye([a[0]]), ye([a[u]])).features.length > 1)
            return !1;
      return !0;
    case "GeometryCollection":
      return e.geometries ? Array.isArray(e.geometries) && e.geometries.length > 0 && e.geometries.every(
        (l) => Ev.has(l.type) && fh(l)
      ) : !1;
    default:
      return !1;
  }
...
function ju(n) {
  for (var e = 0; e < n.length - 1; e++)
    for (var t = n[e], r = e + 1; r < n.length - 2; r++) {
      var o = [n[r], n[r + 1]];
      if (Ie(t, ke(o))) return !0;
    }
  return !1;
}
function Cv(n, e, t) {
  for (var r = ye(n), o = t + 1; o < e.length; o++)
    if (!la(r, ye(e[o])) && ah(r, ke(e[o][0])))
      return !1;
  return !0;
}
function ca(n, e) {
...
function ys(n, e = {}) {
  const t = qe(n), r = (t[0] + t[2]) / 2, o = (t[1] + t[3]) / 2;
...
(function(n, e) {
  (function(t, r) {
    ...
    function t(h, i) {
      ...
      for (var s = 0, c = Array(i); s < i; s++) c[s] = h[s];
      return c;
    }
    function r(h, i, s) {
      return i = v(i), function(c, d) {
    ...
    function a(h, i, s) {
      ...
      var c = [null];
      c.push.apply(c, i);
      var d = new (h.bind.apply(h, c))();
      return s && _(d, s.prototype), d;
    }
    function u(h, i) {
      for (var s = 0; s < i.length; s++) {
        var c = i[s];
        c.enumerable = c.enumerable || !1, c.configurable = !0, "value" in c && (c.writable = !0), Object.defineProperty(h, L(c.key), c);
      }
    }
    function l(h, i, s) {
      ...
      if (!s) {
        if (Array.isArray(h) || (s = b(h)) || i) {
          ...
          return { s: d, n: function() {
            return c >= h.length ? { done: !0 } : { done: !1, value: h[c++] };
          }, e: function(P) {
            throw P;
          }, f: d };
        }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function g() {
      return g = typeof Reflect < "u" && Reflect.get ? Reflect.get.bind() : function(h, i, s) {
        ...
        if (c) {
          var d = Object.getOwnPropertyDescriptor(c, i);
    ...
    function _(h, i) {
      return _ = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(s, c) {
        return s.__proto__ = c, s;
      }, _(h, i);
    }
    function w(h, i, s, c) {
      var d = g(v(1 & c ? h.prototype : h), i, s);
      return 2 & c && typeof d == "function" ? function(y) {
        return d.apply(s, y);
      } : d;
    }
    function S(h) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    function k(h) {
      ...
      return k = function(s) {
        ...
        return c.prototype = Object.create(s.prototype, { constructor: { value: c, enumerable: !1, writable: !0, configurable: !0 } }), _(c, s);
      }, k(h);
    }
    var N = function() {
      function h() {
      ...
      return l(h, [{ key: "getEndCapStyle", value: function() {
        ...
        if (this._quadrantSegments = h.DEFAULT_QUADRANT_SEGMENTS, this._endCapStyle = h.CAP_ROUND, this._joinStyle = h.JOIN_ROUND, this._mitreLimit = h.DEFAULT_MITRE_LIMIT, this._isSingleSided = !1, this._simplifyFactor = h.DEFAULT_SIMPLIFY_FACTOR, arguments.length !== 0) {
          if (arguments.length === 1) {
            ...
            this.setQuadrantSegments(s), this.setEndCapStyle(c);
    ...
    var A = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ Exception: i })[0], c;
      }
      return m(i, h), l(i, [{ key: "toString", value: function() {
        return this.message;
      } }]);
    }(k(Error)), O = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ IllegalArgumentException: i })[0], c;
      }
      return m(i, h), l(i);
    }(A), Y = function() {
      return l(function h() {
    ...
    var T, D, B, z, X, R, U, G, H = function() {
      return l(function h() {
        o(this, h);
    ...
    W.NaN = NaN, W.isNaN = function(h) {
    ...
    }) : (T = 1023, D = Math.log2, B = Math.floor, z = Math.pow, X = function() {
      for (var h = 53; h > 0; h--) {
        var i = z(2, h) - 1;
      ...
      if (d = 0, F = 0, (i = B(h)) > 1) if (i <= X) (d = B(D(i))) <= 20 ? (F = 0, P = i << 20 - d & 1048575) : (F = i % (s = z(2, c = d - 20)) << 32 - c, P = i / s & 1048575);
      else for (c = i, F = 0; (c = B(s = c / 2)) !== 0; ) d++, F >>>= 1, F |= (1 & P) << 31, P >>>= 1, s !== c && (P |= 524288);
      if (E = d + T, y = i === 0, i = h - i, d < 52 && i !== 0) for (c = 0; ; ) {
        if ((s = 2 * i) >= 1 ? (i = s - 1, y ? (E--, y = !1) : (c <<= 1, c |= 1, d++)) : (i = s, y ? --E == 0 && (d++, y = !1) : (c <<= 1, d++)), d === 20) P |= c, c = 0;
        else if (d === 52) {
          F |= c;
          break;
        }
        if (s === 1) {
          d < 20 ? P |= c << 20 - d : d < 52 && (F |= c << 52 - d);
          break;
        }
      }
      return P |= E << 20, new J(P |= x, F);
    }, W.longBitsToDouble = function(h) {
      var i, s, c, d, y = h.high, x = h.low, E = y & 1 << 31 ? -1 : 1;
      for (c = ((2146435072 & y) >> 20) - T, d = 0, s = 1 << 19, i = 1; i <= 20; i++) y & s && (d += z(2, -i)), s >>>= 1;
      for (s = 1 << 31, i = 21; i <= 52; i++) x & s && (d += z(2, -i)), s >>>= 1;
      if (c === -1023) {
        if (d === 0) return 0 * E;
        c = -1022;
      } else {
        if (c === 1024) return d === 0 ? E / 0 : NaN;
        d += 1;
      }
      return E * d * z(2, c);
    });
    var Q = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ RuntimeException: i })[0], c;
      }
      return m(i, h), l(i);
    }(A), re = function(h) {
      function i() {
      ...
      return m(i, h), l(i, null, [{ key: "constructor_", value: function() {
      ...
      return l(h, null, [{ key: "shouldNeverReachHere", value: function() {
        ...
        if (arguments.length === 2) {
          ...
          var c = arguments[0], d = arguments[1], y = arguments[2];
          if (!d.equals(c)) throw new re("Expected " + c + " but encountered " + d + (y !== null ? ": " + y : ""));
        }
      } }]);
      ...
      return l(h, [{ key: "getM", value: function() {
        return W.NaN;
        ...
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1];
          return !!H.equalsWithTolerance(this.x, s.x, c) && !!H.equalsWithTolerance(this.y, s.y, c);
        }
        ...
        var s = this.x - i.x, c = this.y - i.y, d = this.getZ() - i.getZ();
        return Math.sqrt(s * s + c * c + d * d);
      } }, { key: "getY", value: function() {
        return this.y;
      } }, { key: "setY", value: function(i) {
        this.y = i;
      } }, { key: "distance", value: function(i) {
        var s = this.x - i.x, c = this.y - i.y;
        ...
        if (this.x = null, this.y = null, this.z = null, arguments.length === 0) h.constructor_.call(this, 0, 0);
          ...
          var s = arguments[0], c = arguments[1];
          h.constructor_.call(this, s, c, h.NULL_ORDINATE);
        } else if (arguments.length === 3) {
      ...
      return l(h, [{ key: "compare", value: function(i, s) {
        var c = h.compare(i.x, s.x);
        if (c !== 0) return c;
    ...
    var _e = function() {
      ...
      return l(h, [{ key: "getArea", value: function() {
        ...
        var s = this._minx > i._minx ? this._minx : i._minx, c = this._miny > i._miny ? this._miny : i._miny;
        return new h(s, this._maxx < i._maxx ? this._maxx : i._maxx, c, this._maxy < i._maxy ? this._maxy : i._maxy);
        ...
        if (arguments.length === 1) {
          ...
          return !this.isNull() && c >= this._minx && c <= this._maxx && d >= this._miny && d <= this._maxy;
        }
        ...
        if (arguments.length === 1) {
          ...
          if (arguments[0] instanceof Z && arguments[1] instanceof Z) {
            var c = arguments[0], d = arguments[1];
            return !this.isNull() && !((c.x < d.x ? c.x : d.x) > this._maxx) && !((c.x > d.x ? c.x : d.x) < this._minx) && !((c.y < d.y ? c.y : d.y) > this._maxy) && !((c.y > d.y ? c.y : d.y) < this._miny);
          }
        ...
        if (arguments.length === 1) {
          ...
          var c = arguments[0], d = arguments[1];
          this.isNull() ? (this._minx = c, this._maxx = c, this._miny = d, this._maxy = d) : (c < this._minx && (this._minx = c), c > this._maxx && (this._maxx = c), d < this._miny && (this._miny = d), d > this._maxy && (this._maxy = d));
        }
        ...
        if (arguments.length === 1) {
          ...
          var s = arguments[0], c = arguments[1];
          if (this.isNull()) return null;
          this._minx -= s, this._maxx += s, this._miny -= c, this._maxy += c, (this._minx > this._maxx || this._miny > this._maxy) && this.setToNull();
        }
        ...
        var c = 0;
        return this._maxy < i._miny ? c = i._miny - this._maxy : this._miny > i._maxy && (c = this._miny - i._maxy), s === 0 ? c : c === 0 ? s : Math.sqrt(s * s + c * c);
      } }, { key: "hashCode", value: function() {
        var i = 17;
        ...
        if (arguments.length === 3) {
          var i = arguments[0], s = arguments[1], c = arguments[2];
          return c.x >= (i.x < s.x ? i.x : s.x) && c.x <= (i.x > s.x ? i.x : s.x) && c.y >= (i.y < s.y ? i.y : s.y) && c.y <= (i.y > s.y ? i.y : s.y);
        }
      ...
      return l(h, [{ key: "isGeometryCollection", value: function() {
        ...
        if (arguments.length === 2) {
          var c = arguments[0], d = arguments[1];
          return i = c, this.getTypeCode() !== i.getTypeCode() ? this.getTypeCode() - i.getTypeCode() : this.isEmpty() && i.isEmpty() ? 0 : this.isEmpty() ? -1 : i.isEmpty() ? 1 : this.compareToSameClass(c, d);
        }
      ...
      } }, { key: "equal", value: function(i, s, c) {
        return c === 0 ? i.equals(s) : i.distance(s) <= c;
        ...
        for (var c = i.iterator(), d = s.iterator(); c.hasNext() && d.hasNext(); ) {
          var y = c.next(), x = d.next(), E = y.compareTo(x);
          if (E !== 0) return E;
        }
    ...
    var q = function() {
      ...
      return l(h, null, [{ key: "toLocationSymbol", value: function(i) {
        switch (i) {
          case h.EXTERIOR:
            return "e";
          case h.BOUNDARY:
    ...
    q.INTERIOR = 0, q.BOUNDARY = 1, q.EXTERIOR = 2, q.NONE = -1;
    var be = function() {
      return l(function h() {
        o(this, h);
      ...
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ NoSuchElementException: i })[0], c;
      }
      return m(i, h), l(i);
    }(A), Ce = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ UnsupportedOperationException: i })[0], c;
      }
      return m(i, h), l(i);
    }(A), pt = function(h) {
      function i() {
      ...
      return m(i, h), l(i, [{ key: "contains", value: function() {
      } }]);
    }(be), gt = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i)).map = /* @__PURE__ */ new Map(), s instanceof be && c.addAll(s), c;
      }
      return m(i, h), l(i, [{ key: "contains", value: function(s) {
      ...
      return l(function h(i) {
        o(this, h), this.iterator = i.values();
        var s = this.iterator.next(), c = s.done, d = s.value;
        this.done = c, this.value = d;
      }, [{ key: "next", value: function() {
        if (this.done) throw new Ne();
        var h = this.value, i = this.iterator.next(), s = i.done, c = i.value;
        return this.done = s, this.value = c, h;
      ...
      return l(h, null, [{ key: "opposite", value: function(i) {
    ...
    var gi = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ EmptyStackException: i })[0], c;
      }
      return m(i, h), l(i);
    }(A), di = function(h) {
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i, [s])).name = Object.keys({ IndexOutOfBoundsException: i })[0], c;
      }
      return m(i, h), l(i);
    }(A), nn = function(h) {
      function i() {
      ...
      return m(i, h), l(i, [{ key: "get", value: function() {
      ...
      return m(i, h), l(i, [{ key: "add", value: function(s) {
        return this.array.push(s), !0;
      } }, { key: "get", value: function(s) {
        if (s < 0 || s >= this.size()) throw new di();
        return this.array[s];
    ...
    var mn = function() {
      ...
      return l(h, [{ key: "intValue", value: function() {
        return this.value;
      } }, { key: "compareTo", value: function(i) {
      ...
      return l(h, [{ key: "le", value: function(i) {
        return this._hi < i._hi || this._hi === i._hi && this._lo <= i._lo;
      } }, { key: "extractSignificantDigits", value: function(i, s) {
        var c = this.abs(), d = h.magnitude(c._hi), y = h.TEN.pow(d);
        (c = c.divide(y)).gt(h.TEN) ? (c = c.divide(h.TEN), d += 1) : c.lt(h.ONE) && (c = c.multiply(h.TEN), d -= 1);
        for (var x = d + 1, E = new mn(), P = h.MAX_PRINT_DIGITS - 1, F = 0; F <= P; F++) {
          i && F === x && E.append(".");
          var $ = Math.trunc(c._hi);
          if ($ < 0) break;
          var K = !1, ne = 0;
          $ > 9 ? (K = !0, ne = "9") : ne = "0" + $, E.append(ne), c = c.subtract(h.valueOf($)).multiply(h.TEN), K && c.selfAdd(h.TEN);
          var ue = !0, he = h.magnitude(c._hi);
        ...
        if (arguments.length === 1) {
          ...
          var c, d, y, x, E = arguments[0], P = arguments[1], F = null, $ = null, K = null, ne = null;
          return y = this._hi / E, ne = (F = (K = h.SPLIT * y) - (F = K - y)) * ($ = (ne = h.SPLIT * E) - ($ = ne - E)) - (x = y * E) + F * (d = E - $) + (c = y - F) * $ + c * d, ne = y + (K = (this._hi - x - ne + this._lo - y * P) / E), this._hi = ne, this._lo = y - ne + K, this;
        }
      } }, { key: "dump", value: function() {
        return "DD<" + this._hi + ", " + this._lo + ">";
      } }, { key: "divide", value: function() {
        if (arguments[0] instanceof h) {
          var i, s, c, d, y = arguments[0], x = null, E = null, P = null, F = null;
          return i = (c = this._hi / y._hi) - (x = (P = h.SPLIT * c) - (x = P - c)), F = x * (E = (F = h.SPLIT * y._hi) - (E = F - y._hi)) - (d = c * y._hi) + x * (s = y._hi - E) + i * E + i * s, new h(F = c + (P = (this._hi - d - F + this._lo - c * y._lo) / y._hi), c - F + P);
        }
        if (typeof arguments[0] == "number") {
          var $ = arguments[0];
        ...
        var s = new h(this), c = h.valueOf(1), d = Math.abs(i);
        if (d > 1) for (; d > 0; ) d % 2 == 1 && c.selfMultiply(s), (d /= 2) > 0 && (s = s.sqr());
        else c = s;
        return i < 0 ? c.reciprocal() : c;
        ...
        var i = 1 / Math.sqrt(this._hi), s = this._hi * i, c = h.valueOf(s), d = this.subtract(c.sqr())._hi * (0.5 * i);
        return c.add(d);
        ...
        if (arguments.length === 1) {
          ...
          if (typeof arguments[0] == "number") {
            var s, c, d, y, x, E = arguments[0], P = null;
            return P = (d = this._hi + E) - (y = d - this._hi), c = (x = (P = E - y + (this._hi - P)) + this._lo) + (d - (s = d + x)), this._hi = s + c, this._lo = c + (s - this._hi), this;
          }
        } else if (arguments.length === 2) {
        ...
        if (arguments.length === 1) {
          ...
          var c, d, y = arguments[0], x = arguments[1], E = null, P = null, F = null, $ = null;
          E = (F = h.SPLIT * this._hi) - this._hi, $ = h.SPLIT * y, E = F - E, c = this._hi - E, P = $ - y;
          var K = (F = this._hi * y) + ($ = E * (P = $ - P) - F + E * (d = y - P) + c * P + c * d + (this._hi * x + this._lo * y)), ne = $ + (E = F - K);
        ...
        if (i !== null) return i;
        var s = new Array(1).fill(null), c = this.extractSignificantDigits(!0, s), d = s[0] + 1, y = c;
        if (c.charAt(0) === ".") y = "0" + c;
        else if (d < 0) y = "0." + h.stringOfChar("0", -d) + c;
        else if (c.indexOf(".") === -1) {
          var x = d - c.length;
          y = c + h.stringOfChar("0", x) + ".0";
        }
        return this.isNegative() ? "-" + y : y;
      } }, { key: "reciprocal", value: function() {
        var i, s, c, d, y = null, x = null, E = null, P = null;
        i = (c = 1 / this._hi) - (y = (E = h.SPLIT * c) - (y = E - c)), x = (P = h.SPLIT * this._hi) - this._hi;
        var F = c + (E = (1 - (d = c * this._hi) - (P = y * (x = P - x) - d + y * (s = this._hi - x) + i * x + i * s) - c * this._lo) / this._hi);
        return new h(F, c - F + E);
      } }, { key: "toSciNotation", value: function() {
        if (this.isZero()) return h.SCI_NOT_ZERO;
        var i = this.getSpecialNumberString();
        if (i !== null) return i;
        var s = new Array(1).fill(null), c = this.extractSignificantDigits(!1, s), d = h.SCI_NOT_EXPONENT_CHAR + s[0];
        if (c.charAt(0) === "0") throw new IllegalStateException("Found leading zero: " + c);
        var y = "";
        c.length > 1 && (y = c.substring(1));
        var x = c.charAt(0) + "." + y;
        ...
        if (this._hi = 0, this._lo = 0, arguments.length === 0) this.init(0);
          ...
          if (typeof arguments[0] == "number") {
            ...
            var c = arguments[0];
            h.constructor_.call(this, h.parse(c));
          }
        } else if (arguments.length === 2) {
        ...
        if (typeof arguments[3] == "number" && typeof arguments[2] == "number" && typeof arguments[0] == "number" && typeof arguments[1] == "number") {
          var i = arguments[0], s = arguments[1], c = arguments[2], d = arguments[3];
          return h.determinant(h.valueOf(i), h.valueOf(s), h.valueOf(c), h.valueOf(d));
        }
        ...
        for (var s = 0, c = i.length; Ns.isWhitespace(i.charAt(s)); ) s++;
        var d = !1;
        if (s < c) {
          var y = i.charAt(s);
          y !== "-" && y !== "+" || (s++, y === "-" && (d = !0));
        }
        for (var x = new h(), E = 0, P = 0, F = 0, $ = !1; !(s >= c); ) {
          var K = i.charAt(s);
          if (s++, Ns.isDigit(K)) {
            var ne = K - "0";
        ...
        var s = Math.abs(i), c = Math.log(s) / Math.log(10), d = Math.trunc(Math.floor(c));
        return 10 * Math.pow(10, d) <= s && (d += 1), d;
      } }, { key: "stringOfChar", value: function(i, s) {
        for (var c = new mn(), d = 0; d < s; d++) c.append(i);
        return c.toString();
      } }]);
    }();
    ...
    var Ts = function() {
      ...
      return l(h, null, [{ key: "orientationIndex", value: function(i, s, c) {
        var d = h.orientationIndexFilter(i, s, c);
        if (d <= 1) return d;
        var y = pe.valueOf(s.x).selfAdd(-i.x), x = pe.valueOf(s.y).selfAdd(-i.y), E = pe.valueOf(c.x).selfAdd(-s.x), P = pe.valueOf(c.y).selfAdd(-s.y);
        ...
        if (arguments[3] instanceof pe && arguments[2] instanceof pe && arguments[0] instanceof pe && arguments[1] instanceof pe) {
          var i = arguments[1], s = arguments[2], c = arguments[3];
          return arguments[0].multiply(c).selfSubtract(i.multiply(s)).signum();
        }
        if (typeof arguments[3] == "number" && typeof arguments[2] == "number" && typeof arguments[0] == "number" && typeof arguments[1] == "number") {
      ...
      } }, { key: "intersection", value: function(i, s, c, d) {
        var y = new pe(i.y).selfSubtract(s.y), x = new pe(s.x).selfSubtract(i.x), E = new pe(i.x).selfMultiply(s.y).selfSubtract(new pe(s.x).selfMultiply(i.y)), P = new pe(c.y).selfSubtract(d.y), F = new pe(d.x).selfSubtract(c.x), $ = new pe(c.x).selfMultiply(d.y).selfSubtract(new pe(d.x).selfMultiply(c.y)), K = x.multiply($).selfSubtract(F.multiply(E)), ne = P.multiply(E).selfSubtract(y.multiply($)), ue = y.multiply(F).selfSubtract(P.multiply(x)), he = K.selfDivide(ue).doubleValue(), ge = ne.selfDivide(ue).doubleValue();
        return W.isNaN(he) || W.isInfinite(he) || W.isNaN(ge) || W.isInfinite(ge) ? null : new Z(he, ge);
      } }, { key: "orientationIndexFilter", value: function(i, s, c) {
        var d = null, y = (i.x - c.x) * (s.y - c.y), x = (i.y - c.y) * (s.x - c.x), E = y - x;
        if (y > 0) {
    ...
    var we = function() {
      ...
      return l(h, null, [{ key: "index", value: function(i, s, c) {
        return Ts.orientationIndex(i, s, c);
        ...
        if (arguments[0] instanceof Array) {
          ...
          do
            (E -= 1) < 0 && (E = s);
          while (i[E].equals2D(c) && E !== d);
          var P = d;
          do
            P = (P + 1) % s;
          while (i[P].equals2D(c) && P !== d);
          var F = i[E], $ = i[P];
          if (F.equals2D(c) || $.equals2D(c) || F.equals2D($)) return !1;
          var K = h.index(F, c, $);
        ...
        if (Ee(arguments[0], Te)) {
          ...
          var ut = null, Ln = ge;
          do
            Ln = (Ln + 1) % ue, ut = ne.getCoordinate(Ln);
          while (ut.equals2D(he) && Ln !== ge);
          if (Ue.equals2D(he) || ut.equals2D(he) || Ue.equals2D(ut)) return !1;
          var br = h.index(Ue, he, ut);
          return br === 0 ? Ue.x > ut.x : br > 0;
        }
      } }]);
    }();
    ...
    var $f = function() {
      return l(function h() {
        ...
        var i = h[this._minIndex - 1], s = h[this._minIndex + 1], c = we.index(this._minCoord, s, i), d = !1;
        (i.y < this._minCoord.y && s.y < this._minCoord.y && c === we.COUNTERCLOCKWISE || i.y > this._minCoord.y && s.y > this._minCoord.y && c === we.CLOCKWISE) && (d = !0), d && (this._minIndex = this._minIndex - 1);
      } }, { key: "getRightmostSideOfSegment", value: function(h, i) {
        var s = h.getEdge().getCoordinates();
        if (i < 0 || i + 1 >= s.length || s[i].y === s[i + 1].y) return -1;
        var c = ie.LEFT;
        return s[i].y < s[i + 1].y && (c = ie.RIGHT), c;
      ...
      function i(s, c) {
        var d;
        return o(this, i), (d = r(this, i, [c ? s + " [ " + c + " ]" : s])).pt = c ? new Z(c) : void 0, d.name = Object.keys({ TopologyException: i })[0], d;
      }
      return m(i, h), l(i, [{ key: "getCoordinate", value: function() {
        return this.pt;
      } }]);
    }(Q), Zf = function() {
      return l(function h() {
      ...
      function i(s) {
        var c;
        return o(this, i), (c = r(this, i)).array = [], s instanceof be && c.addAll(s), c;
      }
      return m(i, h), l(i, [{ key: "interfaces_", get: function() {
        return [nn, be];
        ...
        s ? this.array.sort(function(c, d) {
          return s.compare(c, d);
        }) : this.array.sort();
      } }, { key: "size", value: function() {
        return this.array.length;
      } }, { key: "toArray", value: function() {
        ...
        for (var c = 0, d = this.array.length; c < d; c++) if (this.array[c] === s) return !!this.array.splice(c, 1);
        return !1;
      } }, { key: Symbol.iterator, value: function() {
      ...
      return l(function h() {
        ...
        for (var i = null, s = h.getEdges().iterator(); s.hasNext(); ) {
          var c = s.next();
          if (c.isVisited() || c.getSym().isVisited()) {
            i = c;
            break;
          }
        }
        if (i === null) throw new rn("unable to find edge to compute depths at " + h.getCoordinate());
        ...
        var i = new gt(), s = new Zf(), c = h.getNode();
        for (s.addLast(c), i.add(c), h.setVisited(!0); !s.isEmpty(); ) {
          var d = s.removeFirst();
        ...
        if (this._env === null) {
          for (var h = new _e(), i = this._dirEdgeList.iterator(); i.hasNext(); ) for (var s = i.next().getEdge().getCoordinates(), c = 0; c < s.length - 1; c++) h.expandToInclude(s[c]);
          this._env = h;
        }
        return this._env;
        ...
        for (var s = h.getEdges().iterator(); s.hasNext(); ) {
          var c = s.next();
          this._dirEdgeList.add(c);
          var d = c.getSym().getNode();
        ...
        this._finder = null, this._dirEdgeList = new ve(), this._nodes = new ve(), this._rightMostCoord = null, this._env = null, this._finder = new $f();
      } }]);
    }(), Rs = function() {
      return l(function h() {
        o(this, h);
      }, null, [{ key: "intersection", value: function(h, i, s, c) {
        var d = h.x < i.x ? h.x : i.x, y = h.y < i.y ? h.y : i.y, x = h.x > i.x ? h.x : i.x, E = h.y > i.y ? h.y : i.y, P = s.x < c.x ? s.x : c.x, F = s.y < c.y ? s.y : c.y, $ = s.x > c.x ? s.x : c.x, K = s.y > c.y ? s.y : c.y, ne = ((d > P ? d : P) + (x < $ ? x : $)) / 2, ue = ((y > F ? y : F) + (E < K ? E : K)) / 2, he = h.x - ne, ge = h.y - ue, Re = i.x - ne, Pe = i.y - ue, Ue = s.x - ne, st = s.y - ue, ut = c.x - ne, Ln = c.y - ue, br = ge - Pe, mu = Re - he, vu = he * Pe - Re * ge, yu = st - Ln, pu = ut - Ue, _u = Ue * Ln - ut * st, wu = br * pu - yu * mu, Zs = (mu * _u - pu * vu) / wu, Ks = (yu * vu - br * _u) / wu;
        return W.isNaN(Zs) || W.isInfinite(Zs) || W.isNaN(Ks) || W.isInfinite(Ks) ? null : new Z(Zs + ne, Ks + ue);
      } }]);
    }(), Mt = function() {
      return l(function h() {
        o(this, h);
      }, null, [{ key: "arraycopy", value: function(h, i, s, c, d) {
        for (var y = 0, x = i; x < i + d; x++) s[c + y] = h[x], y++;
...
` }[h];
      ...
      return l(h, null, [{ key: "log10", value: function(i) {
        var s = Math.log(i);
        return W.isInfinite(s) || W.isNaN(s) ? s : s / h.LOG_10;
      } }, { key: "min", value: function(i, s, c, d) {
        var y = i;
        return s < y && (y = s), c < y && (y = c), d < y && (y = d), y;
        ...
        if (arguments.length === 3) {
          var i = arguments[1], s = arguments[2], c = arguments[0];
          return i > c && (c = i), s > c && (c = s), c;
        }
        if (arguments.length === 4) {
    ...
    _r.LOG_10 = Math.log(10);
    var Xt = function() {
      function h() {
        o(this, h);
      }
      return l(h, null, [{ key: "segmentToSegment", value: function(i, s, c, d) {
        if (i.equals(s)) return h.pointToSegment(i, c, d);
        if (c.equals(d)) return h.pointToSegment(d, i, s);
        var y = !1;
        if (_e.intersects(i, s, c, d)) {
          var x = (s.x - i.x) * (d.y - c.y) - (s.y - i.y) * (d.x - c.x);
          if (x === 0) y = !0;
          else {
            var E = (i.y - c.y) * (d.x - c.x) - (i.x - c.x) * (d.y - c.y), P = ((i.y - c.y) * (s.x - i.x) - (i.x - c.x) * (s.y - i.y)) / x, F = E / x;
            (F < 0 || F > 1 || P < 0 || P > 1) && (y = !0);
          }
        } else y = !0;
        return y ? _r.min(h.pointToSegment(i, c, d), h.pointToSegment(s, c, d), h.pointToSegment(c, i, s), h.pointToSegment(d, i, s)) : 0;
      } }, { key: "pointToSegment", value: function(i, s, c) {
        if (s.x === c.x && s.y === c.y) return i.distance(s);
        var d = (c.x - s.x) * (c.x - s.x) + (c.y - s.y) * (c.y - s.y), y = ((i.x - s.x) * (c.x - s.x) + (i.y - s.y) * (c.y - s.y)) / d;
        if (y <= 0) return i.distance(s);
        if (y >= 1) return i.distance(c);
        var x = ((s.y - i.y) * (c.x - s.x) - (s.x - i.x) * (c.y - s.y)) / d;
        return Math.abs(x) * Math.sqrt(d);
      } }, { key: "pointToLinePerpendicular", value: function(i, s, c) {
        var d = (c.x - s.x) * (c.x - s.x) + (c.y - s.y) * (c.y - s.y), y = ((s.y - i.y) * (c.x - s.x) - (s.x - i.x) * (c.y - s.y)) / d;
        ...
        for (var c = i.distance(s[0]), d = 0; d < s.length - 1; d++) {
      ...
      return l(function h() {
        ...
        var s = 0, c = new Z();
        h.getCoordinate(0, c);
        for (var d = c.x, y = c.y, x = 1; x < i; x++) {
          h.getCoordinate(x, c);
          var E = c.x, P = c.y, F = E - d, $ = P - y;
      ...
      return l(h, null, [{ key: "copyCoord", value: function(i, s, c, d) {
        for (var y = Math.min(i.getDimension(), c.getDimension()), x = 0; x < y; x++) c.setOrdinate(d, x, i.getOrdinate(s, x));
        ...
        if (arguments.length === 2) {
          if (Ee(arguments[0], Te) && Number.isInteger(arguments[1])) {
            ...
            var c = arguments[0], d = arguments[1], y = h.indexOf(d, c);
            if (y <= 0) return null;
            h.scroll(c, y);
          }
        } else if (arguments.length === 3) {
        ...
        for (var d = Math.min(i.getDimension(), s.getDimension()), y = 0; y < c; y++) for (var x = 0; x < d; x++) {
        ...
        if (arguments.length === 3) {
          for (var s = arguments[0], c = arguments[2], d = -1, y = null, x = arguments[1]; x <= c; x++) {
            var E = s.getCoordinate(x);
            (y === null || y.compareTo(E) > 0) && (y = E, d = x);
          }
          return d;
        }
      } }, { key: "extend", value: function(i, s, c) {
        var d = i.create(c, s.getDimension()), y = s.size();
        if (h.copy(s, 0, d, 0, y), y > 0) for (var x = y; x < c; x++) h.copy(s, y - 1, d, x, 1);
        return d;
      } }, { key: "reverse", value: function(i) {
        for (var s = i.size() - 1, c = Math.trunc(s / 2), d = 0; d <= c; d++) h.swap(i, d, s - d);
      } }, { key: "swap", value: function(i, s, c) {
        if (s === c) return null;
        for (var d = 0; d < i.getDimension(); d++) {
          var y = i.getOrdinate(s, d);
          i.setOrdinate(s, d, i.getOrdinate(c, d)), i.setOrdinate(c, d, y);
        }
      } }, { key: "copy", value: function(i, s, c, d, y) {
        for (var x = 0; x < y; x++) h.copyCoord(i, s + x, c, d + x);
      } }, { key: "ensureValidRing", value: function(i, s) {
        var c = s.size();
        return c === 0 ? s : c <= 3 ? h.createClosedRing(i, s, 4) : s.getOrdinate(0, Te.X) === s.getOrdinate(c - 1, Te.X) && s.getOrdinate(0, Te.Y) === s.getOrdinate(c - 1, Te.Y) ? s : h.createClosedRing(i, s, c + 1);
      } }, { key: "indexOf", value: function(i, s) {
        for (var c = 0; c < s.size(); c++) if (i.x === s.getOrdinate(c, Te.X) && i.y === s.getOrdinate(c, Te.Y)) return c;
        return -1;
      } }, { key: "createClosedRing", value: function(i, s, c) {
        var d = i.create(c, s.getDimension()), y = s.size();
        h.copy(s, 0, d, 0, y);
        for (var x = y; x < c; x++) h.copy(s, 0, d, x, 1);
        return d;
      } }, { key: "minCoordinate", value: function(i) {
        for (var s = null, c = 0; c < i.size(); c++) {
          var d = i.getCoordinate(c);
      ...
      return l(h, null, [{ key: "toDimensionSymbol", value: function(i) {
        switch (i) {
          case h.FALSE:
            return h.SYM_FALSE;
          case h.TRUE:
    ...
    var vi = function() {
      ...
      return m(i, h), l(i, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof ae) {
          ...
          for (var y = 0; y < this._points.size(); y++) if (!this.equal(this._points.getCoordinate(y), d._points.getCoordinate(y), c)) return !1;
          return !0;
        }
        return w(i, "equalsExact", this, 1).apply(this, arguments);
      } }, { key: "normalize", value: function() {
        for (var s = 0; s < Math.trunc(this._points.size() / 2); s++) {
          var c = this._points.size() - 1 - s;
          if (!this._points.getCoordinate(s).equals(this._points.getCoordinate(c))) {
            if (this._points.getCoordinate(s).compareTo(this._points.getCoordinate(c)) > 0) {
              var d = this._points.copy();
              Cn.reverse(d), this._points = d;
            }
            return null;
          }
        }
        ...
        return Cn.reverse(s), this.getFactory().createLineString(s);
        ...
        return Qf.ofLine(this._points);
      } }, { key: "getNumPoints", value: function() {
        return this._points.size();
      } }, { key: "compareToSameClass", value: function() {
        if (arguments.length === 1) {
          for (var s = arguments[0], c = 0, d = 0; c < this._points.size() && d < s._points.size(); ) {
            var y = this._points.getCoordinate(c).compareTo(s._points.getCoordinate(d));
            if (y !== 0) return y;
            c++, d++;
          }
          return c < this._points.size() ? 1 : d < s._points.size() ? -1 : 0;
        }
        if (arguments.length === 2) {
          var x = arguments[0];
        ...
        if (Ee(arguments[0], mi)) for (var s = arguments[0], c = 0; c < this._points.size(); c++) s.filter(this._points.getCoordinate(c));
        ...
        } else Ee(arguments[0], vi) ? arguments[0].filter(this) : Ee(arguments[0], Y) && arguments[0].filter(this);
        ...
        for (var c = 0; c < this._points.size(); c++) if (this._points.getCoordinate(c).equals(s)) return !0;
        return !1;
        ...
        if (this._points = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var s = arguments[0], c = arguments[1];
            ae.constructor_.call(this, c), this.init(s);
          }
        }
      } }]);
    }(ae), Ta = l(function h() {
      ...
      return m(i, h), l(i, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof ae) {
          var s = arguments[0], c = arguments[1];
          return !!this.isEquivalentClass(s) && (!(!this.isEmpty() || !s.isEmpty()) || this.isEmpty() === s.isEmpty() && this.equal(s.getCoordinate(), this.getCoordinate(), c));
        }
        return w(i, "equalsExact", this, 1).apply(this, arguments);
      } }, { key: "normalize", value: function() {
      } }, { key: "getCoordinate", value: function() {
      ...
      return l(h, null, [{ key: "ofRing", value: function() {
        if (arguments[0] instanceof Array) {
          var i = arguments[0];
        ...
        if (arguments[0] instanceof Array) {
          ...
          for (var s = 0, c = i[0].x, d = 1; d < i.length - 1; d++) {
            var y = i[d].x - c, x = i[d + 1].y;
            s += y * (i[d - 1].y - x);
          }
          return s / 2;
        }
      ...
      return l(function h() {
        ...
        if (arguments.length === 1) i.sort(function(ne, ue) {
          ...
          s.sort();
          var c = i.slice(0, arguments[1]).concat(s, i.slice(arguments[2], i.length));
          i.splice(0, i.length);
          var d, y = f(c);
          try {
            for (y.s(); !(d = y.n()).done; ) {
      ...
      return m(i, h), l(i, [{ key: "computeEnvelopeInternal", value: function() {
        ...
        for (var s = new Array(this.getNumPoints()).fill(null), c = -1, d = this._shell.getCoordinates(), y = 0; y < d.length; y++) s[++c] = d[y];
        for (var x = 0; x < this._holes.length; x++) for (var E = this._holes[x].getCoordinates(), P = 0; P < E.length; P++) s[++c] = E[P];
        return s;
      } }, { key: "getArea", value: function() {
        var s = 0;
        s += Ra.ofRing(this._shell.getCoordinateSequence());
        for (var c = 0; c < this._holes.length; c++) s -= Ra.ofRing(this._holes[c].getCoordinateSequence());
        return s;
      } }, { key: "copyInternal", value: function() {
        for (var s = this._shell.copy(), c = new Array(this._holes.length).fill(null), d = 0; d < this._holes.length; d++) c[d] = this._holes[d].copy();
        return new i(s, c, this._factory);
      } }, { key: "isRectangle", value: function() {
        if (this.getNumInteriorRing() !== 0 || this._shell === null || this._shell.getNumPoints() !== 5) return !1;
        for (var s = this._shell.getCoordinateSequence(), c = this.getEnvelopeInternal(), d = 0; d < 5; d++) {
          var y = s.getX(d);
          if (y !== c.getMinX() && y !== c.getMaxX()) return !1;
          var x = s.getY(d);
          if (x !== c.getMinY() && x !== c.getMaxY()) return !1;
        }
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof ae) {
          ...
          if (!y.equalsExact(x, c) || this._holes.length !== d._holes.length) return !1;
          for (var E = 0; E < this._holes.length; E++) if (!this._holes[E].equalsExact(d._holes[E], c)) return !1;
          return !0;
        }
        return w(i, "equalsExact", this, 1).apply(this, arguments);
      } }, { key: "normalize", value: function() {
        if (arguments.length === 0) {
          ...
          var y = c.getCoordinateSequence(), x = Cn.minCoordinateIndex(y, 0, y.size() - 2);
          Cn.scroll(y, x, !0), we.isCCW(y) === d && Cn.reverse(y);
        }
      } }, { key: "getCoordinate", value: function() {
        ...
        for (var s = this.getExteriorRing().reverse(), c = new Array(this.getNumInteriorRing()).fill(null), d = 0; d < c.length; d++) c[d] = this.getInteriorRingN(d).reverse();
        return this.getFactory().createPolygon(s, c);
      } }, { key: "getTypeCode", value: function() {
        ...
        for (var c = 0; c < this._holes.length; c++) s += this._holes[c].getLength();
        return s;
      } }, { key: "getNumPoints", value: function() {
        for (var s = this._shell.getNumPoints(), c = 0; c < this._holes.length; c++) s += this._holes[c].getNumPoints();
        return s;
      } }, { key: "convexHull", value: function() {
        return this.getExteriorRing().convexHull();
      } }, { key: "normalized", value: function(s, c) {
        var d = s.copy();
        return this.normalize(d, c), d;
      } }, { key: "compareToSameClass", value: function() {
        if (arguments.length === 1) {
          var s = arguments[0], c = this._shell, d = s._shell;
          return c.compareToSameClass(d);
        }
        if (arguments.length === 2) {
        ...
        if (Ee(arguments[0], mi)) {
          var s = arguments[0];
          this._shell.apply(s);
          for (var c = 0; c < this._holes.length; c++) this._holes[c].apply(s);
        } else if (Ee(arguments[0], yi)) {
          var d = arguments[0];
        ...
        s[0] = this._shell;
        for (var c = 0; c < this._holes.length; c++) s[c + 1] = this._holes[c];
        ...
        var s = arguments[0], c = arguments[1], d = arguments[2];
        if (ae.constructor_.call(this, d), s === null && (s = this.getFactory().createLinearRing()), c === null && (c = []), ae.hasNullElements(c)) throw new O("holes must not contain null elements");
        if (s.isEmpty() && ae.hasNonEmptyElements(c)) throw new O("shell is empty but holes are not");
        this._shell = s, this._holes = c;
      } }]);
    }(ae), jf = function(h) {
      function i() {
        return o(this, i), r(this, i, arguments);
      ...
      return m(i, h), l(i, [{ key: "contains", value: function(s) {
        var c, d = f(this.array);
        try {
          for (d.s(); !(c = d.n()).done; )
            if (c.value.compareTo(s) === 0) return !0;
        } catch (y) {
          d.e(y);
        } finally {
          d.f();
        ...
        for (var c = 0, d = this.array.length; c < d; c++)
          if (this.array[c].compareTo(s) === 1) return !!this.array.splice(c, 0, s);
        return this.array.push(s), !0;
      } }, { key: "addAll", value: function(s) {
        var c, d = f(s);
        try {
      ...
      return m(i, h), l(i, [{ key: "computeEnvelopeInternal", value: function() {
        for (var s = new _e(), c = 0; c < this._geometries.length; c++) s.expandToInclude(this._geometries[c].getEnvelopeInternal());
        return s;
      } }, { key: "getGeometryN", value: function(s) {
        return this._geometries[s];
      } }, { key: "getCoordinates", value: function() {
        for (var s = new Array(this.getNumPoints()).fill(null), c = -1, d = 0; d < this._geometries.length; d++) for (var y = this._geometries[d].getCoordinates(), x = 0; x < y.length; x++) s[++c] = y[x];
        return s;
      } }, { key: "getArea", value: function() {
        for (var s = 0, c = 0; c < this._geometries.length; c++) s += this._geometries[c].getArea();
        return s;
      } }, { key: "copyInternal", value: function() {
        for (var s = new Array(this._geometries.length).fill(null), c = 0; c < s.length; c++) s[c] = this._geometries[c].copy();
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof ae) {
          ...
          for (var y = 0; y < this._geometries.length; y++) if (!this._geometries[y].equalsExact(d._geometries[y], c)) return !1;
          return !0;
        }
        return w(i, "equalsExact", this, 1).apply(this, arguments);
      } }, { key: "normalize", value: function() {
        for (var s = 0; s < this._geometries.length; s++) this._geometries[s].normalize();
        Sn.sort(this._geometries);
      } }, { key: "getCoordinate", value: function() {
        return this.isEmpty() ? null : this._geometries[0].getCoordinate();
      } }, { key: "getBoundaryDimension", value: function() {
        for (var s = oe.FALSE, c = 0; c < this._geometries.length; c++) s = Math.max(s, this._geometries[c].getBoundaryDimension());
        return s;
      } }, { key: "reverseInternal", value: function() {
        for (var s = this._geometries.length, c = new ve(s), d = 0; d < s; d++) c.add(this._geometries[d].reverse());
        return this.getFactory().buildGeometry(c);
      } }, { key: "getTypeCode", value: function() {
        return ae.TYPECODE_GEOMETRYCOLLECTION;
      } }, { key: "getDimension", value: function() {
        for (var s = oe.FALSE, c = 0; c < this._geometries.length; c++) s = Math.max(s, this._geometries[c].getDimension());
        return s;
      } }, { key: "getLength", value: function() {
        for (var s = 0, c = 0; c < this._geometries.length; c++) s += this._geometries[c].getLength();
        return s;
      } }, { key: "getNumPoints", value: function() {
        for (var s = 0, c = 0; c < this._geometries.length; c++) s += this._geometries[c].getNumPoints();
        return s;
      } }, { key: "getNumGeometries", value: function() {
        return this._geometries.length;
      } }, { key: "compareToSameClass", value: function() {
        if (arguments.length === 1) {
          var s = arguments[0], c = new Oa(Sn.asList(this._geometries)), d = new Oa(Sn.asList(s._geometries));
        ...
        if (Ee(arguments[0], mi)) for (var s = arguments[0], c = 0; c < this._geometries.length; c++) this._geometries[c].apply(s);
        else if (Ee(arguments[0], yi)) {
          var d = arguments[0];
        ...
        if (this._geometries = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var s = arguments[0], c = arguments[1];
            if (ae.constructor_.call(this, c), s === null && (s = []), ae.hasNullElements(s)) throw new O("geometries must not contain null elements");
            this._geometries = s;
          }
        }
      } }]);
      ...
      return m(i, h), l(i, [{ key: "copyInternal", value: function() {
        for (var s = new Array(this._geometries.length).fill(null), c = 0; c < s.length; c++) s[c] = this._geometries[c].copy();
        return new i(s, this._factory);
        ...
        if (arguments.length === 2 && typeof arguments[1] == "number" && arguments[0] instanceof ae) {
          var s = arguments[0], c = arguments[1];
          return !!this.isEquivalentClass(s) && w(i, "equalsExact", this, 1).call(this, s, c);
        }
        return w(i, "equalsExact", this, 1).apply(this, arguments);
      } }, { key: "getCoordinate", value: function() {
      ...
      return m(i, h), l(i, [{ key: "copyInternal", value: function() {
        ...
        var s = this._points.copy();
        return Cn.reverse(s), this.getFactory().createLinearRing(s);
      } }, { key: "getTypeCode", value: function() {
        ...
        var s = arguments[0], c = arguments[1];
        wr.constructor_.call(this, s, c), this.validateConstruction();
      } }]);
    }(wr);
    ...
    var In = function(h) {
      ...
      return m(i, h), l(i, [{ key: "setOrdinate", value: function(s, c) {
        switch (s) {
          case i.X:
            this.x = c;
            break;
        ...
        if (arguments.length === 0) Z.constructor_.call(this);
          ...
          if (arguments[0] instanceof i) {
            ...
            var c = arguments[0];
            Z.constructor_.call(this, c.x, c.y);
          }
        } else if (arguments.length === 2) {
          var d = arguments[0], y = arguments[1];
    ...
    In.X = 0, In.Y = 1, In.Z = -1, In.M = -1;
    var kn = function(h) {
      function i() {
        var s;
        return o(this, i), s = r(this, i), i.constructor_.apply(s, arguments), s;
      }
      return m(i, h), l(i, [{ key: "getM", value: function() {
        return this._m;
      } }, { key: "setOrdinate", value: function(s, c) {
        switch (s) {
          case i.X:
            this.x = c;
            break;
        ...
        if (this._m = null, arguments.length === 0) Z.constructor_.call(this), this._m = 0;
          ...
          if (arguments[0] instanceof i) {
            ...
            var c = arguments[0];
            Z.constructor_.call(this, c.x, c.y), this._m = this.getM();
          }
        } else if (arguments.length === 3) {
          var d = arguments[0], y = arguments[1], x = arguments[2];
    ...
    var Ds = function(h) {
      ...
      return l(h, null, [{ key: "measures", value: function(i) {
        return i instanceof In ? 0 : i instanceof kn || i instanceof Ds ? 1 : 0;
      } }, { key: "dimension", value: function(i) {
        return i instanceof In ? 2 : i instanceof kn ? 3 : i instanceof Ds ? 4 : 3;
      } }, { key: "create", value: function() {
        if (arguments.length === 1) {
          var i = arguments[0];
          return h.create(i, 0);
        ...
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1];
          return s === 2 ? new In() : s === 3 && c === 0 ? new Z() : s === 3 && c === 1 ? new kn() : s === 4 && c === 1 ? new Ds() : new Z();
        }
      } }]);
    }(), Er = function(h) {
      function i() {
      ...
      return m(i, h), l(i, [{ key: "getCoordinate", value: function(s) {
        return this.get(s);
      } }, { key: "addAll", value: function() {
        if (arguments.length === 2 && typeof arguments[1] == "boolean" && Ee(arguments[0], be)) {
          for (var s = arguments[1], c = !1, d = arguments[0].iterator(); d.hasNext(); ) this.add(d.next(), s), c = !0;
          return c;
        }
        return w(i, "addAll", this, 1).apply(this, arguments);
      } }, { key: "clone", value: function() {
        for (var s = w(i, "clone", this, 1).call(this), c = 0; c < this.size(); c++) s.add(c, this.get(c).clone());
        return s;
      } }, { key: "toCoordinateArray", value: function() {
        if (arguments.length === 0) return this.toArray(i.coordArrayType);
        if (arguments.length === 1) {
          if (arguments[0]) return this.toArray(i.coordArrayType);
          for (var s = this.size(), c = new Array(s).fill(null), d = 0; d < s; d++) c[d] = this.get(s - d - 1);
          return c;
        }
      } }, { key: "add", value: function() {
        if (arguments.length === 1) {
        ...
        if (arguments.length !== 0) {
          if (arguments.length === 1) {
            ...
            var c = arguments[0], d = arguments[1];
            this.ensureCapacity(c.length), this.add(c, d);
          }
        }
      } }]);
    }(ve);
    ...
    var tt = function() {
      ...
      return l(h, null, [{ key: "isRing", value: function(i) {
        ...
        Mt.arraycopy(i, c, d, 0, i.length - c), Mt.arraycopy(i, 0, d, i.length - c, c), Mt.arraycopy(d, 0, i, 0, i.length);
      } }, { key: "equals", value: function() {
        if (arguments.length === 2) {
          var i = arguments[0], s = arguments[1];
          if (i === s) return !0;
          if (i === null || s === null || i.length !== s.length) return !1;
          for (var c = 0; c < i.length; c++) if (!i[c].equals(s[c])) return !1;
          return !0;
        }
        if (arguments.length === 3) {
          var d = arguments[0], y = arguments[1], x = arguments[2];
        ...
        for (var c = new Er(), d = 0; d < i.length; d++) s.intersects(i[d]) && c.add(i[d], !0);
        ...
        return h.hasRepeatedPoints(i) ? new Er(i, !1).toCoordinateArray() : i;
      } }, { key: "reverse", value: function(i) {
        for (var s = i.length - 1, c = Math.trunc(s / 2), d = 0; d <= c; d++) {
          var y = i[d];
          i[d] = i[s - d], i[s - d] = y;
        }
      } }, { key: "removeNull", value: function(i) {
        for (var s = 0, c = 0; c < i.length; c++) i[c] !== null && s++;
        ...
        if (arguments.length === 1) {
          for (var i = arguments[0], s = new Array(i.length).fill(null), c = 0; c < i.length; c++) s[c] = i[c].copy();
          return s;
        }
        ...
        for (var c = 0; c < i.length; c++) {
          var d = i[c], y = s[i.length - c - 1];
          if (d.compareTo(y) !== 0) return !1;
        }
        return !0;
      } }, { key: "envelope", value: function(i) {
        for (var s = new _e(), c = 0; c < i.length; c++) s.expandToInclude(i[c]);
        return s;
        ...
        for (var c = 0; c < s.length; c++) if (i.equals(s[c])) return c;
        return -1;
      } }, { key: "increasingDirection", value: function(i) {
        for (var s = 0; s < Math.trunc(i.length / 2); s++) {
          var c = i.length - 1 - s, d = i[s].compareTo(i[c]);
          if (d !== 0) return d;
        }
        return 1;
      } }, { key: "compare", value: function(i, s) {
        for (var c = 0; c < i.length && c < s.length; ) {
          var d = i[c].compareTo(s[c]);
          if (d !== 0) return d;
          c++;
        }
        return c < s.length ? -1 : c < i.length ? 1 : 0;
      } }, { key: "minCoordinate", value: function(i) {
        for (var s = null, c = 0; c < i.length; c++) (s === null || s.compareTo(i[c]) > 0) && (s = i[c]);
        return s;
      } }, { key: "extract", value: function(i, s, c) {
        s = _r.clamp(s, 0, i.length);
        var d = (c = _r.clamp(c, -1, i.length)) - s + 1;
        c < 0 && (d = 0), s >= i.length && (d = 0), c < s && (d = 0);
        var y = new Array(d).fill(null);
        if (d === 0) return y;
        for (var x = 0, E = s; E <= c; E++) y[x++] = i[E];
        return y;
      } }]);
    }(), tg = function() {
      return l(function h() {
      ...
      return l(function h() {
        ...
        var d = tt.compare(s, c);
        return tt.isEqualReversed(s, c) ? 0 : d;
      } }, { key: "OLDcompare", value: function(h, i) {
        var s = h, c = i;
        if (s.length < c.length) return -1;
        if (s.length > c.length) return 1;
        if (s.length === 0) return 0;
        for (var d = tt.increasingDirection(s), y = tt.increasingDirection(c), x = d > 0 ? 0 : s.length - 1, E = y > 0 ? 0 : s.length - 1, P = 0; P < s.length; P++) {
          var F = s[x].compareTo(c[E]);
          if (F !== 0) return F;
          x += d, E += y;
        }
        return 0;
    ...
    tt.ForwardComparator = tg, tt.BidirectionalComparator = ng, tt.coordArrayType = new Array(0).fill(null);
    var wi = function() {
      return l(function h(i) {
        o(this, h), this.str = i;
      }, [{ key: "append", value: function(h) {
      ...
      return l(h, [{ key: "getM", value: function(i) {
        return this.hasM() ? this._coordinates[i].getM() : W.NaN;
      } }, { key: "setOrdinate", value: function(i, s, c) {
        switch (s) {
          case Te.X:
            this._coordinates[i].x = c;
            break;
          case Te.Y:
            this._coordinates[i].y = c;
            break;
          default:
            this._coordinates[i].setOrdinate(s, c);
        }
        ...
        return _i.create(this.getDimension(), this.getMeasures());
      } }, { key: "getDimension", value: function() {
        ...
        for (var i = new Array(this.size()).fill(null), s = 0; s < this._coordinates.length; s++) {
          var c = this.createCoordinate();
          c.setCoordinate(this._coordinates[s]), i[s] = c;
        }
        return new h(i, this._dimension, this._measures);
      } }, { key: "toString", value: function() {
        if (this._coordinates.length > 0) {
          var i = new wi(17 * this._coordinates.length);
        ...
        if (this._dimension = 3, this._measures = 0, this._coordinates = null, arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            ...
            for (var c = 0; c < s; c++) this._coordinates[c] = new Z();
          ...
          if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
            ...
            for (var $ = 0; $ < P; $++) this._coordinates[$] = _i.create(F);
          }
        } else if (arguments.length === 3) {
      ...
      return l(h, [{ key: "readResolve", value: function() {
        return h.instance();
      } }, { key: "create", value: function() {
        if (arguments.length === 1) {
          if (arguments[0] instanceof Array) return new Cr(arguments[0]);
          if (Ee(arguments[0], Te)) return new Cr(arguments[0]);
        } else {
          if (arguments.length === 2) {
            var i = arguments[1];
            return i > 3 && (i = 3), i < 2 && (i = 2), new Cr(arguments[0], i);
          }
          if (arguments.length === 3) {
            var s = arguments[2], c = arguments[1] - s;
            return s > 1 && (s = 1), c > 3 && (c = 3), c < 2 && (c = 2), new Cr(arguments[0], c + s, s);
          }
        }
      } }, { key: "interfaces_", get: function() {
        return [Pa, M];
    ...
    var Bs = function(h) {
      ...
      return m(i, h), l(i, [{ key: "copyInternal", value: function() {
        ...
        if (this.isEmpty()) return this.getFactory().createMultiLineString();
        for (var s = new ve(), c = 0; c < this._geometries.length; c++) for (var d = this._geometries[c].getBoundary(), y = 0; y < d.getNumGeometries(); y++) s.add(d.getGeometryN(y));
      ...
      return m(i, h), l(i, [{ key: "get", value: function(s) {
        return this.map.get(s) || null;
      } }, { key: "put", value: function(s, c) {
        return this.map.set(s, c), c;
      } }, { key: "values", value: function() {
        for (var s = new ve(), c = this.map.values(), d = c.next(); !d.done; ) s.add(d.value), d = c.next();
        return s;
      } }, { key: "entrySet", value: function() {
        var s = new gt();
      ...
      return l(h, [{ key: "equals", value: function(i) {
        if (!(i instanceof h)) return !1;
        var s = i;
        return this._modelType === s._modelType && this._scale === s._scale;
      } }, { key: "compareTo", value: function(i) {
        var s = i, c = this.getMaximumSignificantDigits(), d = s.getMaximumSignificantDigits();
        return vn.compare(c, d);
        ...
        if (this._modelType = null, this._scale = null, arguments.length === 0) this._modelType = h.FLOATING;
          ...
          if (arguments[0] instanceof qn) {
            ...
            var c = arguments[0];
            this._modelType = c._modelType, this._scale = c._scale;
          }
        }
    ...
    qn.nameToTypeMap = new rg(), Bt.Type = qn, Bt.FIXED = new qn("FIXED"), Bt.FLOATING = new qn("FLOATING"), Bt.FLOATING_SINGLE = new qn("FLOATING SINGLE"), Bt.maximumPreciseValue = 9007199254740992;
    var Gs = function(h) {
      function i() {
        var s;
        return o(this, i), s = r(this, i), i.constructor_.apply(s, arguments), s;
      ...
      return l(h, [{ key: "createEmpty", value: function(i) {
        switch (i) {
          case -1:
        ...
        return arguments.length === 0 ? new Gs(null, this) : arguments.length === 1 ? new Gs(arguments[0], this) : void 0;
      } }, { key: "buildGeometry", value: function(i) {
        for (var s = null, c = !1, d = !1, y = i.iterator(); y.hasNext(); ) {
          var x = y.next(), E = x.getTypeCode();
          s === null && (s = E), E !== s && (c = !0), x instanceof Et && (d = !0);
        }
        if (s === null) return this.createGeometryCollection();
        if (c || d) return this.createGeometryCollection(h.toGeometryArray(i));
        var P = i.iterator().next();
        if (i.size() > 1) {
          if (P instanceof pi) return this.createMultiPolygon(h.toPolygonArray(i));
          if (P instanceof wr) return this.createMultiLineString(h.toLineStringArray(i));
          if (P instanceof As) return this.createMultiPoint(h.toPointArray(i));
        ...
        if (arguments.length === 1) {
          ...
          if (Ee(arguments[0], Te)) return new As(arguments[0], this);
        }
        ...
        if (arguments.length === 1) {
          ...
          return new pi(arguments[0], arguments[1], this);
      } }, { key: "getSRID", value: function() {
        return this._SRID;
        ...
        if (arguments.length === 1) {
          ...
          if (Ee(arguments[0], Te)) return new xr(arguments[0], this);
        }
      } }, { key: "createMultiPolygon", value: function() {
        return arguments.length === 0 ? new Bs(null, this) : arguments.length === 1 ? new Bs(arguments[0], this) : void 0;
      } }, { key: "createMultiPoint", value: function() {
        if (arguments.length === 0) return new Os(null, this);
        if (arguments.length === 1) {
          if (arguments[0] instanceof Array) return new Os(arguments[0], this);
          if (Ee(arguments[0], Te)) {
            var i = arguments[0];
            if (i === null) return this.createMultiPoint(new Array(0).fill(null));
            for (var s = new Array(i.size()).fill(null), c = 0; c < i.size(); c++) {
              var d = this.getCoordinateSequenceFactory().create(1, i.getDimension(), i.getMeasures());
              Cn.copy(i, c, d, 0, 1), s[c] = this.createPoint(d);
            }
        ...
        if (this._precisionModel = null, this._coordinateSequenceFactory = null, this._SRID = null, arguments.length === 0) h.constructor_.call(this, new Bt(), 0);
          ...
          var c = arguments[0], d = arguments[1];
          h.constructor_.call(this, c, d, h.getDefaultCoordinateSequenceFactory());
        } else if (arguments.length === 3) {
    ...
    }(), zs = "XY", ig = "XYZ", sg = "XYM", og = "XYZM", Fa = { POINT: "Point", LINE_STRING: "LineString", LINEAR_RING: "LinearRing", POLYGON: "Polygon", MULTI_POINT: "MultiPoint", MULTI_LINE_STRING: "MultiLineString", MULTI_POLYGON: "MultiPolygon", GEOMETRY_COLLECTION: "GeometryCollection", CIRCLE: "Circle" }, Ba = "EMPTY", xi = 1, sn = 2, yn = 3, Ga = 4, Yn = 5, ag = 6;
    for (var ug in Fa) Fa[ug].toUpperCase();
    var lg = function() {
      return l(function h(i) {
...
`;
        ...
        var h, i = this.nextChar_(), s = this.index_, c = i;
        if (i == "(") h = sn;
        else if (i == ",") h = Yn;
        else if (i == ")") h = yn;
        else if (this.isNumeric_(i) || i == "-") h = Ga, c = this.readNumber_();
        else if (this.isAlpha_(i)) h = xi, c = this.readText_();
        else {
          if (this.isWhiteSpace_(i)) return this.nextToken();
          if (i !== "") throw new Error("Unexpected character: " + i);
          h = ag;
        }
        return { position: s, value: c, type: h };
      } }, { key: "readNumber_", value: function() {
        var h, i = this.index_, s = !1, c = !1;
        do
          h == "." ? s = !0 : h != "e" && h != "E" || (c = !0), h = this.nextChar_();
        while (this.isNumeric_(h, s) || !c && (h == "e" || h == "E") || c && (h == "-" || h == "+"));
      ...
      return l(function h(i, s) {
        o(this, h), this.lexer_ = i, this.token_, this.layout_ = zs, this.factory = s;
        ...
        var h = zs, i = this.token_;
        if (this.isTokenType(xi)) {
          var s = i.value;
          s === "Z" ? h = ig : s === "M" ? h = sg : s === "ZM" && (h = og), h !== zs && this.consume_();
        }
        return h;
        ...
        var h;
        if (this.match(sn)) {
          if (h = this.token_.type == sn ? this.parsePointTextList_() : this.parsePointList_(), this.match(yn)) return h;
        } else if (this.isEmptyGeometry_()) return [];
        throw new Error(this.formatErrorMessage_());
        ...
        for (var h = [], i = this.layout_.length, s = 0; s < i; ++s) {
          var c = this.token_;
          if (!this.match(Ga)) break;
          h.push(c.value);
        }
        if (h.length == i) return h;
        throw new Error(this.formatErrorMessage_());
      } }, { key: "parsePointList_", value: function() {
        for (var h = [this.parsePoint_()]; this.match(Yn); ) h.push(this.parsePoint_());
        return h;
      } }, { key: "parsePointTextList_", value: function() {
        for (var h = [this.parsePointText_()]; this.match(Yn); ) h.push(this.parsePointText_());
        return h;
      } }, { key: "parseLineStringTextList_", value: function() {
        for (var h = [this.parseLineStringText_()]; this.match(Yn); ) h.push(this.parseLineStringText_());
        return h;
      } }, { key: "parsePolygonTextList_", value: function() {
        for (var h = [this.parsePolygonText_()]; this.match(Yn); ) h.push(this.parsePolygonText_());
        return h;
      } }, { key: "isEmptyGeometry_", value: function() {
        var h = this.isTokenType(xi) && this.token_.value == Ba;
        ...
        if (this.match(xi)) {
          ...
          switch (d) {
            case "POINT":
              ...
              return x ? h.createPoint(a(Z, S(x))) : h.createPoint();
            case "LINESTRING":
    ...
    function Sr(h) {
      ...
      }), s = [], c = 0, d = i.length; c < d; ++c) s.push(i[c].join(" "));
      return s.join(", ");
    }
    function qa(h) {
      var i = [];
      i.push("(" + Sr(h.getExteriorRing()) + ")");
      for (var s = 0, c = h.getNumInteriorRing(); s < c; ++s) i.push("(" + Sr(h.getInteriorRingN(s)) + ")");
      return i.join(", ");
    }
    var hg = { Point: za, LineString: Sr, LinearRing: Sr, Polygon: qa, MultiPoint: function(h) {
      for (var i = [], s = 0, c = h.getNumGeometries(); s < c; ++s) i.push("(" + za(h.getGeometryN(s)) + ")");
      return i.join(", ");
    }, MultiLineString: function(h) {
      for (var i = [], s = 0, c = h.getNumGeometries(); s < c; ++s) i.push("(" + Sr(h.getGeometryN(s)) + ")");
      return i.join(", ");
    }, MultiPolygon: function(h) {
      for (var i = [], s = 0, c = h.getNumGeometries(); s < c; ++s) i.push("(" + qa(h.getGeometryN(s)) + ")");
      return i.join(", ");
    }, GeometryCollection: function(h) {
      for (var i = [], s = 0, c = h.getNumGeometries(); s < c; ++s) i.push(Ua(h.getGeometryN(s)));
      return i.join(", ");
    } };
    function Ua(h) {
      var i = h.getGeometryType(), s = hg[i];
      i = i.toUpperCase();
      var c = function(d) {
        var y = "";
      ...
      return c.length > 0 && (i += " " + c), h.isEmpty() ? i + " " + Ba : i + " (" + s(h) + ")";
    }
    var fg = function() {
      return l(function h(i) {
        o(this, h), this.geometryFactory = i || new Un(), this.precisionModel = this.geometryFactory.getPrecisionModel();
      }, [{ key: "read", value: function(h) {
        var i = new lg(h);
        return new cg(i, this.geometryFactory).parse();
      } }, { key: "write", value: function(h) {
        return Ua(h);
      } }]);
    }(), qs = function() {
      return l(function h(i) {
        o(this, h), this.parser = new fg(i);
      }, [{ key: "write", value: function(h) {
      ...
      return l(h, [{ key: "getIndexAlongSegment", value: function(i, s) {
      ...
      } }, { key: "computeIntersection", value: function(i, s, c, d) {
        this._inputLines[0][0] = i, this._inputLines[0][1] = s, this._inputLines[1][0] = c, this._inputLines[1][1] = d, this._result = this.computeIntersect(i, s, c, d);
        ...
        return qs.toLineString(this._inputLines[0][0], this._inputLines[0][1]) + " - " + qs.toLineString(this._inputLines[1][0], this._inputLines[1][1]) + this.getTopologySummary();
      ...
      } }, { key: "computeEdgeDistance", value: function(i, s, c) {
        var d = Math.abs(c.x - s.x), y = Math.abs(c.y - s.y), x = -1;
        if (i.equals(s)) x = 0;
        else if (i.equals(c)) x = d > y ? d : y;
        else {
      ...
      } }, { key: "nonRobustComputeEdgeDistance", value: function(i, s, c) {
    ...
    var bn = function(h) {
      ...
      return m(i, h), l(i, [{ key: "isInSegmentEnvelopes", value: function(s) {
        var c = new _e(this._inputLines[0][0], this._inputLines[0][1]), d = new _e(this._inputLines[1][0], this._inputLines[1][1]);
        return c.contains(s) && d.contains(s);
      } }, { key: "computeIntersection", value: function() {
        if (arguments.length !== 3) return w(i, "computeIntersection", this, 1).apply(this, arguments);
        var s = arguments[0], c = arguments[1], d = arguments[2];
        if (this._isProper = !1, _e.intersects(c, d, s) && we.index(c, d, s) === 0 && we.index(d, c, s) === 0) return this._isProper = !0, (s.equals(c) || s.equals(d)) && (this._isProper = !1), this._result = We.POINT_INTERSECTION, null;
        this._result = We.NO_INTERSECTION;
      } }, { key: "intersection", value: function(s, c, d, y) {
        var x = this.intersectionSafe(s, c, d, y);
        return this.isInSegmentEnvelopes(x) || (x = new Z(i.nearestEndpoint(s, c, d, y))), this._precisionModel !== null && this._precisionModel.makePrecise(x), x;
      } }, { key: "checkDD", value: function(s, c, d, y, x) {
        var E = Ts.intersection(s, c, d, y), P = this.isInSegmentEnvelopes(E);
        Mt.out.println("DD in env = " + P + "  --------------------- " + E), x.distance(E) > 1e-4 && Mt.out.println("Distance = " + x.distance(E));
      } }, { key: "intersectionSafe", value: function(s, c, d, y) {
        var x = Rs.intersection(s, c, d, y);
        return x === null && (x = i.nearestEndpoint(s, c, d, y)), x;
      } }, { key: "computeCollinearIntersection", value: function(s, c, d, y) {
        var x = _e.intersects(s, c, d), E = _e.intersects(s, c, y), P = _e.intersects(d, y, s), F = _e.intersects(d, y, c);
        return x && E ? (this._intPt[0] = d, this._intPt[1] = y, We.COLLINEAR_INTERSECTION) : P && F ? (this._intPt[0] = s, this._intPt[1] = c, We.COLLINEAR_INTERSECTION) : x && P ? (this._intPt[0] = d, this._intPt[1] = s, !d.equals(s) || E || F ? We.COLLINEAR_INTERSECTION : We.POINT_INTERSECTION) : x && F ? (this._intPt[0] = d, this._intPt[1] = c, !d.equals(c) || E || P ? We.COLLINEAR_INTERSECTION : We.POINT_INTERSECTION) : E && P ? (this._intPt[0] = y, this._intPt[1] = s, !y.equals(s) || x || F ? We.COLLINEAR_INTERSECTION : We.POINT_INTERSECTION) : E && F ? (this._intPt[0] = y, this._intPt[1] = c, !y.equals(c) || x || P ? We.COLLINEAR_INTERSECTION : We.POINT_INTERSECTION) : We.NO_INTERSECTION;
      } }, { key: "computeIntersect", value: function(s, c, d, y) {
        if (this._isProper = !1, !_e.intersects(s, c, d, y)) return We.NO_INTERSECTION;
        var x = we.index(s, c, d), E = we.index(s, c, y);
        if (x > 0 && E > 0 || x < 0 && E < 0) return We.NO_INTERSECTION;
        var P = we.index(d, y, s), F = we.index(d, y, c);
        return P > 0 && F > 0 || P < 0 && F < 0 ? We.NO_INTERSECTION : x === 0 && E === 0 && P === 0 && F === 0 ? this.computeCollinearIntersection(s, c, d, y) : (x === 0 || E === 0 || P === 0 || F === 0 ? (this._isProper = !1, s.equals2D(d) || s.equals2D(y) ? this._intPt[0] = s : c.equals2D(d) || c.equals2D(y) ? this._intPt[0] = c : x === 0 ? this._intPt[0] = new Z(d) : E === 0 ? this._intPt[0] = new Z(y) : P === 0 ? this._intPt[0] = new Z(s) : F === 0 && (this._intPt[0] = new Z(c))) : (this._isProper = !0, this._intPt[0] = this.intersection(s, c, d, y)), We.POINT_INTERSECTION);
      } }], [{ key: "nearestEndpoint", value: function(s, c, d, y) {
        var x = s, E = Xt.pointToSegment(s, d, y), P = Xt.pointToSegment(c, d, y);
        return P < E && (E = P, x = c), (P = Xt.pointToSegment(d, s, c)) < E && (E = P, x = d), (P = Xt.pointToSegment(y, s, c)) < E && (E = P, x = y), x;
      } }]);
    }(We), gg = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "countSegment", value: function(i, s) {
        ...
        if (i.y === this._p.y && s.y === this._p.y) {
          var c = i.x, d = s.x;
          return c > d && (c = s.x, d = i.x), this._p.x >= c && this._p.x <= d && (this._isPointOnSegment = !0), null;
        }
        ...
        if (arguments[0] instanceof Z && Ee(arguments[1], Te)) {
          for (var i = arguments[1], s = new h(arguments[0]), c = new Z(), d = new Z(), y = 1; y < i.size(); y++) if (i.getCoordinate(y, c), i.getCoordinate(y - 1, d), s.countSegment(c, d), s.isOnSegment()) return s.getLocation();
      ...
      return l(h, null, [{ key: "isOnLine", value: function() {
        if (arguments[0] instanceof Z && Ee(arguments[1], Te)) {
          for (var i = arguments[0], s = arguments[1], c = new bn(), d = new Z(), y = new Z(), x = s.size(), E = 1; E < x; E++) if (s.getCoordinate(E - 1, d), s.getCoordinate(E, y), c.computeIntersection(i, d, y), c.hasIntersection()) return !0;
          return !1;
        }
        if (arguments[0] instanceof Z && arguments[1] instanceof Array) {
          for (var P = arguments[0], F = arguments[1], $ = new bn(), K = 1; K < F.length; K++) {
            var ne = F[K - 1], ue = F[K];
        ...
        return gg.locatePointInRing(i, s);
      } }, { key: "isInRing", value: function(i, s) {
        return h.locateInRing(i, s) !== q.EXTERIOR;
      } }]);
    }(), Lt = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "setAllLocations", value: function(i) {
        for (var s = 0; s < this.location.length; s++) this.location[s] = i;
      } }, { key: "isNull", value: function() {
        for (var i = 0; i < this.location.length; i++) if (this.location[i] !== q.NONE) return !1;
        return !0;
      } }, { key: "setAllLocationsIfNull", value: function(i) {
        for (var s = 0; s < this.location.length; s++) this.location[s] === q.NONE && (this.location[s] = i);
        ...
        if (i.location.length > this.location.length) {
          ...
          s[ie.ON] = this.location[ie.ON], s[ie.LEFT] = q.NONE, s[ie.RIGHT] = q.NONE, this.location = s;
        }
        for (var c = 0; c < this.location.length; c++) this.location[c] === q.NONE && c < i.location.length && (this.location[c] = i.location[c]);
        ...
        var i = new mn();
        return this.location.length > 1 && i.append(q.toLocationSymbol(this.location[ie.LEFT])), i.append(q.toLocationSymbol(this.location[ie.ON])), this.location.length > 1 && i.append(q.toLocationSymbol(this.location[ie.RIGHT])), i.toString();
      } }, { key: "setLocations", value: function(i, s, c) {
        this.location[ie.ON] = i, this.location[ie.LEFT] = s, this.location[ie.RIGHT] = c;
      } }, { key: "get", value: function(i) {
        return i < this.location.length ? this.location[i] : q.NONE;
      } }, { key: "isArea", value: function() {
        return this.location.length > 1;
      } }, { key: "isAnyNull", value: function() {
        for (var i = 0; i < this.location.length; i++) if (this.location[i] === q.NONE) return !0;
        return !1;
        ...
        this.location = new Array(i).fill(null), this.setAllLocations(q.NONE);
        ...
        if (this.location = null, arguments.length === 1) {
          if (arguments[0] instanceof Array) {
            ...
            var c = arguments[0];
            if (this.init(c.location.length), c !== null) for (var d = 0; d < this.location.length; d++) this.location[d] = c.location[d];
          }
        } else if (arguments.length === 3) {
          var y = arguments[0], x = arguments[1], E = arguments[2];
      ...
      return l(h, [{ key: "getGeometryCount", value: function() {
        var i = 0;
        ...
        if (arguments.length === 1) {
          ...
          var s = arguments[0], c = arguments[1];
          this.elt[s].setAllLocationsIfNull(c);
        }
      } }, { key: "isLine", value: function(i) {
        return this.elt[i].isLine();
      } }, { key: "merge", value: function(i) {
        for (var s = 0; s < 2; s++) this.elt[s] === null && i.elt[s] !== null ? this.elt[s] = new Lt(i.elt[s]) : this.elt[s].merge(i.elt[s]);
      } }, { key: "flip", value: function() {
        ...
        this.elt[i].isArea() && (this.elt[i] = new Lt(this.elt[i].location[0]));
      } }], [{ key: "constructor_", value: function() {
        if (this.elt = new Array(2).fill(null), arguments.length === 1) {
          if (Number.isInteger(arguments[0])) {
            var i = arguments[0];
            this.elt[0] = new Lt(i), this.elt[1] = new Lt(i);
          } else if (arguments[0] instanceof h) {
            var s = arguments[0];
            this.elt[0] = new Lt(s.elt[0]), this.elt[1] = new Lt(s.elt[1]);
          }
        } else if (arguments.length === 2) {
          var c = arguments[0], d = arguments[1];
          this.elt[0] = new Lt(q.NONE), this.elt[1] = new Lt(q.NONE), this.elt[c].setLocation(d);
        } else if (arguments.length === 3) {
          var y = arguments[0], x = arguments[1], E = arguments[2];
          this.elt[0] = new Lt(y, x, E), this.elt[1] = new Lt(y, x, E);
        } else if (arguments.length === 4) {
          var P = arguments[0], F = arguments[1], $ = arguments[2], K = arguments[3];
          this.elt[0] = new Lt(q.NONE, q.NONE, q.NONE), this.elt[1] = new Lt(q.NONE, q.NONE, q.NONE), this.elt[P].setLocations(F, $, K);
        }
      } }, { key: "toLineLabel", value: function(i) {
        for (var s = new h(q.NONE), c = 0; c < 2; c++) s.setLocation(c, i.getLocation(c));
        return s;
      } }]);
    }(), Ei = function() {
      return l(function h() {
        ...
        var i = h, s = !0;
        do {
          if (i === null) throw new rn("Found null DirectedEdge");
          if (i.getEdgeRing() === this) throw new rn("Directed Edge visited twice during ring-building at " + i.getCoordinate());
          this._edges.add(i);
          var c = i.getLabel();
          ee.isTrue(c.isArea()), this.mergeLabel(c), this.addPoints(i.getEdge(), i.isForward(), s), s = !1, this.setEdgeRing(i, this), i = this.getNext(i);
        ...
        if (i) {
          var d = 1;
          s && (d = 0);
          for (var y = d; y < c.length; y++) this._pts.add(c[y]);
        } else {
          var x = c.length - 2;
          s && (x = c.length - 1);
          for (var E = x; E >= 0; E--) this._pts.add(c[E]);
        }
        ...
        if (!i.getEnvelopeInternal().contains(h) || !Us.isInRing(h, i.getCoordinates())) return !1;
        ...
        if (arguments.length === 1) {
          ...
          if (s === q.NONE) return null;
          if (this._label.getLocation(i) === q.NONE) return this._label.setLocation(i, s), null;
        }
        ...
        if (this._startDe = null, this._maxNodeDegree = -1, this._edges = new ve(), this._pts = new ve(), this._label = new Pt(q.NONE), this._ring = null, this._isHole = null, this._shell = null, this._holes = new ve(), this._geometryFactory = null, arguments.length !== 0) {
          if (arguments.length === 2) {
            var h = arguments[0], i = arguments[1];
      ...
      return m(i, h), l(i, [{ key: "setEdgeRing", value: function(s, c) {
        s.setMinEdgeRing(c);
      } }, { key: "getNext", value: function(s) {
        return s.getNextMin();
      } }], [{ key: "constructor_", value: function() {
        var s = arguments[0], c = arguments[1];
        Ei.constructor_.call(this, s, c);
      } }]);
    }(Ei), mg = function(h) {
      function i() {
        var s;
      ...
      return m(i, h), l(i, [{ key: "buildMinimalRings", value: function() {
        var s = new ve(), c = this._startDe;
        do {
          if (c.getMinEdgeRing() === null) {
            var d = new dg(c, this._geometryFactory);
            s.add(d);
          }
          c = c.getNext();
        } while (c !== this._startDe);
        return s;
      } }, { key: "setEdgeRing", value: function(s, c) {
        s.setEdgeRing(c);
      ...
      return m(i, h), l(i, [{ key: "isIncidentEdgeInResult", value: function() {
      ...
      } }, { key: "computeMergedLocation", value: function(s, c) {
        var d = q.NONE;
        if (d = this._label.getLocation(c), !s.isNull(c)) {
          var y = s.getLocation(c);
          d !== q.BOUNDARY && (d = y);
        }
        return d;
        ...
        var s = arguments[0], c = arguments[1];
        this._label === null ? this._label = new Pt(s, c) : this._label.setLocation(s, c);
      } }, { key: "getEdges", value: function() {
        return this._edges;
      } }, { key: "mergeLabel", value: function() {
        if (arguments[0] instanceof i) {
        ...
        } else if (arguments[0] instanceof Pt) for (var c = arguments[0], d = 0; d < 2; d++) {
          var y = this.computeMergedLocation(c, d);
          this._label.getLocation(d) === q.NONE && this._label.setLocation(d, y);
        }
      } }, { key: "add", value: function(s) {
        ...
        var c = q.NONE;
        this._label !== null && (c = this._label.getLocation(s));
        var d = null;
        switch (c) {
          case q.BOUNDARY:
            d = q.INTERIOR;
        ...
        var s = arguments[0], c = arguments[1];
        this._coord = s, this._edges = c, this._label = new Pt(0, q.NONE);
      } }]);
    }(Ya), vg = function(h) {
      function i() {
        return o(this, i), r(this, i, arguments);
    ...
    var Ir = function(h) {
      ...
      return m(i, h), l(i, [{ key: "get", value: function(s) {
        for (var c = this.root_; c !== null; ) {
          var d = s.compareTo(c.key);
          if (d < 0) c = c.left;
          else {
            if (!(d > 0)) return c.value;
            c = c.right;
          }
        }
        return null;
      } }, { key: "put", value: function(s, c) {
        if (this.root_ === null) return this.root_ = { key: s, value: c, left: null, right: null, parent: null, color: 0, getValue: function() {
          return this.value;
        }, getKey: function() {
          return this.key;
        } }, this.size_ = 1, null;
        ...
        while (x !== null);
        var P = { key: s, left: null, right: null, value: c, parent: d, color: 0, getValue: function() {
          return this.value;
        }, getKey: function() {
          return this.key;
        } };
        ...
        var c;
        for (s.color = 1; s != null && s !== this.root_ && s.parent.color === 1; ) De(s) === Ys(De(De(s))) ? Xa(c = Va(De(De(s)))) === 1 ? (Vt(De(s), 0), Vt(c, 0), Vt(De(De(s)), 1), s = De(De(s))) : (s === Va(De(s)) && (s = De(s), this.rotateLeft(s)), Vt(De(s), 0), Vt(De(De(s)), 1), this.rotateRight(De(De(s)))) : Xa(c = Ys(De(De(s)))) === 1 ? (Vt(De(s), 0), Vt(c, 0), Vt(De(De(s)), 1), s = De(De(s))) : (s === Ys(De(s)) && (s = De(s), this.rotateRight(s)), Vt(De(s), 0), Vt(De(De(s)), 1), this.rotateLeft(De(De(s))));
        this.root_.color = 0;
      } }, { key: "values", value: function() {
        var s = new ve(), c = this.getFirstEntry();
        if (c !== null) for (s.add(c.value); (c = i.successor(c)) !== null; ) s.add(c.value);
        return s;
      } }, { key: "entrySet", value: function() {
        var s = new gt(), c = this.getFirstEntry();
        if (c !== null) for (s.add(c); (c = i.successor(c)) !== null; ) s.add(c);
        return s;
      } }, { key: "rotateLeft", value: function(s) {
        if (s != null) {
          var c = s.right;
          s.right = c.left, c.left != null && (c.left.parent = s), c.parent = s.parent, s.parent == null ? this.root_ = c : s.parent.left === s ? s.parent.left = c : s.parent.right = c, c.left = s, s.parent = c;
        }
      } }, { key: "rotateRight", value: function(s) {
        if (s != null) {
          var c = s.left;
          s.left = c.right, c.right != null && (c.right.parent = s), c.parent = s.parent, s.parent == null ? this.root_ = c : s.parent.right === s ? s.parent.right = c : s.parent.left = c, c.right = s, s.parent = c;
        }
        ...
        if (s.right !== null) {
          for (c = s.right; c.left !== null; ) c = c.left;
          return c;
        }
        c = s.parent;
        for (var d = s; c !== null && d === c.right; ) d = c, c = c.parent;
        return c;
      } }]);
    }(vg), Ha = function() {
      return l(function h() {
        ...
        if (arguments[0] instanceof Ci) {
          var s = arguments[0], c = this.nodeMap.get(s.getCoordinate());
          return c === null ? (this.nodeMap.put(s.getCoordinate(), s), s) : (c.mergeLabel(s), c);
        }
        ...
        for (var i = new ve(), s = this.iterator(); s.hasNext(); ) {
          var c = s.next();
          c.getLabel().getLocation(h) === q.BOUNDARY && i.add(c);
        }
        return i;
      ...
      return l(h, null, [{ key: "isNorthern", value: function(i) {
        ...
        if (arguments[0] instanceof Z && arguments[1] instanceof Z) {
          var c = arguments[0], d = arguments[1];
          if (d.x === c.x && d.y === c.y) throw new O("Cannot compute the quadrant for two identical points " + c);
          return d.x >= c.x ? d.y >= c.y ? h.NE : h.SE : d.y >= c.y ? h.NW : h.SW;
        }
      } }]);
    }();
    ...
    var Wa = function() {
      ...
      return l(h, [{ key: "compareDirection", value: function(i) {
        ...
        var s = Math.atan2(this._dy, this._dx), c = this.getClass().getName(), d = c.lastIndexOf("."), y = c.substring(d + 1);
        ...
        var i = Math.atan2(this._dy, this._dx), s = this.getClass().getName(), c = s.lastIndexOf(".");
        return "  " + s.substring(c + 1) + ": " + this._p0 + " - " + this._p1 + " " + this._quadrant + ":" + i + "   " + this._label;
        ...
        if (this._edge = null, this._label = null, this._node = null, this._p0 = null, this._p1 = null, this._dx = null, this._dy = null, this._quadrant = null, arguments.length === 1) {
          ...
          var s = arguments[0], c = arguments[1], d = arguments[2];
          h.constructor_.call(this, s, c, d, null);
        } else if (arguments.length === 4) {
          var y = arguments[0], x = arguments[1], E = arguments[2], P = arguments[3];
      ...
      return m(i, h), l(i, [{ key: "getNextMin", value: function() {
        ...
        return this._next;
      } }, { key: "setDepth", value: function(s, c) {
        if (this._depth[s] !== -999 && this._depth[s] !== c) throw new rn("assigned depths do not match", this.getCoordinate());
        this._depth[s] = c;
      } }, { key: "isInteriorAreaEdge", value: function() {
        for (var s = !0, c = 0; c < 2; c++) this._label.isArea(c) && this._label.getLocation(c, ie.LEFT) === q.INTERIOR && this._label.getLocation(c, ie.RIGHT) === q.INTERIOR || (s = !1);
        return s;
        ...
        var s = this._label.isLine(0) || this._label.isLine(1), c = !this._label.isArea(0) || this._label.allPositionsEqual(0, q.EXTERIOR), d = !this._label.isArea(1) || this._label.allPositionsEqual(1, q.EXTERIOR);
        return s && c && d;
      ...
      } }, { key: "setEdgeDepths", value: function(s, c) {
        var d = this.getEdge().getDepthDelta();
        this._isForward || (d = -d);
        var y = 1;
        s === ie.LEFT && (y = -1);
        var x = ie.opposite(s), E = c + d * y;
        this.setDepth(s, c), this.setDepth(x, E);
        ...
        var s = arguments[0], c = arguments[1];
        if (Wa.constructor_.call(this, s), this._isForward = c, c) this.init(s.getCoordinate(0), s.getCoordinate(1));
        else {
          var d = s.getNumPoints() - 1;
          this.init(s.getCoordinate(d), s.getCoordinate(d - 1));
        }
        this.computeDirectedLabel();
      } }, { key: "depthFactor", value: function(s, c) {
        return s === q.EXTERIOR && c === q.INTERIOR ? 1 : s === q.INTERIOR && c === q.EXTERIOR ? -1 : 0;
      } }]);
    }(Wa), $a = function() {
      return l(function h() {
        o(this, h);
      }, [{ key: "createNode", value: function(h) {
        return new Ci(h, null);
      } }]);
    }(), Za = function() {
      return l(function h() {
        o(this, h), h.constructor_.apply(this, arguments);
        ...
        if (s === null) return !1;
        var c = s.getLabel();
        return c !== null && c.getLocation(h) === q.BOUNDARY;
      } }, { key: "linkAllDirectedEdges", value: function() {
        for (var h = this._nodes.iterator(); h.hasNext(); )
          h.next().getEdges().linkAllDirectedEdges();
      } }, { key: "matchInSameDirection", value: function(h, i, s, c) {
        return !!h.equals(s) && we.index(h, i, c) === we.COLLINEAR && dt.quadrant(h, i) === dt.quadrant(s, c);
        ...
        for (var s = 0; s < this._edges.size(); s++) {
          var c = this._edges.get(s), d = c.getCoordinates();
          if (this.matchInSameDirection(h, i, d[0], d[1]) || this.matchInSameDirection(h, i, d[d.length - 1], d[d.length - 2])) return c;
        }
        return null;
        ...
        for (var i = h.iterator(); i.hasNext(); ) {
          var s = i.next();
          this._edges.add(s);
          var c = new Xs(s, !0), d = new Xs(s, !1);
          c.setSym(d), d.setSym(c), this.add(c), this.add(d);
        }
      } }, { key: "add", value: function(h) {
        ...
        for (var s = 0; s < this._edges.size(); s++) {
          var c = this._edges.get(s), d = c.getCoordinates();
          if (h.equals(d[0]) && i.equals(d[1])) return c;
        }
        return null;
      } }], [{ key: "constructor_", value: function() {
        if (this._edges = new ve(), this._nodes = null, this._edgeEndList = new ve(), arguments.length === 0) this._nodes = new Ha(new $a());
        else if (arguments.length === 1) {
          var h = arguments[0];
          this._nodes = new Ha(h);
        }
      ...
      return l(h, [{ key: "sortShellsAndHoles", value: function(i, s, c) {
        for (var d = i.iterator(); d.hasNext(); ) {
          var y = d.next();
          y.isHole() ? c.add(y) : s.add(y);
        }
      } }, { key: "computePolygons", value: function(i) {
        for (var s = new ve(), c = i.iterator(); c.hasNext(); ) {
          var d = c.next().toPolygon(this._geometryFactory);
          s.add(d);
        }
        return s;
        ...
        for (var c = s.iterator(); c.hasNext(); ) {
          ...
          if (d.getShell() === null) {
            ...
            if (y === null) throw new rn("unable to assign hole to a shell", d.getCoordinate(0));
            d.setShell(y);
          }
        }
      } }, { key: "buildMinimalEdgeRings", value: function(i, s, c) {
        for (var d = new ve(), y = i.iterator(); y.hasNext(); ) {
          ...
          if (x.getMaxNodeDegree() > 2) {
            ...
            P !== null ? (this.placePolygonHoles(P, E), s.add(P)) : c.addAll(E);
          } else d.add(x);
        }
        return d;
        ...
        for (var s = new ve(), c = i.iterator(); c.hasNext(); ) {
          ...
          if (d.isInResult() && d.getLabel().isArea() && d.getEdgeRing() === null) {
            var y = new mg(d, this._geometryFactory);
        ...
        for (var s = 0, c = null, d = i.iterator(); d.hasNext(); ) {
          var y = d.next();
          y.isHole() || (c = y, s++);
        }
        return ee.isTrue(s <= 1, "found two shells in MinimalEdgeRing list"), c;
      } }, { key: "add", value: function() {
        if (arguments.length === 1) {
          var i = arguments[0];
        ...
        for (var c = i.getLinearRing(), d = c.getEnvelopeInternal(), y = c.getCoordinateN(0), x = null, E = null, P = s.iterator(); P.hasNext(); ) {
          var F = P.next(), $ = F.getLinearRing(), K = $.getEnvelopeInternal();
          if (!K.equals(d) && K.contains(d)) {
            y = tt.ptNotInList(c.getCoordinates(), $.getCoordinates());
            var ne = !1;
            Us.isInRing(y, $.getCoordinates()) && (ne = !0), ne && (x === null || E.contains(K)) && (E = (x = F).getLinearRing().getEnvelopeInternal());
          }
        }
        return x;
      } }]);
      ...
      return Xn.sort(h), h.get(0);
    }, sort: function(h, i) {
      var s = h.toArray();
      i ? Sn.sort(s, i) : Sn.sort(s);
      for (var c = h.iterator(), d = 0, y = s.length; d < y; d++) c.next(), c.set(s[d]);
      ...
      return l(h, null, [{ key: "maxDistance", value: function(i, s, c, d, y, x, E, P) {
        var F = h.distance(i, s, y, x);
        return F = Math.max(F, h.distance(i, s, E, P)), F = Math.max(F, h.distance(c, d, y, x)), F = Math.max(F, h.distance(c, d, E, P));
      } }, { key: "distance", value: function(i, s, c, d) {
        var y = c - i, x = d - s;
        return Math.sqrt(y * y + x * x);
      } }, { key: "maximumDistance", value: function(i, s) {
        var c = Math.min(i.getMinX(), s.getMinX()), d = Math.min(i.getMinY(), s.getMinY()), y = Math.max(i.getMaxX(), s.getMaxX()), x = Math.max(i.getMaxY(), s.getMaxY());
        return h.distance(c, d, y, x);
      } }, { key: "minMaxDistance", value: function(i, s) {
        var c = i.getMinX(), d = i.getMinY(), y = i.getMaxX(), x = i.getMaxY(), E = s.getMinX(), P = s.getMinY(), F = s.getMaxX(), $ = s.getMaxY(), K = h.maxDistance(c, d, c, x, E, P, E, $);
        return K = Math.min(K, h.maxDistance(c, d, c, x, E, P, F, P)), K = Math.min(K, h.maxDistance(c, d, c, x, F, $, E, $)), K = Math.min(K, h.maxDistance(c, d, c, x, F, $, F, P)), K = Math.min(K, h.maxDistance(c, d, y, d, E, P, E, $)), K = Math.min(K, h.maxDistance(c, d, y, d, E, P, F, P)), K = Math.min(K, h.maxDistance(c, d, y, d, F, $, E, $)), K = Math.min(K, h.maxDistance(c, d, y, d, F, $, F, P)), K = Math.min(K, h.maxDistance(y, x, c, x, E, P, E, $)), K = Math.min(K, h.maxDistance(y, x, c, x, E, P, F, P)), K = Math.min(K, h.maxDistance(y, x, c, x, F, $, E, $)), K = Math.min(K, h.maxDistance(y, x, c, x, F, $, F, P)), K = Math.min(K, h.maxDistance(y, x, y, d, E, P, E, $)), K = Math.min(K, h.maxDistance(y, x, y, d, E, P, F, P)), K = Math.min(K, h.maxDistance(y, x, y, d, F, $, E, $)), K = Math.min(K, h.maxDistance(y, x, y, d, F, $, F, P));
      } }]);
    }(), Vn = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "maximumDistance", value: function() {
        return _g.maximumDistance(this._boundable1.getBounds(), this._boundable2.getBounds());
      } }, { key: "expandToQueue", value: function(i, s) {
        var c = h.isComposite(this._boundable1), d = h.isComposite(this._boundable2);
        if (c && d) return h.area(this._boundable1) > h.area(this._boundable2) ? (this.expand(this._boundable1, this._boundable2, !1, i, s), null) : (this.expand(this._boundable2, this._boundable1, !0, i, s), null);
        if (c) return this.expand(this._boundable1, this._boundable2, !1, i, s), null;
      ...
      } }, { key: "expand", value: function(i, s, c, d, y) {
        for (var x = i.getChildBoundables().iterator(); x.hasNext(); ) {
          var E = x.next(), P = null;
          (P = c ? new h(s, E, this._itemDistance) : new h(E, s, this._itemDistance)).getDistance() < y && d.add(P);
        }
        ...
        var i = arguments[0], s = arguments[1], c = arguments[2];
        this._boundable1 = i, this._boundable2 = s, this._itemDistance = c, this._distance = this.distance();
      ...
      return l(h, [{ key: "queryInternal", value: function() {
        if (Ee(arguments[2], Ja) && arguments[0] instanceof Object && arguments[1] instanceof Nt) for (var i = arguments[0], s = arguments[2], c = arguments[1].getChildBoundables(), d = 0; d < c.size(); d++) {
          var y = c.get(d);
          this.getIntersectsOp().intersects(y.getBounds(), i) && (y instanceof Nt ? this.queryInternal(i, y, s) : y instanceof on ? s.visitItem(y.getItem()) : ee.shouldNeverReachHere());
        }
        else if (Ee(arguments[2], nn) && arguments[0] instanceof Object && arguments[1] instanceof Nt) for (var x = arguments[0], E = arguments[2], P = arguments[1].getChildBoundables(), F = 0; F < P.size(); F++) {
          var $ = P.get(F);
          this.getIntersectsOp().intersects($.getBounds(), x) && ($ instanceof Nt ? this.queryInternal(x, $, E) : $ instanceof on ? E.add($.getItem()) : ee.shouldNeverReachHere());
        }
        ...
        if (arguments.length === 1) {
          for (var i = 0, s = arguments[0].getChildBoundables().iterator(); s.hasNext(); ) {
            var c = s.next();
            c instanceof Nt ? i += this.size(c) : c instanceof on && (i += 1);
          }
          return i;
        }
      } }, { key: "removeItem", value: function(i, s) {
        for (var c = null, d = i.getChildBoundables().iterator(); d.hasNext(); ) {
          var y = d.next();
          y instanceof on && y.getItem() === s && (c = y);
        }
        return c !== null && (i.getChildBoundables().remove(c), !0);
        ...
        if (arguments.length === 1) {
          for (var s = arguments[0], c = new ve(), d = s.getChildBoundables().iterator(); d.hasNext(); ) {
            var y = d.next();
            if (y instanceof Nt) {
              var x = this.itemsTree(y);
              x !== null && c.add(x);
            } else y instanceof on ? c.add(y.getItem()) : ee.shouldNeverReachHere();
          }
          return c.size() <= 0 ? null : c;
        }
      } }, { key: "insert", value: function(i, s) {
        ee.isTrue(!this._built, "Cannot insert items into an STR packed R-tree after it has been built."), this._itemBoundables.add(new on(i, s));
        ...
        if (arguments.length === 3) {
          var c = arguments[0], d = arguments[1], y = arguments[2];
          if (ee.isTrue(c > -2), d.getLevel() === c) return y.add(d), null;
          for (var x = d.getChildBoundables().iterator(); x.hasNext(); ) {
            var E = x.next();
            E instanceof Nt ? this.boundablesAtLevel(c, E, y) : (ee.isTrue(E instanceof on), c === -1 && y.add(E));
          }
          return null;
        }
      } }, { key: "query", value: function() {
        ...
        if (arguments.length === 2) {
          ...
          this.getIntersectsOp().intersects(this._root.getBounds(), c) && this.queryInternal(c, this._root, d);
        }
        ...
        if (arguments.length === 3) {
          var c = arguments[0], d = arguments[1], y = arguments[2], x = this.removeItem(d, y);
          if (x) return !0;
          for (var E = null, P = d.getChildBoundables().iterator(); P.hasNext(); ) {
            var F = P.next();
            if (this.getIntersectsOp().intersects(F.getBounds(), c) && F instanceof Nt && (x = this.remove(c, F, y))) {
              E = F;
              break;
            }
          }
        ...
        ee.isTrue(!i.isEmpty());
        var c = this.createParentBoundables(i, s + 1);
        return c.size() === 1 ? c.get(0) : this.createHigherLevels(c, s + 1);
        ...
        ee.isTrue(!i.isEmpty());
        var c = new ve();
        c.add(this.createNode(s));
        var d = new ve(i);
        Xn.sort(d, this.getComparator());
        for (var y = d.iterator(); y.hasNext(); ) {
          var x = y.next();
          this.lastNode(c).getChildBoundables().size() === this.getNodeCapacity() && c.add(this.createNode(s)), this.lastNode(c).addChildBoundable(x);
        }
        return c;
      } }, { key: "isEmpty", value: function() {
    ...
    var wg = function() {
      ...
      return m(i, h), l(i, [{ key: "createParentBoundablesFromVerticalSlices", value: function(s, c) {
        ee.isTrue(s.length > 0);
        for (var d = new ve(), y = 0; y < s.length; y++) d.addAll(this.createParentBoundablesFromVerticalSlice(s[y], c));
        return d;
      } }, { key: "nearestNeighbourK", value: function() {
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1];
          return this.nearestNeighbourK(s, W.POSITIVE_INFINITY, c);
        }
        if (arguments.length === 3) {
          var d = arguments[0], y = arguments[2], x = arguments[1], E = new Si();
          E.add(d);
          for (var P = new Si(); !E.isEmpty() && x >= 0; ) {
        ...
        var s = arguments[0], c = arguments[1];
        if (s.isNull()) return null;
        w(i, "insert", this, 1).call(this, s, c);
      } }, { key: "getIntersectsOp", value: function() {
        return i.intersectsOp;
      } }, { key: "verticalSlices", value: function(s, c) {
        for (var d = Math.trunc(Math.ceil(s.size() / c)), y = new Array(c).fill(null), x = s.iterator(), E = 0; E < c; E++) {
          y[E] = new ve();
        ...
        if (arguments.length === 2) {
          var c = arguments[0], d = arguments[1];
          w(i, "query", this, 1).call(this, c, d);
        }
      } }, { key: "getComparator", value: function() {
        return i.yComparator;
      } }, { key: "createParentBoundablesFromVerticalSlice", value: function(s, c) {
        return w(i, "createParentBoundables", this, 1).call(this, s, c);
      } }, { key: "remove", value: function() {
        if (arguments.length === 2 && arguments[1] instanceof Object && arguments[0] instanceof _e) {
          var s = arguments[0], c = arguments[1];
          return w(i, "remove", this, 1).call(this, s, c);
        }
      ...
      } }, { key: "createParentBoundables", value: function(s, c) {
        ee.isTrue(!s.isEmpty());
        var d = Math.trunc(Math.ceil(s.size() / this.getNodeCapacity())), y = new ve(s);
        Xn.sort(y, i.xComparator);
        var x = this.verticalSlices(y, Math.trunc(Math.ceil(Math.sqrt(d))));
        return this.createParentBoundablesFromVerticalSlices(x, c);
      } }, { key: "nearestNeighbour", value: function() {
        if (arguments.length === 1) {
          if (Ee(arguments[0], wg)) {
            var s = arguments[0];
            if (this.isEmpty()) return null;
            var c = new Vn(this.getRoot(), this.getRoot(), s);
            return this.nearestNeighbour(c);
          }
          if (arguments[0] instanceof Vn) {
            var d = arguments[0], y = W.POSITIVE_INFINITY, x = null, E = new Si();
          ...
          if (arguments.length === 2) {
            ...
            var ne = new Vn(this.getRoot(), $.getRoot(), K);
            return this.nearestNeighbour(ne);
          }
          if (arguments.length === 3) {
            var ue = arguments[2], he = new on(arguments[0], arguments[1]), ge = new Vn(this.getRoot(), he, ue);
            return this.nearestNeighbour(ge)[0];
          }
          if (arguments.length === 4) {
            var Re = arguments[2], Pe = arguments[3], Ue = new on(arguments[0], arguments[1]), st = new Vn(this.getRoot(), Ue, Re);
            return this.nearestNeighbourK(st, Pe);
          }
        }
      } }, { key: "isWithinDistance", value: function() {
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1], d = W.POSITIVE_INFINITY, y = new Si();
          for (y.add(s); !y.isEmpty(); ) {
            var x = y.poll(), E = x.getDistance();
            if (E > c) return !1;
            if (x.maximumDistance() <= c) return !0;
            if (x.isLeaves()) {
              if ((d = E) <= c) return !0;
        ...
        if (arguments.length === 3) {
          var P = arguments[0], F = arguments[1], $ = arguments[2], K = new Vn(this.getRoot(), P.getRoot(), F);
        ...
        if (arguments.length === 0) i.constructor_.call(this, i.DEFAULT_NODE_CAPACITY);
          ...
          var s = arguments[0];
          Hn.constructor_.call(this, s);
        }
      } }, { key: "centreX", value: function(s) {
        return i.avg(s.getMinX(), s.getMaxX());
      } }, { key: "avg", value: function(s, c) {
        return (s + c) / 2;
      } }, { key: "getItems", value: function(s) {
        for (var c = new Array(s.size()).fill(null), d = 0; !s.isEmpty(); ) {
          var y = s.poll();
          c[d] = y.getBoundable(0).getItem(), d++;
        }
        return c;
      ...
      return m(i, h), l(i, [{ key: "computeBounds", value: function() {
        for (var s = null, c = this.getChildBoundables().iterator(); c.hasNext(); ) {
          var d = c.next();
        ...
        var s = arguments[0];
        Nt.constructor_.call(this, s);
      } }]);
    }(Nt);
    Ht.STRtreeNode = Qa, Ht.xComparator = new (function() {
      return l(function h() {
        o(this, h);
      }, [{ key: "interfaces_", get: function() {
        return [j];
      } }, { key: "compare", value: function(h, i) {
        return Hn.compareDoubles(Ht.centreX(h.getBounds()), Ht.centreX(i.getBounds()));
      } }]);
    }())(), Ht.yComparator = new (function() {
      return l(function h() {
        o(this, h);
      }, [{ key: "interfaces_", get: function() {
        return [j];
      } }, { key: "compare", value: function(h, i) {
        return Hn.compareDoubles(Ht.centreY(h.getBounds()), Ht.centreY(i.getBounds()));
      } }]);
    }())(), Ht.intersectsOp = new (function() {
      return l(function h() {
        o(this, h);
      }, [{ key: "interfaces_", get: function() {
        return [IntersectsOp];
    ...
    }())(), Ht.DEFAULT_NODE_CAPACITY = 10;
    var xg = function() {
      function h() {
        o(this, h);
      }
      return l(h, null, [{ key: "relativeSign", value: function(i, s) {
        return i < s ? -1 : i > s ? 1 : 0;
      } }, { key: "compare", value: function(i, s, c) {
        if (s.equals2D(c)) return 0;
        var d = h.relativeSign(s.x, c.x), y = h.relativeSign(s.y, c.y);
        switch (i) {
          case 0:
      ...
      return l(function h() {
        ...
        var i = h;
        return this.segmentIndex < i.segmentIndex ? -1 : this.segmentIndex > i.segmentIndex ? 1 : this.coord.equals2D(i.coord) ? 0 : this._isInterior ? i._isInterior ? xg.compare(this._segmentOctant, this.coord, i.coord) : 1 : -1;
        ...
        var h = arguments[0], i = arguments[1], s = arguments[2], c = arguments[3];
        this._segString = h, this.coord = new Z(i), this.segmentIndex = s, this._segmentOctant = c, this._isInterior = !i.equals2D(h.getCoordinate(s));
      } }]);
    }(), Cg = function() {
      return l(function h() {
        o(this, h);
      ...
      return l(function h() {
        ...
        for (var i = this.iterator(), s = i.next(); i.hasNext(); ) {
          var c = i.next();
          this.addEdgeCoordinates(s, c, h), s = c;
        }
        ...
        var c = this._edge.getCoordinate(i.segmentIndex), d = i.isInterior() || !i.coord.equals2D(c);
        d || s--;
        ...
        for (var i = 0; i < this._edge.size() - 2; i++) {
          ...
          var c = this._edge.getCoordinate(i + 2);
          s.equals2D(c) && h.add(vn.valueOf(i + 1));
        }
      } }, { key: "addEdgeCoordinates", value: function(h, i, s) {
        var c = this.createSplitEdgePts(h, i);
        s.add(c, !1);
      } }, { key: "iterator", value: function() {
        ...
        for (var i = this.iterator(), s = i.next(); i.hasNext(); ) {
          var c = i.next(), d = this.createSplitEdge(s, c);
          h.add(d), s = c;
        }
      } }, { key: "findCollapseIndex", value: function(h, i, s) {
        if (!h.coord.equals2D(i.coord)) return !1;
        var c = i.segmentIndex - h.segmentIndex;
        return i.isInterior() || c--, c === 1 && (s[0] = h.segmentIndex + 1, !0);
      } }, { key: "findCollapsesFromInsertedNodes", value: function(h) {
        for (var i = new Array(1).fill(null), s = this.iterator(), c = s.next(); s.hasNext(); ) {
          var d = s.next();
          this.findCollapseIndex(c, d, i) && h.add(vn.valueOf(i[0])), c = d;
        }
      } }, { key: "getEdge", value: function() {
        return this._edge;
        ...
        return new Mn(s, this._edge.getData());
      } }, { key: "add", value: function(h, i) {
        var s = new Eg(this._edge, h, i, this._edge.getSegmentOctant(i)), c = this._nodeMap.get(s);
        return c !== null ? (ee.isTrue(c.coord.equals2D(h), "Found equal nodes with different coordinates"), c) : (this._nodeMap.put(s, s), s);
        ...
        var c = h.get(h.size() - 1).getCoordinates(), d = c[c.length - 1];
      ...
      return l(h, null, [{ key: "octant", value: function() {
        if (typeof arguments[0] == "number" && typeof arguments[1] == "number") {
          var i = arguments[0], s = arguments[1];
          if (i === 0 && s === 0) throw new O("Cannot compute the octant for point ( " + i + ", " + s + " )");
          var c = Math.abs(i), d = Math.abs(s);
          return i >= 0 ? s >= 0 ? c >= d ? 0 : 1 : c >= d ? 7 : 6 : s >= 0 ? c >= d ? 3 : 2 : c >= d ? 4 : 5;
        }
        if (arguments[0] instanceof Z && arguments[1] instanceof Z) {
      ...
      return l(h, [{ key: "getCoordinates", value: function() {
        return this._pts;
      } }, { key: "size", value: function() {
        ...
        return i.equals2D(s) ? 0 : Ig.octant(i, s);
      } }, { key: "getData", value: function() {
        return this._data;
        ...
        if (arguments.length === 2) {
          ...
          var c = arguments[1], d = arguments[3], y = new Z(arguments[0].getIntersection(d));
          this.addIntersection(y, c);
        }
      } }, { key: "toString", value: function() {
        return qs.toLineString(new Cr(this._pts));
        ...
        return this._nodeList.add(i, c);
      } }, { key: "addIntersections", value: function(i, s, c) {
        for (var d = 0; d < i.getIntersectionNum(); d++) this.addIntersection(i, s, c, d);
      } }, { key: "interfaces_", get: function() {
        return [bg];
      } }], [{ key: "constructor_", value: function() {
        this._nodeList = new Sg(this), this._pts = null, this._data = null;
        var i = arguments[0], s = arguments[1];
        ...
        if (arguments.length === 2) for (var c = arguments[1], d = arguments[0].iterator(); d.hasNext(); )
          d.next().getNodeList().addSplitEdges(c);
      } }]);
    }(), Ct = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "minX", value: function() {
        return Math.min(this.p0.x, this.p1.x);
      } }, { key: "orientationIndex", value: function() {
        if (arguments[0] instanceof h) {
          var i = arguments[0], s = we.index(this.p0, this.p1, i.p0), c = we.index(this.p0, this.p1, i.p1);
          return s >= 0 && c >= 0 || s <= 0 && c <= 0 ? Math.max(s, c) : 0;
        }
        if (arguments[0] instanceof Z) {
          var d = arguments[0];
        ...
        if (arguments[0] instanceof Z) {
          ...
          var s = this.projectionFactor(i), c = new Z();
          return c.x = this.p0.x + s * (this.p1.x - this.p0.x), c.y = this.p0.y + s * (this.p1.y - this.p0.y), c;
        }
        if (arguments[0] instanceof h) {
        ...
        return Xt.pointToLinePerpendicular(i, this.p0, this.p1);
        ...
        var s = this.p1.x - this.p0.x, c = this.p1.y - this.p0.y, d = s * s + c * c;
        return d <= 0 ? W.NaN : ((i.x - this.p0.x) * s + (i.y - this.p0.y) * c) / d;
      } }, { key: "closestPoints", value: function(i) {
        var s = this.intersection(i);
        if (s !== null) return [s, s];
        var c = new Array(2).fill(null), d = W.MAX_VALUE, y = null, x = this.closestPoint(i.p0);
        d = x.distance(i.p0), c[0] = x, c[1] = i.p0;
        var E = this.closestPoint(i.p1);
        (y = E.distance(i.p1)) < d && (d = y, c[0] = E, c[1] = i.p1);
        var P = i.closestPoint(this.p0);
        (y = P.distance(this.p0)) < d && (d = y, c[0] = this.p0, c[1] = P);
        var F = i.closestPoint(this.p1);
        return (y = F.distance(this.p1)) < d && (d = y, c[0] = this.p1, c[1] = F), c;
        ...
        var s = i, c = this.p0.compareTo(s.p0);
        return c !== 0 ? c : this.p1.compareTo(s.p1);
      } }, { key: "reverse", value: function() {
        var i = this.p0;
        ...
        return Rs.intersection(this.p0, this.p1, i.p0, i.p1);
      } }, { key: "maxY", value: function() {
        return Math.max(this.p0.y, this.p1.y);
      } }, { key: "pointAlongOffset", value: function(i, s) {
        var c = this.p0.x + i * (this.p1.x - this.p0.x), d = this.p0.y + i * (this.p1.y - this.p0.y), y = this.p1.x - this.p0.x, x = this.p1.y - this.p0.y, E = Math.sqrt(y * y + x * x), P = 0, F = 0;
        if (s !== 0) {
          if (E <= 0) throw new IllegalStateException("Cannot compute offset from zero-length line segment");
          P = s * y / E, F = s * x / E;
        }
        return new Z(c - F, d + P);
        ...
        if (arguments.length === 1) {
          ...
          var s = arguments[0], c = arguments[1];
          this.p0.x = s.x, this.p0.y = s.y, this.p1.x = c.x, this.p1.y = c.y;
        }
        ...
        var s = this.p1.getY() - this.p0.getY(), c = this.p0.getX() - this.p1.getX(), d = this.p0.getY() * (this.p1.getX() - this.p0.getX()) - this.p0.getX() * (this.p1.getY() - this.p0.getY()), y = s * s + c * c, x = s * s - c * c, E = i.getX(), P = i.getY();
        return new Z((-x * E - 2 * s * c * P - 2 * s * d) / y, (x * P - 2 * s * c * E - 2 * c * d) / y);
      } }, { key: "distance", value: function() {
        if (arguments[0] instanceof h) {
          var i = arguments[0];
          return Xt.segmentToSegment(this.p0, this.p1, i.p0, i.p1);
        }
        if (arguments[0] instanceof Z) {
          var s = arguments[0];
          return Xt.pointToSegment(s, this.p0, this.p1);
        }
        ...
        var s = Math.trunc(i) ^ Math.trunc(i >> 32), c = W.doubleToLongBits(this.p1.x);
        return c ^= 31 * W.doubleToLongBits(this.p1.y), s ^ (Math.trunc(c) ^ Math.trunc(c >> 32));
      } }, { key: "interfaces_", get: function() {
        return [V, M];
      } }], [{ key: "constructor_", value: function() {
      ...
      return l(function h() {
      ...
      } }, { key: "computeSelect", value: function(h, i, s, c) {
        var d = this._pts[i], y = this._pts[s];
        if (s - i == 1) return c.select(this, i), null;
        if (!h.intersects(d, y)) return null;
        var x = Math.trunc((i + s) / 2);
        i < x && this.computeSelect(h, i, x, c), x < s && this.computeSelect(h, x, s, c);
      } }, { key: "getCoordinates", value: function() {
        ...
        if (arguments.length === 2) {
          ...
          var s = arguments[0], c = arguments[1], d = arguments[2], y = arguments[3], x = arguments[4], E = arguments[5];
          if (c - s == 1 && x - y == 1) return E.overlap(this, s, d, y), null;
          if (!this.overlaps(s, c, d, y, x)) return null;
          var P = Math.trunc((s + c) / 2), F = Math.trunc((y + x) / 2);
          s < P && (y < F && this.computeOverlaps(s, P, d, y, F, E), F < x && this.computeOverlaps(s, P, d, F, x, E)), P < c && (y < F && this.computeOverlaps(P, c, d, y, F, E), F < x && this.computeOverlaps(P, c, d, F, x, E));
        }
        ...
        return this._env;
      } }, { key: "overlaps", value: function(h, i, s, c, d) {
        return _e.intersects(this._pts[h], this._pts[i], s._pts[c], s._pts[d]);
        ...
        var h = arguments[0], i = arguments[1], s = arguments[2], c = arguments[3];
        this._pts = h, this._start = i, this._end = s, this._context = c;
      } }]);
    }(), Lg = function() {
      function h() {
        o(this, h);
      }
      return l(h, null, [{ key: "findChainEnd", value: function(i, s) {
        for (var c = s; c < i.length - 1 && i[c].equals2D(i[c + 1]); ) c++;
        if (c >= i.length - 1) return i.length - 1;
        for (var d = dt.quadrant(i[c], i[c + 1]), y = s + 1; y < i.length && !(!i[y - 1].equals2D(i[y]) && dt.quadrant(i[y - 1], i[y]) !== d); )
          y++;
        return y - 1;
        ...
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1], d = new ve(), y = 0;
          do {
            var x = h.findChainEnd(s, y), E = new ja(s, y, x, c);
            d.add(E), y = x;
          } while (y < s.length - 1);
          return d;
        }
      ...
      return m(i, h), l(i, [{ key: "getMonotoneChains", value: function() {
        ...
        for (var c = Lg.getChains(s.getCoordinates(), s).iterator(); c.hasNext(); ) {
          var d = c.next();
        ...
        for (var c = s.iterator(); c.hasNext(); ) this.add(c.next());
        this.intersectChains();
      } }, { key: "intersectChains", value: function() {
        for (var s = new tu(this._segInt), c = this._monoChains.iterator(); c.hasNext(); ) for (var d = c.next(), y = this._index.query(d.getEnvelope()).iterator(); y.hasNext(); ) {
          var x = y.next();
          if (x.getId() > d.getId() && (d.computeOverlaps(x, s), this._nOverlaps++), this._segInt.isDone()) return null;
        }
      } }], [{ key: "constructor_", value: function() {
        if (this._monoChains = new ve(), this._index = new Ht(), this._idCounter = 0, this._nodedSegStrings = null, this._nOverlaps = 0, arguments.length !== 0) {
          if (arguments.length === 1) {
            var s = arguments[0];
            eu.constructor_.call(this, s);
          }
        }
      } }]);
    }(eu), tu = function(h) {
      ...
      return m(i, h), l(i, [{ key: "overlap", value: function() {
        if (arguments.length !== 4) return w(i, "overlap", this, 1).apply(this, arguments);
        var s = arguments[1], c = arguments[2], d = arguments[3], y = arguments[0].getContext(), x = c.getContext();
    ...
    Hs.SegmentOverlapAction = tu;
    var Gt = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "isDeletable", value: function(i, s, c, d) {
        var y = this._inputLine[i], x = this._inputLine[s], E = this._inputLine[c];
        return !!this.isConcave(y, x, E) && !!this.isShallow(y, x, E, d) && this.isShallowSampled(y, x, i, c, d);
      } }, { key: "deleteShallowConcavities", value: function() {
        for (var i = 1, s = this.findNextNonDeletedIndex(i), c = this.findNextNonDeletedIndex(s), d = !1; c < this._inputLine.length; ) {
          var y = !1;
          this.isDeletable(i, s, c, this._distanceTol) && (this._isDeleted[s] = h.DELETE, y = !0, d = !0), i = y ? c : s, s = this.findNextNonDeletedIndex(i), c = this.findNextNonDeletedIndex(s);
        }
        return d;
      } }, { key: "isShallowConcavity", value: function(i, s, c, d) {
        return we.index(i, s, c) === this._angleOrientation && Xt.pointToSegment(s, i, c) < d;
      } }, { key: "isShallowSampled", value: function(i, s, c, d, y) {
        var x = Math.trunc((d - c) / h.NUM_PTS_TO_CHECK);
        x <= 0 && (x = 1);
        for (var E = c; E < d; E += x) if (!this.isShallow(i, s, this._inputLine[E], y)) return !1;
        return !0;
      } }, { key: "isConcave", value: function(i, s, c) {
        var d = we.index(i, s, c) === this._angleOrientation;
        return d;
        ...
        return s;
      } }, { key: "isShallow", value: function(i, s, c, d) {
        return Xt.pointToSegment(s, i, c) < d;
      } }, { key: "collapseLine", value: function() {
        for (var i = new Er(), s = 0; s < this._inputLine.length; s++) this._isDeleted[s] !== h.DELETE && i.add(this._inputLine[s]);
    ...
    var nu = function() {
      ...
      return l(h, [{ key: "getCoordinates", value: function() {
        ...
        if (s) for (var c = 0; c < i.length; c++) this.addPt(i[c]);
        ...
        return new Un().createLineString(this.getCoordinates()).toString();
      } }, { key: "closeRing", value: function() {
    ...
    nu.COORDINATE_ARRAY_TYPE = new Array(0).fill(null);
    var St = function() {
      function h() {
        o(this, h);
      }
      return l(h, null, [{ key: "toDegrees", value: function(i) {
        ...
        if (arguments.length === 2) {
          var s = arguments[0], c = arguments[1], d = c.x - s.x, y = c.y - s.y;
          return Math.atan2(y, d);
        }
      } }, { key: "isAcute", value: function(i, s, c) {
        var d = i.x - s.x, y = i.y - s.y;
        return d * (c.x - s.x) + y * (c.y - s.y) > 0;
      } }, { key: "isObtuse", value: function(i, s, c) {
        var d = i.x - s.x, y = i.y - s.y;
        return d * (c.x - s.x) + y * (c.y - s.y) < 0;
      } }, { key: "interiorAngle", value: function(i, s, c) {
        var d = h.angle(s, i), y = h.angle(s, c);
        return Math.abs(y - d);
        ...
        return i;
      } }, { key: "angleBetween", value: function(i, s, c) {
        var d = h.angle(s, i), y = h.angle(s, c);
        return h.diff(d, y);
      } }, { key: "diff", value: function(i, s) {
        var c = null;
        return (c = i < s ? s - i : i - s) > Math.PI && (c = 2 * Math.PI - c), c;
      } }, { key: "toRadians", value: function(i) {
        return i * Math.PI / 180;
      } }, { key: "getTurn", value: function(i, s) {
        var c = Math.sin(s - i);
        return c > 0 ? h.COUNTERCLOCKWISE : c < 0 ? h.CLOCKWISE : h.NONE;
      } }, { key: "angleBetweenOriented", value: function(i, s, c) {
        var d = h.angle(s, i), y = h.angle(s, c) - d;
        return y <= -Math.PI ? y + h.PI_TIMES_2 : y > Math.PI ? y - h.PI_TIMES_2 : y;
      } }]);
    }();
    St.PI_TIMES_2 = 2 * Math.PI, St.PI_OVER_2 = Math.PI / 2, St.PI_OVER_4 = Math.PI / 4, St.COUNTERCLOCKWISE = we.COUNTERCLOCKWISE, St.CLOCKWISE = we.CLOCKWISE, St.NONE = we.COLLINEAR;
    var kr = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "addNextSegment", value: function(i, s) {
        ...
        var c = we.index(this._s0, this._s1, this._s2), d = c === we.CLOCKWISE && this._side === ie.LEFT || c === we.COUNTERCLOCKWISE && this._side === ie.RIGHT;
        c === 0 ? this.addCollinear(s) : d ? this.addOutsideTurn(c, s) : this.addInsideTurn(c, s);
      } }, { key: "addLineEndCap", value: function(i, s) {
        var c = new Ct(i, s), d = new Ct();
        this.computeOffsetSegment(c, ie.LEFT, this._distance, d);
        var y = new Ct();
        this.computeOffsetSegment(c, ie.RIGHT, this._distance, y);
      ...
      } }, { key: "addMitreJoin", value: function(i, s, c, d) {
        var y = Rs.intersection(s.p0, s.p1, c.p0, c.p1);
        if (y !== null && (d <= 0 ? 1 : y.distance(i) / Math.abs(d)) <= this._bufParams.getMitreLimit()) return this._segList.addPt(y), null;
        this.addLimitedMitreJoin(s, c, d, this._bufParams.getMitreLimit());
      ...
      } }, { key: "addCornerFillet", value: function(i, s, c, d, y) {
        var x = s.x - i.x, E = s.y - i.y, P = Math.atan2(E, x), F = c.x - i.x, $ = c.y - i.y, K = Math.atan2($, F);
        d === we.CLOCKWISE ? P <= K && (P += 2 * Math.PI) : P >= K && (P -= 2 * Math.PI), this._segList.addPt(s), this.addDirectedFillet(i, P, K, d, y), this._segList.addPt(c);
      } }, { key: "addLastSegment", value: function() {
        this._segList.addPt(this._offset1.p1);
      } }, { key: "initSideSegments", value: function(i, s, c) {
        this._s1 = i, this._s2 = s, this._side = c, this._seg1.setCoordinates(i, s), this.computeOffsetSegment(this._seg1, c, this._distance, this._offset1);
      } }, { key: "addLimitedMitreJoin", value: function(i, s, c, d) {
        var y = this._seg0.p1, x = St.angle(y, this._seg0.p0), E = St.angleBetweenOriented(this._seg0.p0, y, this._seg1.p1) / 2, P = St.normalize(x + E), F = St.normalize(P + Math.PI), $ = d * c, K = c - $ * Math.abs(Math.sin(E)), ne = y.x + $ * Math.cos(F), ue = y.y + $ * Math.sin(F), he = new Z(ne, ue), ge = new Ct(y, he), Re = ge.pointAlongOffset(1, K), Pe = ge.pointAlongOffset(1, -K);
        this._side === ie.LEFT ? (this._segList.addPt(Re), this._segList.addPt(Pe)) : (this._segList.addPt(Pe), this._segList.addPt(Re));
      } }, { key: "addDirectedFillet", value: function(i, s, c, d, y) {
        var x = d === we.CLOCKWISE ? -1 : 1, E = Math.abs(s - c), P = Math.trunc(E / this._filletAngleQuantum + 0.5);
        if (P < 1) return null;
        for (var F = E / P, $ = new Z(), K = 0; K < P; K++) {
          var ne = s + x * K * F;
          $.x = i.x + y * Math.cos(ne), $.y = i.y + y * Math.sin(ne), this._segList.addPt($);
        }
      } }, { key: "computeOffsetSegment", value: function(i, s, c, d) {
        var y = s === ie.LEFT ? 1 : -1, x = i.p1.x - i.p0.x, E = i.p1.y - i.p0.y, P = Math.sqrt(x * x + E * E), F = y * c * x / P, $ = y * c * E / P;
        ...
        if (this._li.computeIntersection(this._offset0.p0, this._offset0.p1, this._offset1.p0, this._offset1.p1), this._li.hasIntersection()) this._segList.addPt(this._li.getIntersection(0));
          ...
          if (this._segList.addPt(this._offset0.p1), this._closingSegLengthFactor > 0) {
            var c = new Z((this._closingSegLengthFactor * this._offset0.p1.x + this._s1.x) / (this._closingSegLengthFactor + 1), (this._closingSegLengthFactor * this._offset0.p1.y + this._s1.y) / (this._closingSegLengthFactor + 1));
        ...
        this._distance = i, this._maxCurveSegmentError = i * (1 - Math.cos(this._filletAngleQuantum / 2)), this._segList = new nu(), this._segList.setPrecisionModel(this._precisionModel), this._segList.setMinimumVertexDistance(i * h.CURVE_VERTEX_SNAP_DISTANCE_FACTOR);
        ...
        var i = arguments[0], s = arguments[1], c = arguments[2];
        this._precisionModel = i, this._bufParams = s, this._li = new bn(), this._filletAngleQuantum = Math.PI / 2 / s.getQuadrantSegments(), s.getQuadrantSegments() >= 8 && s.getJoinStyle() === N.JOIN_ROUND && (this._closingSegLengthFactor = h.MAX_CLOSING_SEG_LEN_FACTOR), this.init(c);
      } }]);
    }();
    kr.OFFSET_SEGMENT_SEPARATION_FACTOR = 1e-3, kr.INSIDE_TURN_VERTEX_SNAP_DISTANCE_FACTOR = 1e-3, kr.CURVE_VERTEX_SNAP_DISTANCE_FACTOR = 1e-6, kr.MAX_CLOSING_SEG_LEN_FACTOR = 80;
    var Pg = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "getOffsetCurve", value: function(i, s) {
        if (this._distance = s, s === 0) return null;
        var c = s < 0, d = Math.abs(s), y = this.getSegGen(d);
        i.length <= 1 ? this.computePointCurve(i[0], y) : this.computeOffsetCurve(i, c, y);
        var x = y.getCoordinates();
        return c && tt.reverse(x), x;
      } }, { key: "computeSingleSidedBufferCurve", value: function(i, s, c) {
        var d = this.simplifyTolerance(this._distance);
        if (s) {
          c.addSegments(i, !0);
          var y = Gt.simplify(i, -d), x = y.length - 1;
          c.initSideSegments(y[x], y[x - 1], ie.LEFT), c.addFirstSegment();
          for (var E = x - 2; E >= 0; E--) c.addNextSegment(y[E], !0);
        } else {
          c.addSegments(i, !1);
          var P = Gt.simplify(i, d), F = P.length - 1;
          c.initSideSegments(P[0], P[1], ie.LEFT), c.addFirstSegment();
          for (var $ = 2; $ <= F; $++) c.addNextSegment(P[$], !0);
        }
        c.addLastSegment(), c.closeRing();
      } }, { key: "computeRingBufferCurve", value: function(i, s, c) {
        var d = this.simplifyTolerance(this._distance);
        s === ie.RIGHT && (d = -d);
        var y = Gt.simplify(i, d), x = y.length - 1;
        c.initSideSegments(y[x - 1], y[0], s);
        for (var E = 1; E <= x; E++) {
          var P = E !== 1;
          c.addNextSegment(y[E], P);
        }
        c.closeRing();
      } }, { key: "computeLineBufferCurve", value: function(i, s) {
        var c = this.simplifyTolerance(this._distance), d = Gt.simplify(i, c), y = d.length - 1;
        s.initSideSegments(d[0], d[1], ie.LEFT);
        for (var x = 2; x <= y; x++) s.addNextSegment(d[x], !0);
        s.addLastSegment(), s.addLineEndCap(d[y - 1], d[y]);
        var E = Gt.simplify(i, -c), P = E.length - 1;
        ...
        var c = Math.abs(s), d = this.getSegGen(c);
      ...
      } }, { key: "getRingCurve", value: function(i, s, c) {
        if (this._distance = c, i.length <= 2) return this.getLineCurve(i, c);
        if (c === 0) return h.copyCoordinates(i);
        var d = this.getSegGen(c);
        return this.computeRingBufferCurve(i, s, d), d.getCoordinates();
      } }, { key: "computeOffsetCurve", value: function(i, s, c) {
        var d = this.simplifyTolerance(this._distance);
        if (s) {
          var y = Gt.simplify(i, -d), x = y.length - 1;
          c.initSideSegments(y[x], y[x - 1], ie.LEFT), c.addFirstSegment();
        ...
        return new kr(this._precisionModel, this._bufParams, i);
      } }], [{ key: "constructor_", value: function() {
        this._distance = 0, this._precisionModel = null, this._bufParams = null;
        var i = arguments[0], s = arguments[1];
        this._precisionModel = i, this._bufParams = s;
      } }, { key: "copyCoordinates", value: function(i) {
        for (var s = new Array(i.length).fill(null), c = 0; c < s.length; c++) s[c] = new Z(i[c]);
        return s;
      } }]);
    }(), ru = function() {
      return l(function h() {
        ...
        if (arguments.length === 1) {
          for (var h = arguments[0], i = new ve(), s = this._subgraphs.iterator(); s.hasNext(); ) {
            var c = s.next(), d = c.getEnvelope();
            h.y < d.getMinY() || h.y > d.getMaxY() || this.findStabbedSegments(h, c.getDirectedEdges(), i);
          }
          return i;
        }
        if (arguments.length === 3) {
          if (Ee(arguments[2], nn) && arguments[0] instanceof Z && arguments[1] instanceof Xs) {
            for (var y = arguments[0], x = arguments[1], E = arguments[2], P = x.getEdge().getCoordinates(), F = 0; F < P.length - 1; F++)
              if (this._seg.p0 = P[F], this._seg.p1 = P[F + 1], this._seg.p0.y > this._seg.p1.y && this._seg.reverse(), !(Math.max(this._seg.p0.x, this._seg.p1.x) < y.x || this._seg.isHorizontal() || y.y < this._seg.p0.y || y.y > this._seg.p1.y || we.index(this._seg.p0, this._seg.p1, y) === we.RIGHT)) {
                ...
                var K = new iu(this._seg, $);
                E.add(K);
              }
          } else if (Ee(arguments[2], nn) && arguments[0] instanceof Z && Ee(arguments[1], nn)) for (var ne = arguments[0], ue = arguments[2], he = arguments[1].iterator(); he.hasNext(); ) {
            var ge = he.next();
        ...
        return i.size() === 0 ? 0 : Xn.min(i)._leftDepth;
      } }], [{ key: "constructor_", value: function() {
    ...
    var su = function(h) {
      ...
      return l(h, [{ key: "getY", value: function() {
        var i = this.y / this.w;
        if (W.isNaN(i) || W.isInfinite(i)) throw new su();
        return i;
      } }, { key: "getX", value: function() {
        var i = this.x / this.w;
        if (W.isNaN(i) || W.isInfinite(i)) throw new su();
      ...
      return l(h, [{ key: "area", value: function() {
        ...
        var i = arguments[0], s = arguments[1], c = arguments[2];
        this.p0 = i, this.p1 = s, this.p2 = c;
      } }, { key: "area", value: function(i, s, c) {
        return Math.abs(((c.x - i.x) * (s.y - i.y) - (s.x - i.x) * (c.y - i.y)) / 2);
      } }, { key: "signedArea", value: function(i, s, c) {
        return ((c.x - i.x) * (s.y - i.y) - (s.x - i.x) * (c.y - i.y)) / 2;
      } }, { key: "det", value: function(i, s, c, d) {
        return i * d - s * c;
      } }, { key: "interpolateZ", value: function(i, s, c, d) {
        var y = s.x, x = s.y, E = c.x - y, P = d.x - y, F = c.y - x, $ = d.y - x, K = E * $ - P * F, ne = i.x - y, ue = i.y - x, he = ($ * ne - P * ue) / K, ge = (-F * ne + E * ue) / K;
        return s.getZ() + he * (c.getZ() - s.getZ()) + ge * (d.getZ() - s.getZ());
      } }, { key: "longestSideLength", value: function(i, s, c) {
        var d = i.distance(s), y = s.distance(c), x = c.distance(i), E = d;
        return y > E && (E = y), x > E && (E = x), E;
      } }, { key: "circumcentreDD", value: function(i, s, c) {
        var d = pe.valueOf(i.x).subtract(c.x), y = pe.valueOf(i.y).subtract(c.y), x = pe.valueOf(s.x).subtract(c.x), E = pe.valueOf(s.y).subtract(c.y), P = pe.determinant(d, y, x, E).multiply(2), F = d.sqr().add(y.sqr()), $ = x.sqr().add(E.sqr()), K = pe.determinant(y, F, E, $), ne = pe.determinant(d, F, x, $), ue = pe.valueOf(c.x).subtract(K.divide(P)).doubleValue(), he = pe.valueOf(c.y).add(ne.divide(P)).doubleValue();
        return new Z(ue, he);
      } }, { key: "isAcute", value: function(i, s, c) {
        return !!St.isAcute(i, s, c) && !!St.isAcute(s, c, i) && !!St.isAcute(c, i, s);
      } }, { key: "circumcentre", value: function(i, s, c) {
        var d = c.x, y = c.y, x = i.x - d, E = i.y - y, P = s.x - d, F = s.y - y, $ = 2 * h.det(x, E, P, F), K = h.det(E, x * x + E * E, F, P * P + F * F), ne = h.det(x, x * x + E * E, P, P * P + F * F);
        return new Z(d - K / $, y + ne / $);
      } }, { key: "perpendicularBisector", value: function(i, s) {
        var c = s.x - i.x, d = s.y - i.y, y = new Ws(i.x + c / 2, i.y + d / 2, 1), x = new Ws(i.x - d + c / 2, i.y + c + d / 2, 1);
        return new Ws(y, x);
      } }, { key: "angleBisector", value: function(i, s, c) {
        var d = s.distance(i), y = d / (d + s.distance(c)), x = c.x - i.x, E = c.y - i.y;
        return new Z(i.x + y * x, i.y + y * E);
      } }, { key: "area3D", value: function(i, s, c) {
        var d = s.x - i.x, y = s.y - i.y, x = s.getZ() - i.getZ(), E = c.x - i.x, P = c.y - i.y, F = c.getZ() - i.getZ(), $ = y * F - x * P, K = x * E - d * F, ne = d * P - y * E, ue = $ * $ + K * K + ne * ne, he = Math.sqrt(ue) / 2;
        return he;
      } }, { key: "centroid", value: function(i, s, c) {
        var d = (i.x + s.x + c.x) / 3, y = (i.y + s.y + c.y) / 3;
        return new Z(d, y);
      } }, { key: "inCentre", value: function(i, s, c) {
        var d = s.distance(c), y = i.distance(c), x = i.distance(s), E = d + y + x, P = (d * i.x + y * s.x + x * c.x) / E, F = (d * i.y + y * s.y + x * c.y) / E;
        return new Z(P, F);
      } }]);
    }(), Tg = function() {
      return l(function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }, [{ key: "addRingSide", value: function(h, i, s, c, d) {
        if (i === 0 && h.length < xr.MINIMUM_VALID_SIZE) return null;
        var y = c, x = d;
        h.length >= xr.MINIMUM_VALID_SIZE && we.isCCW(h) && (y = d, x = c, s = ie.opposite(s));
        var E = this._curveBuilder.getRingCurve(h, s, i);
        this.addCurve(E, y, x);
      } }, { key: "addRingBothSides", value: function(h, i) {
        this.addRingSide(h, i, ie.LEFT, q.EXTERIOR, q.INTERIOR), this.addRingSide(h, i, ie.RIGHT, q.INTERIOR, q.EXTERIOR);
      } }, { key: "addPoint", value: function(h) {
        if (this._distance <= 0) return null;
        var i = h.getCoordinates(), s = this._curveBuilder.getLineCurve(i, this._distance);
        this.addCurve(s, q.EXTERIOR, q.INTERIOR);
      } }, { key: "addPolygon", value: function(h) {
        var i = this._distance, s = ie.LEFT;
        this._distance < 0 && (i = -this._distance, s = ie.RIGHT);
        var c = h.getExteriorRing(), d = tt.removeRepeatedPoints(c.getCoordinates());
        if (this._distance < 0 && this.isErodedCompletely(c, this._distance) || this._distance <= 0 && d.length < 3) return null;
        this.addRingSide(d, i, s, q.EXTERIOR, q.INTERIOR);
        for (var y = 0; y < h.getNumInteriorRing(); y++) {
          var x = h.getInteriorRingN(y), E = tt.removeRepeatedPoints(x.getCoordinates());
          this._distance > 0 && this.isErodedCompletely(x, -this._distance) || this.addRingSide(E, i, ie.opposite(s), q.INTERIOR, q.EXTERIOR);
        }
      } }, { key: "isTriangleErodedCompletely", value: function(h, i) {
        var s = new Ng(h[0], h[1], h[2]), c = s.inCentre();
        return Xt.pointToSegment(c, s.p0, s.p1) < Math.abs(i);
        ...
        var c = new Mn(h, new Pt(0, q.BOUNDARY, i, s));
        this._curveList.add(c);
      } }, { key: "getCurves", value: function() {
        return this.add(this._inputGeom), this._curveList;
      } }, { key: "add", value: function(h) {
        if (h.isEmpty()) return null;
        if (h instanceof pi) this.addPolygon(h);
        else if (h instanceof wr) this.addLineString(h);
        else if (h instanceof As) this.addPoint(h);
        else if (h instanceof Os) this.addCollection(h);
        else if (h instanceof Gs) this.addCollection(h);
        else if (h instanceof Bs) this.addCollection(h);
        else {
        ...
        var c = h.getEnvelopeInternal(), d = Math.min(c.getHeight(), c.getWidth());
      ...
      return l(h, [{ key: "next", value: function() {
      ...
      return l(h, [{ key: "locate", value: function(i) {
        ...
        if (s.isEmpty()) return q.EXTERIOR;
        var c = s.getExteriorRing(), d = h.locatePointInRing(i, c);
        if (d !== q.INTERIOR) return d;
        for (var y = 0; y < s.getNumInteriorRing(); y++) {
          var x = s.getInteriorRingN(y), E = h.locatePointInRing(i, x);
          if (E === q.BOUNDARY) return q.BOUNDARY;
          if (E === q.INTERIOR) return q.EXTERIOR;
        }
        return q.INTERIOR;
      } }, { key: "locatePointInRing", value: function(i, s) {
        return s.getEnvelopeInternal().intersects(i) ? Us.locateInRing(i, s.getCoordinates()) : q.EXTERIOR;
      } }, { key: "containsPointInPolygon", value: function(i, s) {
        return q.EXTERIOR !== h.locatePointInPolygon(i, s);
      } }, { key: "locateInGeometry", value: function(i, s) {
        if (s instanceof pi) return h.locatePointInPolygon(i, s);
        if (s instanceof Et) for (var c = new Ag(s); c.hasNext(); ) {
          var d = c.next();
          if (d !== s) {
            var y = h.locateInGeometry(i, d);
            if (y !== q.EXTERIOR) return y;
          }
        }
        return q.EXTERIOR;
      } }, { key: "isContained", value: function(i, s) {
        return q.EXTERIOR !== h.locate(i, s);
      } }, { key: "locate", value: function(i, s) {
        return s.isEmpty() ? q.EXTERIOR : s.getEnvelopeInternal().intersects(i) ? h.locateInGeometry(i, s) : q.EXTERIOR;
      } }]);
    }(), Dg = function() {
      return l(function h() {
        o(this, h), h.constructor_.apply(this, arguments);
        ...
        for (var i = q.NONE, s = this.iterator(); s.hasNext(); ) {
          var c = s.next().getLabel();
          c.isArea(h) && c.getLocation(h, ie.LEFT) !== q.NONE && (i = c.getLocation(h, ie.LEFT));
        }
        if (i === q.NONE) return null;
        for (var d = i, y = this.iterator(); y.hasNext(); ) {
          var x = y.next(), E = x.getLabel();
          if (E.getLocation(h, ie.ON) === q.NONE && E.setLocation(h, ie.ON, d), E.isArea(h)) {
            var P = E.getLocation(h, ie.LEFT), F = E.getLocation(h, ie.RIGHT);
            if (F !== q.NONE) {
              if (F !== d) throw new rn("side location conflict", x.getCoordinate());
              P === q.NONE && ee.shouldNeverReachHere("found single null side (at " + x.getCoordinate() + ")"), d = P;
            } else ee.isTrue(E.getLocation(h, ie.LEFT) === q.NONE, "found single null side"), E.setLocation(h, ie.RIGHT, d), E.setLocation(h, ie.LEFT, d);
          }
        }
      } }, { key: "getCoordinate", value: function() {
        var h = this.iterator();
        ...
        var s = i.size() - 1, c = i.get(s).getLabel().getLocation(h, ie.LEFT);
        ee.isTrue(c !== q.NONE, "Found unlabelled area edge");
        for (var d = c, y = this.iterator(); y.hasNext(); ) {
        ...
        return this._ptInAreaLocation[h] === q.NONE && (this._ptInAreaLocation[h] = Og.locate(i, s[h].getGeometry())), this._ptInAreaLocation[h];
      } }, { key: "toString", value: function() {
        var h = new mn();
...
`);
        ...
        for (var i = [!1, !1], s = this.iterator(); s.hasNext(); ) for (var c = s.next().getLabel(), d = 0; d < 2; d++) c.isLine(d) && c.getLocation(d) === q.BOUNDARY && (i[d] = !0);
        ...
        this._edgeMap = new Ir(), this._edgeList = null, this._ptInAreaLocation = [q.NONE, q.NONE];
      } }]);
    }(), Fg = function(h) {
      function i() {
        var s;
      ...
      return m(i, h), l(i, [{ key: "linkResultDirectedEdges", value: function() {
        this.getResultAreaEdges();
        for (var s = null, c = null, d = this._SCANNING_FOR_INCOMING, y = 0; y < this._resultAreaEdgeList.size(); y++) {
          ...
          if (x.getLabel().isArea()) switch (s === null && x.isInResult() && (s = x), d) {
            case this._SCANNING_FOR_INCOMING:
              ...
              c = E, d = this._LINKING_TO_OUTGOING;
              break;
            case this._LINKING_TO_OUTGOING:
              if (!x.isInResult()) continue;
              c.setNext(x), d = this._SCANNING_FOR_INCOMING;
          }
        }
        if (d === this._LINKING_TO_OUTGOING) {
          if (s === null) throw new rn("no outgoing dirEdge found", this.getCoordinate());
          ee.isTrue(s.isInResult(), "unable to link last incoming dirEdge"), c.setNext(s);
        }
      } }, { key: "insert", value: function(s) {
        var c = s;
        this.insertEdgeEnd(c, c);
      } }, { key: "getRightmostEdge", value: function() {
        var s = this.getEdges(), c = s.size();
        if (c < 1) return null;
        var d = s.get(0);
        if (c === 1) return d;
        var y = s.get(c - 1), x = d.getQuadrant(), E = y.getQuadrant();
        ...
        for (var s = this.iterator(); s.hasNext(); ) {
          var c = s.next();
          (c.isInResult() || c.getSym().isInResult()) && this._resultAreaEdgeList.add(c);
        }
        ...
        this.getEdges();
        for (var s = null, c = null, d = this._edgeList.size() - 1; d >= 0; d--) {
          var y = this._edgeList.get(d), x = y.getSym();
          c === null && (c = x), s !== null && x.setNext(s), s = y;
        }
        c.setNext(s);
      } }, { key: "computeDepths", value: function() {
        if (arguments.length === 1) {
          var s = arguments[0], c = this.findIndex(s), d = s.getDepth(ie.LEFT), y = s.getDepth(ie.RIGHT), x = this.computeDepths(c + 1, this._edgeList.size(), d);
          if (this.computeDepths(0, c, x) !== y) throw new rn("depth mismatch at " + s.getCoordinate());
        } else if (arguments.length === 3) {
        ...
        for (var s = this.iterator(); s.hasNext(); ) {
          var c = s.next();
          c.getLabel().merge(c.getSym().getLabel());
        }
      } }, { key: "linkMinimalDirectedEdges", value: function(s) {
        for (var c = null, d = null, y = this._SCANNING_FOR_INCOMING, x = this._resultAreaEdgeList.size() - 1; x >= 0; x--) {
          var E = this._resultAreaEdgeList.get(x), P = E.getSym();
          switch (c === null && E.getEdgeRing() === s && (c = E), y) {
            case this._SCANNING_FOR_INCOMING:
        ...
        y === this._LINKING_TO_OUTGOING && (ee.isTrue(c !== null, "found null for first outgoing dirEdge"), ee.isTrue(c.getEdgeRing() === s, "unable to link last incoming dirEdge"), d.setNextMin(c));
      } }, { key: "getOutgoingDegree", value: function() {
        if (arguments.length === 0) {
          for (var s = 0, c = this.iterator(); c.hasNext(); )
            c.next().isInResult() && s++;
          return s;
        }
        if (arguments.length === 1) {
        ...
        for (var s = q.NONE, c = this.iterator(); c.hasNext(); ) {
          var d = c.next(), y = d.getSym();
          if (!d.isLineEdge()) {
            if (d.isInResult()) {
              s = q.INTERIOR;
              break;
        ...
        for (var x = s, E = this.iterator(); E.hasNext(); ) {
          ...
          P.isLineEdge() ? P.getEdge().setCovered(x === q.INTERIOR) : (P.isInResult() && (x = q.EXTERIOR), F.isInResult() && (x = q.INTERIOR));
        }
      } }, { key: "computeLabelling", value: function(s) {
        w(i, "computeLabelling", this, 1).call(this, s), this._label = new Pt(q.NONE);
        for (var c = this.iterator(); c.hasNext(); ) for (var d = c.next().getEdge().getLabel(), y = 0; y < 2; y++) {
          var x = d.getLocation(y);
          x !== q.INTERIOR && x !== q.BOUNDARY || this._label.setLocation(y, q.INTERIOR);
        }
      } }], [{ key: "constructor_", value: function() {
      ...
      return m(i, h), l(i, [{ key: "createNode", value: function(s) {
        return new Ci(s, new Fg());
      } }]);
    }($a), ou = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "compareTo", value: function(i) {
        var s = i;
      ...
      } }, { key: "compareOriented", value: function(i, s, c, d) {
        for (var y = s ? 1 : -1, x = d ? 1 : -1, E = s ? i.length : -1, P = d ? c.length : -1, F = s ? 0 : i.length - 1, $ = d ? 0 : c.length - 1; ; ) {
          var K = i[F].compareTo(c[$]);
          if (K !== 0) return K;
          var ne = (F += y) === E, ue = ($ += x) === P;
          if (ne && !ue) return -1;
          if (!ne && ue) return 1;
      ...
      return l(function h() {
        ...
        for (var i = 0; i < this._edges.size(); i++) {
          var s = this._edges.get(i);
          i > 0 && h.print(","), h.print("(");
          for (var c = s.getCoordinates(), d = 0; d < c.length; d++) d > 0 && h.print(","), h.print(c[d].x + " " + c[d].y);
          h.println(")");
        }
        h.print(")  ");
        ...
        this._edges = new ve(), this._ocaMap = new Ir();
      } }]);
    }(), au = function() {
      return l(function h() {
        o(this, h);
      }, [{ key: "processIntersections", value: function(h, i, s, c) {
      } }, { key: "isDone", value: function() {
      } }]);
    }(), zg = function() {
      function h() {
      ...
      return l(h, [{ key: "isTrivialIntersection", value: function(i, s, c, d) {
        if (i === c && this._li.getIntersectionNum() === 1) {
      ...
      } }, { key: "processIntersections", value: function(i, s, c, d) {
        if (i === c && s === d) return null;
        this.numTests++;
        var y = i.getCoordinates()[s], x = i.getCoordinates()[s + 1], E = c.getCoordinates()[d], P = c.getCoordinates()[d + 1];
        this._li.computeIntersection(y, x, E, P), this._li.hasIntersection() && (this.numIntersections++, this._li.isInteriorIntersection() && (this.numInteriorIntersections++, this._hasInterior = !0), this.isTrivialIntersection(i, s, c, d) || (this._hasIntersection = !0, i.addIntersections(this._li, s, 0), c.addIntersections(this._li, d, 1), this._li.isProper() && (this.numProperIntersections++, this._hasProper = !0, this._hasProperInterior = !0)));
      } }, { key: "hasIntersection", value: function() {
      ...
      return l(function h() {
        ...
        var s = i.segmentIndex - h.segmentIndex + 2, c = this.edge.pts[i.segmentIndex], d = i.dist > 0 || !i.coord.equals2D(c);
        d || s--;
        var y = new Array(s).fill(null), x = 0;
        y[x++] = new Z(h.coord);
        for (var E = h.segmentIndex + 1; E <= i.segmentIndex; E++) y[x++] = this.edge.pts[E];
        return d && (y[x] = i.coord), new lu(y, new Pt(this.edge._label));
      } }, { key: "add", value: function(h, i, s) {
        var c = new qg(h, i, s), d = this._nodeMap.get(c);
        return d !== null ? d : (this._nodeMap.put(c, c), c);
      ...
      return l(h, [{ key: "isIntersects", value: function() {
        return !this.isDisjoint();
      } }, { key: "isCovers", value: function() {
        return (h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) || h.isTrue(this._matrix[q.INTERIOR][q.BOUNDARY]) || h.isTrue(this._matrix[q.BOUNDARY][q.INTERIOR]) || h.isTrue(this._matrix[q.BOUNDARY][q.BOUNDARY])) && this._matrix[q.EXTERIOR][q.INTERIOR] === oe.FALSE && this._matrix[q.EXTERIOR][q.BOUNDARY] === oe.FALSE;
      } }, { key: "isCoveredBy", value: function() {
        return (h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) || h.isTrue(this._matrix[q.INTERIOR][q.BOUNDARY]) || h.isTrue(this._matrix[q.BOUNDARY][q.INTERIOR]) || h.isTrue(this._matrix[q.BOUNDARY][q.BOUNDARY])) && this._matrix[q.INTERIOR][q.EXTERIOR] === oe.FALSE && this._matrix[q.BOUNDARY][q.EXTERIOR] === oe.FALSE;
      } }, { key: "set", value: function() {
        if (arguments.length === 1) for (var i = arguments[0], s = 0; s < i.length; s++) {
          var c = Math.trunc(s / 3), d = s % 3;
          this._matrix[c][d] = oe.toDimensionValue(i.charAt(s));
        }
        else if (arguments.length === 3) {
          var y = arguments[0], x = arguments[1], E = arguments[2];
          this._matrix[y][x] = E;
        ...
        return h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) && this._matrix[q.EXTERIOR][q.INTERIOR] === oe.FALSE && this._matrix[q.EXTERIOR][q.BOUNDARY] === oe.FALSE;
      } }, { key: "setAtLeast", value: function() {
        if (arguments.length === 1) for (var i = arguments[0], s = 0; s < i.length; s++) {
          var c = Math.trunc(s / 3), d = s % 3;
          this.setAtLeast(c, d, oe.toDimensionValue(i.charAt(s)));
        }
        else if (arguments.length === 3) {
          var y = arguments[0], x = arguments[1], E = arguments[2];
          this._matrix[y][x] < E && (this._matrix[y][x] = E);
        }
      } }, { key: "setAtLeastIfValid", value: function(i, s, c) {
        i >= 0 && s >= 0 && this.setAtLeast(i, s, c);
      } }, { key: "isWithin", value: function() {
        return h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) && this._matrix[q.INTERIOR][q.EXTERIOR] === oe.FALSE && this._matrix[q.BOUNDARY][q.EXTERIOR] === oe.FALSE;
      } }, { key: "isTouches", value: function(i, s) {
        return i > s ? this.isTouches(s, i) : (i === oe.A && s === oe.A || i === oe.L && s === oe.L || i === oe.L && s === oe.A || i === oe.P && s === oe.A || i === oe.P && s === oe.L) && this._matrix[q.INTERIOR][q.INTERIOR] === oe.FALSE && (h.isTrue(this._matrix[q.INTERIOR][q.BOUNDARY]) || h.isTrue(this._matrix[q.BOUNDARY][q.INTERIOR]) || h.isTrue(this._matrix[q.BOUNDARY][q.BOUNDARY]));
      } }, { key: "isOverlaps", value: function(i, s) {
        return i === oe.P && s === oe.P || i === oe.A && s === oe.A ? h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) && h.isTrue(this._matrix[q.INTERIOR][q.EXTERIOR]) && h.isTrue(this._matrix[q.EXTERIOR][q.INTERIOR]) : i === oe.L && s === oe.L && this._matrix[q.INTERIOR][q.INTERIOR] === 1 && h.isTrue(this._matrix[q.INTERIOR][q.EXTERIOR]) && h.isTrue(this._matrix[q.EXTERIOR][q.INTERIOR]);
      } }, { key: "isEquals", value: function(i, s) {
        return i === s && h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) && this._matrix[q.INTERIOR][q.EXTERIOR] === oe.FALSE && this._matrix[q.BOUNDARY][q.EXTERIOR] === oe.FALSE && this._matrix[q.EXTERIOR][q.INTERIOR] === oe.FALSE && this._matrix[q.EXTERIOR][q.BOUNDARY] === oe.FALSE;
      } }, { key: "toString", value: function() {
        for (var i = new wi("123456789"), s = 0; s < 3; s++) for (var c = 0; c < 3; c++) i.setCharAt(3 * s + c, oe.toDimensionSymbol(this._matrix[s][c]));
        return i.toString();
      } }, { key: "setAll", value: function(i) {
        for (var s = 0; s < 3; s++) for (var c = 0; c < 3; c++) this._matrix[s][c] = i;
        ...
        for (var s = 0; s < 3; s++) for (var c = 0; c < 3; c++) if (!h.matches(this._matrix[s][c], i.charAt(3 * s + c))) return !1;
        return !0;
      } }, { key: "add", value: function(i) {
        for (var s = 0; s < 3; s++) for (var c = 0; c < 3; c++) this.setAtLeast(s, c, i.get(s, c));
      } }, { key: "isDisjoint", value: function() {
        return this._matrix[q.INTERIOR][q.INTERIOR] === oe.FALSE && this._matrix[q.INTERIOR][q.BOUNDARY] === oe.FALSE && this._matrix[q.BOUNDARY][q.INTERIOR] === oe.FALSE && this._matrix[q.BOUNDARY][q.BOUNDARY] === oe.FALSE;
      } }, { key: "isCrosses", value: function(i, s) {
        return i === oe.P && s === oe.L || i === oe.P && s === oe.A || i === oe.L && s === oe.A ? h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) && h.isTrue(this._matrix[q.INTERIOR][q.EXTERIOR]) : i === oe.L && s === oe.P || i === oe.A && s === oe.P || i === oe.A && s === oe.L ? h.isTrue(this._matrix[q.INTERIOR][q.INTERIOR]) && h.isTrue(this._matrix[q.EXTERIOR][q.INTERIOR]) : i === oe.L && s === oe.L && this._matrix[q.INTERIOR][q.INTERIOR] === 0;
      } }, { key: "interfaces_", get: function() {
        return [C];
      } }], [{ key: "constructor_", value: function() {
        if (this._matrix = null, arguments.length === 0) this._matrix = Array(3).fill().map(function() {
          ...
          if (typeof arguments[0] == "string") {
            ...
            var s = arguments[0];
            h.constructor_.call(this), this._matrix[q.INTERIOR][q.INTERIOR] = s._matrix[q.INTERIOR][q.INTERIOR], this._matrix[q.INTERIOR][q.BOUNDARY] = s._matrix[q.INTERIOR][q.BOUNDARY], this._matrix[q.INTERIOR][q.EXTERIOR] = s._matrix[q.INTERIOR][q.EXTERIOR], this._matrix[q.BOUNDARY][q.INTERIOR] = s._matrix[q.BOUNDARY][q.INTERIOR], this._matrix[q.BOUNDARY][q.BOUNDARY] = s._matrix[q.BOUNDARY][q.BOUNDARY], this._matrix[q.BOUNDARY][q.EXTERIOR] = s._matrix[q.BOUNDARY][q.EXTERIOR], this._matrix[q.EXTERIOR][q.INTERIOR] = s._matrix[q.EXTERIOR][q.INTERIOR], this._matrix[q.EXTERIOR][q.BOUNDARY] = s._matrix[q.EXTERIOR][q.BOUNDARY], this._matrix[q.EXTERIOR][q.EXTERIOR] = s._matrix[q.EXTERIOR][q.EXTERIOR];
          }
        }
        ...
        if (typeof arguments[0] == "string" && typeof arguments[1] == "string") {
          var c = arguments[1];
          return new h(arguments[0]).matches(c);
        }
      ...
      return l(h, [{ key: "size", value: function() {
        return this._size;
      } }, { key: "addAll", value: function(i) {
        return i === null || i.length === 0 ? null : (this.ensureCapacity(this._size + i.length), Mt.arraycopy(i, 0, this._data, this._size, i.length), void (this._size += i.length));
      } }, { key: "ensureCapacity", value: function(i) {
        if (i <= this._data.length) return null;
        var s = Math.max(i, 2 * this._data.length);
        this._data = Sn.copyOf(this._data, s);
      } }, { key: "toArray", value: function() {
        var i = new Array(this._size).fill(null);
        return Mt.arraycopy(this._data, 0, i, 0, this._size), i;
      } }, { key: "add", value: function(i) {
      ...
      return l(h, [{ key: "getChainStartIndices", value: function(i) {
        var s = 0, c = new Xg(Math.trunc(i.length / 2));
        c.add(s);
        do {
        ...
        for (var c = dt.quadrant(i[s], i[s + 1]), d = s + 1; d < i.length && dt.quadrant(i[d - 1], i[d]) === c; )
          d++;
        return d - 1;
        ...
        return h.toIntArray(c);
      } }], [{ key: "toIntArray", value: function(i) {
        for (var s = new Array(i.size()).fill(null), c = 0; c < s.length; c++) s[c] = i.get(c).intValue();
        return s;
      } }]);
    }(), Hg = function() {
      return l(function h() {
        ...
        if (arguments.length === 4) {
          var h = arguments[0], i = arguments[1], s = arguments[2], c = arguments[3];
          this.computeIntersectsForChain(this.startIndex[h], this.startIndex[h + 1], i, i.startIndex[s], i.startIndex[s + 1], c);
        } else if (arguments.length === 6) {
        ...
        return _e.intersects(this.pts[h], this.pts[i], s.pts[c], s.pts[d]);
      } }, { key: "getStartIndexes", value: function() {
        return this.startIndex;
      } }, { key: "computeIntersects", value: function(h, i) {
        for (var s = 0; s < this.startIndex.length - 1; s++) for (var c = 0; c < h.startIndex.length - 1; c++) this.computeIntersectsForChain(s, h, c, i);
      } }], [{ key: "constructor_", value: function() {
      ...
      return l(h, [{ key: "getDepth", value: function(i, s) {
        return this._depth[i][s];
      } }, { key: "setDepth", value: function(i, s, c) {
        this._depth[i][s] = c;
      } }, { key: "isNull", value: function() {
        if (arguments.length === 0) {
        ...
        if (arguments.length === 1) {
          var c = arguments[0];
          return this._depth[c][1] === h.NULL_VALUE;
        }
        if (arguments.length === 2) {
          var d = arguments[0], y = arguments[1];
        ...
        for (var i = 0; i < 2; i++) if (!this.isNull(i)) {
          ...
          for (var c = 1; c < 3; c++) {
            var d = 0;
            this._depth[i][c] > s && (d = 1), this._depth[i][c] = d;
          }
        }
      } }, { key: "getDelta", value: function(i) {
        return this._depth[i][ie.RIGHT] - this._depth[i][ie.LEFT];
      } }, { key: "getLocation", value: function(i, s) {
        return this._depth[i][s] <= 0 ? q.EXTERIOR : q.INTERIOR;
      } }, { key: "toString", value: function() {
        return "A: " + this._depth[0][1] + "," + this._depth[0][2] + " B: " + this._depth[1][1] + "," + this._depth[1][2];
      } }, { key: "add", value: function() {
        if (arguments.length === 1) for (var i = arguments[0], s = 0; s < 2; s++) for (var c = 1; c < 3; c++) {
          var d = i.getLocation(s, c);
          d !== q.EXTERIOR && d !== q.INTERIOR || (this.isNull(s, c) ? this._depth[s][c] = h.depthAtLocation(d) : this._depth[s][c] += h.depthAtLocation(d));
        }
        else if (arguments.length === 3) {
          var y = arguments[0], x = arguments[1];
          arguments[2] === q.INTERIOR && this._depth[y][x]++;
        }
      } }], [{ key: "constructor_", value: function() {
        ...
        return i === q.EXTERIOR ? 0 : i === q.INTERIOR ? 1 : h.NULL_VALUE;
      } }]);
    }();
    uu.NULL_VALUE = -1;
    var lu = function(h) {
      ...
      return m(i, h), l(i, [{ key: "getDepth", value: function() {
        return this._depth;
      } }, { key: "getCollapsedEdge", value: function() {
        var s = new Array(2).fill(null);
        return s[0] = this.pts[0], s[1] = this.pts[1], new i(s, Pt.toLineLabel(this._label));
      } }, { key: "isIsolated", value: function() {
        ...
        for (var d = !0, y = !0, x = this.pts.length, E = 0; E < this.pts.length; E++) if (this.pts[E].equals2D(c.pts[E]) || (d = !1), this.pts[E].equals2D(c.pts[--x]) || (y = !1), !d && !y) return !1;
        return !0;
      } }, { key: "getCoordinate", value: function() {
        ...
        for (var c = 0; c < this.pts.length; c++) c > 0 && s.print(","), s.print(this.pts[c].x + " " + this.pts[c].y);
        ...
        for (var c = this.pts.length - 1; c >= 0; c--) s.print(this.pts[c] + " ");
        s.println("");
      } }, { key: "getMonotoneChainEdge", value: function() {
        return this._mce === null && (this._mce = new Hg(this)), this._mce;
      } }, { key: "getEnvelope", value: function() {
        if (this._env === null) {
          this._env = new _e();
        ...
        return this._env;
      } }, { key: "addIntersection", value: function(s, c, d, y) {
        var x = new Z(s.getIntersection(y)), E = c, P = s.getEdgeDistance(d, y), F = E + 1;
        ...
        for (var c = 0; c < this.pts.length; c++) c > 0 && s.append(","), s.append(this.pts[c].x + " " + this.pts[c].y);
        ...
        for (var c = 0; c < this.pts.length; c++) if (!this.pts[c].equals2D(s.pts[c])) return !1;
        return !0;
      } }, { key: "setDepthDelta", value: function(s) {
        this._depthDelta = s;
      } }, { key: "getEdgeIntersectionList", value: function() {
        return this.eiList;
      } }, { key: "addIntersections", value: function(s, c, d) {
        for (var y = 0; y < s.getIntersectionNum(); y++) this.addIntersection(s, c, d, y);
      } }], [{ key: "constructor_", value: function() {
        if (this.pts = null, this._env = null, this.eiList = new Ug(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new uu(), this._depthDelta = 0, arguments.length === 1) {
          var s = arguments[0];
          i.constructor_.call(this, s, null);
        } else if (arguments.length === 2) {
          var c = arguments[0], d = arguments[1];
          this.pts = c, this._label = d;
        }
      } }, { key: "updateIM", value: function() {
        if (!(arguments.length === 2 && arguments[1] instanceof Yg && arguments[0] instanceof Pt)) return w(i, "updateIM", this).apply(this, arguments);
        var s = arguments[0], c = arguments[1];
        c.setAtLeastIfValid(s.getLocation(0, ie.ON), s.getLocation(1, ie.ON), 1), s.isArea() && (c.setAtLeastIfValid(s.getLocation(0, ie.LEFT), s.getLocation(1, ie.LEFT), 2), c.setAtLeastIfValid(s.getLocation(0, ie.RIGHT), s.getLocation(1, ie.RIGHT), 2));
      } }]);
    }(Ya), cu = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "setWorkingPrecisionModel", value: function(i) {
        this._workingPrecisionModel = i;
      } }, { key: "insertUniqueEdge", value: function(i) {
        var s = this._edgeList.findEqualEdge(i);
        if (s !== null) {
          var c = s.getLabel(), d = i.getLabel();
          s.isPointwiseEqual(i) || (d = new Pt(i.getLabel())).flip(), c.merge(d);
        ...
        for (var c = new ve(), d = i.iterator(); d.hasNext(); ) {
          var y = d.next(), x = y.getRightmostCoordinate(), E = new ru(c).getDepth(x);
          y.computeDepth(E), y.findResultEdges(), c.add(y), s.add(y.getDirectedEdges(), y.getNodes());
        }
      } }, { key: "createSubgraphs", value: function(i) {
        for (var s = new ve(), c = i.getNodes().iterator(); c.hasNext(); ) {
          var d = c.next();
          if (!d.isVisited()) {
            var y = new Jf();
            y.create(d), s.add(y);
        ...
        return Xn.sort(s, Xn.reverseOrder()), s;
      } }, { key: "createEmptyResultGeometry", value: function() {
        return this._geomFact.createPolygon();
      } }, { key: "getNoder", value: function(i) {
        if (this._workingNoder !== null) return this._workingNoder;
        var s = new Hs(), c = new bn();
        return c.setPrecisionModel(i), s.setSegmentIntersector(new zg(c)), s;
      } }, { key: "buffer", value: function(i, s) {
        var c = this._workingPrecisionModel;
        c === null && (c = i.getPrecisionModel()), this._geomFact = i.getFactory();
        var d = new Pg(c, this._bufParams), y = new Tg(i, s, d).getCurves();
        if (y.size() <= 0) return this.createEmptyResultGeometry();
        this.computeNodedEdges(y, c), this._graph = new Za(new Bg()), this._graph.addEdges(this._edgeList.getEdges());
        var x = this.createSubgraphs(this._graph), E = new yg(this._geomFact);
        ...
        var c = this.getNoder(s);
        c.computeNodes(i);
        for (var d = c.getNodedSubstrings().iterator(); d.hasNext(); ) {
          var y = d.next(), x = y.getCoordinates();
          if (x.length !== 2 || !x[0].equals2D(x[1])) {
            var E = y.getData(), P = new lu(y.getCoordinates(), new Pt(E));
        ...
        this._bufParams = null, this._workingPrecisionModel = null, this._workingNoder = null, this._geomFact = null, this._graph = null, this._edgeList = new Gg();
        var i = arguments[0];
        this._bufParams = i;
      } }, { key: "depthDelta", value: function(i) {
        var s = i.getLocation(0, ie.LEFT), c = i.getLocation(0, ie.RIGHT);
        return s === q.INTERIOR && c === q.EXTERIOR ? 1 : s === q.EXTERIOR && c === q.INTERIOR ? -1 : 0;
      } }, { key: "convertSegStrings", value: function(i) {
        for (var s = new Un(), c = new ve(); i.hasNext(); ) {
          var d = i.next(), y = s.createLineString(d.getCoordinates());
          c.add(y);
        }
        return s.buildGeometry(c);
      } }]);
    }(), Wg = function() {
      function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }
      return l(h, [{ key: "rescale", value: function() {
        if (Ee(arguments[0], be)) for (var i = arguments[0].iterator(); i.hasNext(); ) {
          var s = i.next();
          this.rescale(s.getCoordinates());
        }
        else if (arguments[0] instanceof Array) {
          for (var c = arguments[0], d = 0; d < c.length; d++) c[d].x = c[d].x / this._scaleFactor + this._offsetX, c[d].y = c[d].y / this._scaleFactor + this._offsetY;
          c.length === 2 && c[0].equals2D(c[1]) && Mt.out.println(c);
        }
      } }, { key: "scale", value: function() {
        if (Ee(arguments[0], be)) {
          for (var i = arguments[0], s = new ve(i.size()), c = i.iterator(); c.hasNext(); ) {
            var d = c.next();
            s.add(new Mn(this.scale(d.getCoordinates()), d.getData()));
          }
          return s;
        }
        if (arguments[0] instanceof Array) {
        ...
        if (this._noder = null, this._scaleFactor = null, this._offsetX = null, this._offsetY = null, this._isScaled = !1, arguments.length === 2) {
          ...
          var c = arguments[0], d = arguments[1];
          this._noder = c, this._scaleFactor = d, this._isScaled = !this.isIntegerPrecision();
        }
      } }]);
    }(), hu = function() {
      function h() {
      ...
      return l(h, [{ key: "checkEndPtVertexIntersections", value: function() {
        if (arguments.length === 0) for (var i = this._segStrings.iterator(); i.hasNext(); ) {
          ...
          for (var c = arguments[0], d = arguments[1].iterator(); d.hasNext(); ) for (var y = d.next().getCoordinates(), x = 1; x < y.length - 1; x++) if (y[x].equals(c)) throw new Q("found endpt/interior pt intersection at index " + x + " :pt " + c);
        }
      } }, { key: "checkInteriorIntersections", value: function() {
        if (arguments.length === 0) for (var i = this._segStrings.iterator(); i.hasNext(); ) for (var s = i.next(), c = this._segStrings.iterator(); c.hasNext(); ) {
          var d = c.next();
        ...
        else if (arguments.length === 1) for (var c = arguments[0].getCoordinates(), d = 0; d < c.length - 2; d++) this.checkCollapse(c[d], c[d + 1], c[d + 2]);
      } }, { key: "hasInteriorIntersection", value: function(i, s, c) {
        for (var d = 0; d < i.getIntersectionNum(); d++) {
          var y = i.getIntersection(d);
          if (!y.equals(s) && !y.equals(c)) return !0;
        }
        return !1;
      } }, { key: "checkCollapse", value: function(i, s, c) {
        if (i.equals(c)) throw new Q("found non-noded collapse at " + h.fact.createLineString([i, s, c]));
      } }], [{ key: "constructor_", value: function() {
    ...
    var $s = function() {
      ...
      return l(h, [{ key: "intersectsScaled", value: function(i, s) {
        var c = Math.min(i.x, s.x), d = Math.max(i.x, s.x), y = Math.min(i.y, s.y), x = Math.max(i.y, s.y), E = this._maxx < c || this._minx > d || this._maxy < y || this._miny > x;
        if (E) return !1;
    ...
    var $g = function() {
      ...
      return l(function h() {
        ...
        if (arguments.length === 3) {
          var i = arguments[0], s = arguments[1], c = arguments[2], d = i.getSafeEnvelope(), y = new gu(i, s, c);
      ...
      return m(i, h), l(i, [{ key: "isNodeAdded", value: function() {
        ...
        var s = arguments[1], c = arguments[0].getContext();
        ...
        var s = arguments[0], c = arguments[1], d = arguments[2];
        this._hotPixel = s, this._parentEdge = c, this._hotPixelVertexIndex = d;
      } }]);
    }($g);
    fu.HotPixelSnapAction = gu;
    var Zg = function() {
      return l(function h() {
        o(this, h), h.constructor_.apply(this, arguments);
      }, [{ key: "processIntersections", value: function(h, i, s, c) {
        if (h === s && i === c) return null;
        var d = h.getCoordinates()[i], y = h.getCoordinates()[i + 1], x = s.getCoordinates()[c], E = s.getCoordinates()[c + 1];
        if (this._li.computeIntersection(d, y, x, E), this._li.hasIntersection() && this._li.isInteriorIntersection()) {
          ...
          h.addIntersections(this._li, i, 0), s.addIntersections(this._li, c, 1);
        }
      } }, { key: "isDone", value: function() {
        return !1;
      ...
      return l(function h() {
        ...
        var i = Mn.getNodedSubstrings(h), s = new hu(i);
        try {
          s.checkValid();
        } catch (c) {
        ...
        else if (arguments[0] instanceof Mn) for (var s = arguments[0], c = s.getCoordinates(), d = 0; d < c.length; d++) {
          var y = new $s(c[d], this._scaleFactor, this._li);
          this._pointSnapper.snap(y, s, d) && s.addIntersection(c[d], d);
        }
      } }, { key: "computeNodes", value: function(h) {
        this._nodedSegStrings = h, this._noder = new Hs(), this._pointSnapper = new fu(this._noder.getIndex()), this.snapRound(h, this._li);
      } }, { key: "computeIntersectionSnaps", value: function(h) {
        for (var i = h.iterator(); i.hasNext(); ) {
          var s = i.next(), c = new $s(s, this._scaleFactor, this._li);
      ...
      return l(h, [{ key: "bufferFixedPrecision", value: function(i) {
        var s = new Wg(new Kg(new Bt(1)), i.getScale()), c = new cu(this._bufParams);
        c.setWorkingPrecisionModel(i), c.setNoder(s), this._resultGeometry = c.buffer(this._argGeom, this._distance);
        ...
        if (arguments.length === 1) {
          var s = arguments[0], c = h.precisionScaleFactor(this._argGeom, this._distance, s), d = new Bt(c);
        ...
        if (this._argGeom = null, this._distance = null, this._bufParams = new N(), this._resultGeometry = null, this._saveException = null, arguments.length === 1) {
          ...
          var s = arguments[0], c = arguments[1];
          this._argGeom = s, this._bufParams = c;
        }
        ...
        if (arguments.length === 3) {
          if (Number.isInteger(arguments[2]) && arguments[0] instanceof ae && typeof arguments[1] == "number") {
            var s = arguments[1], c = arguments[2], d = new h(arguments[0]);
            return d.setQuadrantSegments(c), d.getResultGeometry(s);
          }
      ...
      } }, { key: "precisionScaleFactor", value: function(i, s, c) {
        var d = i.getEnvelopeInternal(), y = _r.max(Math.abs(d.getMaxX()), Math.abs(d.getMaxY()), Math.abs(d.getMinX()), Math.abs(d.getMinY())) + 2 * (s > 0 ? s : 0), x = c - Math.trunc(Math.log(y) / Math.log(10) + 1);
        return Math.pow(10, x);
      } }]);
    }();
    Wn.CAP_ROUND = N.CAP_ROUND, Wn.CAP_BUTT = N.CAP_FLAT, Wn.CAP_FLAT = N.CAP_FLAT, Wn.CAP_SQUARE = N.CAP_SQUARE, Wn.MAX_PRECISION_DIGITS = 12;
    var Jg = ["Point", "MultiPoint", "LineString", "MultiLineString", "Polygon", "MultiPolygon"], du = function() {
      return l(function h(i) {
        o(this, h), this.geometryFactory = i || new Un();
      }, [{ key: "read", value: function(h) {
        var i, s = (i = typeof h == "string" ? JSON.parse(h) : h).type;
        if (!Tt[s]) throw new Error("Unknown GeoJSON type: " + i.type);
        return Jg.indexOf(s) !== -1 ? Tt[s].call(this, i.coordinates) : s === "GeometryCollection" ? Tt[s].call(this, i.geometries) : Tt[s].call(this, i);
      } }, { key: "write", value: function(h) {
        var i = h.getGeometryType();
        if (!Wt[i]) throw new Error("Geometry is not supported");
        return Wt[i].call(this, h);
      } }]);
    }(), Tt = { Feature: function(h) {
      var i = {};
      for (var s in h) i[s] = h[s];
      if (h.geometry) {
        var c = h.geometry.type;
        if (!Tt[c]) throw new Error("Unknown GeoJSON type: " + h.type);
        i.geometry = this.read(h.geometry);
      }
      return h.bbox && (i.bbox = Tt.bbox.call(this, h.bbox)), i;
      ...
      for (var i = [], s = 0; s < h.length; ++s) i.push(Tt.Point.call(this, h[s]));
      return this.geometryFactory.createMultiPoint(i);
    }, LineString: function(h) {
      var i = Tt.coordinates.call(this, h);
      return this.geometryFactory.createLineString(i);
    }, MultiLineString: function(h) {
      for (var i = [], s = 0; s < h.length; ++s) i.push(Tt.LineString.call(this, h[s]));
      return this.geometryFactory.createMultiLineString(i);
    }, Polygon: function(h) {
      for (var i = Tt.coordinates.call(this, h[0]), s = this.geometryFactory.createLinearRing(i), c = [], d = 1; d < h.length; ++d) {
        var y = h[d], x = Tt.coordinates.call(this, y), E = this.geometryFactory.createLinearRing(x);
        c.push(E);
      }
      return this.geometryFactory.createPolygon(s, c);
    }, MultiPolygon: function(h) {
      for (var i = [], s = 0; s < h.length; ++s) {
        var c = h[s];
        i.push(Tt.Polygon.call(this, c));
      }
    ...
    } }, Wt = { coordinate: function(h) {
      var i = [h.x, h.y];
      return h.z && i.push(h.z), h.m && i.push(h.m), i;
    }, Point: function(h) {
      return { type: "Point", coordinates: Wt.coordinate.call(this, h.getCoordinate()) };
    }, MultiPoint: function(h) {
      for (var i = [], s = 0; s < h._geometries.length; ++s) {
        var c = h._geometries[s], d = Wt.Point.call(this, c);
        i.push(d.coordinates);
      }
      return { type: "MultiPoint", coordinates: i };
    }, LineString: function(h) {
      for (var i = [], s = h.getCoordinates(), c = 0; c < s.length; ++c) {
        var d = s[c];
        i.push(Wt.coordinate.call(this, d));
      }
      return { type: "LineString", coordinates: i };
    }, MultiLineString: function(h) {
      for (var i = [], s = 0; s < h._geometries.length; ++s) {
        var c = h._geometries[s], d = Wt.LineString.call(this, c);
        i.push(d.coordinates);
      }
      return { type: "MultiLineString", coordinates: i };
    }, Polygon: function(h) {
      var i = [], s = Wt.LineString.call(this, h._shell);
      i.push(s.coordinates);
      for (var c = 0; c < h._holes.length; ++c) {
        var d = h._holes[c], y = Wt.LineString.call(this, d);
        i.push(y.coordinates);
      }
      return { type: "Polygon", coordinates: i };
    }, MultiPolygon: function(h) {
      for (var i = [], s = 0; s < h._geometries.length; ++s) {
        var c = h._geometries[s], d = Wt.Polygon.call(this, c);
        i.push(d.coordinates);
      }
      return { type: "MultiPolygon", coordinates: i };
    }, GeometryCollection: function(h) {
      for (var i = [], s = 0; s < h._geometries.length; ++s) {
        var c = h._geometries[s], d = c.getGeometryType();
        i.push(Wt[d].call(this, c));
      }
      return { type: "GeometryCollection", geometries: i };
    } };
    return { BufferOp: Wn, GeoJSONReader: function() {
      return l(function h(i) {
        o(this, h), this.parser = new du(i || new Un());
      }, [{ key: "read", value: function(h) {
        return this.parser.read(h);
      } }]);
    }(), GeoJSONWriter: function() {
      return l(function h() {
        o(this, h), this.parser = new du(this.geometryFactory);
      }, [{ key: "write", value: function(h) {
        return this.parser.write(h);
      } }]);
    }() };
...
class kv {
  ...
  add(e) {
    ...
    for (let o = 0; o < this._n && o < 32; o++) {
      const a = t[o], u = e + a, l = Math.abs(e) < Math.abs(a) ? e - (u - a) : a - (u - e);
      l && (t[r++] = l), e = u;
    }
...
function dh(n) {
  return Array.from(bv(n));
}
var Xe = 1e-6, Ae = Math.PI, Dt = Ae / 2, el = Ae / 4, Ut = Ae * 2, an = 180 / Ae, It = Ae / 180, je = Math.abs, Mv = Math.atan, hr = Math.atan2, $e = Math.cos, Ve = Math.sin, Lv = Math.sign || function(n) {
...
function fr(n) {
  return n > 1 ? Dt : n < -1 ? -Dt : Math.asin(n);
}
function zr() {
}
function es(n, e) {
  n && nl.hasOwnProperty(n.type) && nl[n.type](n, e);
}
var tl = {
  ...
  FeatureCollection: function(n, e) {
    for (var t = n.features, r = -1, o = t.length; ++r < o; ) es(t[r].geometry, e);
  }
}, nl = {
  Sphere: function(n, e) {
    e.sphere();
  ...
  LineString: function(n, e) {
    Io(n.coordinates, e, 0);
  },
  MultiLineString: function(n, e) {
    for (var t = n.coordinates, r = -1, o = t.length; ++r < o; ) Io(t[r], e, 0);
  },
  Polygon: function(n, e) {
    rl(n.coordinates, e);
  },
  MultiPolygon: function(n, e) {
    for (var t = n.coordinates, r = -1, o = t.length; ++r < o; ) rl(t[r], e);
  },
  GeometryCollection: function(n, e) {
    for (var t = n.geometries, r = -1, o = t.length; ++r < o; ) es(t[r], e);
  }
};
function Io(n, e, t) {
...
function rl(n, e) {
  var t = -1, r = n.length;
  for (e.polygonStart(); ++t < r; ) Io(n[t], e, 1);
  e.polygonEnd();
}
function Pv(n, e) {
  n && tl.hasOwnProperty(n.type) ? tl[n.type](n, e) : es(n, e);
}
function ko(n) {
  return [hr(n[1], n[0]), fr(n[2])];
}
function gr(n) {
...
function Lo(n, e) {
  return [je(n) > Ae ? n + Math.round(-n / Ut) * Ut : n, e];
}
Lo.invert = Lo;
function Nv(n, e, t) {
  return (n %= Ut) ? e || t ? Mo(sl(n), ol(e, t)) : sl(n) : e || t ? ol(e, t) : Lo;
}
function il(n) {
  return function(e, t) {
    return e += n, [e > Ae ? e - Ut : e < -Ae ? e + Ut : e, t];
  };
}
function sl(n) {
  var e = il(n);
  return e.invert = il(-n), e;
}
function ol(n, e) {
  var t = $e(n), r = Ve(n), o = $e(e), a = Ve(e);
  function u(l, f) {
    var g = $e(f), v = $e(l) * g, m = Ve(l) * g, p = Ve(f), _ = p * t + v * r;
    return [
      hr(m * o - _ * a, v * t - p * r),
      fr(_ * o + m * a)
    ];
  }
  return u.invert = function(l, f) {
    var g = $e(f), v = $e(l) * g, m = Ve(l) * g, p = Ve(f), _ = p * o - m * a;
    return [
      hr(m * o + p * a, v * t + _ * r),
      fr(_ * t - v * r)
    ];
...
function Tv(n, e, t, r, o, a) {
  if (t) {
    var u = $e(e), l = Ve(e), f = r * t;
    o == null ? (o = e + r * Ut, a = e - f / 2) : (o = al(u, o), a = al(u, a), (r > 0 ? o < a : o > a) && (o += r * Ut));
    for (var g, v = o; r > 0 ? v > a : v < a; v -= f)
      g = ko([u, -l * $e(v), -l * Ve(v)]), n.point(g[0], g[1]);
  }
}
function al(n, e) {
  e = gr(e), e[0] -= n, bo(e);
  var t = mh(-e[1]);
  return ((-e[2] < 0 ? -t : t) + Ut - Xe) % Ut;
}
function vh() {
  var n = [], e;
  return {
...
function yh(n, e, t, r, o) {
  ...
  if (n.forEach(function(w) {
    if (!((S = w.length - 1) <= 0)) {
      ...
      if (Yi(L, b)) {
        if (!L[2] && !b[2]) {
          for (o.lineStart(), l = 0; l < S; ++l) o.point((L = w[l])[0], L[1]);
          o.lineEnd();
          return;
        }
        b[0] += 2 * Xe;
      }
      a.push(k = new Ti(L, w, null, !0)), u.push(k.o = new Ti(L, null, k, !1)), a.push(k = new Ti(b, w, null, !1)), u.push(k.o = new Ti(b, null, k, !0));
    }
  }), !!a.length) {
    for (u.sort(e), ul(a), ul(u), l = 0, f = u.length; l < f; ++l)
      u[l].e = t = !t;
    for (var g = a[0], v, m; ; ) {
      ...
      do {
        if (p.v = p.o.v = !0, p.e) {
          if (_)
            for (l = 0, f = v.length; l < f; ++l) o.point((m = v[l])[0], m[1]);
          else
            r(p.x, p.n.x, 1, o);
          p = p.n;
        } else {
          if (_)
            for (v = p.p.z, l = v.length - 1; l >= 0; --l) o.point((m = v[l])[0], m[1]);
          else
            r(p.x, p.p.x, -1, o);
          p = p.p;
        }
...
function lo(n) {
  return je(n[0]) <= Ae ? n[0] : Lv(n[0]) * ((je(n[0]) + Ae) % Ut - Ae);
}
function Rv(n, e) {
  var t = lo(e), r = e[1], o = Ve(r), a = [Ve(t), -$e(t), 0], u = 0, l = 0, f = new kv();
  o === 1 ? r = Dt + Xe : o === -1 && (r = -Dt - Xe);
  for (var g = 0, v = n.length; g < v; ++g)
    if (p = (m = n[g]).length)
      for (var m, p, _ = m[p - 1], w = lo(_), S = _[1] / 2 + el, L = Ve(S), b = $e(S), k = 0; k < p; ++k, w = A, L = Y, b = V, _ = N) {
        var N = m[k], A = lo(N), O = N[1] / 2 + el, Y = Ve(O), V = $e(O), C = A - w, M = C >= 0 ? 1 : -1, T = M * C, D = T > Ae, B = L * Y;
        if (f.add(hr(B * M * Ve(T), b * V + B * $e(T))), u += D ? C + M * Ut : C, D ^ w >= t ^ A >= t) {
          var z = ts(gr(_), gr(N));
          bo(z);
          var X = ts(a, z);
          bo(X);
          var R = (D ^ C >= 0 ? -1 : 1) * fr(X[2]);
          (r > R || r === R && (z[0] || z[1])) && (l += D ^ C >= 0 ? 1 : -1);
        }
      }
  return (u < -Xe || u < Xe && f < -1e-12) ^ l & 1;
}
function ph(n, e, t, r) {
  return function(o) {
    var a = e(o), u = vh(), l = e(u), f = !1, g, v, m, p = {
      point: _,
      lineStart: S,
      lineEnd: L,
      polygonStart: function() {
        p.point = b, p.lineStart = k, p.lineEnd = N, v = [], g = [];
      },
      polygonEnd: function() {
        p.point = _, p.lineStart = S, p.lineEnd = L, v = dh(v);
        var A = Rv(g, r);
        v.length ? (f || (o.polygonStart(), f = !0), yh(v, Ov, A, t, o)) : A && (f || (o.polygonStart(), f = !0), o.lineStart(), t(null, null, 1, o), o.lineEnd()), f && (o.polygonEnd(), f = !1), v = g = null;
      },
      sphere: function() {
    ...
    function b(A, O) {
      m.push([A, O]), l.point(A, O);
    }
    function k() {
      l.lineStart(), m = [];
    }
    function N() {
      b(m[0][0], m[0][1]), l.lineEnd();
      var A = l.clean(), O = u.result(), Y, V = O.length, C, M, T;
      if (m.pop(), g.push(m), m = null, !!V) {
        ...
        V > 1 && A & 2 && O.push(O.pop().concat(O.shift())), v.push(O.filter(Av));
      }
    }
    return p;
  };
...
function Ov(n, e) {
  return ((n = n.x)[0] < 0 ? n[1] - Dt - Xe : Dt - n[1]) - ((e = e.x)[0] < 0 ? e[1] - Dt - Xe : Dt - e[1]);
}
const ll = ph(
  function() {
    return !0;
...
function Dv(n) {
  ...
  return {
    ...
    point: function(a, u) {
      var l = a > 0 ? Ae : -Ae, f = je(a - e);
      je(f - Ae) < Xe ? (n.point(e, t = (t + u) / 2 > 0 ? Dt : -Dt), n.point(r, t), n.lineEnd(), n.lineStart(), n.point(l, t), n.point(a, t), o = 0) : r !== l && f >= Ae && (je(e - r) < Xe && (e -= r * Xe), je(a - l) < Xe && (a -= l * Xe), t = Fv(e, t, a, u), n.point(r, t), n.lineEnd(), n.lineStart(), n.point(l, t), o = 0), n.point(e = a, t = u), r = l;
    },
    lineEnd: function() {
      n.lineEnd(), e = t = NaN;
    },
...
function Fv(n, e, t, r) {
  var o, a, u = Ve(n - t);
  return je(u) > Xe ? Mv((Ve(e) * (a = $e(r)) * Ve(t) - Ve(r) * (o = $e(e)) * Ve(n)) / (o * a * u)) : (e + r) / 2;
}
function Bv(n, e, t, r) {
  var o;
  if (n == null)
    o = t * Dt, r.point(-Ae, o), r.point(0, o), r.point(Ae, o), r.point(Ae, 0), r.point(Ae, -o), r.point(0, -o), r.point(-Ae, -o), r.point(-Ae, 0), r.point(-Ae, o);
...
function Gv(n) {
  ...
  function l(v) {
    ...
    return {
      ...
      point: function(L, b) {
        var k = [L, b], N, A = u(L, b), O = r ? A ? 0 : g(L, b) : A ? g(L + (L < 0 ? Ae : -Ae), b) : 0;
        if (!m && (w = _ = A) && v.lineStart(), A !== _ && (N = f(m, k), (!N || Yi(m, N) || Yi(k, N)) && (k[2] = 1)), A !== _)
          S = 0, A ? (v.lineStart(), N = f(k, m), v.point(N[0], N[1])) : (N = f(m, k), v.point(N[0], N[1], 2), v.lineEnd()), m = N;
        else if (o && m && r ^ A) {
          var Y;
          !(O & p) && (Y = f(k, m, !0)) && (S = 0, r ? (v.lineStart(), v.point(Y[0][0], Y[0][1]), v.point(Y[1][0], Y[1][1]), v.lineEnd()) : (v.point(Y[1][0], Y[1][1]), v.lineEnd(), v.lineStart(), v.point(Y[0][0], Y[0][1], 3)));
        }
        A && (!m || !Yi(m, k)) && v.point(k[0], k[1]), m = k, _ = A, p = O;
      },
      lineEnd: function() {
        _ && v.lineEnd(), m = null;
      },
  ...
  function f(v, m, p) {
    var _ = gr(v), w = gr(m), S = [1, 0, 0], L = ts(_, w), b = Pi(L, L), k = L[0], N = b - k * k;
    if (!N) return !p && v;
    var A = e * b / N, O = -e * k / N, Y = ts(S, L), V = Ni(S, A), C = Ni(L, O);
    uo(V, C);
    var M = Y, T = Pi(V, M), D = Pi(M, M), B = T * T - D * (Pi(V, V) - 1);
    if (!(B < 0)) {
      var z = fi(B), X = Ni(M, (-T - z) / D);
      if (uo(X, V), X = ko(X), !p) return X;
  ...
  return ph(u, l, a, r ? [0, -n] : [-Ae, n - Ae]);
}
function zv(n, e, t, r, o, a) {
  var u = n[0], l = n[1], f = e[0], g = e[1], v = 0, m = 1, p = f - u, _ = g - l, w;
  if (w = t - u, !(!p && w > 0)) {
    if (w /= p, p < 0) {
      if (w < v) return;
      w < m && (m = w);
    ...
    if (w = o - u, !(!p && w < 0)) {
      ...
      if (w = r - l, !(!_ && w > 0)) {
        ...
        if (w = a - l, !(!_ && w < 0)) {
          ...
          return v > 0 && (n[0] = u + v * p, n[1] = l + v * _), m < 1 && (e[0] = u + m * p, e[1] = l + m * _), !0;
        }
      }
    }
  }
...
function qv(n, e, t, r) {
  ...
  return function(g) {
    var v = g, m = vh(), p, _, w, S, L, b, k, N, A, O, Y, V = {
      point: C,
      lineStart: B,
      lineEnd: z,
      polygonStart: T,
    ...
    function D() {
      var R = M(), U = Y && R, G = (p = dh(p)).length;
      (U || G) && (g.polygonStart(), U && (g.lineStart(), a(null, null, 1, g), g.lineEnd()), G && yh(p, l, R, a, g), g.polygonEnd()), v = g, p = _ = w = null;
    }
    function B() {
      V.point = X, _ && _.push(w = []), O = !0, A = !1, k = N = NaN;
    }
    function z() {
      p && (X(S, L), b && A && m.rejoin(), p.push(m.result())), V.point = C, A && v.lineEnd();
    }
    function X(R, U) {
      var G = o(R, U);
      if (_ && w.push([R, U]), O)
        S = R, L = U, b = G, O = !1, G && (v.lineStart(), v.point(R, U));
      else if (G && A) v.point(R, U);
      else {
        var H = [k = Math.max(Ri, Math.min(qr, k)), N = Math.max(Ri, Math.min(qr, N))], J = [R = Math.max(Ri, Math.min(qr, R)), U = Math.max(Ri, Math.min(qr, U))];
        zv(H, J, n, e, t, r) ? (A || (v.lineStart(), v.point(H[0], H[1])), v.point(J[0], J[1]), G || v.lineEnd(), Y = !1) : G && (v.lineStart(), v.point(R, U), Y = !1);
      }
      k = R, N = U, A = G;
    }
    return V;
...
const cl = (n) => n;
var dr = 1 / 0, ns = dr, Jr = -dr, rs = Jr, hl = {
  point: Uv,
  lineStart: zr,
  lineEnd: zr,
  polygonStart: zr,
  ...
  result: function() {
    var n = [[dr, ns], [Jr, rs]];
    return Jr = rs = -(ns = dr = 1 / 0), n;
  }
};
function Uv(n, e) {
  n < dr && (dr = n), n > Jr && (Jr = n), e < ns && (ns = e), e > rs && (rs = e);
}
function ha(n) {
  return function(e) {
    var t = new Po();
...
function fa(n, e, t) {
  ...
  return n.scale(150).translate([0, 0]), r != null && n.clipExtent(null), Pv(t, n.stream(hl)), e(hl.result()), r != null && n.clipExtent(r), n;
}
function _h(n, e, t) {
  return fa(n, function(r) {
    var o = e[1][0] - e[0][0], a = e[1][1] - e[0][1], u = Math.min(o / (r[1][0] - r[0][0]), a / (r[1][1] - r[0][1])), l = +e[0][0] + (o - u * (r[1][0] + r[0][0])) / 2, f = +e[0][1] + (a - u * (r[1][1] + r[0][1])) / 2;
    n.scale(150 * u).translate([l, f]);
  }, t);
}
function Yv(n, e, t) {
  return _h(n, [[0, 0], e], t);
...
function Xv(n, e, t) {
  return fa(n, function(r) {
    var o = +e, a = o / (r[1][0] - r[0][0]), u = (o - a * (r[1][0] + r[0][0])) / 2, l = -a * r[0][1];
    n.scale(150 * a).translate([u, l]);
  }, t);
}
function Vv(n, e, t) {
  return fa(n, function(r) {
    var o = +e, a = o / (r[1][1] - r[0][1]), u = -a * r[0][0], l = (o - a * (r[1][1] + r[0][1])) / 2;
    n.scale(150 * a).translate([u, l]);
  }, t);
}
var fl = 16, Hv = $e(30 * It);
function gl(n, e) {
  return +e ? $v(n, e) : Wv(n);
}
function Wv(n) {
...
function $v(n, e) {
  function t(r, o, a, u, l, f, g, v, m, p, _, w, S, L) {
    var b = g - r, k = v - o, N = b * b + k * k;
    if (N > 4 * e && S--) {
      var A = u + p, O = l + _, Y = f + w, V = fi(A * A + O * O + Y * Y), C = fr(Y /= V), M = je(je(Y) - 1) < Xe || je(a - m) < Xe ? (a + m) / 2 : hr(O, A), T = n(M, C), D = T[0], B = T[1], z = D - r, X = B - o, R = k * z - b * X;
      (R * R / N > e || je((b * z + k * X) / N - 0.5) > 0.3 || u * p + l * _ + f * w < Hv) && (t(r, o, a, u, l, f, D, B, M, A /= V, O /= V, Y, S, L), L.point(D, B), t(D, B, M, A, O, Y, g, v, m, p, _, w, S, L));
    }
  }
  return function(r) {
    var o, a, u, l, f, g, v, m, p, _, w, S, L = {
      point: b,
      lineStart: k,
      lineEnd: A,
      polygonStart: function() {
    ...
    function N(C, M) {
      var T = gr([C, M]), D = n(C, M);
      t(m, p, v, _, w, S, m = D[0], p = D[1], v = C, _ = T[0], w = T[1], S = T[2], fl, r), r.point(m, p);
    }
    function A() {
      L.point = b, r.lineEnd();
    }
    function O() {
      k(), L.point = Y, L.lineEnd = V;
    }
    function Y(C, M) {
      N(o = C, M), a = m, u = p, l = _, f = w, g = S, L.point = N;
    }
    function V() {
      t(m, p, v, _, w, S, a, u, o, l, f, g, fl, r), L.lineEnd = A, A();
    }
    return L;
  };
}
...
function Jv(n, e, t, r, o) {
  function a(u, l) {
    return u *= r, l *= o, [e + n * u, t - n * l];
  }
  return a.invert = function(u, l) {
    return [(u - e) / n * r, (t - l) / n * o];
  }, a;
}
function dl(n, e, t, r, o, a) {
  if (!a) return Jv(n, e, t, r, o);
  var u = $e(a), l = Ve(a), f = u * n, g = l * n, v = u / n, m = l / n, p = (l * t - u * e) / n, _ = (l * e + u * t) / n;
  function w(S, L) {
    return S *= r, L *= o, [f * S - g * L + e, t - g * S - f * L];
  }
  return w.invert = function(S, L) {
    return [r * (v * S - m * L + p), o * (_ - m * S - v * L)];
  }, w;
}
function Qv(n) {
  return jv(function() {
...
function jv(n) {
  var e, t = 150, r = 480, o = 250, a = 0, u = 0, l = 0, f = 0, g = 0, v, m = 0, p = 1, _ = 1, w = null, S = ll, L = null, b, k, N, A = cl, O = 0.5, Y, V, C, M, T;
  function D(R) {
    return C(R[0] * It, R[1] * It);
  }
  function B(R) {
    return R = C.invert(R[0], R[1]), R && [R[0] * an, R[1] * an];
  }
  D.stream = function(R) {
    return M && T === R ? M : M = Zv(Kv(v)(S(Y(A(T = R)))));
  }, D.preclip = function(R) {
    return arguments.length ? (S = R, w = void 0, X()) : S;
  }, D.postclip = function(R) {
    return arguments.length ? (A = R, L = b = k = N = null, X()) : A;
  }, D.clipAngle = function(R) {
    return arguments.length ? (S = +R ? Gv(w = R * It) : (w = null, ll), X()) : w * an;
  }, D.clipExtent = function(R) {
    return arguments.length ? (A = R == null ? (L = b = k = N = null, cl) : qv(L = +R[0][0], b = +R[0][1], k = +R[1][0], N = +R[1][1]), X()) : L == null ? null : [[L, b], [k, N]];
  }, D.scale = function(R) {
    return arguments.length ? (t = +R, z()) : t;
  }, D.translate = function(R) {
    return arguments.length ? (r = +R[0], o = +R[1], z()) : [r, o];
  }, D.center = function(R) {
    return arguments.length ? (a = R[0] % 360 * It, u = R[1] % 360 * It, z()) : [a * an, u * an];
  }, D.rotate = function(R) {
    return arguments.length ? (l = R[0] % 360 * It, f = R[1] % 360 * It, g = R.length > 2 ? R[2] % 360 * It : 0, z()) : [l * an, f * an, g * an];
  }, D.angle = function(R) {
    return arguments.length ? (m = R % 360 * It, z()) : m * an;
  }, D.reflectX = function(R) {
    return arguments.length ? (p = R ? -1 : 1, z()) : p < 0;
  }, D.reflectY = function(R) {
    return arguments.length ? (_ = R ? -1 : 1, z()) : _ < 0;
  }, D.precision = function(R) {
    return arguments.length ? (Y = gl(V, O = R * R), X()) : fi(O);
  ...
  function z() {
    var R = dl(t, 0, 0, p, _, m).apply(null, e(a, u)), U = dl(t, r - R[0], o - R[1], p, _, m);
    return v = Nv(l, f, g), V = Mo(e, U), C = Mo(v, V), Y = gl(V, O), X();
  }
  function X() {
    return M = T = null, D;
  }
  return function() {
    return e = n.apply(this, arguments), D.invert = e.invert && B, z();
  };
}
function e0(n) {
  return function(e, t) {
...
function t0(n) {
  return function(e, t) {
    var r = fi(e * e + t * t), o = n(r), a = Ve(o), u = $e(o);
    return [
      hr(e * a, r * u),
      fr(r && t * a / r)
    ];
...
var wh = e0(function(n) {
  return (n = mh(n)) && n / Ve(n);
});
wh.invert = t0(function(n) {
  return n;
});
function n0() {
  return Qv(wh).scale(79.4188).clipAngle(180 - 1e-3);
}
var { BufferOp: r0, GeoJSONReader: i0, GeoJSONWriter: s0 } = Iv;
function o0(n, e, t) {
  t = t || {};
...
function Xi(n, e, t, r) {
  ...
  var l = a0(a), f = {
    type: a.type,
    coordinates: Eh(a.coordinates, l)
  }, g = new i0(), v = g.read(f), m = si(vr(e, t), "meters"), p = r0.bufferOp(v, m, r), _ = new s0();
  if (p = _.write(p), !xh(p.coordinates)) {
    var w = {
      type: p.type,
      coordinates: Ch(p.coordinates, l)
    };
    return Je(w, o);
  }
}
function xh(n) {
  return Array.isArray(n[0]) ? xh(n[0]) : isNaN(n[0]);
}
function Eh(n, e) {
...
function a0(n) {
  var e = ys(n).geometry.coordinates, t = [-e[0], -e[1]];
  return n0().rotate(t).scale(Be);
}
function ga(n, e = {}) {
  let t = 0, r = 0, o = 0;
  return at(n, function(a, u, l) {
    let f = e.weight ? l == null ? void 0 : l[e.weight] : void 0;
    if (f = f ?? 1, !et(f))
      throw new Error(
...
function u0(n, e = {}) {
  ...
  var r = e.weight, o = ga(n, { weight: e.weight }), a = ce([]);
  Le(n, function(l) {
    var f;
    a.features.push(
      Ft(l, {
        properties: { weight: (f = l.properties) == null ? void 0 : f[r] }
      })
    );
  });
  const u = {
...
function Sh(n, e, t, r, o) {
  var a = r.tolerance || 1e-3, u = 0, l = 0, f = 0, g = 0;
  if (Le(t, function(p) {
    var _, w = (_ = p.properties) == null ? void 0 : _.weight, S = w ?? 1;
    if (S = Number(S), !et(S)) throw new Error("weight value must be a number");
    if (S > 0) {
      g += 1;
      var L = S * ze(p, n);
      L === 0 && (L = 1);
      var b = S / L;
      u += p.geometry.coordinates[0] * b, l += p.geometry.coordinates[1] * b, f += b;
    }
  ...
  }) : (r.medianCandidates.push([v, m]), Sh(
    [v, m],
    n,
    t,
    r,
...
var da = { exports: {} };
const l0 = /* @__PURE__ */ ch(mm), c0 = /* @__PURE__ */ ch(Em);
var ps = { exports: {} }, h0 = function(e, t, r, o) {
  var a = e[0], u = e[1], l = !1;
  r === void 0 && (r = 0), o === void 0 && (o = t.length);
  for (var f = (o - r) / 2, g = 0, v = f - 1; g < f; v = g++) {
    var m = t[r + g * 2 + 0], p = t[r + g * 2 + 1], _ = t[r + v * 2 + 0], w = t[r + v * 2 + 1], S = p > u != w > u && a < (_ - m) * (u - p) / (w - p) + m;
    S && (l = !l);
  }
  return l;
}, f0 = function(e, t, r, o) {
  ...
  for (var f = o - r, g = 0, v = f - 1; g < f; v = g++) {
    var m = t[g + r][0], p = t[g + r][1], _ = t[v + r][0], w = t[v + r][1], S = p > u != w > u && a < (_ - m) * (u - p) / (w - p) + m;
    S && (l = !l);
  }
  return l;
}, Ih = h0, kh = f0;
ps.exports = function(e, t, r, o) {
  return t.length > 0 && Array.isArray(t[0]) ? kh(e, t, r, o) : Ih(e, t, r, o);
};
ps.exports.nested = kh;
ps.exports.flat = Ih;
var g0 = ps.exports, No = { exports: {} };
(function(n, e) {
  (function(t, r) {
    r(e);
  })(lh, function(t) {
    const o = 33306690738754706e-32;
    function a(S, L, b, k, N) {
      let A, O, Y, V, C = L[0], M = k[0], T = 0, D = 0;
      M > C == M > -C ? (A = C, C = L[++T]) : (A = M, M = k[++D]);
      let B = 0;
      if (T < S && D < b) for (M > C == M > -C ? (Y = A - ((O = C + A) - C), C = L[++T]) : (Y = A - ((O = M + A) - M), M = k[++D]), A = O, Y !== 0 && (N[B++] = Y); T < S && D < b; ) M > C == M > -C ? (Y = A - ((O = A + C) - (V = O - A)) + (C - V), C = L[++T]) : (Y = A - ((O = A + M) - (V = O - A)) + (M - V), M = k[++D]), A = O, Y !== 0 && (N[B++] = Y);
      for (; T < S; ) Y = A - ((O = A + C) - (V = O - A)) + (C - V), C = L[++T], A = O, Y !== 0 && (N[B++] = Y);
      for (; D < b; ) Y = A - ((O = A + M) - (V = O - A)) + (M - V), M = k[++D], A = O, Y !== 0 && (N[B++] = Y);
      return A === 0 && B !== 0 || (N[B++] = A), B;
    }
    function u(S) {
      return new Float64Array(S);
    }
    const l = 33306690738754716e-32, f = 22204460492503146e-32, g = 11093356479670487e-47, v = u(4), m = u(8), p = u(12), _ = u(16), w = u(4);
    t.orient2d = function(S, L, b, k, N, A) {
      const O = (L - A) * (b - N), Y = (S - N) * (k - A), V = O - Y;
      if (O === 0 || Y === 0 || O > 0 != Y > 0) return V;
      const C = Math.abs(O + Y);
      return Math.abs(V) >= l * C ? V : -function(M, T, D, B, z, X, R) {
        let U, G, H, J, W, j, Q, re, ee, te, se, fe, Z, Fe, _e, ae, q, be;
        const Ne = M - z, Ce = D - z, pt = T - X, gt = B - X;
        W = (_e = (re = Ne - (Q = (j = 134217729 * Ne) - (j - Ne))) * (te = gt - (ee = (j = 134217729 * gt) - (j - gt))) - ((Fe = Ne * gt) - Q * ee - re * ee - Q * te)) - (se = _e - (q = (re = pt - (Q = (j = 134217729 * pt) - (j - pt))) * (te = Ce - (ee = (j = 134217729 * Ce) - (j - Ce))) - ((ae = pt * Ce) - Q * ee - re * ee - Q * te))), v[0] = _e - (se + W) + (W - q), W = (Z = Fe - ((fe = Fe + se) - (W = fe - Fe)) + (se - W)) - (se = Z - ae), v[1] = Z - (se + W) + (W - ae), W = (be = fe + se) - fe, v[2] = fe - (be - W) + (se - W), v[3] = be;
        let Yt = function(Ps, Ee) {
          let mn = Ee[0];
          for (let vn = 1; vn < Ps; vn++) mn += Ee[vn];
          return mn;
        }(4, v), ie = f * R;
        if (Yt >= ie || -Yt >= ie || (U = M - (Ne + (W = M - Ne)) + (W - z), H = D - (Ce + (W = D - Ce)) + (W - z), G = T - (pt + (W = T - pt)) + (W - X), J = B - (gt + (W = B - gt)) + (W - X), U === 0 && G === 0 && H === 0 && J === 0) || (ie = g * R + o * Math.abs(Yt), (Yt += Ne * J + gt * U - (pt * H + Ce * G)) >= ie || -Yt >= ie)) return Yt;
        W = (_e = (re = U - (Q = (j = 134217729 * U) - (j - U))) * (te = gt - (ee = (j = 134217729 * gt) - (j - gt))) - ((Fe = U * gt) - Q * ee - re * ee - Q * te)) - (se = _e - (q = (re = G - (Q = (j = 134217729 * G) - (j - G))) * (te = Ce - (ee = (j = 134217729 * Ce) - (j - Ce))) - ((ae = G * Ce) - Q * ee - re * ee - Q * te))), w[0] = _e - (se + W) + (W - q), W = (Z = Fe - ((fe = Fe + se) - (W = fe - Fe)) + (se - W)) - (se = Z - ae), w[1] = Z - (se + W) + (W - ae), W = (be = fe + se) - fe, w[2] = fe - (be - W) + (se - W), w[3] = be;
        const gi = a(4, v, 4, w, m);
        W = (_e = (re = Ne - (Q = (j = 134217729 * Ne) - (j - Ne))) * (te = J - (ee = (j = 134217729 * J) - (j - J))) - ((Fe = Ne * J) - Q * ee - re * ee - Q * te)) - (se = _e - (q = (re = pt - (Q = (j = 134217729 * pt) - (j - pt))) * (te = H - (ee = (j = 134217729 * H) - (j - H))) - ((ae = pt * H) - Q * ee - re * ee - Q * te))), w[0] = _e - (se + W) + (W - q), W = (Z = Fe - ((fe = Fe + se) - (W = fe - Fe)) + (se - W)) - (se = Z - ae), w[1] = Z - (se + W) + (W - ae), W = (be = fe + se) - fe, w[2] = fe - (be - W) + (se - W), w[3] = be;
        const di = a(gi, m, 4, w, p);
        W = (_e = (re = U - (Q = (j = 134217729 * U) - (j - U))) * (te = J - (ee = (j = 134217729 * J) - (j - J))) - ((Fe = U * J) - Q * ee - re * ee - Q * te)) - (se = _e - (q = (re = G - (Q = (j = 134217729 * G) - (j - G))) * (te = H - (ee = (j = 134217729 * H) - (j - H))) - ((ae = G * H) - Q * ee - re * ee - Q * te))), w[0] = _e - (se + W) + (W - q), W = (Z = Fe - ((fe = Fe + se) - (W = fe - Fe)) + (se - W)) - (se = Z - ae), w[1] = Z - (se + W) + (W - ae), W = (be = fe + se) - fe, w[2] = fe - (be - W) + (se - W), w[3] = be;
        const nn = a(di, p, 4, w, _);
        return _[nn - 1];
      }(S, L, b, k, N, A, C);
    }, t.orient2dfast = function(S, L, b, k, N, A) {
      return (L - A) * (b - N) - (S - N) * (k - A);
    }, Object.defineProperty(t, "__esModule", { value: !0 });
  });
})(No, No.exports);
var d0 = No.exports, ml = l0, Vi = c0, m0 = g0, v0 = d0.orient2d;
Vi.default && (Vi = Vi.default);
da.exports = bh;
da.exports.default = bh;
function bh(n, e, t) {
  e = Math.max(0, e === void 0 ? 2 : e), t = t || 0;
  var r = x0(n), o = new ml(16);
  o.toBBox = function(k) {
    return {
      minX: k[0],
      minY: k[1],
  ...
  }, o.compareMinX = function(k, N) {
    return k[0] - N[0];
  }, o.compareMinY = function(k, N) {
    return k[1] - N[1];
  }, o.load(n);
  for (var a = [], u = 0, l; u < r.length; u++) {
    var f = r[u];
    o.remove(f), l = pl(f, l), a.push(l);
  }
  var g = new ml(16);
  for (u = 0; u < a.length; u++) g.insert(co(a[u]));
  for (var v = e * e, m = t * t; a.length; ) {
    var p = a.shift(), _ = p.p, w = p.next.p, S = ho(_, w);
    if (!(S < m)) {
      var L = S / v;
      f = y0(o, p.prev.p, _, w, p.next.next.p, L, g), f && Math.min(ho(f, _), ho(f, w)) <= L && (a.push(p), a.push(pl(f, p)), o.remove(f), g.remove(p), g.insert(co(p)), g.insert(co(p.next)));
    }
  }
  p = l;
  var b = [];
...
function y0(n, e, t, r, o, a, u) {
  for (var l = new Vi([], p0), f = n.data; f; ) {
    for (var g = 0; g < f.children.length; g++) {
      var v = f.children[g], m = f.leaf ? fo(v, t, r) : _0(t, r, v);
      m > a || l.push({
        node: v,
        dist: m
      });
    ...
    for (; l.length && !l.peek().node.children; ) {
      var p = l.pop(), _ = p.node, w = fo(_, e, t), S = fo(_, r, o);
      if (p.dist < w && p.dist < S && yl(t, _, u) && yl(r, _, u)) return _;
    }
    f = l.pop(), f && (f = f.node);
  }
  return null;
...
function _0(n, e, t) {
  if (vl(n, t) || vl(e, t)) return 0;
  var r = Ai(n[0], n[1], e[0], e[1], t.minX, t.minY, t.maxX, t.minY);
  if (r === 0) return 0;
  var o = Ai(n[0], n[1], e[0], e[1], t.minX, t.minY, t.minX, t.maxY);
  if (o === 0) return 0;
  var a = Ai(n[0], n[1], e[0], e[1], t.maxX, t.minY, t.maxX, t.maxY);
  if (a === 0) return 0;
  var u = Ai(n[0], n[1], e[0], e[1], t.minX, t.maxY, t.maxX, t.maxY);
...
function yl(n, e, t) {
  for (var r = Math.min(n[0], e[0]), o = Math.min(n[1], e[1]), a = Math.max(n[0], e[0]), u = Math.max(n[1], e[1]), l = t.search({ minX: r, minY: o, maxX: a, maxY: u }), f = 0; f < l.length; f++)
    if (w0(l[f].p, l[f].next.p, n, e)) return !1;
  return !0;
}
function tr(n, e, t) {
  return v0(n[0], n[1], e[0], e[1], t[0], t[1]);
}
function w0(n, e, t, r) {
  return n !== r && e !== t && tr(n, e, t) > 0 != tr(n, e, r) > 0 && tr(t, r, n) > 0 != tr(t, r, e) > 0;
}
function co(n) {
...
function fo(n, e, t) {
  ...
  if (a !== 0 || u !== 0) {
    var l = ((n[0] - r) * a + (n[1] - o) * u) / (a * a + u * u);
    l > 1 ? (r = t[0], o = t[1]) : l > 0 && (r += a * l, o += u * l);
  }
  return a = n[0] - r, u = n[1] - o, a * a + u * u;
}
function Ai(n, e, t, r, o, a, u, l) {
  var f = t - n, g = r - e, v = u - o, m = l - a, p = n - o, _ = e - a, w = f * f + g * g, S = f * v + g * m, L = v * v + m * m, b = f * p + g * _, k = v * p + m * _, N = w * L - S * S, A, O, Y, V, C = N, M = N;
  N === 0 ? (O = 0, C = 1, V = k, M = L) : (O = S * k - L * b, V = w * k - S * b, O < 0 ? (O = 0, V = k, M = L) : O > C && (O = C, V = k + S, M = L)), V < 0 ? (V = 0, -b < 0 ? O = 0 : -b > w ? O = C : (O = -b, C = w)) : V > M && (V = M, -b + S < 0 ? O = 0 : -b + S > w ? O = C : (O = -b + S, C = w)), A = O === 0 ? 0 : O / C, Y = V === 0 ? 0 : V / M;
  var T = (1 - A) * n + A * t, D = (1 - A) * e + A * r, B = (1 - Y) * o + Y * u, z = (1 - Y) * a + Y * l, X = B - T, R = z - D;
  return X * X + R * R;
}
function E0(n, e) {
...
function C0(n) {
  ...
  for (var e = [], t = 0; t < n.length; t++) {
    for (; e.length >= 2 && tr(e[e.length - 2], e[e.length - 1], n[t]) <= 0; )
      e.pop();
    e.push(n[t]);
  }
  for (var r = [], o = n.length - 1; o >= 0; o--) {
    for (; r.length >= 2 && tr(r[r.length - 2], r[r.length - 1], n[o]) <= 0; )
      r.pop();
    r.push(n[o]);
  }
...
function Lh(n, e = {}) {
  switch (xt(n)) {
    ...
    case "Polygon":
      ...
      var r = Ft(n, { properties: e.properties }), o = r.geometry.coordinates, a = 0, u = 0, l = 0, f, g, v, m, p, _, w, S, L = t.map(function(A) {
        return [A[0] - o[0], A[1] - o[1]];
      });
      for (f = 0; f < t.length - 1; f++)
        g = L[f], m = g[0], _ = g[1], v = L[f + 1], p = v[0], w = v[1], S = m * w - p * _, l += S, a += (m + p) * S, u += (_ + w) * S;
      if (l === 0)
        return r;
      var b = l * 0.5, k = 1 / (6 * b);
      return de(
    ...
    default:
      var N = Mh(n);
      return N ? Lh(N, { properties: e.properties }) : Ft(n, { properties: e.properties });
  }
}
function ma(n, e, t = {}) {
  ...
  for (let u = 0; u < r; u++)
    a.push(
      en(n, e, u * -360 / r, t).geometry.coordinates
    );
...
function Ph(n) {
  ...
  }), e.properties = _s(n.properties), n.geometry == null ? e.geometry = null : e.geometry = va(n.geometry), e;
}
function _s(n) {
  const e = {};
  return n && Object.keys(n).forEach((t) => {
    const r = n[t];
    typeof r == "object" ? r === null ? e[t] = null : Array.isArray(r) ? e[t] = r.map((o) => o) : e[t] = _s(r) : e[t] = r;
  }), e;
}
function k0(n) {
  ...
  }), e.features = n.features.map((t) => Ph(t)), e;
}
function va(n) {
  const e = { type: n.type };
  return n.bbox && (e.bbox = n.bbox), n.type === "GeometryCollection" ? (e.geometries = n.geometries.map((t) => va(t)), e) : (e.coordinates = Nh(n.coordinates), e);
}
function Nh(n) {
  const e = n;
  return typeof e[0] != "object" ? e.slice() : e.map((t) => Nh(t));
}
function Th(n, e) {
  if (!n) throw new Error("geojson is required");
  if (n.type !== "FeatureCollection")
...
function ya(n, e, t) {
  ...
  for (var r = pa(n, e), o = Object.keys(r), a = 0; a < o.length; a++) {
    for (var u = o[a], l = r[u], f = [], g = 0; g < l.length; g++)
      f.push(n.features[l[g]]);
    t(ce(f), u, a);
  }
}
function Rh(n, e, t, r) {
...
const b0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  filterProperties: Ah,
  getCluster: Th,
  propertiesContainsFilter: _a
}, Symbol.toStringTag, { value: "Module" }));
function M0(n, e, t = {}) {
  t.mutate !== !0 && (n = nt(n));
  const r = t.minPoints || 3, o = oi(e, t.units);
  var a = new yr(n.features.length), u = n.features.map((_) => !1), l = n.features.map((_) => !1), f = n.features.map((_) => !1), g = n.features.map((_) => -1);
  a.load(
    n.features.map((_, w) => {
      var [S, L] = _.geometry.coordinates;
      return {
        minX: S,
        minY: L,
        maxX: S,
  ...
  const v = (_) => {
    const w = n.features[_], [S, L] = w.geometry.coordinates, b = Math.max(L - o, -90), k = Math.min(L + o, 90), N = function() {
      return b < 0 && k > 0 ? o : Math.abs(b) < Math.abs(k) ? o / Math.cos(Qe(k)) : o / Math.cos(Qe(b));
    }(), A = Math.max(S - N, -360), O = Math.min(S + N, 360), Y = { minX: A, minY: b, maxX: O, maxY: k };
  ...
  return n.features.forEach((_, w) => {
    ...
    var S = n.features[w];
    S.properties || (S.properties = {}), g[w] >= 0 ? (S.properties.dbscan = f[w] ? "edge" : "core", S.properties.cluster = g[w]) : S.properties.dbscan = "noise";
  }), n;
}
var Oh = {
  /**
...
}, Dh = Oh, L0 = Dh.eudist, P0 = Dh.dist, N0 = {
  kmrand: function(e, t) {
    for (var r = {}, o = [], a = t << 2, u = e.length, l = e[0].length > 0; o.length < t && a-- > 0; ) {
      var f = e[Math.floor(Math.random() * u)], g = l ? f.join("_") : "" + f;
      r[g] || (r[g] = !0, o.push(f));
    }
   ...
   */
  kmpp: function(e, t) {
    var r = e[0].length ? L0 : P0, o = [], a = e.length, u = e[0].length > 0, l = e[Math.floor(Math.random() * a)];
    for (u ? l.join("_") : "" + l, o.push(l); o.length < t; ) {
...
}, wa = Oh, Fh = N0, T0 = wa.eudist;
wa.mandist;
wa.dist;
var R0 = Fh.kmrand, A0 = Fh.kmpp, _l = 1e4;
function wl(n, e, t) {
  t = t || [];
  for (var r = 0; r < n; r++)
    t[r] = e;
...
function O0(n, e, t, r) {
  var o = [], a = [], u = [], l = [], f = !1, g = r || _l, v = n.length, m = n[0].length, p = m > 0, _ = [];
  if (t)
    t == "kmrand" ? o = R0(n, e) : t == "kmpp" ? o = A0(n, e) : o = t;
  else for (var w = {}; o.length < e; ) {
    var S = Math.floor(Math.random() * v);
    w[S] || (w[S] = !0, o.push(n[S]));
  }
  do {
    wl(e, 0, _);
    for (var L = 0; L < v; L++) {
      for (var b = 1 / 0, k = 0, N = 0; N < e; N++) {
        var l = p ? T0(n[L], o[N]) : Math.abs(n[L] - o[N]);
        l <= b && (b = l, k = N);
      }
      u[L] = k, _[k]++;
    }
    for (var A = [], a = [], O = 0; O < e; O++)
      A[O] = p ? wl(m, 0, A[O]) : 0, a[O] = o[O];
    if (p) {
      for (var Y = 0; Y < e; Y++)
        o[Y] = [];
      for (var V = 0; V < v; V++)
      ...
      f = !0;
      for (var B = 0; B < e; B++) {
        for (var z = o[B], X = A[B], R = a[B], U = _[B], G = 0; G < m; G++)
          z[G] = X[G] / U || 0;
        if (f) {
          for (var H = 0; H < m; H++)
            if (R[H] != z[H]) {
...
function B0(n, e = {}) {
  ...
  var r = Zr(n), o = r.slice(0, e.numberOfClusters), a = F0(r, e.numberOfClusters, o), u = {};
  return a.centroids.forEach(function(l, f) {
    u[f] = l;
  }), Le(n, function(l, f) {
    var g = a.idxs[f];
    l.properties.cluster = g, l.properties.centroid = u[g];
  }), n;
}
function G0(n, e, t, r) {
  var o = new yr(6), a = e.features.map(function(u) {
    var l;
    return {
...
function Bh(n, e) {
  ...
  return ce(
    Y0(
      ...
      let l = {};
      return t ? (o.push(r.a.z), a.push(r.b.z), u.push(r.c.z)) : l = {
        a: r.a.z,
        b: r.b.z,
        c: r.c.z
      }, ye([[o, a, u, o]], l);
...
var xl = class {
  constructor(n, e, t) {
    ...
    const r = e.x - n.x, o = e.y - n.y, a = t.x - n.x, u = t.y - n.y, l = r * (n.x + e.x) + o * (n.y + e.y), f = a * (n.x + t.x) + u * (n.y + t.y), g = 2 * (r * (t.y - e.y) - o * (t.x - e.x));
    let v, m;
    this.x = (u * l - o * f) / g, this.y = (r * f - a * l) / g, v = this.x - n.x, m = this.y - n.y, this.r = v * v + m * m;
  }
};
function q0(n, e) {
  return e.x - n.x;
...
function Y0(n) {
  ...
  let _ = r - t, w = a - o;
  const S = _ > w ? _ : w, L = (r + t) * 0.5, b = (a + o) * 0.5, k = [
    new xl(
      {
        __sentinel: !0,
        x: L - 20 * S,
  ...
  let O;
  for (e = n.length; e--; ) {
    for (A.length = 0, O = k.length; O--; ) {
      if (_ = n[e].x - k[O].x, _ > 0 && _ * _ > k[O].r) {
        N.push(k[O]), k.splice(O, 1);
        continue;
      }
      w = n[e].y - k[O].y, !(_ * _ + w * w > k[O].r) && (A.push(
        k[O].a,
        k[O].b,
        k[O].b,
        k[O].c,
    ...
    for (U0(A), O = A.length; O; )
      f = A[--O], l = A[--O], g = n[e], v = f.x - l.x, m = f.y - l.y, p = 2 * (v * (g.y - f.y) - m * (g.x - f.x)), Math.abs(p) > u && k.push(new xl(l, f, g));
  }
  for (Array.prototype.push.apply(N, k), e = N.length; e--; )
...
function V0(n) {
  ...
  return function(l, f) {
    f || (e = t = 0);
    var g = 2, v = l.length, m = new Array(v);
    for (m[0] = (e += l[0]) * r + a, m[1] = (t += l[1]) * o + u; g < v; ) m[g] = l[g], ++g;
    return m;
  };
}
function H0(n, e) {
...
function W0(n, e) {
  ...
  e.forEach(function(g, v) {
    ...
    var v = l(g), m = v[0], p = v[1], _, w;
    if (_ = o[m])
      if (delete o[_.end], _.push(g), _.end = p, w = r[p]) {
        delete r[w.start];
        var S = w === _ ? _ : _.concat(w);
        r[S.start = _.start] = o[S.end = w.end] = S;
      } else
        r[_.start] = o[_.end] = _;
    else if (_ = r[p])
...
function Z0(n) {
  return Gh(n, K0.apply(this, arguments));
}
function K0(n, e) {
  var t = {}, r = [], o = [];
  e.forEach(a);
  ...
  function l(f) {
    return $0(Gh(n, { type: "Polygon", arcs: [f] }).coordinates[0]);
  }
  return r.forEach(function(f) {
    ...
    arcs: o.map(function(f) {
      ...
      }), g = W0(n, g), (v = g.length) > 1)
        for (var m = 1, p = l(g[0]), _, w; m < v; ++m)
          (_ = l(g[m])) > p && (w = g[0], g[0] = g[m], g[m] = w, p = _);
      return g;
    }).filter(function(f) {
      return f.length > 0;
    })
...
function J0(n) {
  ...
  function a(m) {
    m != null && xa.call(u, m.type) && u[m.type](m);
  }
  var u = {
...
function Q0(n, e, t, r, o) {
  ...
  for (var a = new r(n = 1 << Math.max(4, Math.ceil(Math.log(n) / Math.LN2))), u = n - 1, l = 0; l < n; ++l)
    a[l] = o;
  function f(m) {
...
function Ea(n, e, t, r, o, a) {
  arguments.length === 3 && (r = a = Array, o = null);
  for (var u = new r(n = 1 << Math.max(4, Math.ceil(Math.log(n) / Math.LN2))), l = new a(n), f = n - 1, g = 0; g < n; ++g)
    u[g] = o;
  function v(w, S) {
    for (var L = e(w) & f, b = u[L], k = 0; b != o; ) {
      if (t(b, w)) return l[L] = S;
      if (++k >= n) throw new Error("full hashmap");
      b = u[L = L + 1 & f];
    }
    return u[L] = w, l[L] = S, S;
  }
  function m(w, S) {
    for (var L = e(w) & f, b = u[L], k = 0; b != o; ) {
      if (t(b, w)) return l[L];
  ...
  function _() {
    for (var w = [], S = 0, L = u.length; S < L; ++S) {
      var b = u[S];
      b != o && w.push(b);
    }
    return w;
...
var zh = new ArrayBuffer(16), El = new Float64Array(zh), Oi = new Uint32Array(zh);
function To(n) {
  El[0] = n[0], El[1] = n[1];
  var e = Oi[0] ^ Oi[1];
  return e = e << 5 ^ e >> 7 ^ Oi[2] ^ Oi[3], e & 2147483647;
}
function j0(n) {
  var e = n.coordinates, t = n.lines, r = n.rings, o = Y(), a = new Int32Array(e.length), u = new Int32Array(e.length), l = new Int32Array(e.length), f = new Int8Array(e.length), g = 0, v, m, p, _, w;
  for (v = 0, m = e.length; v < m; ++v)
    a[v] = u[v] = l[v] = -1;
  for (v = 0, m = t.length; v < m; ++v) {
    var S = t[v], L = S[0], b = S[1];
  ...
  function O(D, B, z, X) {
    if (a[z] !== D) {
      ...
      if (R >= 0) {
        var U = l[z];
        (R !== B || U !== X) && (R !== X || U !== B) && (++g, f[z] = 1);
      } else
        u[z] = B, l[z] = X;
    }
  }
  function Y() {
    for (var D = Ea(e.length * 1.4, V, C, Int32Array, -1, Int32Array), B = new Int32Array(e.length), z = 0, X = e.length; z < X; ++z)
      B[z] = D.maybeSet(z, z);
    return B;
  }
  function V(D) {
  ...
  a = u = l = null;
  var M = Q0(g * 1.4, To, An), T;
  for (v = 0, m = e.length; v < m; ++v)
    f[T = o[v]] && M.add(e[T]);
  return M;
}
function ey(n) {
  var e = j0(n), t = n.coordinates, r = n.lines, o = n.rings, a, u, l;
  for (u = 0, l = r.length; u < l; ++u)
    for (var f = r[u], g = f[0], v = f[1]; ++g < v; )
      e.has(t[g]) && (a = { 0: g, 1: f[1] }, f[1] = g, f = f.next = a);
  for (u = 0, l = o.length; u < l; ++u)
    for (var m = o[u], p = m[0], _ = p, w = m[1], S = e.has(t[p]); ++_ < w; )
      e.has(t[_]) && (S ? (a = { 0: _, 1: m[1] }, m[1] = _, m = m.next = a) : (ty(t, p, w, w - _), t[w] = t[p], S = !0, _ = p));
  return n;
}
function ty(n, e, t, r) {
  go(n, e, t), go(n, e, e + r), go(n, e + r, t);
}
function go(n, e, t) {
...
function ny(n) {
  var e = n.coordinates, t = n.lines, r, o = n.rings, a, u = t.length + o.length, l, f;
  for (delete n.lines, delete n.rings, l = 0, f = t.length; l < f; ++l)
    for (r = t[l]; r = r.next; ) ++u;
  for (l = 0, f = o.length; l < f; ++l)
    for (a = o[l]; a = a.next; ) ++u;
  var g = Ea(u * 2 * 1.4, To, An), v = n.arcs = [];
  ...
  function m(k) {
    ...
    O ? O.push(k) : g.set(N, [k]), V ? V.push(k) : g.set(A, [k]), v.push(k);
  }
  function p(k) {
    var N, A, O, Y, V;
    if (A = g.get(N = e[k[0]]))
    ...
    A ? A.push(k) : g.set(N, [k]), v.push(k);
  }
  function _(k, N) {
    var A = k[0], O = N[0], Y = k[1], V = N[1];
    if (A - Y !== O - V) return !1;
    for (; A <= Y; ++A, ++O) if (!An(e[A], e[O])) return !1;
    return !0;
  }
  function w(k, N) {
    var A = k[0], O = N[0], Y = k[1], V = N[1];
    if (A - Y !== O - V) return !1;
    for (; A <= Y; ++A, --V) if (!An(e[A], e[V])) return !1;
    return !0;
  }
  function S(k, N) {
    var A = k[0], O = N[0], Y = k[1], V = N[1], C = Y - A;
    if (C !== V - O) return !1;
    for (var M = b(k), T = b(N), D = 0; D < C; ++D)
      if (!An(e[A + (D + M) % C], e[O + (D + T) % C])) return !1;
    return !0;
  }
  function L(k, N) {
    var A = k[0], O = N[0], Y = k[1], V = N[1], C = Y - A;
    if (C !== V - O) return !1;
    for (var M = b(k), T = C - b(N), D = 0; D < C; ++D)
      if (!An(e[A + (D + M) % C], e[V - (D + T) % C])) return !1;
    return !0;
  }
  function b(k) {
    for (var N = k[0], A = k[1], O = N, Y = O, V = e[O]; ++O < A; ) {
      var C = e[O];
...
function iy(n) {
  var e = {}, t;
  for (t in n) e[t] = sy(n[t]);
  return e;
}
function sy(n) {
  return n == null ? { type: null } : (n.type === "FeatureCollection" ? oy : n.type === "Feature" ? qh : Ca)(n);
}
function oy(n) {
  var e = { type: "GeometryCollection", geometries: n.features.map(qh) };
  return n.bbox != null && (e.bbox = n.bbox), e;
}
function qh(n) {
  var e = Ca(n.geometry), t;
...
function Ca(n) {
  ...
  var e = n.type === "GeometryCollection" ? { type: "GeometryCollection", geometries: n.geometries.map(Ca) } : n.type === "Point" || n.type === "MultiPoint" ? { type: n.type, coordinates: n.coordinates } : { type: n.type, arcs: n.coordinates };
  return n.bbox != null && (e.bbox = n.bbox), e;
}
function ay(n, e) {
  var t = J0(n = iy(n)), r = ny(ey(ry(n))), o = r.coordinates, a = Ea(r.arcs.length * 1.4, uy, ly);
  n = r.objects, r.bbox = t, r.arcs = r.arcs.map(function(m, p) {
    return a.set(m, p), o.slice(m[0], m[1] + 1);
  }), delete r.coordinates, o = null;
  function u(m) {
    m && xa.call(l, m.type) && l[m.type](m);
  }
  var l = {
    GeometryCollection: function(m) {
...
function cy(n, e = {}) {
  ...
  return o && r.push(o), r.length ? r.length === 1 ? r[0] : En(
...
function hy(n, e) {
  const t = n.geometry.coordinates, r = e.geometry.coordinates, o = Di(t[0]), a = Di(t[t.length - 1]), u = Di(r[0]), l = Di(r[r.length - 1]);
  let f;
  if (o === l)
...
function fy(n, e = {}) {
  ...
  const r = ay({ geoms: Ko(t).geometry });
  return Z0(r, r.objects.geoms.geometries);
}
function gy(n, e = {}) {
  if (e = e || {}, !Oe(e))
    throw new Error("options is invalid");
...
function my(n, e = {}) {
  const t = e.maxEdge || 1 / 0, r = vy(n), o = Bh(r);
  if (o.features = o.features.filter((u) => {
    const l = u.geometry.coordinates[0][0], f = u.geometry.coordinates[0][1], g = u.geometry.coordinates[0][2], v = ze(l, f, e), m = ze(f, g, e), p = ze(l, g, e);
    return v <= t && m <= t && p <= t;
  }), o.features.length < 1)
    return null;
  const a = gy(o);
...
var yy = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, mo = Math.ceil, At = Math.floor, _t = "[BigNumber Error] ", Cl = _t + "Number primitive has more than 15 significant digits: ", zt = 1e14, Se = 14, vo = 9007199254740991, yo = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], pn = 1e7, rt = 1e9;
function Uh(n) {
  var e, t, r, o = k.prototype = { constructor: k, toString: null, valueOf: null }, a = new k(1), u = 20, l = 4, f = -7, g = 21, v = -1e7, m = 1e7, p = !1, _ = 1, w = 0, S = {
    prefix: "",
    groupSize: 3,
  ...
  function k(C, M) {
    var T, D, B, z, X, R, U, G, H = this;
    if (!(H instanceof k)) return new k(C, M);
    if (M == null) {
      ...
      if ((R = typeof C == "number") && C * 0 == 0) {
        if (H.s = 1 / C < 0 ? (C = -C, -1) : 1, C === ~~C) {
          for (z = 0, X = C; X >= 10; X /= 10, z++) ;
          z > m ? H.c = H.e = null : (H.e = z, H.c = [C]);
          return;
        }
        G = String(C);
      } else {
        if (!yy.test(G = String(C))) return r(H, G, R);
        H.s = G.charCodeAt(0) == 45 ? (G = G.slice(1), -1) : 1;
      }
      (z = G.indexOf(".")) > -1 && (G = G.replace(".", "")), (X = G.search(/e/i)) > 0 ? (z < 0 && (z = X), z += +G.slice(X + 1), G = G.substring(0, X)) : z < 0 && (z = G.length);
    } else {
      if (Ze(M, 2, L.length, "Base"), M == 10 && b)
        return H = new k(C), Y(H, u + H.e + 1, l);
      if (G = String(C), R = typeof C == "number") {
        if (C * 0 != 0) return r(H, G, R, M);
        if (H.s = 1 / C < 0 ? (G = G.slice(1), -1) : 1, k.DEBUG && G.replace(/^0\.0*|\./, "").length > 15)
          throw Error(Cl + C);
      } else
        H.s = G.charCodeAt(0) === 45 ? (G = G.slice(1), -1) : 1;
      for (T = L.slice(0, M), z = X = 0, U = G.length; X < U; X++)
      ...
      R = !1, G = t(G, M, 10, H.s), (z = G.indexOf(".")) > -1 ? G = G.replace(".", "") : z = G.length;
    }
    for (X = 0; G.charCodeAt(X) === 48; X++) ;
    for (U = G.length; G.charCodeAt(--U) === 48; ) ;
    if (G = G.slice(X, ++U)) {
      if (U -= X, R && k.DEBUG && U > 15 && (C > vo || C !== At(C)))
        throw Error(Cl + H.s * C);
      if ((z = z - X - 1) > m)
        H.c = H.e = null;
      else if (z < v)
        H.c = [H.e = 0];
      else {
        if (H.e = z, H.c = [], X = (z + 1) % Se, z < 0 && (X += Se), X < U) {
          for (X && H.c.push(+G.slice(0, X)), U -= Se; X < U; )
            H.c.push(+G.slice(X, X += Se));
          X = Se - (G = G.slice(X)).length;
        } else
          X -= U;
        for (; X--; G += "0") ;
        H.c.push(+G);
  ...
  k.clone = Uh, k.ROUND_UP = 0, k.ROUND_DOWN = 1, k.ROUND_CEIL = 2, k.ROUND_FLOOR = 3, k.ROUND_HALF_UP = 4, k.ROUND_HALF_DOWN = 5, k.ROUND_HALF_EVEN = 6, k.ROUND_HALF_CEIL = 7, k.ROUND_HALF_FLOOR = 8, k.EUCLID = 9, k.config = k.set = function(C) {
    var M, T;
    if (C != null)
      if (typeof C == "object") {
        if (C.hasOwnProperty(M = "DECIMAL_PLACES") && (T = C[M], Ze(T, 0, rt, M), u = T), C.hasOwnProperty(M = "ROUNDING_MODE") && (T = C[M], Ze(T, 0, 8, M), l = T), C.hasOwnProperty(M = "EXPONENTIAL_AT") && (T = C[M], T && T.pop ? (Ze(T[0], -rt, 0, M), Ze(T[1], 0, rt, M), f = T[0], g = T[1]) : (Ze(T, -rt, rt, M), f = -(g = T < 0 ? -T : T))), C.hasOwnProperty(M = "RANGE"))
          if (T = C[M], T && T.pop)
  ...
  }, k.isBigNumber = function(C) {
    if (!C || C._isBigNumber !== !0) return !1;
    if (!k.DEBUG) return !0;
    var M, T, D = C.c, B = C.e, z = C.s;
    e: if ({}.toString.call(D) == "[object Array]") {
      if ((z === 1 || z === -1) && B >= -rt && B <= rt && B === At(B)) {
        if (D[0] === 0) {
          if (B === 0 && D.length === 1) return !0;
          break e;
        }
        if (M = (B + 1) % Se, M < 1 && (M += Se), String(D[0]).length == M) {
          for (M = 0; M < D.length; M++)
            if (T = D[M], T < 0 || T >= zt || T !== At(T)) break e;
          if (T !== 0) return !0;
        }
      }
    } else if (D === null && B === null && (z === null || z === 1 || z === -1))
      return !0;
    ...
    var C = 9007199254740992, M = Math.random() * C & 2097151 ? function() {
      return At(Math.random() * C);
    } : function() {
      return (Math.random() * 1073741824 | 0) * 8388608 + (Math.random() * 8388608 | 0);
    };
    return function(T) {
      var D, B, z, X, R, U = 0, G = [], H = new k(a);
      if (T == null ? T = u : Ze(T, 0, rt), X = mo(T / Se), p)
      ...
      for (X = G[--U], T %= Se, X && T && (R = yo[Se - T], G[U] = At(X / R) * R); G[U] === 0; G.pop(), U--) ;
      if (U < 0)
        G = [z = 0];
      else {
        for (z = -1; G[0] === 0; G.splice(0, 1), z -= Se) ;
        for (U = 1, R = G[0]; R >= 10; R /= 10, U++) ;
        U < Se && (z -= Se - U);
      }
      return H.e = z, H.c = G, H;
    };
  }(), k.sum = function() {
    for (var C = 1, M = arguments, T = new k(M[0]); C < M.length; ) T = T.plus(M[C++]);
    return T;
  }, t = /* @__PURE__ */ function() {
    var C = "0123456789";
    function M(T, D, B, z) {
      for (var X, R = [0], U, G = 0, H = T.length; G < H; ) {
        ...
        for (R[0] += z.indexOf(T.charAt(G++)), X = 0; X < R.length; X++)
          R[X] > B - 1 && (R[X + 1] == null && (R[X + 1] = 0), R[X + 1] += R[X] / B | 0, R[X] %= B);
      }
      return R.reverse();
    }
    return function(T, D, B, z, X) {
      var R, U, G, H, J, W, j, Q, re = T.indexOf("."), ee = u, te = l;
      for (re >= 0 && (H = w, w = 0, T = T.replace(".", ""), Q = new k(D), W = Q.pow(T.length - re), w = H, Q.c = M(
        un(Rt(W.c), W.e, "0"),
        10,
        B,
        C
      ...
      if (re < 0 ? --G : (W.c = j, W.e = G, W.s = z, W = e(W, Q, ee, te, B), j = W.c, J = W.r, G = W.e), U = G + ee + 1, re = j[U], H = B / 2, J = J || U < 0 || j[U + 1] != null, J = te < 4 ? (re != null || J) && (te == 0 || te == (W.s < 0 ? 3 : 2)) : re > H || re == H && (te == 4 || J || te == 6 && j[U - 1] & 1 || te == (W.s < 0 ? 8 : 7)), U < 1 || !j[0])
        T = J ? un(R.charAt(1), -ee, R.charAt(0)) : R.charAt(0);
      else {
        if (j.length = U, J)
          for (--B; ++j[--U] > B; )
    ...
    function C(D, B, z) {
      var X, R, U, G, H = 0, J = D.length, W = B % pn, j = B / pn | 0;
      for (D = D.slice(); J--; )
        U = D[J] % pn, G = D[J] / pn | 0, X = j * U + G * W, R = W * U + X % pn * pn + H, H = (R / z | 0) + (X / pn | 0) + j * G, D[J] = R % z;
    ...
    function T(D, B, z, X) {
      for (var R = 0; z--; )
        D[z] -= R, R = D[z] < B[z] ? 1 : 0, D[z] = R * X + D[z] - B[z];
      for (; !D[0] && D.length > 1; D.splice(0, 1)) ;
    }
    return function(D, B, z, X, R) {
      var U, G, H, J, W, j, Q, re, ee, te, se, fe, Z, Fe, _e, ae, q, be = D.s == B.s ? 1 : -1, Ne = D.c, Ce = B.c;
      if (!Ne || !Ne[0] || !Ce || !Ce[0])
        return new k(
      ...
      for (re = new k(be), ee = re.c = [], G = D.e - B.e, be = z + G + 1, R || (R = zt, G = Ot(D.e / Se) - Ot(B.e / Se), be = be / Se | 0), H = 0; Ce[H] == (Ne[H] || 0); H++) ;
      if (Ce[H] > (Ne[H] || 0) && G--, be < 0)
        ee.push(1), J = !0;
      else {
        for (Fe = Ne.length, ae = Ce.length, H = 0, be += 2, W = At(R / (Ce[0] + 1)), W > 1 && (Ce = C(Ce, W, R), Ne = C(Ne, W, R), ae = Ce.length, Fe = Ne.length), Z = ae, te = Ne.slice(0, ae), se = te.length; se < ae; te[se++] = 0) ;
        q = Ce.slice(), q = [0].concat(q), _e = Ce[0], Ce[1] >= R / 2 && _e++;
        do {
          if (W = 0, U = M(Ce, te, ae, se), U < 0) {
            if (fe = te[0], ae != se && (fe = fe * R + (te[1] || 0)), W = At(fe / _e), W > 1)
              for (W >= R && (W = R - 1), j = C(Ce, W, R), Q = j.length, se = te.length; M(j, te, Q, se) == 1; )
                W--, T(j, ae < Q ? q : Ce, Q, R), Q = j.length, U = 1;
            else
              W == 0 && (U = W = 1), j = Ce.slice(), Q = j.length;
            if (Q < se && (j = [0].concat(j)), T(te, j, se, R), se = te.length, U == -1)
              for (; M(Ce, te, ae, se) < 1; )
                W++, T(te, ae < se ? q : Ce, se, R), se = te.length;
          } else U === 0 && (W++, te = [0]);
  ...
  function N(C, M, T, D) {
    var B, z, X, R, U;
    if (T == null ? T = l : Ze(T, 0, 8), !C.c) return C.toString();
    if (B = C.c[0], X = C.e, M == null)
      U = Rt(C.c), U = D == 1 || D == 2 && (X <= f || X >= g) ? Bi(U, X) : un(U, X, "0");
    else if (C = Y(new k(C), M, T), z = C.e, U = Rt(C.c), R = U.length, D == 1 || D == 2 && (M <= z || z <= f)) {
      for (; R < M; U += "0", R++) ;
      U = Bi(U, z);
    } else if (M -= X + (D === 2 && z > X), U = un(U, z, "0"), z + 1 > R) {
      if (--M > 0) for (U += "."; M--; U += "0") ;
    } else if (M += z - R, M > 0)
      for (z + 1 == R && (U += "."); M--; U += "0") ;
    return C.s < 0 && B ? "-" + U : U;
  ...
  function A(C, M) {
    for (var T, D, B = 1, z = new k(C[0]); B < C.length; B++)
      D = new k(C[B]), (!D.s || (T = Nn(z, D)) === M || T === 0 && z.s === M) && (z = D);
    return z;
  }
  function O(C, M, T) {
    for (var D = 1, B = M.length; !M[--B]; M.pop()) ;
    for (B = M[0]; B >= 10; B /= 10, D++) ;
    return (T = D + T * Se - 1) > m ? C.c = C.e = null : T < v ? C.c = [C.e = 0] : (C.e = T, C.c = M), C;
  }
  r = /* @__PURE__ */ function() {
    var C = /^(-?)0([xbo])(?=\w[\w.]*$)/i, M = /^([^.]+)\.$/, T = /^\.([^.]+)$/, D = /^-?(Infinity|NaN)$/, B = /^\s*\+(?=[\w.])|^\s+|\s+$/g;
    return function(z, X, R, U) {
      var G, H = R ? X : X.replace(B, "");
      if (D.test(H))
        z.s = isNaN(H) ? null : H < 0 ? -1 : 1;
      else {
  ...
  function Y(C, M, T, D) {
    var B, z, X, R, U, G, H, J = C.c, W = yo;
    if (J) {
      e: {
        for (B = 1, R = J[0]; R >= 10; R /= 10, B++) ;
        if (z = M - B, z < 0)
          z += Se, X = M, U = J[G = 0], H = At(U / W[B - X - 1] % 10);
        else if (G = mo((z + 1) / Se), G >= J.length)
          if (D) {
            for (; J.length <= G; J.push(0)) ;
            U = H = 0, B = 1, z %= Se, X = z - Se + 1;
          } else
            break e;
        else {
          for (U = R = J[G], B = 1; R >= 10; R /= 10, B++) ;
          z %= Se, X = z - Se + B, H = X < 0 ? 0 : At(U / W[B - X - 1] % 10);
        }
        ...
        (z > 0 ? X > 0 ? U / W[B - X] : 0 : J[G - 1]) % 10 & 1 || T == (C.s < 0 ? 8 : 7)), M < 1 || !J[0])
          return J.length = 0, D ? (M -= C.e + 1, J[0] = W[(Se - M % Se) % Se], C.e = -M || 0) : J[0] = C.e = 0, C;
        if (z == 0 ? (J.length = G, R = 1, G--) : (J.length = G + 1, R = W[Se - z], J[G] = X > 0 ? At(U / W[B - X] % W[X]) * R : 0), D)
          for (; ; )
            if (G == 0) {
              for (z = 1, X = J[0]; X >= 10; X /= 10, z++) ;
              for (X = J[0] += R, R = 1; X >= 10; X /= 10, R++) ;
              z != R && (C.e++, J[0] == zt && (J[0] = 1));
              break;
            } else {
              if (J[G] += R, J[G] != zt) break;
              J[G--] = 0, R = 1;
            }
  ...
  function V(C) {
    var M, T = C.e;
    return T === null ? C.toString() : (M = Rt(C.c), M = T <= f || T >= g ? Bi(M, T) : un(M, T, "0"), C.s < 0 ? "-" + M : M);
  }
  return o.absoluteValue = o.abs = function() {
    var C = new k(this);
    return C.s < 0 && (C.s = 1), C;
  }, o.comparedTo = function(C, M) {
    return Nn(this, new k(C, M));
  }, o.decimalPlaces = o.dp = function(C, M) {
    var T, D, B, z = this;
    if (C != null)
      return Ze(C, 0, rt), M == null ? M = l : Ze(M, 0, 8), Y(new k(z), C + z.e + 1, M);
    if (!(T = z.c)) return null;
    if (D = ((B = T.length - 1) - Ot(this.e / Se)) * Se, B = T[B]) for (; B % 10 == 0; B /= 10, D--) ;
    return D < 0 && (D = 0), D;
  }, o.dividedBy = o.div = function(C, M) {
    return e(this, new k(C, M), u, l);
  }, o.dividedToIntegerBy = o.idiv = function(C, M) {
    return e(this, new k(C, M), 0, 1);
  }, o.exponentiatedBy = o.pow = function(C, M) {
    var T, D, B, z, X, R, U, G, H, J = this;
    if (C = new k(C), C.c && !C.isInteger())
      throw Error(_t + "Exponent not an integer: " + V(C));
    if (M != null && (M = new k(M)), R = C.e > 14, !J.c || !J.c[0] || J.c[0] == 1 && !J.e && J.c.length == 1 || !C.c || !C.c[0])
      return H = new k(Math.pow(+V(J), R ? C.s * (2 - Fi(C)) : +V(C))), M ? H.mod(M) : H;
    if (U = C.s < 0, M) {
      ...
      if (C.e > 9 && (J.e > 0 || J.e < -1 || (J.e == 0 ? J.c[0] > 1 || R && J.c[1] >= 24e7 : J.c[0] < 8e13 || R && J.c[0] <= 9999975e7)))
        return z = J.s < 0 && Fi(C) ? -0 : 0, J.e > -1 && (z = 1 / z), new k(U ? 1 / z : z);
      w && (z = mo(w / Se + 2));
    }
    for (R ? (T = new k(0.5), U && (C.s = 1), G = Fi(C)) : (B = Math.abs(+V(C)), G = B % 2), H = new k(a); ; ) {
      if (G) {
        if (H = H.times(J), !H.c) break;
        z ? H.c.length > z && (H.c.length = z) : D && (H = H.mod(M));
      }
      if (B) {
        if (B = At(B / 2), B === 0) break;
        G = B % 2;
      ...
      J = J.times(J), z ? J.c && J.c.length > z && (J.c.length = z) : D && (J = J.mod(M));
    }
    return D ? H : (U && (H = a.div(H)), M ? H.mod(M) : z ? Y(H, w, l, X) : H);
  }, o.integerValue = function(C) {
    var M = new k(this);
    return C == null ? C = l : Ze(C, 0, 8), Y(M, M.e + 1, C);
  }, o.isEqualTo = o.eq = function(C, M) {
    return Nn(this, new k(C, M)) === 0;
  }, o.isFinite = function() {
    return !!this.c;
  }, o.isGreaterThan = o.gt = function(C, M) {
    return Nn(this, new k(C, M)) > 0;
  }, o.isGreaterThanOrEqualTo = o.gte = function(C, M) {
    return (M = Nn(this, new k(C, M))) === 1 || M === 0;
  }, o.isInteger = function() {
    return !!this.c && Ot(this.e / Se) > this.c.length - 2;
    ...
    var T, D, B, z, X = this, R = X.s;
    if (C = new k(C, M), M = C.s, !R || !M) return new k(NaN);
    if (R != M)
      return C.s = -M, X.plus(C);
    var U = X.e / Se, G = C.e / Se, H = X.c, J = C.c;
    if (!U || !G) {
      if (!H || !J) return H ? (C.s = -M, C) : new k(J ? X : NaN);
      if (!H[0] || !J[0])
        return J[0] ? (C.s = -M, C) : new k(H[0] ? X : (
          // IEEE 754 (2008) 6.3: n - n = -0 when rounding to -Infinity
          l == 3 ? -0 : 0
        ));
    }
    if (U = Ot(U), G = Ot(G), H = H.slice(), R = U - G) {
      for ((z = R < 0) ? (R = -R, B = H) : (G = U, B = J), B.reverse(), M = R; M--; B.push(0)) ;
      B.reverse();
    } else
      for (D = (z = (R = H.length) < (M = J.length)) ? R : M, R = M = 0; M < D; M++)
        if (H[M] != J[M]) {
          z = H[M] < J[M];
          break;
        }
    if (z && (B = H, H = J, J = B, C.s = -C.s), M = (D = J.length) - (T = H.length), M > 0) for (; M--; H[T++] = 0) ;
    for (M = zt - 1; D > R; ) {
      if (H[--D] < J[D]) {
        for (T = D; T && !H[--T]; H[T] = M) ;
        --H[T], H[D] += zt;
    ...
    return H[0] ? O(C, H, G) : (C.s = l == 3 ? -1 : 1, C.c = [C.e = 0], C);
  }, o.modulo = o.mod = function(C, M) {
    var T, D, B = this;
    return C = new k(C, M), !B.c || !C.s || C.c && !C.c[0] ? new k(NaN) : !C.c || B.c && !B.c[0] ? new k(B) : (_ == 9 ? (D = C.s, C.s = 1, T = e(B, C, 0, 3), C.s = D, T.s *= D) : T = e(B, C, 0, _), C = B.minus(T.times(C)), !C.c[0] && _ == 1 && (C.s = B.s), C);
  }, o.multipliedBy = o.times = function(C, M) {
    var T, D, B, z, X, R, U, G, H, J, W, j, Q, re, ee, te = this, se = te.c, fe = (C = new k(C, M)).c;
    if (!se || !fe || !se[0] || !fe[0])
      return !te.s || !C.s || se && !se[0] && !fe || fe && !fe[0] && !se ? C.c = C.e = C.s = null : (C.s *= te.s, !se || !fe ? C.c = C.e = null : (C.c = [0], C.e = 0)), C;
    for (D = Ot(te.e / Se) + Ot(C.e / Se), C.s *= te.s, U = se.length, J = fe.length, U < J && (Q = se, se = fe, fe = Q, B = U, U = J, J = B), B = U + J, Q = []; B--; Q.push(0)) ;
    for (re = zt, ee = pn, B = J; --B >= 0; ) {
      for (T = 0, W = fe[B] % ee, j = fe[B] / ee | 0, X = U, z = B + X; z > B; )
        G = se[--X] % ee, H = se[X] / ee | 0, R = j * G + H * W, G = W * G + R % ee * ee + Q[z] + T, T = (G / re | 0) + (R / ee | 0) + j * H, Q[z--] = G % re;
      Q[z] = T;
    }
    ...
    var T, D = this, B = D.s;
    if (C = new k(C, M), M = C.s, !B || !M) return new k(NaN);
    if (B != M)
      return C.s = -M, D.minus(C);
    var z = D.e / Se, X = C.e / Se, R = D.c, U = C.c;
    if (!z || !X) {
      if (!R || !U) return new k(B / 0);
      if (!R[0] || !U[0]) return U[0] ? C : new k(R[0] ? D : B * 0);
    }
    if (z = Ot(z), X = Ot(X), R = R.slice(), B = z - X) {
      for (B > 0 ? (X = z, T = U) : (B = -B, T = R), T.reverse(); B--; T.push(0)) ;
      T.reverse();
    }
    for (B = R.length, M = U.length, B - M < 0 && (T = U, U = R, R = T, M = B), B = 0; M; )
      B = (R[--M] = R[M] + U[M] + B) / zt | 0, R[M] = zt === R[M] ? 0 : R[M] % zt;
    return B && (R = [B].concat(R), ++X), O(C, R, X);
  }, o.precision = o.sd = function(C, M) {
    var T, D, B, z = this;
    if (C != null && C !== !!C)
      return Ze(C, 1, rt), M == null ? M = l : Ze(M, 0, 8), Y(new k(z), C, M);
    if (!(T = z.c)) return null;
    if (B = T.length - 1, D = B * Se + 1, B = T[B]) {
      for (; B % 10 == 0; B /= 10, D--) ;
      for (B = T[0]; B >= 10; B /= 10, D++) ;
    }
    return C && z.e + 1 > D && (D = z.e + 1), D;
  }, o.shiftedBy = function(C) {
    return Ze(C, -vo, vo), this.times("1e" + C);
  }, o.squareRoot = o.sqrt = function() {
    var C, M, T, D, B, z = this, X = z.c, R = z.s, U = z.e, G = u + 4, H = new k("0.5");
    if (R !== 1 || !X || !X[0])
      return new k(!R || R < 0 && (!X || X[0]) ? NaN : X ? z : 1 / 0);
    if (R = Math.sqrt(+V(z)), R == 0 || R == 1 / 0 ? (M = Rt(X), (M.length + U) % 2 == 0 && (M += "0"), R = Math.sqrt(+M), U = Ot((U + 1) / 2) - (U < 0 || U % 2), R == 1 / 0 ? M = "5e" + U : (M = R.toExponential(), M = M.slice(0, M.indexOf("e") + 1) + U), T = new k(M)) : T = new k(R + ""), T.c[0]) {
      for (U = T.e, R = U + G, R < 3 && (R = 0); ; )
        if (B = T, T = H.times(B.plus(e(z, B, G, 1))), Rt(B.c).slice(0, R) === (M = Rt(T.c)).slice(0, R))
          if (T.e < U && --R, M = M.slice(R - 3, R + 1), M == "9999" || !D && M == "4999") {
            if (!D && (Y(B, B.e + u + 2, 0), B.times(B).eq(z))) {
              T = B;
              break;
            }
            G += 4, R += 4, D = 1;
          } else {
            (!+M || !+M.slice(1) && M.charAt(0) == "5") && (Y(T, T.e + u + 2, 1), C = !T.times(T).eq(z));
            break;
          }
    }
    return Y(T, T.e + u + 1, l, C);
    ...
    var D, B = this;
    if (T == null)
      C != null && M && typeof M == "object" ? (T = M, M = null) : C && typeof C == "object" ? (T = C, C = M = null) : T = S;
    else if (typeof T != "object")
      throw Error(_t + "Argument not an object: " + T);
    if (D = B.toFixed(C, M), B.c) {
      var z, X = D.split("."), R = +T.groupSize, U = +T.secondaryGroupSize, G = T.groupSeparator || "", H = X[0], J = X[1], W = B.s < 0, j = W ? H.slice(1) : H, Q = j.length;
      if (U && (z = R, R = U, U = z, Q -= z), R > 0 && Q > 0) {
        for (z = Q % R || R, H = j.substr(0, z); z < Q; z += R) H += G + j.substr(z, R);
        U > 0 && (H += G + j.slice(z)), W && (H = "-" + H);
      }
    ...
    var M, T, D, B, z, X, R, U, G, H, J, W, j = this, Q = j.c;
    if (C != null && (R = new k(C), !R.isInteger() && (R.c || R.s !== 1) || R.lt(a)))
      throw Error(_t + "Argument " + (R.isInteger() ? "out of range: " : "not an integer: ") + V(R));
    if (!Q) return new k(j);
    for (M = new k(a), G = T = new k(a), D = U = new k(a), W = Rt(Q), z = M.e = W.length - j.e - 1, M.c[0] = yo[(X = z % Se) < 0 ? Se + X : X], C = !C || R.comparedTo(M) > 0 ? z > 0 ? M : G : R, X = m, m = 1 / 0, R = new k(W), U.c[0] = 0; H = e(R, M, 0, 1), B = T.plus(H.times(D)), B.comparedTo(C) != 1; )
      T = D, D = B, G = U.plus(H.times(B = G)), U = B, M = R.minus(H.times(B = M)), R = B;
    return B = e(C.minus(T), D, 0, 1), U = U.plus(B.times(G)), T = T.plus(B.times(D)), U.s = G.s = j.s, z = z * 2, J = e(G, D, z, l).minus(j).abs().comparedTo(
      e(U, T, z, l).minus(j).abs()
    ) < 1 ? [G, D] : [U, T], m = X, J;
  }, o.toNumber = function() {
    return +V(this);
    ...
    return B === null ? D ? (M = "Infinity", D < 0 && (M = "-" + M)) : M = "NaN" : (C == null ? M = B <= f || B >= g ? Bi(Rt(T.c), B) : un(Rt(T.c), B, "0") : C === 10 && b ? (T = Y(new k(T), u + B + 1, l), M = un(Rt(T.c), T.e, "0")) : (Ze(C, 2, L.length, "Base"), M = t(un(Rt(T.c), B, "0"), 10, C, D, !0)), D < 0 && T.c[0] && (M = "-" + M)), M;
  }, o.valueOf = o.toJSON = function() {
    return V(this);
  }, o._isBigNumber = !0, o[Symbol.toStringTag] = "BigNumber", o[Symbol.for("nodejs.util.inspect.custom")] = o.valueOf, n != null && k.set(n), k;
}
function Ot(n) {
  var e = n | 0;
...
function Rt(n) {
  for (var e, t, r = 1, o = n.length, a = n[0] + ""; r < o; ) {
    for (e = n[r++] + "", t = Se - e.length; t--; e = "0" + e) ;
    a += e;
  }
...
function Nn(n, e) {
  var t, r, o = n.c, a = e.c, u = n.s, l = e.s, f = n.e, g = e.e;
  if (!u || !l) return null;
  if (t = o && !o[0], r = a && !a[0], t || r) return t ? r ? 0 : -l : u;
  if (u != l) return u;
  if (t = u < 0, r = f == g, !o || !a) return r ? 0 : !o ^ t ? 1 : -1;
  if (!r) return f > g ^ t ? 1 : -1;
  for (l = (f = o.length) < (g = a.length) ? f : g, u = 0; u < l; u++) if (o[u] != a[u]) return o[u] > a[u] ^ t ? 1 : -1;
...
var Qt = Uh(), py = class {
  ...
  splay(n) {
    ...
    for (; ; )
      if (f = l(u.key, n), f > 0) {
        let g = u.left;
        if (g == null || (f = l(g.key, n), f > 0 && (u.left = g.right, g.right = u, u = g, g = u.left, g == null)))
          break;
        t == null ? r = u : t.left = u, t = u, u = g;
      } else if (f < 0) {
        let g = u.right;
        if (g == null || (f = l(g.key, n), f < 0 && (u.right = g.left, g.left = u, u = g, g = u.right, g == null)))
          break;
...
}, Ac, Oc, is = class Ur extends _y {
  constructor(t, r) {
    super();
    le(this, "root", null);
    le(this, "compare");
    le(this, "validKey");
    le(this, Ac, "[object Set]");
  ...
  add(t) {
    ...
    return r != 0 && this.addNewRoot(new Pr(t), r), this;
  }
  addAndReturn(t) {
    const r = this.splay(t);
    return r != 0 && this.addNewRoot(new Pr(t), r), this.root.key;
  }
  addAll(t) {
    for (const r of t)
      this.add(r);
  ...
  retainAll(t) {
    const r = new Ur(this.compare, this.validKey), o = this.modificationCount;
    for (const a of t) {
  ...
  intersection(t) {
    const r = new Ur(this.compare, this.validKey);
    for (const o of this)
      t.has(o) && r.add(o);
    return r;
  }
  ...
  clone() {
    const t = new Ur(this.compare, this.validKey);
  ...
  copyNode(t) {
    ...
    function r(a, u) {
      let l, f;
      do {
        if (l = a.left, f = a.right, l != null) {
          const g = new Pr(l.key);
          u.left = g, r(l, g);
        }
        if (f != null) {
          const g = new Pr(f.key);
          u.right = g, a = f, u = g;
        }
      } while (f != null);
    }
    const o = new Pr(t.key);
    return r(t, o), o;
  }
  toSet() {
    return this.clone();
  ...
  [(Oc = Symbol.iterator, Ac = Symbol.toStringTag, Oc)]() {
  ...
  const e = n ? (t, r) => r.minus(t).abs().isLessThanOrEqualTo(n) : Xh(!1);
...
function Ey(n) {
  ...
  return (t, r, o) => {
    const a = t.x, u = t.y, l = o.x, f = o.y, g = u.minus(f).times(r.x.minus(l)).minus(a.minus(l).times(r.y.minus(f)));
    return e(g, a, u, l, f) ? 0 : g.comparedTo(0);
  };
}
var Cy = (n) => n, Sy = (n) => {
  if (n) {
    const e = new is(Ro(n)), t = new is(Ro(n)), r = (a, u) => u.addAndReturn(a), o = (a) => ({
      x: r(a.x, e),
      y: r(a.y, t)
    });
    return o({ x: new Qt(0), y: new Qt(0) }), o;
  }
  return Cy;
}, Ao = (n) => ({
  set: (e) => {
  ...
  snap: Sy(n),
  orient: Ey(n)
}), gn = Ao(), Nr = (n, e) => n.ll.x.isLessThanOrEqualTo(e.x) && e.x.isLessThanOrEqualTo(n.ur.x) && n.ll.y.isLessThanOrEqualTo(e.y) && e.y.isLessThanOrEqualTo(n.ur.y), Oo = (n, e) => {
...
}, Hi = (n, e) => n.x.times(e.y).minus(n.y.times(e.x)), Vh = (n, e) => n.x.times(e.x).plus(n.y.times(e.y)), ss = (n) => Vh(n, n).sqrt(), Iy = (n, e, t) => {
  const r = { x: e.x.minus(n.x), y: e.y.minus(n.y) }, o = { x: t.x.minus(n.x), y: t.y.minus(n.y) };
  return Hi(o, r).div(ss(o)).div(ss(r));
}, ky = (n, e, t) => {
  const r = { x: e.x.minus(n.x), y: e.y.minus(n.y) }, o = { x: t.x.minus(n.x), y: t.y.minus(n.y) };
  return Vh(o, r).div(ss(o)).div(ss(r));
}, Sl = (n, e, t) => e.y.isZero() ? null : { x: n.x.plus(e.x.div(e.y).times(t.minus(n.y))), y: t }, Il = (n, e, t) => e.x.isZero() ? null : { x: t, y: n.y.plus(e.y.div(e.x).times(t.minus(n.x))) }, by = (n, e, t, r) => {
  if (e.x.isZero()) return Il(t, r, n.x);
  if (r.x.isZero()) return Il(n, e, t.x);
  if (e.y.isZero()) return Sl(t, r, n.y);
  if (r.y.isZero()) return Sl(n, e, t.y);
  const o = Hi(e, r);
  if (o.isZero()) return null;
  const a = { x: t.x.minus(n.x), y: t.y.minus(n.y) }, u = Hi(a, e).div(o), l = Hi(a, r).div(o), f = n.x.plus(l.times(e.x)), g = t.x.plus(u.times(r.x)), v = n.y.plus(l.times(e.y)), m = t.y.plus(u.times(r.y)), p = f.plus(g).div(2), _ = v.plus(m).div(2);
  return { x: p, y: _ };
}, Zt = class Hh {
  ...
  static compare(e, t) {
    const r = Hh.comparePoints(e.point, t.point);
  ...
  getLeftmostComparator(e) {
    const t = /* @__PURE__ */ new Map(), r = (o) => {
      const a = o.otherSE;
      t.set(o, {
        sine: Iy(this.point, e.point, a.point),
        cosine: ky(this.point, e.point, a.point)
      });
    };
    return (o, a) => {
      t.has(o) || r(o), t.has(a) || r(a);
      const { sine: u, cosine: l } = t.get(o), { sine: f, cosine: g } = t.get(a);
      return u.isGreaterThanOrEqualTo(0) && f.isGreaterThanOrEqualTo(0) ? l.isLessThan(g) ? 1 : l.isGreaterThan(g) ? -1 : 0 : u.isLessThan(0) && f.isLessThan(0) ? l.isLessThan(g) ? -1 : l.isGreaterThan(g) ? 1 : 0 : f.isLessThan(u) ? -1 : f.isGreaterThan(u) ? 1 : 0;
    };
  }
}, My = class Do {
  constructor(e) {
  ...
  static factory(e) {
    ...
    for (let r = 0, o = e.length; r < o; r++) {
      ...
      let u = null, l = a.leftSE, f = a.rightSE;
      const g = [l], v = l.point, m = [];
      for (; u = l, l = f, g.push(l), l.point !== v; )
        for (; ; ) {
          const p = l.getAvailableLinkedEvents();
          if (p.length === 0) {
            const S = g[0].point, L = g[g.length - 1].point;
            throw new Error(
              `Unable to complete output ring starting at [${S.x}, ${S.y}]. Last matching segment found ends at [${L.x}, ${L.y}].`
            );
          }
          if (p.length === 1) {
            f = p[0].otherSE;
          ...
          for (let S = 0, L = m.length; S < L; S++)
            if (m[S].point === l.point) {
              _ = S;
              break;
            }
          if (_ !== null) {
            const S = m.splice(_)[0], L = g.splice(S.index);
            L.unshift(L[0].otherSE), t.push(new Do(L.reverse()));
            continue;
          }
          m.push({
            index: g.length,
          ...
          const w = l.getLeftmostComparator(u);
  ...
  getGeom() {
    ...
    for (let g = 1, v = this.events.length - 1; g < v; g++) {
      ...
      gn.orient(m, e, p) !== 0 && (t.push(m), e = m);
    }
    if (t.length === 1) return null;
    const r = t[0], o = t[1];
    gn.orient(r, e, o) === 0 && t.shift(), t.push(t[0]);
    const a = this.isExteriorRing() ? 1 : -1, u = this.isExteriorRing() ? 0 : t.length - 1, l = this.isExteriorRing() ? t.length : -1, f = [];
    for (let g = u; g != l; g += a)
  ...
  _composePolys(n) {
    ...
    for (let r = 0, o = n.length; r < o; r++) {
      const a = n[r];
      if (!a.poly)
        if (a.isExteriorRing()) e.push(new kl(a));
        else {
          const u = a.enclosingRing();
          u != null && u.poly || e.push(new kl(u)), (t = u == null ? void 0 : u.poly) == null || t.addInterior(a);
        }
    }
    return e;
  }
}, Py = class {
  constructor(n, e = os.compare) {
    le(this, "queue");
    le(this, "tree");
    le(this, "segments");
    this.queue = n, this.tree = new is(e), this.segments = [];
  }
  process(n) {
    const e = n.segment, t = [];
    if (n.consumedBy)
    ...
    if (n.isLeft) {
      let a = null;
      if (r) {
        const l = r.getIntersection(e);
        if (l !== null && (e.isAnEndpoint(l) || (a = l), !r.isAnEndpoint(l))) {
      ...
      if (o) {
        ...
        if (l !== null && (e.isAnEndpoint(l) || (u = l), !o.isAnEndpoint(l))) {
      ...
      if (a !== null || u !== null) {
        let l = null;
        a === null ? l = u : u === null ? l = a : l = Zt.comparePoints(
          a,
          u
  ...
  run(n, e, t) {
    ...
    for (let g = 0, v = t.length; g < v; g++)
      r.push(new Ml(t[g], !1));
    if (Yr.numMultiPolys = r.length, Yr.type === "difference") {
      const g = r[0];
      let v = 1;
      for (; v < r.length; )
        Oo(r[v].bbox, g.bbox) !== null ? v++ : r.splice(v, 1);
    }
    if (Yr.type === "intersection")
      for (let g = 0, v = r.length; g < v; g++) {
        const m = r[g];
        for (let p = g + 1, _ = r.length; p < _; p++)
          if (Oo(m.bbox, r[p].bbox) === null) return [];
      }
    const o = new is(Zt.compare);
    for (let g = 0, v = r.length; g < v; g++) {
    ...
    gn.reset();
    const l = My.factory(a.segments);
    return new Ly(l).getGeom();
  }
}, Yr = new Ny(), mr = Yr, Ty = 0, os = class Wi {
  ...
  constructor(e, t, r, o) {
    ...
    le(this, "_afterState");
    le(this, "_isInResult");
    this.id = ++Ty, this.leftSE = e, e.segment = this, e.otherSE = t, this.rightSE = t, t.segment = this, t.otherSE = e, this.rings = r, this.windings = o;
  }
  ...
  static compare(e, t) {
    ...
    const l = e.leftSE.point.y, f = t.leftSE.point.y, g = e.rightSE.point.y, v = t.rightSE.point.y;
    if (r.isLessThan(o)) {
      if (f.isLessThan(l) && f.isLessThan(g)) return 1;
      if (f.isGreaterThan(l) && f.isGreaterThan(g)) return -1;
    ...
    if (r.isGreaterThan(o)) {
      if (l.isLessThan(f) && l.isLessThan(v)) return -1;
      if (l.isGreaterThan(f) && l.isGreaterThan(v)) return 1;
    ...
    if (!a.eq(u)) {
      const m = g.minus(l), p = a.minus(r), _ = v.minus(f), w = u.minus(o);
  ...
  static fromRing(e, t, r) {
    ...
    const f = new Zt(o, !0), g = new Zt(a, !1);
    return new Wi(f, g, [r], [u]);
  }
   ...
   */
  comparePoint(e) {
    return gn.orient(this.leftSE.point, e, this.rightSE.point);
  }
  /**
   ...
   */
  getIntersection(e) {
    const t = this.bbox(), r = e.bbox(), o = Oo(t, r);
    if (o === null) return null;
    const a = this.leftSE.point, u = this.rightSE.point, l = e.leftSE.point, f = e.rightSE.point, g = Nr(t, l) && this.comparePoint(l) === 0, v = Nr(r, a) && e.comparePoint(a) === 0, m = Nr(t, f) && this.comparePoint(f) === 0, p = Nr(r, u) && e.comparePoint(u) === 0;
    if (v && g)
      return p && !m ? u : !p && m ? f : null;
    if (v)
      return m && a.x.eq(f.x) && a.y.eq(f.y) ? null : a;
    if (g)
      return p && u.x.eq(l.x) && u.y.eq(l.y) ? null : l;
    if (p && m) return null;
    if (p) return u;
    if (m) return f;
    const _ = by(a, this.vector(), l, e.vector());
    return _ === null || !Nr(o, _) ? null : gn.snap(_);
  }
  /**
   ...
   */
  split(e) {
    const t = [], r = e.events !== void 0, o = new Zt(e, !0), a = new Zt(e, !1), u = this.rightSE;
    ...
    return Zt.comparePoints(l.leftSE.point, l.rightSE.point) > 0 && l.swapEvents(), Zt.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(), r && (o.checkForConsuming(), a.checkForConsuming()), t;
  }
  ...
  consume(e) {
    ...
    if (o !== 0) {
      ...
      for (let a = 0, u = r.rings.length; a < u; a++) {
        const l = r.rings[a], f = r.windings[a], g = t.rings.indexOf(l);
        g === -1 ? (t.rings.push(l), t.windings.push(f)) : t.windings[g] += f;
      }
  ...
  afterState() {
    ...
    for (let l = 0, f = this.rings.length; l < f; l++) {
      const g = this.rings[l], v = this.windings[l], m = t.indexOf(g);
      m === -1 ? (t.push(g), r.push(v)) : r[m] += v;
    }
    const a = [], u = [];
    for (let l = 0, f = t.length; l < f; l++) {
      if (r[l] === 0) continue;
      const g = t[l], v = g.poly;
      if (u.indexOf(v) === -1)
  ...
  isInResult() {
    ...
    switch (mr.type) {
      ...
      case "intersection": {
        let r, o;
        e.length < t.length ? (r = e.length, o = t.length) : (r = t.length, o = e.length), this._isInResult = o === mr.numMultiPolys && r < o;
        break;
      }
      case "xor": {
  ...
  constructor(n, e, t) {
    ...
    if (this.poly = e, this.isExterior = t, this.segments = [], typeof n[0][0] != "number" || typeof n[0][1] != "number")
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    const r = gn.snap({ x: new Qt(n[0][0]), y: new Qt(n[0][1]) });
    this.bbox = {
      ll: { x: r.x, y: r.y },
      ur: { x: r.x, y: r.y }
    };
    ...
    for (let a = 1, u = n.length; a < u; a++) {
      if (typeof n[a][0] != "number" || typeof n[a][1] != "number")
        throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
      const l = gn.snap({ x: new Qt(n[a][0]), y: new Qt(n[a][1]) });
      l.x.eq(o.x) && l.y.eq(o.y) || (this.segments.push(os.fromRing(o, l, this)), l.x.isLessThan(this.bbox.ll.x) && (this.bbox.ll.x = l.x), l.y.isLessThan(this.bbox.ll.y) && (this.bbox.ll.y = l.y), l.x.isGreaterThan(this.bbox.ur.x) && (this.bbox.ur.x = l.x), l.y.isGreaterThan(this.bbox.ur.y) && (this.bbox.ur.y = l.y), o = l);
    }
    (!r.x.eq(o.x) || !r.y.eq(o.y)) && this.segments.push(os.fromRing(o, r, this));
  }
  getSweepEvents() {
    const n = [];
  ...
  constructor(n, e) {
    ...
    if (!Array.isArray(n))
      throw new Error("Input geometry is not a valid Polygon or MultiPolygon");
    this.exteriorRing = new bl(n[0], this, !0), this.bbox = {
      ll: { x: this.exteriorRing.bbox.ll.x, y: this.exteriorRing.bbox.ll.y },
      ur: { x: this.exteriorRing.bbox.ur.x, y: this.exteriorRing.bbox.ur.y }
    }, this.interiorRings = [];
    for (let t = 1, r = n.length; t < r; t++) {
      const o = new bl(n[t], this, !1);
  ...
  constructor(n, e) {
    ...
    this.polys = [], this.bbox = {
      ll: { x: new Qt(Number.POSITIVE_INFINITY), y: new Qt(Number.POSITIVE_INFINITY) },
      ur: { x: new Qt(Number.NEGATIVE_INFINITY), y: new Qt(Number.NEGATIVE_INFINITY) }
    };
    for (let t = 0, r = n.length; t < r; t++) {
      const o = new Ry(n[t], this);
...
}, xn = (n, ...e) => mr.run("union", n, e), Wh = (n, ...e) => mr.run("intersection", n, e), Ay = (n, ...e) => mr.run("xor", n, e), $h = (n, ...e) => mr.run("difference", n, e), Oy = gn.set;
...
function Fy(n) {
  ...
  const t = n.features[0].properties || {}, r = $h(e[0], ...e.slice(1));
...
function By(n, e = {}) {
  ...
  if (t) {
    ...
    for (let u = 0; u < a.length; u++) {
      ...
      l && l.properties && (l.properties[t] = a[u], r.push(l));
    }
  } else
    return Fo(
      wt(
...
function Zh(n, e) {
  var t, r;
  e = e || {};
  const o = e.threshold || 1e4, a = e.p || 2, u = (t = e.binary) != null ? t : !1, l = e.alpha || -1, f = (r = e.standardization) != null ? r : !1, g = [];
  Le(n, (m) => {
    g.push(Ft(m));
  });
  const v = [];
  ...
  for (let m = 0; m < g.length; m++)
    for (let p = m; p < g.length; p++) {
      m === p && (v[m][p] = 0);
      const _ = Gy(g[m], g[p], a);
      v[m][p] = _, v[p][m] = _;
    }
  for (let m = 0; m < g.length; m++)
    for (let p = 0; p < g.length; p++) {
      const _ = v[m][p];
      _ !== 0 && (u ? _ <= o ? v[m][p] = 1 : v[m][p] = 0 : _ <= o ? v[m][p] = Math.pow(_, l) : v[m][p] = 0);
    }
  if (f)
    for (let m = 0; m < g.length; m++) {
...
function xs(n, e, t, r = {}) {
  ...
  return l[0] += l[0] - u[0] > 180 ? -360 : u[0] - l[0] > 180 ? 360 : 0, de(l, r.properties);
}
function qy(n, e, t, r) {
  r = r === void 0 ? Be : Number(r);
  const o = e / r, a = n[0] * Math.PI / 180, u = Qe(n[1]), l = Qe(t), f = o * Math.cos(l);
  let g = u + f;
  Math.abs(g) > Math.PI / 2 && (g = g > 0 ? Math.PI - g : -Math.PI - g);
  const v = Math.log(
    Math.tan(g / 2 + Math.PI / 4) / Math.tan(u / 2 + Math.PI / 4)
  ), m = Math.abs(v) > 1e-11 ? f / v : Math.cos(u), p = o * Math.sin(l) / m;
  return [
...
function Kh(n, e, t) {
  ...
  return (o === !1 || o === void 0) && (n = nt(n)), He(n, function(u) {
    const f = Fn(a, u) + e, g = sr(a, u), v = me(
      xs(a, g, f)
    );
    u[0] = v[0], u[1] = v[1];
  }), wn(n), n;
...
function Jh(n, e, t, r) {
  ...
  let u = r.angle || 0;
  const l = r.pivot || n, f = r.properties || {};
  ...
  const g = Me(
    Kh(de(Me(n)), u, { pivot: l })
  );
  u = -90 + u, o = Math.ceil(o / 4);
  let v = [], m = [];
  const p = e, _ = t, w = _, S = (p - _) / (Math.PI / 2), L = (p + _) * Math.PI / 4, b = 0.5, k = o;
  let N = 0, A = 0;
  for (let Y = 0; Y < o; Y++)
    A += N, S === 0 ? N = L / k / w : N = (-(S * A + w) + Math.sqrt(Math.pow(S * A + w, 2) - 4 * (b * S) * -(L / k))) / (2 * (b * S)), A != 0 && v.push(A);
  m.push(0);
...
const Ll = Math.PI / 180, Pl = 180 / Math.PI;
class as {
  constructor(e, t) {
    le(this, "lon");
    le(this, "lat");
    le(this, "x");
    le(this, "y");
    this.lon = e, this.lat = t, this.x = Ll * e, this.y = Ll * t;
  }
  /**
...
class Hy {
  constructor(e, t, r) {
    ...
    if (!t || t.x === void 0 || t.y === void 0)
      throw new Error("GreatCircle constructor expects two args: start and end objects with x and y properties");
    this.start = new as(e.x, e.y), this.end = new as(t.x, t.y), this.properties = r || {};
   ...
   */
  Arc(e, t) {
    var p, _, w, S, L, b, k, N, A, O, Y, V, C, M, T, D, B, z, X, R, U, G, H, J, W;
    let r = [];
    if (!e || e <= 2)
    ...
    let o = !1, a = 0;
    const u = (t == null ? void 0 : t.offset) ?? 10, l = 180 - u, f = -180 + u, g = 360 - u;
    for (let j = 1; j < r.length; ++j) {
      const Q = ((p = r[j - 1]) == null ? void 0 : p[0]) ?? 0, re = ((_ = r[j]) == null ? void 0 : _[0]) ?? 0, ee = Math.abs(re - Q);
      ee > g && (re > l && Q < f || Q > l && re < f) ? o = !0 : ee > a && (a = ee);
    }
    const v = [];
    if (o && a < u) {
      let j = [];
      ...
      for (let Q = 0; Q < r.length; ++Q) {
        ...
        if (Q > 0 && Math.abs(re - (((S = r[Q - 1]) == null ? void 0 : S[0]) ?? 0)) > g) {
          const ee = parseFloat((((L = r[Q - 1]) == null ? void 0 : L[0]) ?? 0).toString()), te = parseFloat((((b = r[Q - 1]) == null ? void 0 : b[1]) ?? 0).toString()), se = parseFloat((((k = r[Q]) == null ? void 0 : k[0]) ?? 0).toString()), fe = parseFloat((((N = r[Q]) == null ? void 0 : N[1]) ?? 0).toString());
          if (ee > -180 && ee < f && se === 180 && Q + 1 < r.length && (((A = r[Q - 1]) == null ? void 0 : A[0]) ?? 0) > -180 && (((O = r[Q - 1]) == null ? void 0 : O[0]) ?? 0) < f) {
            ...
            continue;
          } else if (ee > l && ee < 180 && se === -180 && Q + 1 < r.length && (((M = r[Q - 1]) == null ? void 0 : M[0]) ?? 0) > l && (((T = r[Q - 1]) == null ? void 0 : T[0]) ?? 0) < 180) {
            j.push([180, ((D = r[Q]) == null ? void 0 : D[1]) ?? 0]), Q++, j.push([((B = r[Q]) == null ? void 0 : B[0]) ?? 0, ((z = r[Q]) == null ? void 0 : z[1]) ?? 0]);
            continue;
          }
          if (ee <= 180 && se >= 180 && ee < se) {
            const Z = (180 - ee) / (se - ee), Fe = Z * fe + (1 - Z) * te;
            j.push([(((X = r[Q - 1]) == null ? void 0 : X[0]) ?? 0) > l ? 180 : -180, Fe]), j = [], j.push([(((R = r[Q - 1]) == null ? void 0 : R[0]) ?? 0) > l ? -180 : 180, Fe]), v.push(j);
          } else
            j = [], v.push(j);
    ...
    const m = new Xy(this.properties);
...
function Wy(n, e, t = {}) {
  ...
  const { properties: r = {}, npoints: o = 100, offset: a = 10 } = t, u = Me(n), l = Me(e);
  if (u[0] === l[0] && u[1] === l[1]) {
...
function Qr(n, e = {}) {
  ...
  const r = Wh(t[0], ...t.slice(1));
  return r.length === 0 ? null : r.length === 1 ? ye(r[0], e.properties) : wt(r, e.properties);
}
function jh(n, e, t = {}) {
  const r = JSON.stringify(t.properties || {}), [o, a, u, l] = n, f = (a + l) / 2, g = (o + u) / 2, m = e * 2 / ze([o, f], [u, f], t) * (u - o), _ = e * 2 / ze([g, a], [g, l], t) * (l - a), w = m / 2, S = w * 2, L = Math.sqrt(3) / 2 * _, b = u - o, k = l - a, N = 3 / 4 * S, A = L, O = (b - S) / (S - w / 2), Y = Math.floor(O), V = (Y * N - w / 2 - b) / 2 - w / 2 + N / 2, C = Math.floor((k - L) / L);
  let M = (k - C * L) / 2;
  const T = C * L - k > L / 2;
  T && (M -= L / 4);
  const D = [], B = [];
    ...
    for (let R = 0; R <= C; R++) {
      ...
      if (U && (H -= L / 2), t.triangles === !0)
        Zy(
          ...
          t.mask ? Qr(ce([t.mask, J])) && z.push(J) : z.push(J);
        });
      else {
        const J = $y(
          [G, H],
...
function $y(n, e, t, r, o, a) {
  const u = [];
  for (let l = 0; l < 6; l++) {
    const f = n[0] + e * o[l], g = n[1] + t * a[l];
    u.push([f, g]);
  }
  return u.push(u[0].slice()), ye([u], r);
}
function Zy(n, e, t, r, o, a) {
  const u = [];
  for (let l = 0; l < 6; l++) {
    const f = [];
    f.push(n), f.push([n[0] + e * o[l], n[1] + t * a[l]]), f.push([
      n[0] + e * o[(l + 1) % 6],
      n[1] + t * a[(l + 1) % 6]
...
function ef(n, e, t = {}) {
  ...
  for (var r = [], o = n[0], a = n[1], u = n[2], l = n[3], f = e / ze([o, a], [u, a], t), g = f * (u - o), v = e / ze([o, a], [o, l], t), m = v * (l - a), p = u - o, _ = l - a, w = Math.floor(p / g), S = Math.floor(_ / m), L = (p - w * g) / 2, b = (_ - S * m) / 2, k = o + L; k <= u; ) {
    for (var N = a + b; N <= l; ) {
      var A = de([k, N], t.properties);
      t.mask ? ca(A, t.mask) && r.push(A) : r.push(A), N += m;
    }
    k += g;
  }
  return ce(r);
...
function tf(n, e, t, r = {}) {
  const o = [], a = n[0], u = n[1], l = n[2], f = n[3], g = l - a, v = Dn(e, r.units, "degrees"), m = f - u, p = Dn(t, r.units, "degrees"), _ = Math.floor(Math.abs(g) / v), w = Math.floor(Math.abs(m) / p), S = (g - _ * v) / 2, L = (m - w * p) / 2;
  let b = a + S;
  for (let k = 0; k < _; k++) {
    let N = u + L;
    for (let A = 0; A < w; A++) {
      ...
      r.mask ? uh(r.mask, O) && o.push(O) : o.push(O), N += p;
    }
    b += v;
  }
  return ce(o);
...
function nf(n, e, t = {}) {
  for (var r = [], o = e / ze([n[0], n[1]], [n[2], n[1]], t), a = o * (n[2] - n[0]), u = e / ze([n[0], n[1]], [n[0], n[3]], t), l = u * (n[3] - n[1]), f = 0, g = n[0]; g <= n[2]; ) {
    for (var v = 0, m = n[1]; m <= n[3]; ) {
      ...
      f % 2 === 0 && v % 2 === 0 ? (p = ye(
        ...
        t.properties
      )), t.mask ? (Qr(ce([t.mask, p])) && r.push(p), Qr(ce([t.mask, _])) && r.push(_)) : (r.push(p), r.push(_)), m += l, v++;
    }
    f++, g += a;
  }
  return ce(r);
...
function Ky(n, e, t) {
  ...
  if (dn(n, "Point", "input must contain Points"), !e)
    throw new Error("cellSize is required");
  var l = (r = t.gridType) != null ? r : "square", f = (o = t.property) != null ? o : "elevation", g = (a = t.weight) != null ? a : 1, v = (u = t.bbox) != null ? u : qe(n);
  ...
  return Le(m, function(_) {
    var w, S = 0, L = 0;
    Le(n, function(k) {
      var N, A = l === "point" ? _ : Ft(_), O = ze(A, k, t), Y;
      if (f !== void 0 && (Y = (N = k.properties) == null ? void 0 : N[f]), Y === void 0 && (Y = k.geometry.coordinates[2]), Y === void 0)
    ...
    var b = nt(_);
    (w = b.properties) != null || (b.properties = {}), b.properties[f] = S / L, p.push(b);
  }), ce(p);
}
var Jy = Object.defineProperty, Nl = Object.getOwnPropertySymbols, Qy = Object.prototype.hasOwnProperty, jy = Object.prototype.propertyIsEnumerable, Tl = (n, e, t) => e in n ? Jy(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, Rl = (n, e) => {
  for (var t in e || (e = {}))
    Qy.call(e, t) && Tl(n, t, e[t]);
  if (Nl)
    for (var t of Nl(e))
      jy.call(e, t) && Tl(n, t, e[t]);
  return n;
};
function ep(n, e = {}) {
  if (!Oe(e)) throw new Error("options is invalid");
  const { zProperty: t = "elevation", flip: r = !1, flags: o = !1 } = e;
  dn(n, "Point", "input must contain Points");
  for (var a = tp(n, r), u = [], l = 0; l < a.length; l++) {
    for (var f = a[l], g = [], v = 0; v < f.length; v++) {
      var m = f[v];
      m.properties == null && (m.properties = {}), m.properties[t] ? g.push(m.properties[t]) : g.push(0), o === !0 && (m.properties.matrixPosition = [l, v]);
    }
    u.push(g);
  }
  return u;
...
function np(n, e, t) {
  ...
  if (dn(n, "Point", "Input must contain Points"), !e) throw new Error("breaks is required");
  if (!Array.isArray(e)) throw new Error("breaks is not an Array");
  if (!Oe(o))
    throw new Error("commonProperties is not an Object");
  if (!Array.isArray(a))
    throw new Error("breaksProperties is not an Array");
  const u = ep(n, { zProperty: r, flip: !0 }), l = u[0].length;
  if (u.length < 2 || l < 2)
...
function Al(n, e) {
  ...
  for (let u = 0; u < o - 1; u++)
    for (let l = 0; l < r - 1; l++) {
      const f = n[u + 1][l + 1], g = n[u][l + 1], v = n[u][l], m = n[u + 1][l];
...
function ip(n, e) {
    ...
    do {
      ...
      for (let f = 0; f < n.length; f++) {
        ...
        if (g[0][0] === u[u.length - 1][0] && g[0][1] === u[u.length - 1][1]) {
          l = !0, u.push(g[1]), n.splice(f, 1);
          break;
        }
        if (g[1][0] === u[0][0] && g[1][1] === u[0][1]) {
          l = !0, u.unshift(g[0]), n.splice(f, 1);
          break;
        }
      }
    } while (l);
  ...
  for (; o.length > 0; ) {
    ...
    else if (l[0] === r - 1 && l[1] !== t - 1)
      f = Gi(
        o,
        (v) => v[0][0] === r - 1 && v[0][1] > l[1],
        // right side, above end
        (v, m) => v[0][1] - m[0][1]
        // prefer positions to the bottom
      ), g = [r - 1, t - 1];
    else if (l[1] === t - 1 && l[0] !== 0)
      f = Gi(
        o,
        (v) => v[0][1] === t - 1 && v[0][0] < l[0],
...
function sp(n, e, t) {
  const r = qe(t), o = r[2] - r[0], a = r[3] - r[1], u = r[0], l = r[1], f = e[0].length - 1, g = e.length - 1, v = o / f, m = a / g;
...
var lp = Object.defineProperty, Dl = Object.getOwnPropertySymbols, cp = Object.prototype.hasOwnProperty, hp = Object.prototype.propertyIsEnumerable, Fl = (n, e, t) => e in n ? lp(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, Bl = (n, e) => {
  for (var t in e || (e = {}))
    cp.call(e, t) && Fl(n, t, e[t]);
  if (Dl)
    for (var t of Dl(e))
      hp.call(e, t) && Fl(n, t, e[t]);
  return n;
};
function fp(n, e = {}) {
  if (!Oe(e)) throw new Error("options is invalid");
  const { zProperty: t = "elevation", flip: r = !1, flags: o = !1 } = e;
  dn(n, "Point", "input must contain Points");
  for (var a = gp(n, r), u = [], l = 0; l < a.length; l++) {
    for (var f = a[l], g = [], v = 0; v < f.length; v++) {
      var m = f[v];
      m.properties == null && (m.properties = {}), m.properties[t] ? g.push(m.properties[t]) : g.push(0), o === !0 && (m.properties.matrixPosition = [l, v]);
    }
...
function dp(n, e, t) {
  ...
  const u = fp(n, { zProperty: r, flip: !0 }), l = u[0].length;
  if (u.length < 2 || l < 2)
    throw new Error("Matrix of points must be at least 2x2");
  for (let v = 1; v < u.length; v++)
    if (u[v].length !== l)
...
function mp(n, e, t, r, o) {
  const a = [];
  for (let u = 0; u < e.length; u++) {
    const l = +e[u], f = Bl(Bl({}, r), o[u]);
    f[t] = l;
    const g = En(vp(n, l), f);
    a.push(g);
  }
...
function vp(n, e) {
  ...
  for (let l = 0; l < r - 1; l++)
    for (let f = 0; f < o - 1; f++) {
      const g = n[l + 1][f + 1], v = n[l][f + 1], m = n[l][f], p = n[l + 1][f];
  ...
  for (; t.length > 0; ) {
    ...
    do {
      ...
      for (let g = 0; g < t.length; g++) {
        const v = t[g];
        if (v[0][0] === l[l.length - 1][0] && v[0][1] === l[l.length - 1][1]) {
          f = !0, l.push(v[1]), t.splice(g, 1);
          break;
        }
        if (v[1][0] === l[0][0] && v[1][1] === l[0][1]) {
          f = !0, l.unshift(v[0]), t.splice(g, 1);
          break;
        }
      }
    } while (f);
...
function yp(n, e, t) {
  const r = qe(t), o = r[2] - r[0], a = r[3] - r[1], u = r[0], l = r[1], f = e[0].length - 1, g = e.length - 1, v = o / f, m = a / g, p = (_) => {
    _[0] = _[0] * v + u, _[1] = _[1] * m + l;
  };
  return n.forEach((_) => {
    He(_, p);
  }), n;
  ...
  return e.forEach((o) => {
    e.forEach((a) => {
      for (let u = 0; u < o.length - 1; u++)
        for (let l = u; l < a.length - 1; l++) {
          if (o === a && (Math.abs(u - l) === 1 || // segments are first and last segment of lineString
          u === 0 && l === o.length - 2 && // lineString is closed
...
function _p(n, e, t, r, o, a, u, l) {
  ...
  return f = (l - a) * (t - n) - (u - o) * (r - e), f === 0 ? _.x !== null && _.y !== null ? _ : !1 : (g = e - a, v = n - o, m = (u - o) * g - (l - a) * v, p = (t - n) * g - (r - e) * v, g = m / f, v = p / f, _.x = n + g * (t - n), _.y = e + g * (r - e), g >= 0 && g <= 1 && (_.onLine1 = !0), v >= 0 && v <= 1 && (_.onLine2 = !0), _.onLine1 && _.onLine2 ? [_.x, _.y] : !1);
}
function Ia(n, e = {}) {
  return ds(
    n,
    (t, r) => {
      ...
      return t + ze(o[0], o[1], e);
    },
    0
  );
}
function rf(n, e, t, r, o = {}) {
  const a = o.steps || 64, u = Gl(t), l = Gl(r), f = !Array.isArray(n) && n.type === "Feature" ? n.properties : {};
  if (u === l)
    return ke(
      ma(n, e, o).geometry.coordinates[0],
      f
    );
  const g = u, v = u < l ? l : l + 360, m = [], p = (v - g) / a;
  for (let _ = 0; _ <= a; _++) {
    const w = _ === a ? v : g + _ * p;
    m.push(
      en(n, e, w, o).geometry.coordinates
    );
  }
  return ke(m, f);
}
...
function sf(n, e, t, r = {}) {
  ...
  for (let _ = 0; _ < a.length && !(e >= f && _ === a.length - 1); _++) {
    if (f > e && u.length === 0) {
      let w = e - f;
      if (!w)
        return u.push(a[_]), ke(u);
      v = fn(a[_], a[_ - 1]) - 180, m = en(a[_], w, v, { units: o }), u.push(m.geometry.coordinates);
    }
    if (f >= t)
      return g = t - f, g ? (v = fn(a[_], a[_ - 1]) - 180, m = en(a[_], g, v, { units: o }), u.push(m.geometry.coordinates), ke(u)) : (u.push(a[_]), ke(u));
    if (f >= e && u.push(a[_]), _ === a.length - 1)
      return ke(u);
    f += ze(a[_], a[_ + 1], { units: o });
  }
  if (f < e && a.length === l)
...
function wp(n, e, t = {}) {
  ...
  const a = [];
  return it(n, (u) => {
    o && (u.geometry.coordinates = u.geometry.coordinates.reverse()), xp(
      u,
      e,
      r,
      (l) => {
...
function Ip(n, e) {
  var t = n[0], r = us(n), o = e[0], a = us(e), u = Bo(r, a), l = Cp(o, t), f = Bo(l, a), g = f / u, v = Ep(t, Sp(g, r));
  return v;
}
function kp(n, e) {
  var t = us(n), r = us(e);
...
function Lp(n, e, t) {
  ...
  ), o = n[0] + t * (e[1] - n[1]) / r, a = e[0] + t * (e[1] - n[1]) / r, u = n[1] + t * (n[0] - e[0]) / r, l = e[1] + t * (n[0] - e[0]) / r;
  return [
    [o, u],
    [a, l]
  ];
...
function Pp(n, e, t) {
  ...
  const o = ln(t, n), a = ln(t, e);
  ql(t, o), ql(t, a);
  const u = o.properties.segmentIndex <= a.properties.segmentIndex ? [o, a] : [a, o], l = [u[0].geometry.coordinates];
  for (let f = u[0].properties.segmentIndex + 1; f < u[1].properties.segmentIndex + 1; f++)
    l.push(r[f]);
  return l.push(u[1].geometry.coordinates), ke(l, t.type === "Feature" ? t.properties : {});
}
function ql(n, e) {
...
function Np(n, e = {}) {
  var t, r, o, a = e.properties, u = (t = e.autoComplete) != null ? t : !0, l = (r = e.orderCoords) != null ? r : !0, f = (o = e.mutate) != null ? o : !1;
...
function Ul(n, e, t, r) {
  ...
  switch (u) {
    case "LineString":
      return t && (a = Yl(a)), ye([a], e);
    case "MultiLineString":
      var l = [], f = 0;
      return a.forEach(function(g) {
        if (t && (g = Yl(g)), r) {
          var v = Tp(qe(ke(g)));
          v > f ? (l.unshift(g), f = v) : l.push(g);
        } else
          l.push(g);
      }), ye(l, e);
    default:
...
function Rp(n, e, t) {
  ...
  const u = Op(a);
  let l = null;
  return n.type === "FeatureCollection" ? l = Ap(n) : n.type === "Feature" ? l = Go(
    xn(n.geometry.coordinates)
  ) : l = Go(
    xn(n.coordinates)
  ), l.geometry.coordinates.forEach(function(f) {
    u.geometry.coordinates.push(f[0]);
  }), u;
}
function Ap(n) {
  const e = n.features.length === 2 ? xn(
...
function Dp(n, e) {
  const t = ze(n, e), r = fn(n, e);
  return en(n, t / 2, r);
}
function Fp(n, e) {
  var t, r;
  const o = e.inputField, a = e.threshold || 1e5, u = e.p || 2, l = (t = e.binary) != null ? t : !1, f = e.alpha || -1, g = (r = e.standardization) != null ? r : !0, v = Zh(n, {
    alpha: f,
    binary: l,
    p: u,
    standardization: g,
  ...
  for (let T = 0; T < k; T++) {
    let D = 0;
    for (let B = 0; B < k; B++)
      w += v[T][B] * (m[T] - p) * (m[B] - p), S += v[T][B], L += Math.pow(v[T][B] + v[B][T], 2), D += v[T][B] + v[B][T];
    b += Math.pow(D, 2);
  }
  L = 0.5 * L;
  const N = w / S / _, A = -1 / (k - 1), O = k * k * L - k * b + 3 * (S * S), Y = (k - 1) * (k + 1) * (S * S), V = O / Y - A * A, C = Math.sqrt(V), M = (N - A) / C;
  return {
...
var Gp = Object.defineProperty, zp = Object.defineProperties, qp = Object.getOwnPropertyDescriptors, Xl = Object.getOwnPropertySymbols, Up = Object.prototype.hasOwnProperty, Yp = Object.prototype.propertyIsEnumerable, Vl = (n, e, t) => e in n ? Gp(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, Hl = (n, e) => {
  for (var t in e || (e = {}))
    Up.call(e, t) && Vl(n, t, e[t]);
  if (Xl)
    for (var t of Xl(e))
      Yp.call(e, t) && Vl(n, t, e[t]);
  return n;
}, Wl = (n, e) => zp(n, qp(e));
function Cs(n, e, t = {}) {
...
function Xp(n, e) {
  e = e || {};
  const t = e.studyArea || ui(qe(n)), r = e.properties || {}, o = e.units || "kilometers", a = [];
  Le(n, (m) => {
    a.push(Ft(m));
  });
  const u = a.length, l = a.map((m, p) => {
    const _ = ce(
      a.filter((w, S) => S !== p)
    );
    return ze(
      m,
      Cs(m, _).geometry.coordinates,
      { units: o }
    );
  }).reduce((m, p) => m + p, 0) / u, f = u / Jo(ai(t), "meters", o), g = 1 / (2 * Math.sqrt(f)), v = 0.26136 / Math.sqrt(u * f);
  return r.nearestNeighborAnalysis = {
    units: o,
    arealUnits: o + "²",
    observedMeanDistance: l,
    expectedMeanDistance: g,
    nearestNeighborIndex: l / g,
    numberOfPoints: u,
    zScore: (l - g) / v
  }, t.properties = r, t;
}
function ka(n, e, t = {}) {
  ...
  if (Array.isArray(n) ? n = de(n) : n.type === "Point" ? n = Je(n) : $r(n, "Point", "point"), !e)
    throw new Error("line is required");
  Array.isArray(e) ? e = ke(e) : e.type === "LineString" ? e = Je(e) : $r(e, "LineString", "line");
  let l = 1 / 0;
  const f = n.geometry.coordinates;
  return Jt(e, (g) => {
    if (g) {
      const v = g.geometry.coordinates[0], m = g.geometry.coordinates[1], p = Vp(f, v, m, { method: a });
      p < l && (l = p);
    }
  }), Dn(l, "degrees", u);
}
function Vp(n, e, t, r) {
  if (r.method === "geodesic")
    return ln(ke([e, t]).geometry, n, {
      units: "degrees"
    }).properties.pointDistance;
  const o = [t[0] - e[0], t[1] - e[1]], a = [n[0] - e[0], n[1] - e[1]], u = $l(a, o);
  if (u <= 0)
    return sr(n, e, { units: "degrees" });
  const l = $l(o, o);
  if (l <= u)
    return sr(n, t, { units: "degrees" });
  const f = u / l, g = [e[0] + f * o[0], e[1] + f * o[1]];
  return sr(n, g, { units: "degrees" });
}
function $l(n, e) {
  return n[0] * e[0] + n[1] * e[1];
}
var Hp = Object.defineProperty, Zl = Object.getOwnPropertySymbols, Wp = Object.prototype.hasOwnProperty, $p = Object.prototype.propertyIsEnumerable, Kl = (n, e, t) => e in n ? Hp(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, po = (n, e) => {
  for (var t in e || (e = {}))
    Wp.call(e, t) && Kl(n, t, e[t]);
  if (Zl)
    for (var t of Zl(e))
      $p.call(e, t) && Kl(n, t, e[t]);
  return n;
};
function Zp(n, e, t = {}) {
  const r = t.units, o = t.properties || {}, a = Kp(n);
  if (!a.features.length)
  ...
  return Le(a, (f) => {
    ...
    g < u && (u = g, l = f);
  }), l && (l.properties = po(po(po({}, { dist: u }), l.properties), o)), l;
}
function Kp(n) {
  const e = [];
...
function Jp(n, e) {
  ...
  const u = e.type === "Feature" && e.properties || {}, l = u.a, f = u.b, g = u.c, v = t[0], m = t[1], p = a[0][0], _ = a[0][1], w = l !== void 0 ? l : a[0][2], S = a[1][0], L = a[1][1], b = f !== void 0 ? f : a[1][2], k = a[2][0], N = a[2][1], A = g !== void 0 ? g : a[2][2];
  return (A * (v - p) * (m - L) + w * (v - S) * (m - N) + b * (v - k) * (m - _) - b * (v - p) * (m - N) - A * (v - S) * (m - _) - w * (v - k) * (m - L)) / ((v - p) * (m - L) + (v - S) * (m - N) + (v - k) * (m - _) - (v - p) * (m - N) - (v - S) * (m - _) - (v - k) * (m - L));
}
function Qp(n) {
  const e = jp(n), t = ys(e);
  let r = !1, o = 0;
  for (; !r && o < e.features.length; ) {
    ...
    if (a.type === "Point")
      ...
      for (; !p && _ < a.coordinates.length - 1; )
        u = t.geometry.coordinates[0], l = t.geometry.coordinates[1], f = a.coordinates[_][0], g = a.coordinates[_][1], v = a.coordinates[_ + 1][0], m = a.coordinates[_ + 1][1], Jl(u, l, f, g, v, m) && (p = !0, r = !0), _++;
    } else if (a.type === "MultiLineString") {
      let _ = 0;
      for (; _ < a.coordinates.length; ) {
        p = !1;
        let w = 0;
        const S = a.coordinates[_];
        for (; !p && w < S.length - 1; )
          u = t.geometry.coordinates[0], l = t.geometry.coordinates[1], f = S[w][0], g = S[w][1], v = S[w + 1][0], m = S[w + 1][1], Jl(u, l, f, g, v, m) && (p = !0, r = !0), w++;
        _++;
      }
    ...
    return t;
  {
    ...
    for (let u = 0; u < e.features.length; u++)
      a.features = a.features.concat(
        Es(e.features[u]).features
      );
    return de(Cs(t, a).geometry.coordinates);
  }
}
function jp(n) {
  return n.type !== "FeatureCollection" ? n.type !== "Feature" ? ce([Je(n)]) : ce([n]) : n;
}
function Jl(n, e, t, r, o, a) {
  const u = Math.sqrt((o - t) * (o - t) + (a - r) * (a - r)), l = Math.sqrt((n - t) * (n - t) + (e - r) * (e - r)), f = Math.sqrt((o - n) * (o - n) + (a - e) * (a - e));
  return u === l + f;
}
function af(n, e) {
  const t = [];
...
function zo(n, e, t = {}) {
  ...
  if (l.type === "MultiPolygon") {
    const v = l.coordinates.map(
      (m) => zo(n, ye(m), { method: a, units: u })
    );
    return Math.min(...v.map(Math.abs)) * (xe(n, e) ? -1 : 1);
  }
  if (l.coordinates.length > 1) {
    const [v, ...m] = l.coordinates.map(
      (_) => zo(n, ye([_]), { method: a, units: u })
    );
    if (v >= 0) return v;
    const p = Math.min(...m);
...
var r1 = class {
  ...
  sortOuterEdges() {
    this.outerEdgesSorted || (this.outerEdges.sort((e, t) => {
      ...
      if (a < 0) return 1;
      if (a > 0) return -1;
      const u = Math.pow(r.coordinates[0] - this.coordinates[0], 2) + Math.pow(r.coordinates[1] - this.coordinates[1], 2), l = Math.pow(o.coordinates[0] - this.coordinates[0], 2) + Math.pow(o.coordinates[1] - this.coordinates[1], 2);
      return u - l;
   ...
   */
  getSymetric() {
    return this.symetric || (this.symetric = new uf(this.to, this.from), this.symetric.symetric = this), this.symetric;
  }
  /**
   ...
   */
  isHole() {
    const n = this.edges.reduce((o, a, u) => (a.from.coordinates[1] > this.edges[o].from.coordinates[1] && (o = u), o), 0), e = (n === 0 ? this.length : n) - 1, t = (n + 1) % this.length, r = ba(
   ...
   */
  toMultiPoint() {
    return ii(this.edges.map((n) => n.from.coordinates));
  }
  /**
   ...
   */
  getEnvelope() {
    return this.envelope ? this.envelope : this.envelope = Qh(this.toPolygon());
  }
  /**
  ...
  static findEdgeRingContaining(n, e) {
    ...
    return e.forEach((a) => {
      ...
      if (o && (r = o.getEnvelope()), !t1(u, t) && Ql(u, t)) {
        const l = n.map(
          (g) => g.from.coordinates
        );
        let f;
        for (const g of l)
          a.some((v) => n1(g, v.from.coordinates)) || (f = g);
        f && a.inside(de(f)) && (!o || Ql(r, u)) && (o = a);
      }
    }), o;
  }
  /**
...
var o1 = class cf {
  ...
  static fromGeoJson(e) {
    ...
    const t = new cf();
    return it(e, (r) => {
      $r(r, "LineString", "Graph::fromGeoJson"), jo(r, (o, a) => {
        if (o) {
          const u = t.getNode(o), l = t.getNode(a);
          t.addEdge(u, l);
        }
        return a;
      });
  ...
  addEdge(e, t) {
    ...
    if ((r = this.edges.get(e)) != null && r.has(t))
      return;
    const o = new i1(e, t), a = o.getSymetric();
    let u = this.edges.get(e);
    u == null && (u = /* @__PURE__ */ new Map(), this.edges.set(e, u)), u.set(t, o);
    let l = this.edges.get(t);
    l == null && (l = /* @__PURE__ */ new Map(), this.edges.set(t, l)), l.set(e, a);
  }
  /**
  ...
  _computeNextCCWEdges(e, t) {
    ...
    for (let u = r.length - 1; u >= 0; --u) {
      let l = r[u], f = l.symetric, g, v;
      l.label === t && (g = l), f.label === t && (v = f), !(!g || !v) && (v && (a = v), g && (a && (a.next = g, a = void 0), o || (o = g)));
    }
    a && (a.next = o);
  }
  /**
...
function u1(n, e) {
  ...
  return at(n, function(o, a, u) {
    if (o.type === "Polygon") {
      ...
      for (let f = 0; f < t; f++) {
        let g = [], v = o;
        f > 0 && (v = ye(l).geometry), l1(v, g), l = g.slice(0);
      }
      r.push(ye(l, u));
      ...
      for (let f = 0; f < t; f++) {
        let g = [], v = o;
        f > 0 && (v = wt(l).geometry), c1(v, g), l = g.slice(0);
      }
      r.push(wt(l, u));
    } else
...
function h1(n, e) {
  ...
  const l = qe(e);
  let f = 0, g = null;
  switch (t[0] > l[0] && t[0] < l[2] && t[1] > l[1] && t[1] < l[3] && (g = Cs(n, Es(e)), f = g.properties.featureIndex), xt(e)) {
    case "Polygon":
      o = r[0][f], a = r[0][0], g !== null && g.geometry.coordinates[1] < t[1] && (a = r[0][f]), u = jr(
        r[0][0],
        r[0][r[0].length - 1],
        t
      ), [o, a] = jl(
    ...
    case "MultiPolygon":
      for (var m = 0, p = 0, _ = 0, w = 0; w < r[0].length; w++) {
        m = w;
        for (var S = !1, L = 0; L < r[0][w].length; L++) {
          if (p = L, _ === f) {
            S = !0;
            break;
          }
...
function jl(n, e, t, r, o) {
  for (let a = 0; a < n.length; a++) {
    ...
    a === n.length - 1 && (l = n[0]);
    const f = jr(u, l, e);
    t <= 0 && f > 0 ? g1(e, u, r) || (r = u) : t > 0 && f <= 0 && (f1(e, u, o) || (o = u)), t = f;
  }
  return [r, o];
}
function f1(n, e, t) {
...
function gf(n, e, t = {}) {
  ...
  var r = t.mutate;
  if (!n) throw new Error("geojson is required");
  return Array.isArray(n) && et(n[0]) ? n = e === "mercator" ? ec(n) : tc(n) : (r !== !0 && (n = nt(n)), He(n, function(o) {
    var a = e === "mercator" ? ec(o) : tc(o);
    o[0] = a[0], o[1] = a[1];
  })), n;
}
function ec(n) {
  var e = Math.PI / 180, t = 6378137, r = 20037508342789244e-9, o = Math.abs(n[0]) <= 180 ? n[0] : n[0] - d1(n[0]) * 360, a = [
    t * o * e,
...
function v1(n, e) {
  e = e || {};
  const t = e.studyBbox || qe(n), r = e.confidenceLevel || 20, o = n.features, a = o.length, u = ai(ui(t)), l = Math.sqrt(u / a * 2), g = Sa(t, l, {
    units: "meters"
  }).features, v = {};
  ...
  const _ = [], w = Object.keys(v).length, S = m / w;
  let L = 0;
  for (let V = 0; V < p + 1; V++)
    L += Math.exp(-S) * Math.pow(S, V) / _1(V), _.push(L);
  const b = [];
  let k = 0;
  for (let V = 0; V < p + 1; V++) {
...
function Ss(n) {
  return Array.isArray(n) ? nc(n) : n && n.bbox ? nc(n.bbox) : [x1(), E1()];
}
function Is(n) {
  n != null && (Array.isArray(n) ? Wr(n) : n.bbox != null && Wr(n.bbox));
}
function mf(n, e = {}) {
  Is(e.bbox), n == null && (n = 1);
  const t = [];
  for (let r = 0; r < n; r++)
    t.push(de(Ss(e.bbox)));
  return ce(t);
...
function vf(n, e = {}) {
  Is(e.bbox), n == null && (n = 1), (e.bbox === void 0 || e.bbox === null) && (e.bbox = [-180, -90, 180, 90]), (!et(e.num_vertices) || e.num_vertices === void 0) && (e.num_vertices = 10), (!et(e.max_radial_length) || e.max_radial_length === void 0) && (e.max_radial_length = 10);
  ...
  for (let l = 0; l < n; l++) {
    ...
    }), f[f.length - 1] = f[0], f = f.reverse().map(w1(Ss(a))), u.push(ye([f]));
  }
  return ce(u);
}
function yf(n, e = {}) {
...
function ic(n, e) {
  Qi(n[0]) !== e && n[0].reverse();
  for (let t = 1; t < n.length; t++)
    Qi(n[t]) === e && n[t].reverse();
}
function I1(n, e) {
...
function b1(n, e, t, r, o = {}) {
  ...
  if (sc(t) === sc(r))
    return ma(n, e, o);
  const u = me(n), l = rf(n, e, t, r, o), f = [[u]];
  return He(l, function(g) {
    f[0].push(g);
  }), f[0].push(u), ye(f, a);
}
function sc(n) {
...
function _f(n, e, t) {
  ...
  return o !== !0 && (n = nt(n)), n.type === "FeatureCollection" && !a ? (Le(n, function(u, l) {
    n.features[l] = oc(
      u,
      e,
      r
    );
  }), e !== 1 && delete n.bbox, n) : oc(n, e, r);
}
function oc(n, e, t) {
  const r = xt(n) === "Point", o = M1(n, t);
  return e === 1 || r || (He(n, function(a) {
    const u = sr(o, a), l = Fn(o, a), f = u * e, g = me(
      xs(o, f, l)
    );
...
function M1(n, e) {
  if (e == null && (e = "centroid"), Array.isArray(e) || typeof e == "object")
    return Me(e);
  const t = n.bbox ? n.bbox : qe(n, { recompute: !0 }), r = t[0], o = t[1], a = t[2], u = t[3];
  switch (e) {
    case "sw":
    case "southwest":
    case "westsouth":
...
var ls = {
  ...
  search: function(n, e, t, r = {}) {
    var o;
    n.cleanDirty(), r = r || {};
    var a = ls.heuristics.manhattan, u = (o = r.closest) != null ? o : !1, l = L1(), f = e;
    for (e.h = a(e, t), l.push(e); l.size() > 0; ) {
      var g = l.pop();
      if (g === t)
        return ac(g);
      g.closed = !0;
      for (var v = n.neighbors(g), m = 0, p = v.length; m < p; ++m) {
        ...
        if (!(_.closed || _.isWall())) {
          var w = g.g + _.getCost(g), S = _.visited;
          (!S || w < _.g) && (_.visited = !0, _.parent = g, _.h = _.h || a(_, t), _.g = w, _.f = _.g + _.h, n.markDirty(_), u && (_.h < f.h || _.h === f.h && _.g < f.g) && (f = _), S ? l.rescoreElement(_) : l.push(_));
        }
      }
    }
    return u ? ac(f) : [];
  ...
  init() {
    ...
    for (var n = 0; n < this.nodes.length; n++)
      ls.cleanNode(this.nodes[n]);
  }
  cleanDirty() {
    for (var n = 0; n < this.dirtyNodes.length; n++)
      ls.cleanNode(this.dirtyNodes[n]);
    this.dirtyNodes = [];
  }
  markDirty(n) {
  ...
  toString() {
    for (var n = [], e = this.grid, t, r, o, a, u = 0, l = e.length; u < l; u++) {
...
`);
  ...
  bubbleUp(n) {
    for (var e = this.content.length, t = this.content[n], r = this.scoreFunction(t); ; ) {
      var o = n + 1 << 1, a = o - 1, u = null, l;
      if (a < e) {
        var f = this.content[a];
        l = this.scoreFunction(f), l < r && (u = a);
      }
      if (o < e) {
...
function R1(n, e, t = {}) {
  ...
  const l = r;
  l.features.push(n), l.features.push(e);
  const f = qe(_f(ui(qe(l)), 1.15)), [g, v, m, p] = f;
  l.features.pop(), l.features.pop();
  const _ = ze([g, v], [m, v], t) / o, w = (m - g) / _, S = ze([g, v], [g, p], t) / o, L = (p - v) / S, b = _ % 1 * w / 2, k = S % 1 * L / 2, N = [], A = [];
  let O, Y, V = 1 / 0, C = 1 / 0, M = p - k, T = 0;
  for (; M >= v; ) {
    const U = [], G = [];
    let H = g + b, J = 0;
    for (; H <= m; ) {
      const W = de([H, M]), j = A1(W, r);
  ...
  const D = new P1(A, { diagonal: !0 }), B = D.grid[O.y][O.x], z = D.grid[Y.y][Y.x], X = ls.search(D, B, z), R = [a];
...
function F1(n, e) {
  for (var t = n[0], r = [t], o, a = 1, u = n.length; a < u; a++)
    o = n[a], O1(o, t) > e && (r.push(o), t = o);
  return t !== o && r.push(o), r;
}
function qo(n, e, t, r, o) {
  for (var a = r, u, l = e + 1; l < t; l++) {
    var f = D1(n[l], n[e], n[t]);
    f > a && (u = l, a = f);
  }
  a > r && (u - e > 1 && qo(n, e, u, r, o), o.push(n[u]), t - u > 1 && qo(n, u, t, r, o));
}
function B1(n, e) {
  var t = n.length - 1, r = [n[0]];
  return qo(n, 0, t, e, r), r.push(n[t]), r;
}
function cs(n, e, t) {
  if (n.length <= 2) return n;
  var r = e !== void 0 ? e * e : 1;
  return n = t ? n : F1(n, r), n = B1(n, r), n;
}
function G1(n, e = {}) {
  var t, r, o;
  if (e = e ?? {}, !Oe(e)) throw new Error("options is invalid");
  const a = (t = e.tolerance) != null ? t : 1, u = (r = e.highQuality) != null ? r : !1, l = (o = e.mutate) != null ? o : !1;
  if (!n) throw new Error("geojson is required");
  if (a && a < 0) throw new Error("invalid tolerance");
  return l !== !0 && (n = nt(n)), at(n, function(f) {
    z1(f, a, u);
  }), n;
}
function z1(n, e, t) {
  ...
  if (Bn(n, { mutate: !0 }), r !== "GeometryCollection")
    switch (r) {
      case "LineString":
        n.coordinates = cs(
          n.coordinates,
...
function uc(n, e, t) {
  return n.map(function(r) {
    ...
    let o = e, a = cs(r, o, t);
    for (; !lc(a) && o >= Number.EPSILON; )
      o -= o * 0.01, a = cs(r, o, t);
    return lc(a) ? ((a[a.length - 1][0] !== a[0][0] || a[a.length - 1][1] !== a[0][1]) && a.push(a[0]), a) : r;
  });
}
function lc(n) {
...
function q1(n) {
  var e = n[0], t = n[1], r = n[2], o = n[3], a = ze(n.slice(0, 2), [r, t]), u = ze(n.slice(0, 2), [e, o]);
  if (a >= u) {
    var l = (t + o) / 2;
    return [
      e,
...
function U1(n, e) {
  ...
  const u = Zr(n).length, l = ga(n, { weight: o });
  let f = 0, g = 0, v = 0;
  Le(n, function(C) {
    var M;
    const T = o && ((M = C.properties) == null ? void 0 : M[o]) || 1, D = cc(me(C), me(l));
    f += Math.pow(D.x, 2) * T, g += Math.pow(D.y, 2) * T, v += D.x * D.y * T;
  });
  const m = f - g, p = Math.sqrt(Math.pow(m, 2) + 4 * Math.pow(v, 2)), _ = 2 * v, w = Math.atan((m + p) / _), S = w * 180 / Math.PI;
  let L = 0, b = 0, k = 0;
  Le(n, function(C) {
    var M;
    const T = o && ((M = C.properties) == null ? void 0 : M[o]) || 1, D = cc(me(C), me(l));
  ...
  const N = Math.sqrt(2 * L / k), A = Math.sqrt(2 * b / k), O = Jh(l, N, A, {
    units: "degrees",
    angle: S,
    steps: r,
    properties: a
    ...
    meanCenterCoordinates: me(l),
    semiMajorAxis: N,
    semiMinorAxis: A,
    numberOfFeatures: u,
    angle: S,
    percentageWithinEllipse: 100 * Zr(Y).length / u
  };
...
var Ma = { exports: {} };
Ma.exports = ks;
Ma.exports.default = ks;
function ks(n, e, t) {
  t = t || 2;
  var r = e && e.length, o = r ? e[0] * t : n.length, a = wf(n, 0, o, t, !0), u = [];
  if (!a || a.next === a.prev) return u;
  var l, f, g, v, m, p, _;
  if (r && (a = $1(n, e, a, t)), n.length > 80 * t) {
    l = g = n[0], f = v = n[1];
    for (var w = t; w < o; w += t)
      m = n[w], p = n[w + 1], m < l && (l = m), p < f && (f = p), m > g && (g = m), p > v && (v = p);
    _ = Math.max(g - l, v - f), _ = _ !== 0 ? 32767 / _ : 0;
  }
  return ei(a, u, t, l, f, _, 0), u;
}
function wf(n, e, t, r, o) {
  var a, u;
  if (o === Xo(n, e, t, r) > 0)
    for (a = e; a < t; a += r) u = hc(a, n[a], n[a + 1], u);
  else
    for (a = t - r; a >= e; a -= r) u = hc(a, n[a], n[a + 1], u);
  return u && bs(u, u.next) && (ni(u), u = u.next), u;
}
function Gn(n, e) {
  if (!n) return n;
  e || (e = n);
  var t = n, r;
  do
    if (r = !1, !t.steiner && (bs(t, t.next) || Ke(t.prev, t, t.next) === 0)) {
      if (ni(t), t = e = t.prev, t === t.next) break;
      r = !0;
    } else
      t = t.next;
  while (r || t !== e);
...
function ei(n, e, t, r, o, a, u) {
  if (n) {
    !u && a && j1(n, r, o, a);
    for (var l = n, f, g; n.prev !== n.next; ) {
      if (f = n.prev, g = n.next, a ? V1(n, r, o, a) : X1(n)) {
        e.push(f.i / t | 0), e.push(n.i / t | 0), e.push(g.i / t | 0), ni(n), n = g.next, l = g.next;
        continue;
      }
      if (n = g, n === l) {
        u ? u === 1 ? (n = H1(Gn(n), e, t), ei(n, e, t, r, o, a, 2)) : u === 2 && W1(n, e, t, r, o, a) : ei(Gn(n), e, t, r, o, a, 1);
        break;
      }
    }
  }
...
function X1(n) {
  ...
  for (var o = e.x, a = t.x, u = r.x, l = e.y, f = t.y, g = r.y, v = o < a ? o < u ? o : u : a < u ? a : u, m = l < f ? l < g ? l : g : f < g ? f : g, p = o > a ? o > u ? o : u : a > u ? a : u, _ = l > f ? l > g ? l : g : f > g ? f : g, w = r.next; w !== e; ) {
    if (w.x >= v && w.x <= p && w.y >= m && w.y <= _ && nr(o, l, a, f, u, g, w.x, w.y) && Ke(w.prev, w, w.next) >= 0) return !1;
    w = w.next;
  }
  return !0;
}
function V1(n, e, t, r) {
  ...
  for (var l = o.x, f = a.x, g = u.x, v = o.y, m = a.y, p = u.y, _ = l < f ? l < g ? l : g : f < g ? f : g, w = v < m ? v < p ? v : p : m < p ? m : p, S = l > f ? l > g ? l : g : f > g ? f : g, L = v > m ? v > p ? v : p : m > p ? m : p, b = Uo(_, w, e, t, r), k = Uo(S, L, e, t, r), N = n.prevZ, A = n.nextZ; N && N.z >= b && A && A.z <= k; ) {
    if (N.x >= _ && N.x <= S && N.y >= w && N.y <= L && N !== o && N !== u && nr(l, v, f, m, g, p, N.x, N.y) && Ke(N.prev, N, N.next) >= 0 || (N = N.prevZ, A.x >= _ && A.x <= S && A.y >= w && A.y <= L && A !== o && A !== u && nr(l, v, f, m, g, p, A.x, A.y) && Ke(A.prev, A, A.next) >= 0)) return !1;
    A = A.nextZ;
  }
  for (; N && N.z >= b; ) {
    if (N.x >= _ && N.x <= S && N.y >= w && N.y <= L && N !== o && N !== u && nr(l, v, f, m, g, p, N.x, N.y) && Ke(N.prev, N, N.next) >= 0) return !1;
    N = N.prevZ;
  }
  for (; A && A.z <= k; ) {
    if (A.x >= _ && A.x <= S && A.y >= w && A.y <= L && A !== o && A !== u && nr(l, v, f, m, g, p, A.x, A.y) && Ke(A.prev, A, A.next) >= 0) return !1;
    A = A.nextZ;
  }
  return !0;
}
function H1(n, e, t) {
  ...
  do {
    ...
    !bs(o, a) && xf(o, r, r.next, a) && ti(o, a) && ti(a, o) && (e.push(o.i / t | 0), e.push(r.i / t | 0), e.push(a.i / t | 0), ni(r), ni(r.next), r = n = a), r = r.next;
  } while (r !== n);
  return Gn(r);
}
function W1(n, e, t, r, o, a) {
  var u = n;
  do {
    for (var l = u.next.next; l !== u.prev; ) {
      if (u.i !== l.i && n_(u, l)) {
        var f = Ef(u, l);
        u = Gn(u, u.next), f = Gn(f, f.next), ei(u, e, t, r, o, a, 0), ei(f, e, t, r, o, a, 0);
        return;
      }
      l = l.next;
    }
...
function $1(n, e, t, r) {
  ...
  for (a = 0, u = e.length; a < u; a++)
    l = e[a] * r, f = a < u - 1 ? e[a + 1] * r : n.length, g = wf(n, l, f, r, !1), g === g.next && (g.steiner = !0), o.push(t_(g));
  for (o.sort(Z1), a = 0; a < o.length; a++)
    t = K1(o[a], t);
  return t;
}
function Z1(n, e) {
...
function K1(n, e) {
  ...
  if (!t)
    return e;
  var r = Ef(t, n);
  return Gn(r, r.next), Gn(t, t.next);
}
function J1(n, e) {
  var t = e, r = n.x, o = n.y, a = -1 / 0, u;
  do {
    if (o <= t.y && o >= t.next.y && t.next.y !== t.y) {
      var l = t.x + (o - t.y) * (t.next.x - t.x) / (t.next.y - t.y);
      if (l <= r && l > a && (a = l, u = t.x < t.next.x ? t : t.next, l === r))
        return u;
    }
    t = t.next;
  } while (t !== e);
  ...
  t = u;
  do
    r >= t.x && t.x >= g && r !== t.x && nr(o < v ? r : a, o, g, v, o < v ? a : r, o, t.x, t.y) && (p = Math.abs(o - t.y) / (r - t.x), ti(t, n) && (p < m || p === m && (t.x > u.x || t.x === u.x && Q1(u, t))) && (u = t, m = p)), t = t.next;
  while (t !== f);
  return u;
}
function Q1(n, e) {
...
function j1(n, e, t, r) {
  var o = n;
  do
    o.z === 0 && (o.z = Uo(o.x, o.y, e, t, r)), o.prevZ = o.prev, o.nextZ = o.next, o = o.next;
  while (o !== n);
  o.prevZ.nextZ = null, o.prevZ = null, e_(o);
}
function e_(n) {
  var e, t, r, o, a, u, l, f, g = 1;
  do {
    for (t = n, n = null, a = null, u = 0; t; ) {
      for (u++, r = t, l = 0, e = 0; e < g && (l++, r = r.nextZ, !!r); e++)
        ;
      for (f = g; l > 0 || f > 0 && r; )
        l !== 0 && (f === 0 || !r || t.z <= r.z) ? (o = t, t = t.nextZ, l--) : (o = r, r = r.nextZ, f--), a ? a.nextZ = o : n = o, o.prevZ = a, a = o;
      t = r;
    }
    a.nextZ = null, g *= 2;
  } while (u > 1);
...
function nr(n, e, t, r, o, a, u, l) {
  return (o - u) * (e - l) >= (n - u) * (a - l) && (n - u) * (r - l) >= (t - u) * (e - l) && (t - u) * (a - l) >= (o - u) * (r - l);
}
function n_(n, e) {
  return n.next.i !== e.i && n.prev.i !== e.i && !r_(n, e) && // dones't intersect other edges
  (ti(n, e) && ti(e, n) && i_(n, e) && // locally visible
  (Ke(n.prev, n, e.prev) || Ke(n, e.prev, e)) || // does not create opposite-facing sectors
  bs(n, e) && Ke(n.prev, n, n.next) > 0 && Ke(e.prev, e, e.next) > 0);
}
function Ke(n, e, t) {
...
function xf(n, e, t, r) {
  var o = qi(Ke(n, e, t)), a = qi(Ke(n, e, r)), u = qi(Ke(t, r, n)), l = qi(Ke(t, r, e));
  return !!(o !== a && u !== l || o === 0 && zi(n, t, e) || a === 0 && zi(n, r, e) || u === 0 && zi(t, n, r) || l === 0 && zi(t, e, r));
}
function zi(n, e, t) {
...
function r_(n, e) {
  var t = n;
  do {
    if (t.i !== n.i && t.next.i !== n.i && t.i !== e.i && t.next.i !== e.i && xf(t, t.next, n, e)) return !0;
    t = t.next;
  } while (t !== n);
  return !1;
}
...
function Ef(n, e) {
  var t = new Yo(n.i, n.x, n.y), r = new Yo(e.i, e.x, e.y), o = n.next, a = e.prev;
...
ks.deviation = function(n, e, t, r) {
  var o = e && e.length, a = o ? e[0] * t : n.length, u = Math.abs(Xo(n, 0, a, t));
  if (o)
    for (var l = 0, f = e.length; l < f; l++) {
      var g = e[l] * t, v = l < f - 1 ? e[l + 1] * t : n.length;
      u -= Math.abs(Xo(n, g, v, t));
    }
  var m = 0;
  for (l = 0; l < r.length; l += 3) {
    var p = r[l] * t, _ = r[l + 1] * t, w = r[l + 2] * t;
    m += Math.abs(
...
function a_(n) {
  ...
  return n.geometry.type === "Polygon" ? e.features = fc(n.geometry.coordinates) : n.geometry.coordinates.forEach(function(t) {
    e.features = e.features.concat(fc(t));
  }), e;
}
function fc(n) {
  const e = u_(n), t = 3, r = o_(e.vertices, e.holes, t), o = [], a = [];
  ...
  for (var u = 0; u < a.length; u += 3) {
    const l = a.slice(u, u + 3);
    l.push(a[u]), o.push(ye([l]));
  }
  return o;
}
function u_(n) {
...
function l_(n, e, t, r) {
  ...
  return e < 0 && (e = -e, t = t + 180), (u === !1 || u === void 0) && (n = nt(n)), He(n, function(l) {
    var f = me(
      xs(l, e, t, { units: o })
    );
    l[0] = f[0], l[1] = f[1], a && l.length === 3 && (l[2] += a);
  }), wn(n), n;
}
function c_(n, e = {}) {
  const t = [];
...
function h_(n, e) {
  ...
  for (var g = 0; g < t.length; g++)
    for (var v = 0; v < t[g].length - 1; v++) {
      ...
      m.forEach(function(w) {
        var S = w.ring, L = w.edge;
        p(g, v, S, L);
      });
    }
  return r;
  function p(w, S, L, b) {
    var k = t[w][S], N = t[w][S + 1], A = t[L][b], O = t[L][b + 1], Y = f_(k, N, A, O);
    if (Y !== null) {
      var V, C;
      if (N[0] !== k[0] ? V = (Y[0] - k[0]) / (N[0] - k[0]) : V = (Y[1] - k[1]) / (N[1] - k[1]), O[0] !== A[0] ? C = (Y[0] - A[0]) / (O[0] - A[0]) : C = (Y[1] - A[1]) / (O[1] - A[1]), !(V >= 1 || V <= 0 || C >= 1 || C <= 0)) {
  ...
  function _(w, S) {
    var L = t[w][S], b = t[w][S + 1], k, N, A, O;
    return L[0] < b[0] ? (k = L[0], N = b[0]) : (k = b[0], N = L[0]), L[1] < b[1] ? (A = L[1], O = b[1]) : (A = b[1], O = L[1]), {
      minX: k,
      minY: A,
      maxX: N,
      maxY: O,
...
function f_(n, e, t, r) {
  if (Xr(n, t) || Xr(n, r) || Xr(e, t) || Xr(r, t))
    return null;
  var o = n[0], a = n[1], u = e[0], l = e[1], f = t[0], g = t[1], v = r[0], m = r[1], p = (o - u) * (g - m) - (a - l) * (f - v);
  if (p === 0) return null;
  var _ = ((o * l - a * u) * (f - v) - (o - u) * (f * m - g * v)) / p, w = ((o * l - a * u) * (g - m) - (a - l) * (f * m - g * v)) / p;
  return [_, w];
}
function Xr(n, e) {
...
function g_(n) {
  ...
  for (var e = n.geometry.coordinates.length, t = [], b = 0; b < e; b++) {
    ...
    Vr(r[0], r[r.length - 1]) || r.push(r[0]);
  ...
  var a = t.length, u = h_(
    n,
    function(re, ee, te, se, fe, Z, Fe, _e, ae, q, be, Ne) {
      return [
        re,
        ee,
        te,
    ...
    for (var Y = [], b = 0; b < e; b++)
      Y.push(
        ye([n.geometry.coordinates[b]], {
          parent: -1,
          winding: d_(n.geometry.coordinates[b])
        })
      );
    let re = ce(Y);
    return J(re), W(re), re;
  ...
  for (var f = [], g = [], b = 0; b < e; b++) {
    ...
    for (var o = 0; o < n.geometry.coordinates[b].length - 1; o++)
      f[b].push([
        new gc(
          n.geometry.coordinates[b][rr(o + 1, n.geometry.coordinates[b].length - 1)],
          1,
          [b, o],
          [b, rr(o + 1, n.geometry.coordinates[b].length - 1)],
          void 0
        )
      ]), g.push(
        new dc(
  ...
  for (var b = 0; b < f.length; b++)
    for (var o = 0; o < f[b].length; o++)
      for (var _ = 0; _ < f[b][o].length; _++) {
        let ee;
        _ == f[b][o].length - 1 ? ee = f[b][rr(o + 1, n.geometry.coordinates[b].length - 1)][0].coord : ee = f[b][o][_ + 1].coord;
        var w = p.search({
          minX: ee[0],
          minY: ee[1],
          maxX: ee[0],
  ...
  for (var b = 0; b < f.length; b++)
    for (var o = 0; o < f[b].length; o++)
      for (var _ = 0; _ < f[b][o].length; _++) {
        ...
        S < a ? g[S].nxtIsectAlongRingAndEdge2 = f[b][o][_].nxtIsectAlongEdgeIn : Vr(
          g[S].ringAndEdge1,
          f[b][o][_].ringAndEdgeIn
        ) ? g[S].nxtIsectAlongRingAndEdge1 = f[b][o][_].nxtIsectAlongEdgeIn : g[S].nxtIsectAlongRingAndEdge2 = f[b][o][_].nxtIsectAlongEdgeIn;
      }
  for (var L = [], b = 0, o = 0; o < e; o++) {
    for (var k = b, _ = 0; _ < n.geometry.coordinates[o].length - 1; _++)
      g[b].coord[0] < g[k].coord[0] && (k = b), b++;
    for (var N = g[k].nxtIsectAlongRingAndEdge2, _ = 0; _ < g.length; _++)
      if (g[_].nxtIsectAlongRingAndEdge1 == k || g[_].nxtIsectAlongRingAndEdge2 == k) {
        var A = _;
        break;
      }
    var O = Zi(
    ...
    L.push({ isect: k, parent: -1, winding: O });
  }
  L.sort(function(Q, re) {
    return g[Q.isect].coord > g[re.isect].coord ? -1 : 1;
  });
  for (var Y = []; L.length > 0; ) {
    var V = L.pop(), C = V.isect, M = V.parent, T = V.winding, D = Y.length, B = [g[C].coord], z = C;
    ...
    for (; !Vr(g[C].coord, g[R].coord); ) {
      ...
      if (U != null && L.splice(U, 1), Vr(X, g[R].ringAndEdge1)) {
        ...
        z = R, R = g[R].nxtIsectAlongRingAndEdge2;
      } else {
        ...
        z = R, R = g[R].nxtIsectAlongRingAndEdge1;
      }
    }
...
function v_(n) {
  var e = [];
  return it(n, function(t) {
    t.geometry.type === "Polygon" && Le(g_(t), function(r) {
  ...
  insert: function(n, e) {
    ...
    if (n) {
      if (e.P = n, e.N = n.N, n.N && (n.N.P = e), n.N = e, n.R) {
        ...
        n.R = e;
      t = n;
    } else this._ ? (n = vc(this._), e.P = null, e.N = n, n.P = n.L = e, t = n) : (e.P = e.N = null, this._ = e, t = null);
    for (e.L = e.R = null, e.U = t, e.C = !0, n = e; t && t.C; )
      r = t.U, t === r.L ? (o = r.R, o && o.C ? (t.C = o.C = !1, r.C = !0, n = r) : (n === t.R && (Tr(this, t), n = t, t = n.U), t.C = !1, r.C = !0, Rr(this, r))) : (o = r.L, o && o.C ? (t.C = o.C = !1, r.C = !0, n = r) : (n === t.L && (Rr(this, t), n = t, t = n.U), t.C = !1, r.C = !0, Tr(this, r))), t = n.U;
    this._.C = !1;
  },
  remove: function(n) {
    n.N && (n.N.P = n.P), n.P && (n.P.N = n.N), n.N = n.P = null;
    var e = n.U, t, r = n.L, o = n.R, a, u;
    if (r ? o ? a = vc(o) : a = r : a = o, e ? e.L === n ? e.L = a : e.R = a : this._ = a, r && o ? (u = a.C, a.C = n.C, a.L = r, r.U = a, a !== o ? (e = a.U, a.U = n.U, n = a.R, e.L = n, a.R = o, o.U = a) : (a.U = e, e = a, n = a.R)) : (u = n.C, n = a), n && (n.U = e), !u) {
      if (n && n.C) {
        n.C = !1;
        return;
      }
      do {
        if (n === this._) break;
        if (n === e.L) {
          if (t = e.R, t.C && (t.C = !1, e.C = !0, Tr(this, e), t = e.R), t.L && t.L.C || t.R && t.R.C) {
            (!t.R || !t.R.C) && (t.L.C = !1, t.C = !0, Rr(this, t), t = e.R), t.C = e.C, e.C = t.R.C = !1, Tr(this, e), n = this._;
            break;
          }
        } else if (t = e.L, t.C && (t.C = !1, e.C = !0, Rr(this, e), t = e.L), t.L && t.L.C || t.R && t.R.C) {
          (!t.L || !t.L.C) && (t.R.C = !1, t.C = !0, Tr(this, t), t = e.L), t.C = e.C, e.C = t.L.C = !1, Rr(this, e), n = this._;
          break;
        }
        t.C = !0, n = e, e = e.U;
      } while (!n.C);
...
function Hr(n, e, t, r) {
  ...
  return o.left = n, o.right = e, t && fs(o, n, e, t), r && fs(o, e, n, r), kt[n.index].halfedges.push(a), kt[e.index].halfedges.push(a), o;
}
function Ar(n, e, t) {
  var r = [e, t];
  return r.left = n, r;
...
function __(n, e, t, r, o) {
  var a = n[0], u = n[1], l = a[0], f = a[1], g = u[0], v = u[1], m = 0, p = 1, _ = g - l, w = v - f, S;
  if (S = e - l, !(!_ && S > 0)) {
    if (S /= _, _ < 0) {
      if (S < m) return;
      S < p && (p = S);
    ...
    if (S = r - l, !(!_ && S < 0)) {
      ...
      if (S = t - f, !(!w && S > 0)) {
        ...
        if (S = o - f, !(!w && S < 0)) {
          ...
          return !(m > 0) && !(p < 1) || (m > 0 && (n[0] = [l + m * _, f + m * w]), p < 1 && (n[1] = [l + p * _, f + p * w])), !0;
        }
      }
    }
  }
}
function w_(n, e, t, r, o) {
  var a = n[1];
  if (a) return !0;
  var u = n[0], l = n.left, f = n.right, g = l[0], v = l[1], m = f[0], p = f[1], _ = (g + m) / 2, w = (v + p) / 2, S, L;
  if (p === v) {
    if (_ < e || _ >= r) return;
    if (g > m) {
      if (!u) u = [_, t];
  ...
  } else if (S = (g - m) / (p - v), L = w - S * _, S < -1 || S > 1)
    if (g > m) {
      if (!u) u = [(t - L) / S, t];
      else if (u[1] >= o) return;
      a = [(o - L) / S, o];
...
function x_(n, e, t, r) {
  for (var o = ft.length, a; o--; )
    (!w_(a = ft[o], n, e, t, r) || !__(a, n, e, t, r) || !(Math.abs(a[0][0] - a[1][0]) > Ge || Math.abs(a[0][1] - a[1][1]) > Ge)) && delete ft[o];
}
function E_(n) {
  return kt[n.index] = {
    site: n,
...
function I_() {
  for (var n = 0, e = kt.length, t, r, o, a; n < e; ++n)
    if ((t = kt[n]) && (a = (r = t.halfedges).length)) {
      var u = new Array(a), l = new Array(a);
      for (o = 0; o < a; ++o) u[o] = o, l[o] = C_(t, ft[r[o]]);
      for (u.sort(function(f, g) {
        return l[g] - l[f];
      }), o = 0; o < a; ++o) l[o] = r[u[o]];
      for (o = 0; o < a; ++o) r[o] = l[o];
    }
}
function k_(n, e, t, r) {
  var o = kt.length, a, u, l, f, g, v, m, p, _, w, S, L, b = !0;
  for (a = 0; a < o; ++a)
    if (u = kt[a]) {
      for (l = u.site, g = u.halfedges, f = g.length; f--; )
        ft[g[f]] || g.splice(f, 1);
      for (f = 0, v = g.length; f < v; )
        w = S_(u, ft[g[f]]), S = w[0], L = w[1], m = Cf(u, ft[g[++f % v]]), p = m[0], _ = m[1], (Math.abs(S - p) > Ge || Math.abs(L - _) > Ge) && (g.splice(f, 0, ft.push(Ar(
          l,
          w,
          Math.abs(S - n) < Ge && r - L > Ge ? [n, Math.abs(p - n) < Ge ? _ : r] : Math.abs(L - r) < Ge && t - S > Ge ? [Math.abs(_ - r) < Ge ? p : t, r] : Math.abs(S - t) < Ge && L - e > Ge ? [t, Math.abs(p - t) < Ge ? _ : e] : Math.abs(L - e) < Ge && S - n > Ge ? [Math.abs(_ - e) < Ge ? p : n, e] : null
        )) - 1), ++v);
      v && (b = !1);
    }
  if (b) {
    ...
    for (a = 0, b = null; a < o; ++a)
      (u = kt[a]) && (l = u.site, k = l[0] - n, N = l[1] - e, A = k * k + N * N, A < O && (O = A, b = u));
    if (b) {
      var Y = [n, e], V = [n, r], C = [t, r], M = [t, e];
      b.halfedges.push(
        ft.push(Ar(l = b.site, Y, V)) - 1,
        ft.push(Ar(l, V, C)) - 1,
        ft.push(Ar(l, C, M)) - 1,
        ft.push(Ar(l, M, Y)) - 1
      );
  ...
  for (a = 0; a < o; ++a)
    (u = kt[a]) && (u.halfedges.length || delete kt[a]);
}
var Sf = [], La;
function b_() {
  Ms(this), this.x = this.y = this.arc = this.site = this.cy = null;
}
function ir(n) {
  var e = n.P, t = n.N;
  if (!(!e || !t)) {
    ...
    if (r !== a) {
      var u = o[0], l = o[1], f = r[0] - u, g = r[1] - l, v = a[0] - u, m = a[1] - l, p = 2 * (f * m - g * v);
      if (!(p >= -1e-12)) {
        var _ = f * f + g * g, w = v * v + m * m, S = (m * _ - g * w) / p, L = (f * w - v * _) / p, b = Sf.pop() || new b_();
        b.arc = n, b.site = o, b.x = S + u, b.y = (b.cy = L + l) + Math.sqrt(S * S + L * L), n.circle = b;
        for (var k = null, N = ri._; N; )
...
function or(n) {
  var e = n.circle;
  e && (e.P || (La = e.N), ri.remove(e), Sf.push(e), Ms(e), n.circle = null);
}
var If = [];
function M_() {
  Ms(this), this.edge = this.site = this.circle = null;
}
function yc(n) {
  var e = If.pop() || new M_();
  return e.site = n, e;
...
function _o(n) {
  or(n), ar.remove(n), If.push(n), Ms(n);
}
function L_(n) {
  var e = n.circle, t = e.x, r = e.cy, o = [t, r], a = n.P, u = n.N, l = [n];
  _o(n);
  for (var f = a; f.circle && Math.abs(t - f.circle.x) < Ge && Math.abs(r - f.circle.cy) < Ge; )
    a = f.P, l.unshift(f), _o(f), f = a;
  l.unshift(f), or(f);
  for (var g = u; g.circle && Math.abs(t - g.circle.x) < Ge && Math.abs(r - g.circle.cy) < Ge; )
    u = g.N, l.push(g), _o(g), g = u;
  l.push(g), or(g);
  var v = l.length, m;
  for (m = 1; m < v; ++m)
    g = l[m], f = l[m - 1], fs(g.edge, f.site, g.site, o);
  f = l[0], g = l[v - 1], g.edge = Hr(f.site, g.site, null, o), ir(f), ir(g);
}
function P_(n) {
  for (var e = n[0], t = n[1], r, o, a, u, l = ar._; l; )
    if (a = kf(l, t) - e, a > Ge) l = l.L;
    else if (u = e - N_(l, t), u > Ge) {
      if (!l.R) {
        r = l;
        break;
      }
      ...
      a > -Ge ? (r = l.P, o = l) : u > -Ge ? (r = l, o = l.N) : r = o = l;
      break;
    }
  E_(n);
  var f = yc(n);
  if (ar.insert(r, f), !(!r && !o)) {
    if (r === o) {
      or(r), o = yc(r.site), ar.insert(f, o), f.edge = o.edge = Hr(r.site, f.site), ir(r), ir(o);
      return;
    }
    if (!o) {
      f.edge = Hr(r.site, f.site);
      return;
    }
    or(r), or(o);
    var g = r.site, v = g[0], m = g[1], p = n[0] - v, _ = n[1] - m, w = o.site, S = w[0] - v, L = w[1] - m, b = 2 * (p * L - _ * S), k = p * p + _ * _, N = S * S + L * L, A = [(L * k - _ * N) / b + v, (p * N - S * k) / b + m];
    fs(o.edge, g, w, A), f.edge = Hr(g, n, null, A), o.edge = Hr(n, w, null, A), ir(r), ir(o);
  }
}
function kf(n, e) {
  ...
  if (!u) return -1 / 0;
  t = u.site;
  var l = t[0], f = t[1], g = f - e;
  if (!g) return l;
  var v = l - r, m = 1 / a - 1 / g, p = v / g;
  return m ? (-p + Math.sqrt(p * p - 2 * m * (v * v / (-2 * g) - f + g / 2 + o - a / 2))) / m + r : (r + l) / 2;
}
function N_(n, e) {
  var t = n.N;
  if (t) return kf(t, e);
...
function Vo(n, e) {
  var t = n.sort(R_).pop(), r, o, a;
  for (ft = [], kt = new Array(n.length), ar = new hs(), ri = new hs(); ; )
    if (a = La, t && (!a || t[1] < a.y || t[1] === a.y && t[0] < a.x))
      (t[0] !== r || t[1] !== o) && (P_(t), r = t[0], o = t[1]), t = n.pop();
    else if (a)
      L_(a.arc);
    else
      break;
  if (I_(), e) {
    var u = +e[0][0], l = +e[0][1], f = +e[1][0], g = +e[1][1];
    x_(u, l, f, g), k_(u, l, f, g);
  }
  this.edges = ft, this.cells = kt, ar = ri = ft = kt = null;
}
Vo.prototype = {
  constructor: Vo,
  polygons: function() {
  ...
  triangles: function() {
    ...
    return this.cells.forEach(function(t, r) {
      if (l = (a = t.halfedges).length)
        for (var o = t.site, a, u = -1, l, f, g = e[a[l - 1]], v = g.left === o ? g.right : g.left; ++u < l; )
          f = v, g = e[a[u]], v = g.left === o ? g.right : g.left, f && v && r < f.index && r < v.index && T_(o, f, v) < 0 && n.push([o.data, f.data, v.data]);
    }), n;
  },
  links: function() {
  ...
  find: function(n, e, t) {
    for (var r = this, o, a = r._found || 0, u = r.cells.length, l; !(l = r.cells[a]); ) if (++a >= u) return null;
    var f = n - l.site[0], g = e - l.site[1], v = f * f + g * g;
    do
      l = r.cells[o = a], a = null, l.halfedges.forEach(function(m) {
        var p = r.edges[m], _ = p.left;
        if (!((_ === l.site || !_) && !(_ = p.right))) {
          var w = n - _[0], S = e - _[1], L = w * w + S * S;
          L < v && (v = L, a = _.index);
        }
      });
    while (a !== null);
    return r._found = o, t == null || v <= t * t ? l.site : null;
  }
};
function A_() {
  var n = y_, e = p_, t = null;
  function r(o) {
    return new Vo(o.map(function(a, u) {
      var l = [Math.round(n(a, u, o) / Ge) * Ge, Math.round(e(a, u, o) / Ge) * Ge];
      return l.index = u, l.data = a, l;
    }), t);
  }
  return r.polygons = function(o) {
    ...
    return arguments.length ? (n = typeof o == "function" ? o : mc(+o), r) : n;
  }, r.y = function(o) {
    return arguments.length ? (e = typeof o == "function" ? o : mc(+o), r) : e;
  }, r.extent = function(o) {
...
function D_(n, e) {
  ...
  return dn(n, "Point", "points"), ce(
    A_().x((r) => r.geometry.coordinates[0]).y((r) => r.geometry.coordinates[1]).extent([
      [t[0], t[1]],
      [t[2], t[3]]
    ]).polygons(n.features).map(function(r, o) {
      return Object.assign(O_(r), {
        properties: _s(n.features[o].properties)
      });
    })
  );
}
function F_(n, e = {}) {
  ...
  o ? Jt(n, (k) => {
    ...
    isNaN(N) || isNaN(A) || (a += N, u += A, l += 1, f += O, g.push(Ft(k)));
  }) : Le(n, (k) => {
  ...
  const v = G_(a, u), m = bf(v), p = z_(
    a,
    u,
    l
  ), _ = f / l, w = Ft(ce(g)), [S, L] = Me(w);
  let b;
  return r ? b = wc(
    [S, L],
    v,
...
function _c(n, e) {
  ...
  if (e) {
    const [o, a] = t, [u, l] = r, f = u - o, g = l - a, v = Math.sqrt(Math.pow(f, 2) + Math.pow(g, 2));
    if (v < 1e-9)
      return [NaN, NaN];
    const m = g / v, p = f / v;
    return [m, p];
  } else {
    const a = bf(fn(t, r)) * Math.PI / 180;
...
function wc(n, e, t, r) {
  if (r) {
    ...
    return u = o - t / 2 * p, l = a - t / 2 * m, f = o + t / 2 * p, g = a + t / 2 * m, [
      [u, l],
      [f, g]
    ];
  } else {
    const o = en(de(n), t / 2, e, {
      units: "meters"
    }), a = en(de(n), -t / 2, e, {
      units: "meters"
    });
...
const Xw = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  multiPoint: ii,
  multiPolygon: wt,
  nearestNeighborAnalysis: Xp,
  nearestPoint: Cs,
  nearestPointOnLine: ln,
  nearestPointToLine: Zp,
  planepoint: Jp,
  point: de,
  pointGrid: ef,
  pointOnFeature: Qp,
  pointToLineDistance: ka,
  pointToPolygonDistance: zo,
  points: Fc,
  pointsWithinPolygon: af,
  polygon: ye,
  polygonSmooth: u1,
  polygonTangents: h1,
  polygonToLine: cr,
...
class q_ {
  constructor(e, t) {
    this.viewer = e, this.config = {
      ...
      allowClick: !1,
      ...t
    }, this.billboardCollection = new I.BillboardCollection(), this.layer = this.viewer.scene.primitives.add(this.billboardCollection), this.data = [], this.bubbleSizes = /* @__PURE__ */ new Map(), this.eventListener = null, this.customVisibleArea = null, this.visibleAreaMode = "screen";
  }
  /**
   * 新增数据
   */
  ...
  addLayer(e) {
    ...
    const u = e.properties.id || bt(), l = {
      ...
      scale: 1,
      scaleByDistance: new I.NearFarScalar(15e4, 1, 4e5, 0.5),
      pixelOffset: new I.Cartesian2(this.config.offset[0], this.config.offset[1]),
      pixelOffsetScaleByDistance: new I.NearFarScalar(15e4, 1, 4e5, 0.5)
    }, f = this.billboardCollection.add(l);
    return f.properties = {
      ...e.properties
  ...
  render() {
    ...
    this.billboardCollection._billboards.forEach((r) => {
      const o = I.SceneTransforms.wgs84ToWindowCoordinates(
        this.viewer.scene,
        r.position
      ), a = I.Cartographic.fromCartesian(r.position);
      let u = !1;
      ...
      if (u) {
        r.show = !0;
        const l = this.bubbleSizes.get(r.id);
        if (!l) return;
        const f = l.width * r.scale, g = l.height * r.scale, v = r.pixelOffset ? r.pixelOffset.x : 0, m = r.pixelOffset ? r.pixelOffset.y : 0, p = {
          id: r.id,
          billboard: r,
          left: o.x + v - f / 2,
          right: o.x + v + f / 2,
  ...
  isPointInVisibleArea(e) {
    if (this.visibleAreaMode === "custom" && this.customVisibleArea) {
      const t = I.Math.toDegrees(e.longitude), r = I.Math.toDegrees(e.latitude), o = de([t, r]);
      return ca(o, this.customVisibleArea);
    }
    return !0;
  }
  /**
  ...
  performCollisionDetection(e, t) {
    ...
    switch (this.config.hideStrategy) {
      ...
      case "distance":
        r = [...e].sort((a, u) => {
          const l = this.calculateDistanceToScreenCenter(a.screenPosition), f = this.calculateDistanceToScreenCenter(u.screenPosition);
          return l - f;
        });
        break;
      default:
  ...
  checkCollision(e, t) {
    ...
    if (r >= o || a >= u)
      return !1;
    const l = (o - r) * (u - a), f = Math.min(e.area, t.area);
    return l / f > this.config.collisionThreshold;
  }
  /**
   * 根据策略决定隐藏哪个气泡
   */
  ...
  updateLayerById(e, t) {
    ...
    if (r !== -1) {
      const u = this.billboardCollection.get(r), l = Cu({
        title: t.title || "",
      ...
      u.setImage("", l), this.bubbleSizes.set(e, {
        width: l.width,
        height: l.height,
        createdTime: Date.now()
        // 重置创建时间
...
class U_ {
  constructor(e, t) {
    this.viewer = e, this.config = {
      ...
      opacity: 1,
      ...t
    }, this.layer = new I.CustomDataSource("circle-group-layer"), this.viewer.dataSources.add(this.layer);
  }
  /**
   * 新增数据
   */
  ...
  addLayer(e) {
    ...
    const a = ((L = e.properties) == null ? void 0 : L.xRadius) || this.config.xRadius || this.config.radius, u = ((b = e.properties) == null ? void 0 : b.yRadius) || this.config.yRadius || this.config.radius, l = ((k = e.properties) == null ? void 0 : k.fillColor) || this.config.fillColor, f = ((N = e.properties) == null ? void 0 : N.outline) || this.config.outline || !1, g = ((A = e.properties) == null ? void 0 : A.outlineColor) || this.config.outlineColor, v = ((O = e.properties) == null ? void 0 : O.outlineWidth) || this.config.outlineWidth, m = ((Y = e.properties) == null ? void 0 : Y.extrudedHeight) || this.config.extrudedHeight, p = ((V = e.properties) == null ? void 0 : V.rotation) || this.config.rotation || 0, _ = ((C = e.properties) == null ? void 0 : C.opacity) || this.config.opacity, w = ((M = e.properties) == null ? void 0 : M.id) || bt(), S = this.layer.entities.add({
      ...
      ellipse: {
        ...
        height: o,
        extrudedHeight: m,
        material: I.Color.fromCssColorString(l).withAlpha(_),
        outline: f,
        outlineColor: I.Color.fromCssColorString(g),
        outlineWidth: v,
...
const Ho = "CircleWaveMaterial";
let xc = !1;
function Y_() {
  xc || !I.Material || !I.Material._materialCache || (I.Material._materialCache.addMaterial(Ho, {
    fabric: {
      type: Ho,
      uniforms: {
        color: I.Color.YELLOW.clone(),
        time: 0,
        count: 2,
        gradient: 1
      },
...
class X_ {
  constructor(e = {}) {
    this._definitionChanged = new I.Event(), this.color = I.Color.fromCssColorString(e.color || "#FFCB33"), this.duration = e.duration || 3e3, this.count = e.count || 3, this.gradient = e.gradient ?? 0.1, this._startTime = Date.now();
  }
  get isConstant() {
    return !1;
  }
  ...
  getValue(e, t = {}) {
    return t.color = I.Color.clone(this.color, t.color), t.time = (Date.now() - this._startTime) % this.duration / this.duration, t.count = this.count, t.gradient = 1 + 10 * (1 - this.gradient), t;
  }
  equals(e) {
    return this === e;
  }
...
class V_ {
  constructor(e, t) {
    this.viewer = e, this.config = {
      ...
      count: 5,
      ...t
    }, this.layer = new I.CustomDataSource("circle-wave-layer"), this.viewer.dataSources.add(this.layer), Y_();
  }
  setData(e = []) {
    if (this.clearLayer(), !Array.isArray(e)) {
      console.error("data must be an array.");
  ...
  addLayer(e) {
    ...
    const [t, r, o = 0] = e.geometry.coordinates, a = e.properties || {}, u = a.id || bt(), l = this.layer.entities.add({
      id: u,
      position: I.Cartesian3.fromDegrees(t, r, o),
      ellipse: {
...
const Wo = "CircleExplosionMaterial";
let Ec = !1;
function H_() {
  Ec || !I.Material || !I.Material._materialCache || (I.Material._materialCache.addMaterial(Wo, {
    fabric: {
      type: Wo,
      uniforms: {
        color: I.Color.RED.clone(),
        time: 0,
        speed: 1,
        fillAlpha: 0.25,
        edgeWidth: 0.03,
...
class W_ {
  constructor(e = {}) {
    this._definitionChanged = new I.Event(), this.color = I.Color.fromCssColorString(e.color || "#ff0000"), this.duration = e.duration || 2e3, this.speed = e.speed || 1, this.fillAlpha = e.fillAlpha ?? 0.25, this.edgeWidth = e.edgeWidth ?? 0.03, this.waveWidth = e.waveWidth ?? 0.05, this._startTime = Date.now();
  }
  get isConstant() {
    return !1;
  }
  ...
  getValue(e, t = {}) {
    return t.color = I.Color.clone(this.color, t.color), t.time = (Date.now() - this._startTime) % this.duration / this.duration, t.speed = this.speed, t.fillAlpha = this.fillAlpha, t.edgeWidth = this.edgeWidth, t.waveWidth = this.waveWidth, t;
  }
  equals(e) {
    return this === e;
  }
...
class $_ {
  constructor(e, t = {}) {
    this.viewer = e, this.config = {
      ...
      height: 0,
      ...t
    }, this.layer = new I.CustomDataSource("circle-explosion-layer"), this.viewer.dataSources.add(this.layer), H_();
  }
  setData(e = []) {
  ...
  addLayer(e) {
    var f;
    if (!this.viewer || this.viewer.isDestroyed() || !((f = e == null ? void 0 : e.geometry) != null && f.coordinates)) return;
    const [t, r, o = this.config.height] = e.geometry.coordinates, a = e.properties || {}, u = a.id || bt(), l = this.layer.entities.add({
      id: u,
      position: I.Cartesian3.fromDegrees(t, r, o),
      ellipse: {
        semiMajorAxis: a.radius || this.config.radius,
...
const $o = "PointRippleMaterial";
let Cc = !1;
function Z_() {
  Cc || !I.Material || !I.Material._materialCache || (I.Material._materialCache.addMaterial($o, {
    fabric: {
      type: $o,
      uniforms: {
        color: new I.Color(1, 0, 0, 1),
        time: 1,
        speed: 1,
        innerFade: 1.5,
        // 中心衰减强度
...
class K_ {
  constructor(e = {}) {
    this._definitionChanged = new I.Event(), this.color = I.Color.fromCssColorString(e.color || "#ff3b30"), this.duration = e.duration || 2e3, this.speed = e.speed ?? 1, this.innerFade = e.innerFade ?? 1.5, this.ringWidth = e.ringWidth ?? 0.06, this._startTime = Date.now();
  }
  get isConstant() {
    return !1;
  }
...
class J_ {
  constructor(e, t = {}) {
    this.viewer = e, this.config = {
      ...
      height: 0,
      ...t
    }, this.layer = new I.CustomDataSource("point-ripple-layer"), this.viewer.dataSources.add(this.layer), Z_();
  }
  /**
...
class Q_ {
  ...
  setData(e) {
    ...
    e.forEach((u) => {
      var v, m;
      const l = (v = u.geometry) == null ? void 0 : v.coordinates, f = ((m = u.geometry) == null ? void 0 : m.type) || "Polygon";
      if (!l || !l.length) return;
      const g = (p) => {
        var A, O, Y;
        const _ = p[0], w = p.slice(1), S = [];
        _.forEach((V) => S.push(V[0], V[1]));
        const L = w.map((V) => {
          const C = [];
          return V.forEach((M) => C.push(M[0], M[1])), new I.PolygonHierarchy(
            I.Cartesian3.fromDegreesArray(C)
          );
        }), b = new I.PolygonGeometry({
          polygonHierarchy: new I.PolygonHierarchy(
            I.Cartesian3.fromDegreesArray(S),
            L
          ),
          vertexFormat: I.PerInstanceColorAppearance.VERTEX_FORMAT
        }), k = ((A = u.properties) == null ? void 0 : A.id) || bt();
        t.push(new I.GeometryInstance({
          geometry: b,
          id: k,
          attributes: {
            color: I.ColorGeometryInstanceAttribute.fromColor(
              I.Color.fromCssColorString(((O = u.properties) == null ? void 0 : O.color) || this.config.color).withAlpha(this.config.opacity)
            )
          }
        }));
        const N = (V) => {
          const C = [];
          return V.forEach((M) => C.push(M[0], M[1])), C.push(V[0][0], V[0][1]), I.Cartesian3.fromDegreesArray(C);
        };
        r.push(new I.GeometryInstance({
          geometry: new I.PolylineGeometry({
            positions: N(_),
          ...
          attributes: {
            color: I.ColorGeometryInstanceAttribute.fromColor(
              I.Color.fromCssColorString(((Y = u.properties) == null ? void 0 : Y.color) || this.config.color)
            )
          }
        })), w.forEach((V) => {
          var C;
          r.push(new I.GeometryInstance({
            ...
            attributes: {
              color: I.ColorGeometryInstanceAttribute.fromColor(
                I.Color.fromCssColorString(((C = u.properties) == null ? void 0 : C.color) || this.config.color)
              )
            }
          }));
        });
      };
      f === "Polygon" && g(l), f === "MultiPolygon" && l.forEach((p) => {
        g(p);
      });
    });
    const o = new I.PerInstanceColorAppearance({
      translucent: !1,
      closed: !0,
      faceForward: !0,
      renderState: I.RenderState.fromCache({
    ...
    const a = new I.PolylineColorAppearance({ translucent: !1 });
...
class j_ {
  ...
  getAppearance(e) {
    var r, o, a, u, l, f, g;
    const t = I.Color.fromCssColorString(this.config.color);
    switch (e) {
      case "dash":
        return new I.PolylineMaterialAppearance({
          material: I.Material.fromType(I.Material.PolylineDashType, {
            color: t,
            //颜色
            gapColor: (r = this.config) != null && r.gapColor ? new I.Color.fromCssColorString((o = this.config) == null ? void 0 : o.gapColor) : I.Color.TRANSPARENT,
            //间隙颜色
      ...
      case "glow":
        return new I.PolylineMaterialAppearance({
          material: I.Material.fromType(I.Material.PolylineGlowType, {
            color: t,
            glowPower: ((u = this.config) == null ? void 0 : u.glowPower) || 0.25,
            taperPower: ((l = this.config) == null ? void 0 : l.taperPower) || 1
          }),
          translucent: !1
        });
      case "outline":
        return new I.PolylineMaterialAppearance({
          material: I.Material.fromType(I.Material.PolylineOutlineType, {
            color: t,
            outlineWidth: ((f = this.config) == null ? void 0 : f.outlineWidth) || 1,
            outlineColor: new I.Color.fromCssColorString((g = this.config) == null ? void 0 : g.outlineColor)
          }),
          translucent: !1
        });
      case "arrow":
        return new I.PolylineMaterialAppearance({
          material: I.Material.fromType(I.Material.PolylineArrowType, {
            color: t
          }),
          translucent: !1
        });
  ...
  setData(e) {
    ...
    const r = this.getAppearance(this.config.type), o = new I.Primitive({
      geometryInstances: t,
      appearance: r,
      asynchronous: !1,
      // 设置较低的绘制顺序，让线先绘制
...
class ew {
  constructor(e, t = {}) {
    this.viewer = e, this.config = {
      ...
      rectangle: {
        coordinates: I.Rectangle.fromDegrees(0, 0, 0, 0),
        material: new I.ImageMaterialProperty({
          image: this._canvas,
          transparent: !0
        })
      }
  ...
  _calcBounds(e) {
    ...
    e.forEach((l) => {
      t = Math.min(t, l.lon), r = Math.min(r, l.lat), o = Math.max(o, l.lon), a = Math.max(a, l.lat);
    });
    const u = 0.01;
    return I.Rectangle.fromDegrees(
      t - u,
      r - u,
      o + u,
      a + u
  ...
  setData(e = []) {
    if (this._points = [], !!Array.isArray(e)) {
      if (e.forEach((t) => {
        ...
        const [r, o] = t.geometry.coordinates, a = Sc((l = t.properties) == null ? void 0 : l.value, 50);
  ...
  _draw() {
    ...
    const r = this._rect, o = I.Math.toDegrees(r.west), a = I.Math.toDegrees(r.south), u = I.Math.toDegrees(r.east), l = I.Math.toDegrees(r.north), f = u - o || 1e-6, g = l - a || 1e-6;
    this._points.forEach((v) => {
      const m = (v.lon - o) / f * t, p = (l - v.lat) / g * t;
      if (!Number.isFinite(m) || !Number.isFinite(p)) return;
      const _ = Math.max(1, Sc(this.config.radius, 50)), w = e.createRadialGradient(m, p, 0, m, p, _), S = Math.min(v.value / this.config.maxValue, 1);
      w.addColorStop(0, `rgba(0,0,0,${S})`), w.addColorStop(1, "rgba(0,0,0,0)"), e.fillStyle = w, e.beginPath(), e.arc(m, p, _, 0, Math.PI * 2), e.fill();
    }), this._applyGradient();
  }
  _applyGradient() {
  ...
  clearLayer() {
    ...
    t.material = new I.ImageMaterialProperty({
      image: this._canvas,
      transparent: !0
    }), t.material = r;
  }
...
var ur = {
  ...
  return e.prototype = {
    ...
    _organiseData: function(r, o) {
      var a = r[this._xField], u = r[this._yField], l = this._radi, f = this._data, g = this._max, v = this._min, m = r[this._valueField] || 1, p = r.radius || this._cfgRadius || t;
      return f[a] || (f[a] = [], l[a] = []), f[a][u] ? f[a][u] += m : (f[a][u] = m, l[a][u] = p), f[a][u] > g ? (o ? this.setDataMax(f[a][u]) : this._max = f[a][u], !1) : {
        x: a,
        y: u,
        value: m,
        radius: p,
  ...
  var e = function(a) {
    var u = a.gradient || a.defaultGradient, l = document.createElement("canvas"), f = l.getContext("2d");
    ...
    var l = document.createElement("canvas"), f = l.getContext("2d"), g = a, v = a;
    if (l.width = l.height = a * 2, u == 1)
    ...
    for (var u = [], l = v.min, f = v.max, g = v.radi, v = v.data, m = Object.keys(v), p = m.length; p--; )
      for (var _ = m[p], w = Object.keys(v[_]), S = w.length; S--; ) {
        var L = w[S], b = v[_][L], k = g[_][L];
        u.push({
          x: _,
          y: L,
          value: b,
  ...
  function o(a) {
    var u = a.container, l = this.shadowCanvas = document.createElement("canvas"), f = this.canvas = a.canvas || document.createElement("canvas");
    this._renderBoundaries = [1e4, 1e4, 0, 0];
    var g = getComputedStyle(a.container) || {};
    f.className = "heatmap-canvas", this._width = f.width = l.width = +g.width.replace(/px/, ""), this._height = f.height = l.height = +g.height.replace(/px/, ""), this.shadowCtx = l.getContext("2d"), this.ctx = f.getContext("2d"), f.style.cssText = l.style.cssText = "position:absolute;left:0;top:0;", u.style.position = "relative", u.appendChild(f), this._palette = e(a), this._templates = {}, this._setStyles(a);
  }
  return o.prototype = {
    ...
    _drawAlpha: function(f) {
      for (var u = this._min = f.min, l = this._max = f.max, f = f.data || [], g = f.length, v = 1 - this._blur; g--; ) {
        var m = f[g], p = m.x, _ = m.y, w = m.radius, S = Math.min(m.value, l), L = p - w, b = _ - w, k = this.shadowCtx, N;
        this._templates[w] ? N = this._templates[w] : this._templates[w] = N = t(w, v), k.globalAlpha = (S - u) / (l - u), k.drawImage(N, L, b), L < this._renderBoundaries[0] && (this._renderBoundaries[0] = L), b < this._renderBoundaries[1] && (this._renderBoundaries[1] = b), L + 2 * w > this._renderBoundaries[2] && (this._renderBoundaries[2] = L + 2 * w), b + 2 * w > this._renderBoundaries[3] && (this._renderBoundaries[3] = b + 2 * w);
      }
    },
    _colorize: function() {
      var a = this._renderBoundaries[0], u = this._renderBoundaries[1], l = this._renderBoundaries[2] - a, f = this._renderBoundaries[3] - u, g = this._width, v = this._height, m = this._opacity, p = this._maxOpacity, _ = this._minOpacity, w = this._useGradientOpacity;
      a < 0 && (a = 0), u < 0 && (u = 0), a + l > g && (l = g - a), u + f > v && (f = v - u);
      for (var S = this.shadowCtx.getImageData(a, u, l, f), L = S.data, b = L.length, k = this._palette, N = 3; N < b; N += 4) {
        var A = L[N], O = A * 4;
        if (O) {
          var Y;
          m > 0 ? Y = m : A < p ? A < _ ? Y = _ : Y = A : Y = p, L[N - 3] = k[O], L[N - 2] = k[O + 1], L[N - 1] = k[O + 2], L[N] = w ? k[O + 3] : Y;
        }
      }
      Object.defineProperty(S, "data", {
        ...
        configurable: !0,
        enumerable: !0
      }), this.ctx.putImageData(S, a, u), this._renderBoundaries = [1e3, 1e3, 0, 0];
    },
    getValueAt: function(a) {
      var u, l = this.shadowCtx, f = l.getImageData(a.x, a.y, 1, 1), g = f.data[3], v = this._max, m = this._min;
  ...
  var e = !1;
  return ur.defaultRenderer === "canvas2d" && (e = nw), e;
}(), Ic = {
  merge: function() {
  ...
  var e = function() {
    ...
    var a = o._renderer, u = o._coordinator, l = o._store;
  ...
  function r() {
    var o = this._config = Ic.merge(ur, arguments[0] || {});
    if (this._coordinator = new e(), o.plugin) {
      ...
      this._renderer = new rw(o), this._store = new tw(o);
    t(this);
  }
  return r.prototype = {
    addData: function() {
    ...
    configure: function(o) {
      return this._config = Ic.merge(this._config, o), this._renderer.updateConfig(this._config), this._coordinator.emit("renderall", this._store._getInternalData()), this;
    },
    repaint: function() {
...
class ow {
  ...
  setData(e) {
    ...
    const r = t.map((o) => {
      ...
      return {
        x: a,
        y: u,
        value: Number(((l = o.properties) == null ? void 0 : l.value) ?? 1)
      };
    });
  ...
  _createHeatmap(e) {
    ...
    const f = this.config.minValue ?? Math.min(...l), g = this.config.maxValue ?? Math.max(...l), v = {
      min: f,
      max: g,
      data: u
    };
    this.heatmap = sw.create({
      container: r,
  ...
  _createLayer() {
    ...
    this.config.renderType === "primitive" ? (this.provider = this.viewer.scene.primitives.add(
      new I.Primitive({
        geometryInstances: new I.GeometryInstance({
          geometry: new I.RectangleGeometry({
            rectangle: I.Rectangle.fromDegrees(...this.bounds),
            vertexFormat: I.EllipsoidSurfaceAppearance.VERTEX_FORMAT
          })
        }),
        appearance: new I.EllipsoidSurfaceAppearance({
          aboveGround: !1
        })
      })
    ), this.provider.appearance.material = new I.Material({
      fabric: {
        type: "Image",
        uniforms: {
          image: e
      ...
      rectangle: {
        coordinates: I.Rectangle.fromDegrees(...this.bounds),
        material: new I.ImageMaterialProperty({
          image: e
        })
      }
  ...
  _updateLayer() {
    const e = this.heatmap.getDataURL();
    this.provider instanceof I.Primitive && (this.provider.appearance.material.uniforms.image = e), this.provider instanceof I.Entity && (this.provider.rectangle.material = new I.ImageMaterialProperty({
      image: e
    })), this.provider instanceof I.ImageryLayer && (this.viewer.imageryLayers.remove(this.provider), this.provider = this.viewer.imageryLayers.addImageryProvider(
      new I.SingleTileImageryProvider({
        url: e,
        rectangle: I.Rectangle.fromDegrees(...this.bounds)
      })
  ...
  /*----------------------------------*/
  clearLayer() {
    this.provider && (this.provider instanceof I.Primitive && this.viewer.scene.primitives.remove(this.provider), this.provider instanceof I.ImageryLayer && this.viewer.imageryLayers.remove(this.provider), this.provider instanceof I.Entity && this.viewer.entities.remove(this.provider), this.provider = null, this.container && (document.body.removeChild(this.container), this.container = null));
  }
  destroy() {
...
class aw {
  ...
  createHemisphere() {
    const e = this.viewer.entities.add({
      position: I.Cartesian3.fromDegrees(
        this.centerLongitude,
        this.centerLatitude,
        this.centerHeight
      ),
      ...
      ellipsoid: {
        radii: new I.Cartesian3(this.radius, this.radius, this.radius),
        maximumCone: I.Math.toRadians(90),
  ...
  createScanWall() {
    const e = this.viewer.entities.add({
      wall: {
        positions: new I.CallbackProperty(() => I.Cartesian3.fromDegreesArrayHeights(this.wallPositions), !1),
  ...
  calculateScanPane(e, t, r, o) {
    const a = I.Cartesian3.fromDegrees(e, t, this.centerHeight), u = I.Transforms.eastNorthUpToFixedFrame(a), l = I.Math.toRadians(o), f = I.Cartesian3.fromElements(
      r * Math.cos(l),
      r * Math.sin(l),
      0
    ), g = I.Matrix4.multiplyByPoint(
      u,
      f,
      new I.Cartesian3()
    ), v = I.Cartographic.fromCartesian(g);
  ...
  calculateScanSector(e, t, r, o) {
    const a = [e, t, this.centerHeight], u = I.Cartesian3.distance(
      I.Cartesian3.fromDegrees(e, t, this.centerHeight),
      I.Cartesian3.fromDegrees(r, o, this.centerHeight)
    );
    for (let l = 0; l <= 90; l += 2) {
      const f = I.Math.toRadians(l), g = this.centerHeight + u * Math.sin(f), v = Math.cos(f);
      a.push((r - e) * v + e), a.push((o - t) * v + t), a.push(g);
    }
    return a;
  }
  getColor(e) {
    return e instanceof I.Color ? e : I.Color.fromCssColorString(e || "#05fbf8");
  }
  stop() {
...
const Vw = {
  ...
  LabelGroupLayer: Nd,
  LineGroupLayer: Td,
  LinePrimitiveLayer: Rd,
  Build3DLayer: Ad,
  BubbleLayer: Od,
  BubbleGroupLayer: q_,
  CircleGroupLayer: U_,
  CircleWaveLayer: V_,
  CircleExplosionLayer: $_,
  PointRippleLayer: J_,
  PolygonPrimitiveLayer: Q_,
  LineMaterialLayer: j_,
  HeatmapLayer: ew,
  HeatmapPrimitiveLayer: ow,
  RadarScanner3DLayer: aw
}, Ui = 3.141592653589793 * 3e3 / 180, yt = 3.141592653589793, kc = 6378245, bc = 0.006693421622965943;
class On {
  static BD09ToGCJ02(e, t) {
    const r = Number(e) - 65e-4, o = Number(t) - 6e-3, a = Math.sqrt(r * r + o * o) - 2e-5 * Math.sin(o * Ui), u = Math.atan2(o, r) - 3e-6 * Math.cos(r * Ui);
    return [a * Math.cos(u), a * Math.sin(u)];
  }
  static GCJ02ToBD09(e, t) {
    const r = Number(e), o = Number(t), a = Math.sqrt(r ** 2 + o ** 2) + 2e-5 * Math.sin(o * Ui), u = Math.atan2(o, r) + 3e-6 * Math.cos(r * Ui);
  ...
  static delta(e, t) {
    ...
    u = 1 - bc * u * u;
    const l = Math.sqrt(u);
    return r = r * 180 / (kc / l * Math.cos(a) * yt), o = o * 180 / (kc * (1 - bc) / (u * l) * yt), [r, o];
  }
...
class Ls extends I.WebMercatorTilingScheme {
  constructor(e = {}) {
    super(e);
    const t = new I.WebMercatorProjection();
    this._projection.project = (r) => {
      const [o, a] = On.WGS84ToGCJ02(
        I.Math.toDegrees(r.longitude),
        I.Math.toDegrees(r.latitude)
      ), u = t.project(new I.Cartographic(
        I.Math.toRadians(o),
        I.Math.toRadians(a)
      ));
      return new I.Cartesian2(u.x, u.y);
    }, this._projection.unproject = (r) => {
      const o = t.unproject(r), [a, u] = On.GCJ02ToWGS84(
        I.Math.toDegrees(o.longitude),
        I.Math.toDegrees(o.latitude)
      );
      return new I.Cartographic(
        I.Math.toRadians(a),
        I.Math.toRadians(u)
      );
    };
...
class Mf extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    var r;
    const t = {
      ...e,
      url: e.url || `${e.protocol || ""}${Mc[e.style] || Mc.elec}`,
      subdomains: (r = e.subdomains) != null && r.length ? e.subdomains : ["01", "02", "03", "04"]
    };
    e.crs === "WGS84" && !e.tilingScheme && (t.tilingScheme = new Ls()), super(t);
  }
}
const Lf = "https://server.arcgisonline.com/arcgis/rest/services/World_Imagery/MapServer";
function uw(n, e) {
...
class Pf extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    const t = e.url || Lf;
    super({
      ...e,
      url: uw(t, e.accessToken),
      minimumLevel: e.minimumLevel ?? 0,
      maximumLevel: e.maximumLevel ?? 23,
      credit: e.credit || new I.Credit("© Esri World Imagery")
    }), this._serviceUrl = t;
  }
  get serviceUrl() {
...
const lw = 637099681e-2, cw = [1289059486e-2, 836237787e-2, 5591021, 348198983e-2, 167804312e-2, 0], Lc = [75, 60, 45, 30, 15, 0], Pc = [
...
class Nf {
  ...
  convertMC2LL(e) {
    ...
    if (this.isWgs84) {
      const a = e.lng / 2003750834e-2 * 180, u = e.lat / 2003750834e-2 * 180, l = 180 / Math.PI * (2 * Math.atan(Math.exp(u * Math.PI / 180)) - Math.PI / 2);
      return { lng: Number(a.toFixed(6)), lat: Number(l.toFixed(6)) };
    }
    const t = Math.abs(e.lat), r = Pc[cw.findIndex((a) => t >= a)] || Pc.at(-1), o = this.convertor(e, r);
  ...
  convertLL2MC(e) {
    ...
    if (this.isWgs84) {
      const u = e.lng * Math.PI / 180 * 6378137, l = e.lat * Math.PI / 180, f = 6378137 / 2 * Math.log((1 + Math.sin(l)) / (1 - Math.sin(l)));
    ...
    let r = Lc.findIndex((a) => t.lat >= a);
    r < 0 && (r = Lc.findIndex((a) => t.lat <= -a));
    const o = this.convertor(t, Nc[r < 0 ? Nc.length - 1 : r]);
  ...
  getDistance(e, t, r, o) {
    return lw * Math.acos(Math.sin(r) * Math.sin(o) + Math.cos(r) * Math.cos(o) * Math.cos(t - e));
  }
  toRadians(e) {
...
class Tf extends I.WebMercatorTilingScheme {
  constructor(e = {}) {
    super(e);
    const t = new Nf();
    this._projection.project = (r) => {
      let o = On.WGS84ToGCJ02(
        I.Math.toDegrees(r.longitude),
        I.Math.toDegrees(r.latitude)
      );
      o = On.GCJ02ToBD09(o[0], o[1]), o[0] = Math.min(180, Math.max(-180, o[0])), o[1] = Math.min(74.000022, Math.max(-71.988531, o[1]));
      const a = t.lngLatToPoint({ lng: o[0], lat: o[1] });
      return new I.Cartesian2(a.x, a.y);
    }, this._projection.unproject = (r) => {
      let o = t.mercatorToLngLat({ lng: r.x, lat: r.y });
      return o = On.BD09ToGCJ02(o.lng, o.lat), o = On.GCJ02ToWGS84(o[0], o[1]), new I.Cartographic(
        I.Math.toRadians(o[0]),
        I.Math.toRadians(o[1])
      );
    }, this.resolutions = e.resolutions || [];
  }
  tileXYToNativeRectangle(e, t, r, o) {
    const a = this.resolutions[r], u = e * a, l = (e + 1) * a, f = (-t + 1) * a, g = -t * a;
    return I.defined(o) ? (o.west = u, o.south = g, o.east = l, o.north = f, o) : new I.Rectangle(u, g, l, f);
  }
  positionToTileXY(e, t, r) {
    if (!I.Rectangle.contains(this._rectangle, e)) return;
    const o = this._projection.project(e);
    if (!I.defined(o)) return;
    const a = this.resolutions[t], u = Math.floor(o.x / a), l = -Math.floor(o.y / a);
    return I.defined(r) ? (r.x = u, r.y = l, r) : new I.Cartesian2(u, l);
  }
}
const hw = {
...
function fw(n = "normal") {
  return Rf[String(n).toLowerCase()];
}
function gw(n, e) {
  if (!e) return n;
...
class Af extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    const t = fw(e.style);
    if (!e.url && !t)
    ...
    const r = e.url || hw[t], o = e.customId || e.style || "", a = gw(r, e.protocol).replaceAll("{customId}", encodeURIComponent(o)).replaceAll("{style}", encodeURIComponent(o));
    let u = e.tilingScheme;
    if (!u && e.crs === "WGS84") {
      const f = Array.from({ length: 19 }, (g, v) => 256 * 2 ** (18 - v));
      u = new Tf({
        resolutions: f,
        rectangleSouthwestInMeters: new I.Cartesian2(-2003772637e-2, -1247410417e-2),
        rectangleNortheastInMeters: new I.Cartesian2(2003772637e-2, 1247410417e-2)
      });
    } else u || (u = new I.WebMercatorTilingScheme({
      rectangleSouthwestInMeters: new I.Cartesian2(-33554054, -33746824),
      rectangleNortheastInMeters: new I.Cartesian2(33554054, 33746824)
    }));
    const l = e.subdomains || ["0", "1", "2", "3"];
    super({
      ...e,
      url: a,
      subdomains: l,
      ...
      credit: e.credit || new I.Credit("© Baidu Maps")
    }), this._url = a, this._crs = e.crs || "BD09", this._style = t || "custom", this._subdomains = Array.isArray(l) ? l : String(l).split(""), this._rectangle = this._tilingScheme.rectangle;
  }
  requestImage(e, t, r) {
    ...
    let l = this._url.replaceAll("{z}", String(r)).replaceAll("{s}", u);
    return this._crs === "WGS84" ? l = l.replaceAll("{x}", String(e)).replaceAll("{y}", String(-t)) : l = l.replaceAll("{x}", String(e - o / 2)).replaceAll("{y}", String(a / 2 - t - 1)), I.ImageryProvider.loadImage(this, l);
  }
}
const dw = "//tiles{s}.geovisearth.com/base/v1/{style}/{z}/{x}/{y}?format={format}&tmsIds=w&token={key}";
class Of extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    const t = e.url || `${e.protocol || ""}${dw.replaceAll("{style}", e.style || "vec").replaceAll("{format}", e.format || "png").replaceAll("{key}", e.key || "")}`;
    super({
      ...e,
      url: t,
...
const Df = Object.freeze({
  ...
  img_cva: "y",
  hybrid: "y"
}), mw = "https://mt{s}.google.com/vt/lyrs={style}&hl={language}&gl={region}&x={x}&y={y}&z={z}", vw = "https://tile.googleapis.com/v1/2dtiles/{z}/{x}/{y}?session={sessionToken}&key={key}";
function yw(n, e) {
  if (n.url) return n.url;
  if (n.key || n.sessionToken) {
    if (!n.key || !n.sessionToken)
      throw new Error("Google Maps Tile API requires both key and sessionToken.");
    return vw.replace("{key}", encodeURIComponent(n.key)).replace("{sessionToken}", encodeURIComponent(n.sessionToken));
  }
  return mw.replace("{style}", e).replace("{language}", encodeURIComponent(n.language || "zh-CN")).replace("{region}", encodeURIComponent(n.region || "cn"));
}
class Ff extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    const t = String(e.style || "normal").toLowerCase(), r = Df[t];
    if (!e.url && !r)
    ...
    const o = {
      ...
      credit: e.credit || new I.Credit("© Google")
    };
    e.crs === "WGS84" && !e.tilingScheme && !(e.key && e.sessionToken) && (o.tilingScheme = new Ls()), super(o), this._style = t;
  }
}
const pw = "//t{s}.tianditu.gov.cn/DataServer?T={style}_w&x={x}&y={y}&l={z}&tk={key}";
class Bf extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    const t = e.url || `${e.protocol || ""}${pw.replaceAll("{style}", e.style || "vec").replaceAll("{key}", e.key || "")}`;
    super({
      ...e,
      url: t,
...
class Gf extends I.UrlTemplateImageryProvider {
  constructor(e = {}) {
    var a;
    const t = e.style || "1", r = (e.url || `${e.protocol || ""}${Tc[e.style] || Tc.elec}`).replace("{style}", t), o = {
      ...e,
      url: r,
...
function ww(n) {
  ...
  return _w.forEach((t) => delete e[t]), e;
}
function qf(n = {}) {
  if (n.provider) return n.provider;
  const e = String(n.type || "url-template").toLowerCase(), t = ww(n);
  if (e === "url-template" || e === "offline") {
    if (!t.url) throw new Error("Base map URL is required.");
    return n.token && (t.url = new I.Resource({
      url: t.url,
      headers: { Authorization: n.token }
    })), !t.tilingScheme && n.coordinateSystem === "GCJ02" && (t.tilingScheme = new Ls()), new I.UrlTemplateImageryProvider(t);
  }
  const r = zf[e];
  if (!r)
...
class Ew {
  ...
  load(e = {}) {
    ...
    const t = qf(this.config), r = {
      show: this.config.show,
      ...this.config.layerOptions || {}
    };
    this.imageryLayer = new I.ImageryLayer(t, r);
  ...
  setTheme(e) {
    this.ensureUsable(), this.removeColor(), e && (this.theme = new Cd(this.viewer), this.theme.addColor({ invertColor: !0, filterRGB: e }));
  }
  removeColor() {
    var e;
...
class Cw extends I.GeographicTilingScheme {
  constructor(e = {}) {
  ...
  tileXYToRectangle(e, t, r, o) {
    ...
    if (!a) return I.Rectangle.MAX_VALUE;
    const u = a * this._tileSize, l = I.Math.toRadians(this._origin[0] + e * u), f = I.Math.toRadians(this._origin[1] - (t + 1) * u), g = I.Math.toRadians(this._origin[0] + (e + 1) * u), v = I.Math.toRadians(this._origin[1] - t * u);
    return I.defined(o) ? (o.west = l, o.south = f, o.east = g, o.north = v, o) : new I.Rectangle(l, f, g, v);
  }
  positionToTileXY(e, t, r) {
    const o = this._resolutions[t + this._zoomOffset];
    if (!o) return new I.Cartesian2();
    const a = o * this._tileSize, u = I.Math.toDegrees(e.longitude), l = I.Math.toDegrees(e.latitude), f = Math.floor((u - this._origin[0]) / a), g = Math.floor((this._origin[1] - l) / a);
    return I.defined(r) ? (r.x = f, r.y = g, r) : new I.Cartesian2(Math.max(0, f), Math.max(0, g));
  }
}
class Sw extends I.WebMercatorTilingScheme {
  constructor(e = {}) {
  ...
  tileXYToNativeRectangle(e, t, r, o) {
    const a = this._resolutions[r + this._zoomOffset];
    if (!a || e < 0 || t < 0) return I.Rectangle.MAX_VALUE;
    const u = a * this._tileSize, l = this._origin[0] + e * u, f = this._origin[1] - (t + 1) * u, g = this._origin[0] + (e + 1) * u, v = this._origin[1] - t * u;
    return I.defined(o) ? (o.west = l, o.south = f, o.east = g, o.north = v, o) : new I.Rectangle(l, f, g, v);
  }
  positionToTileXY(e, t, r) {
    if (!I.Rectangle.contains(this._rectangle, e)) return;
    const o = this._resolutions[t + this._zoomOffset];
    if (!o) return new I.Cartesian2();
    const a = o * this._tileSize, u = this._projection.project(e), l = Math.floor((u.x - this._origin[0]) / a), f = Math.floor((this._origin[1] - u.y) / a);
    return I.defined(r) ? (r.x = l, r.y = f, r) : new I.Cartesian2(Math.max(0, l), Math.max(0, f));
  }
}
const Hw = {
  BaseMap: Ew,
  createImageryProvider: qf,
  imageryProviderTypes: xw,
  AMapImageryProvider: Mf,
  ArcGISImageryProvider: Pf,
  arcgisWorldImageryUrl: Lf,
  BaiduImageryProvider: Af,
  baiduImageryStyles: Rf,
  TencentImageryProvider: Gf,
  TdtImageryProvider: Bf,
  GoogleImageryProvider: Ff,
  googleImageryStyles: Df,
  GeoVisImageryProvider: Of,
  GCJ02TilingScheme: Ls,
  BD09TilingScheme: Tf,
  CustomGeographicTilingScheme: Cw,
  CustomMercatorTilingScheme: Sw,
  BD09Projection: Nf,
  CoordTransform: On
};
let Rc = 0;
function Iw(n) {
  return Rc += 1, `bmap-viewer-weather-${n}-${Rc}`;
}
class zn {
  constructor(e, t, r = {}, o = {}) {
    var a;
  ...
  load(e = {}) {
    return this.ensureUsable(), this.remove(), this.config = { ...this.defaults, ...this.config, ...e }, this.colorCache.clear(), this.stage = this.createStage(Iw(this.type)), this.viewer.scene.postProcessStages.add(this.stage), this.viewer.scene.requestRender(), this.stage;
  }
  createStage() {
  ...
  getColor(e, t) {
    ...
    if (!this.colorCache.has(o)) {
      const a = r instanceof I.Color ? I.Color.clone(r) : I.Color.fromCssColorString(String(r));
...
class Uf extends zn {
  constructor(e, t = {}) {
    super(e, "rain", $t, t), this.rainStage = null, this.lightningStage = null, this.load();
  }
  createStage(e) {
    return this.rainStage = new I.PostProcessStage({
      name: `${e}-rain`,
      fragmentShader: kw,
      uniforms: {
        intensity: () => this.getNumber("intensity", $t.intensity, 0, 1),
        density: () => this.getNumber("density", $t.density, 0.1, 3),
        speed: () => this.getNumber("speed", $t.speed, 0.05, 5),
        size: () => this.getNumber("size", $t.size, 0.1, 3),
        angle: () => this.getNumber("angle", $t.angle, -180, 180),
        wind: () => this.getNumber("wind", $t.wind, -2, 2),
        tint: () => this.getColor("color", $t.color)
      }
    }), this.lightningStage = new I.PostProcessStage({
      name: `${e}-lightning`,
      fragmentShader: bw,
      uniforms: {
        ...
        mixFactor: () => this.getNumber(
          "lightningMixFactor",
          $t.lightningMixFactor,
          0,
          1
        ),
        fallInterval: () => this.getNumber(
          "lightningFallInterval",
          $t.lightningFallInterval,
          0.01,
          1
        )
      }
    }), new I.PostProcessStageComposite({
      name: e,
...
class Yf extends zn {
  constructor(e, t = {}) {
    super(e, "snow", _n, t), this.load();
  }
  createStage(e) {
    return new I.PostProcessStage({
      name: e,
      fragmentShader: Mw,
      uniforms: {
        intensity: () => this.getNumber("intensity", _n.intensity, 0, 1),
        density: () => this.getNumber("density", _n.density, 0.1, 3),
        speed: () => this.getNumber("speed", _n.speed, 0.05, 5),
        size: () => this.getNumber("size", _n.size, 0.1, 3),
        angle: () => this.getNumber("angle", _n.angle, -180, 180),
        drift: () => this.getNumber("drift", _n.drift, -2, 2),
        tint: () => this.getColor("color", _n.color)
      }
    });
  }
}
...
class Xf extends zn {
  constructor(e, t = {}) {
    super(e, "fog", Tn, wo(t)), this.load();
  }
  load(e = {}) {
    return super.load(wo(e));
  }
  setOptions(e = {}) {
    return super.setOptions(wo(e));
  }
  createStage(e) {
    return new I.PostProcessStage({
      name: e,
      ...
      uniforms: {
        ...
        nearDistance: () => this.getNumber("near", Tn.near, 0, 1e7),
        farDistance: () => this.getNumber("far", Tn.far, 1, 1e7),
        density: () => this.getNumber("density", Tn.density, 0.01, 10),
        skyAmount: () => this.getNumber("skyAmount", Tn.skyAmount, 0, 1),
        fogColor: () => this.getColor("color", Tn.color)
      }
    });
  }
}
...
class Zo extends zn {
  constructor(e, t = {}) {
    super(e, "sandstorm", Jn, t), this.load();
  }
  createStage(e) {
    return new I.PostProcessStage({
      name: e,
      ...
      uniforms: {
        ...
        density: () => this.getNumber("density", Jn.density, 0.05, 2.5),
        speed: () => this.getNumber("speed", Jn.speed, 0.01, 5),
        wind: () => this.getNumber("wind", Jn.wind, -2, 2),
        sandColor: () => this.getColor("color", Jn.color)
      }
    });
  }
}
...
class Vf extends zn {
  ...
  createStage(e) {
    return new I.PostProcessStage({
      ...
      fragmentShader: Nw,
      uniforms: {
        intensity: () => this.getNumber("intensity", Rn.intensity, 0, 2),
        coverage: () => this.getNumber("coverage", Rn.coverage, 0, 1),
        scale: () => this.getNumber("scale", Rn.scale, 0.25, 20),
        speed: () => this.getNumber("speed", Rn.speed, -5, 5),
        altitude: () => this.getNumber("altitude", Rn.altitude, 0, 1),
        cloudColor: () => this.getColor("color", Rn.color)
      }
    });
  }
}
...
class Hf extends zn {
  constructor(e, t = {}) {
    super(e, "lightning", Qn, t), this.load();
  }
  createStage(e) {
    return new I.PostProcessStage({
      name: e,
      fragmentShader: Tw,
      uniforms: {
        intensity: () => this.getNumber("intensity", Qn.intensity, 0, 2),
        frequency: () => this.getNumber("frequency", Qn.frequency, 0.01, 5),
        brightness: () => this.getNumber("brightness", Qn.brightness, 0, 3),
        width: () => this.getNumber("width", Qn.width, 1e-3, 0.08),
        flashColor: () => this.getColor("color", Qn.color)
      }
    });
  }
}
...
function Wf(n, e, t = {}) {
  ...
  const a = String(r || "").toLowerCase(), u = Rw[a];
  if (!u)
...
class Ow {
  ...
  load(e, t = {}) {
    ...
    const r = { ...t };
    return delete r.type, this.type = String(e).toLowerCase(), this.config = { ...r }, this.effect = Wf(this.viewer, this.type, r), this.effect;
  }
  switch(e, t = {}) {
...
const Ww = {
  WeatherSystem: Ow,
  createWeatherEffect: Wf,
  weatherEffectTypes: Aw,
  BaseWeatherEffect: zn,
  RainEffect: Uf,
  SnowEffect: Yf,
  FogEffect: Xf,
  SandstormEffect: Zo,
...
export {
  Mf as AMapImageryProvider,
  Pf as ArcGISImageryProvider,
  Nf as BD09Projection,
  Tf as BD09TilingScheme,
  xo as BMapViewer,
  Af as BaiduImageryProvider,
  Ew as BaseMap,
  Hw as BaseMaps,
  zn as BaseWeatherEffect,
  Vf as CloudEffect,
  On as CoordTransform,
  Cw as CustomGeographicTilingScheme,
  Sw as CustomMercatorTilingScheme,
  Cd as EarthColor,
  Xf as FogEffect,
  Ls as GCJ02TilingScheme,
  Of as GeoVisImageryProvider,
  Ff as GoogleImageryProvider,
  Hf as LightningEffect,
  Vw as MapLayers,
  Bw as PickTools,
  Uf as RainEffect,
  Zo as SandstormEffect,
  Yf as SnowEffect,
  Bf as TdtImageryProvider,
  Gf as TencentImageryProvider,
  Ww as WeatherEffects,
  Ow as WeatherSystem,
  Lf as arcgisWorldImageryUrl,
  Rf as baiduImageryStyles,
  qf as createImageryProvider,
  Wf as createWeatherEffect,
  $w as default,
  Df as googleImageryStyles,
  xw as imageryProviderTypes,
  Xw as turf,
  yd as useCesium,
  Aw as weatherEffectTypes
};
